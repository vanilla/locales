...
$Definition['Sources that are selected here will be available to AI Suggested Answers.'] = 'Источники, выбранные здесь, будут доступны для предложенных ответов ИИ.';
