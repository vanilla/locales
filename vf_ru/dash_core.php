...
$Definition['%s is not a valid email address'] = '%s не правильный адрес электронной почты';
...
$Definition['. The community forum is what all of your users &amp; customers will see when they visit '] = '. Форум сообщества это то что ваши пользователи будут видеть при посещении ';
...
$Definition['Authors can always edit their posts'] = 'Автор всегда может редактировать свою публикацию';
$Definition['Authors can edit for 1 day after posting'] = 'Автор не сможет редактировать свою публикацию по прошествии 1 дня после её создания';
$Definition['Authors can edit for 1 month after posting'] = 'Автор не сможет редактировать свою публикацию через 1 месяц после её создания';
$Definition['Authors can edit for 1 week after posting'] = 'Автор не сможет редактировать свою публикацию через 1 неделю после её создания';
$Definition['Authors can edit for 5 minutes after posting'] = 'Автор не сможет редактировать свою публикацию через 5 минут после её создания';
$Definition['Authors can edit for 15 minutes after posting'] = 'Автор не сможет редактировать свою публикацию через 15 минут после её создания';
$Definition['Authors can edit for 30 minutes after posting'] = 'Автор не сможет редактировать свою публикацию через 30 минут после её создания';
$Definition['Authors cannot edit their posts'] = 'Авторам запрещено редактировать свои публикации';
...
$Definition['Ban List'] = 'Список отлучённых';
$Definition['Banner'] = 'Шапка сайта';
$Definition['Banner Logo'] = 'Логотип сайта';
$Definition['Banner Title'] = 'Заголовок сайта';
...
$Definition['Browse for a new banner logo if you would like to change it:'] = 'Просто укажите новый логотип, если вы хотите сменить текущий:';
...
$Definition['Categories &amp; Discussions'] = 'Разделы и Дискуссии';
$Definition['Categories are used to help organize discussions.'] = 'Разделы используются для того, чтобы организовать дискуссии. Хватайте и перетаскивайте разделы друг относительно друга. ';
$Definition['Categories are used to organize discussions.'] = '<strong>Разделы</strong> позволяют организовать дискуссии.';
...
$Definition['Comment  Body'] = 'Тело комментария';
...
$Definition['Comment  Subject'] = 'Предмет комментария';
...
$Definition['Content Flagging'] = 'Упрекаемый контент';
...
$Definition['Create & organize discussion categories, manage your users, and more...'] = 'Создай и организуй разделы дискуссий, управляй своими пользователями и более того...';
...
$Definition['starting your first discussion'] = 'создает вашу первую дискуссию';
...
$Definition['The banner title appears on the top-left of every page. If a banner logo is uploaded, it will replace the banner title on user-facing forum pages.'] = 'Заголовок сайта отображается вверху каждой страницы сайта. Если вы загрузите логотип, он заменит собой заголовок.';
...
$Definition['The following content has been flagged by users for moderator review.'] = 'Этот контент был помечен пользователями для того, чтобы модератор проверил его.';
...
$Definition['This is the administrative dashboard for your new community. Check out the configuration options to the left: from here you can configure how your community works. <b>Only users in the "Administrator" role can see this part of your community.</b>'] = 'Это административная панель вашего нового форума. В левой части панели вы найдёте меню консоли через которое вы можете переходить между разными её страницами и настраивать разные параметры конфигурации. Сделать это могут <b>только пользователи с привилегиями "Администратора"</b>.';
...
$Definition['This show the plugin on only selected discussion pages'] = 'Эта опция позволяет показывать плагин только на выбранных страницах дискуссий.';
...
$Definition['To embed your Vanilla community forum into a remote web application, use the forum embed code or one of the forum embed plugins below.'] = 'Для встраивания вашего форума на другой сайт, используйте код вставки форума или вставьте его с помощью плагинов указанных ниже.';
...
$Definition['Where should the plugin be shown?'] = 'Где должен быть показан плагин?';
...
$Definition['You need to configure ProxyConnect'] = 'Вам необходимо настроить прокси-соединение';
