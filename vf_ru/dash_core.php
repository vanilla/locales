...
$Definition['# of automation rules'] = 'количество правил автоматизации';
...
$Definition['1 Column - Default'] = '1 столбец - по умолчанию';
$Definition['1 Column - Full Width'] = '1 колонка - Полная ширина';
...
$Definition['2 Columns - Default'] = '2 столбца - по умолчанию';
$Definition['2 Columns - Even'] = '2 столбца - четное число';
$Definition['2 weeks after being sent'] = 'Две недели после отправки';
$Definition['3 Columns - Default'] = '3 столбца - по умолчанию';
$Definition['3 Columns - Even'] = '3 столбца - четное число';
...
$Definition['A banner to create a visually distinct area to place header information and begin a search.'] = 'Баннер, создающий визуально выделяющуюся область для размещения заголовка и начала поиска.';
...
$Definition['Admin Options'] = 'Параметры администратора';
...
$Definition['A fully customizable fragment to add custom elements and data to your community.'] = 'Полностью настраиваемый фрагмент для добавления пользовательских элементов и данных в ваше сообщество.';
$Definition['A hero banner widget designed to create visually striking headers for your community pages.'] = 'Виджет для создания эффектных заголовков на страницах вашего сообщества.';
...
$Definition['A list of statistics about the community and its members.'] = 'Список статистических данных о сообществе и его участниках.';
...
$Definition['Answers Thread'] = 'Тема с ответами';
...
$Definition['Article Content'] = 'Содержание статьи';
$Definition['Article Count'] = 'Количество статей';
$Definition['Article Header'] = 'Заголовок статьи';
$Definition['Article Language Picker'] = 'Выбор языка статьи';
$Definition['Article Reactions'] = 'Реакции на статью';
$Definition['Articles'] = 'Статьи';
$Definition['Article Table of Contents'] = 'Содержание статьи';
$Definition['A single announcement item used to highlight specific posts to members.'] = 'Отдельный пункт объявления, используемый для того, чтобы выделить конкретные публикации для участников.';
$Definition['A single category item in a list.'] = 'Отдельный элемент категории в списке.';
$Definition['A single comment item in a list.'] = 'Отдельный комментарий в списке.';
$Definition['A single post item in a list.'] = 'Отдельный элемент записи в списке.';
$Definition['Assets'] = 'Ресурсы';
...
$Definition['Breadcrumbs'] = 'Панировочные сухари';
...
$Definition['Call To Action'] = 'Призыв к действию';
$Definition['Call to Action'] = 'Призыв к действию';
...
$Definition['Category Articles'] = 'Статьи по категориям';
...
$Definition['Category Subcategory List'] = 'Список категорий и подкатегорий';
...
$Definition['Choose who should receive this email when this automation rule is run'] = 'Выберите, кто должен получить это электронное письмо при запуске данного правила автоматизации.';
...
$Definition['Comment Editor'] = 'Редактор комментариев';
...
$Definition['Comment Thread'] = 'Ветка комментариев';
...
$Definition['Content Banner'] = 'Контент-баннер';
...
$Definition['Create Post Form'] = 'Создать форму публикации';
...
$Definition['Custom HTML'] = 'Пользовательский HTML';
$Definition['Custom Icon'] = 'Пользовательский значок';
$Definition['Customize AI Persona'] = 'Настройте личность ИИ';
$Definition['Customize the appearance and content of Call to Action widgets with fragment-specific styling and layout options.'] = 'Настройте внешний вид и содержимое виджетов «Призыв к действию» с помощью параметров стиля и компоновки, специфичных для каждого фрагмента.';
$Definition['Customize the appearance of Rich Text widgets with fragment-specific styling.'] = 'Настройте внешний вид виджетов форматированного текста с помощью стилей, специфичных для каждого фрагмента.';
$Definition['Customize the search bar widget so that users can search the community.'] = 'Настройте виджет поисковой строки, чтобы пользователи могли искать информацию в сообществе.';
...
$Definition['Delete an email template.'] = 'Удалить шаблон электронного письма.';
...
$Definition['Display a list of categories and optionally nested child categories.'] = 'Отобразить список категорий и, при необходимости, вложенные дочерние категории.';
$Definition['Display a list of statistics about the community and its members.'] = 'Отобразить список статистических данных о сообществе и его участниках.';
$Definition['Display a search bar to search the entire community or specific parts of it.'] = 'Отобразить строку поиска для поиска по всему сообществу или по его отдельным частям.';
$Definition['Display a searchbox on top of the banner image.'] = 'Отображать поле поиска сверху от баннерного изображения.';
$Definition['Display attention grabbing images, text and links to encourage specific actions.'] = 'Используйте привлекательные изображения, текст и ссылки, чтобы побудить к совершению конкретных действий.';
...
$Definition['Display records from this subcommunity.'] = 'Показать записи из этого подсообщества.';
$Definition['Display rich text content with full formatting support.'] = 'Отображение форматированного текстового контента с полной поддержкой форматирования.';
...
$Definition['Email Audience'] = 'Аудитория электронной почты';
...
$Definition['Email template name already exists. Enter a unique name to proceed.'] = 'Шаблон электронного письма с таким названием уже существует. Введите уникальное имя, чтобы продолжить.';
$Definition['Email Template not enabled.'] = 'Шаблон электронного письма не включен.';
$Definition['Email template not found.'] = 'Шаблон электронного письма не найден.';
$Definition['Email Templates'] = 'Шаблоны электронных писем';
$Definition['Email templates can be used in conjunction with <0/> to communicate with users based on member activity or other community triggers.'] = 'Шаблоны электронных писем можно использовать совместно с <0/> для связи с пользователями на основе активности участников или других триггеров сообщества.';
...
$Definition['Enable this option to send a follow-up email when the rule is triggered.'] = 'Включите эту опцию, чтобы отправлять последующее электронное письмо при срабатывании правила.';
...
$Definition['Featured Collections'] = 'Рекомендуемые коллекции';
$Definition['Featured Image'] = 'Главное изображение';
$Definition['Featured Links'] = 'Рекомендуемые ссылки';
...
$Definition['Guest Sign In'] = 'Вход для гостей';
...
$Definition['Help Center Article List'] = 'Список статей справочного центра';
...
$Definition['Help Center Home'] = 'Главная страница справочного центра';
$Definition['Help Center Home Pages'] = 'Домашние страницы справочного центра';
$Definition['Help Center Overview'] = 'Обзор справочного центра';
$Definition['Help Center Overview Asset'] = 'Обзор справочного центра.';
...
$Definition['How a comment is displayed in a list of comments on a post or idea.'] = 'Как комментарий отображается в списке комментариев к публикации или идее.';
$Definition['How an answer is displayed in a list of answers on a question.'] = 'Как отображается ответ в списке ответов на вопрос.';
...
$Definition['Impacted User'] = 'Пострадавший пользователь';
...
$Definition['Knowledge Bases List'] = 'Список баз знаний';
$Definition['Knowledge Bases List Asset'] = 'Список ресурсов баз знаний';
...
$Definition['LeaderBoard (Grid)'] = 'Таблица лидеров (сетка)';
$Definition['LeaderBoard (List)'] = 'Таблица лидеров (Список)';
$Definition['Learn more'] = 'Узнать больше';
$Definition['Learn more.'] = 'Узнать больше.';
$Definition['Learn more about HSTS at %s.'] = 'Узнайте больше о HSTS по адресу %s.';
$Definition['Leave any field blank to use your default email styles as configured on the <0>Email Settings</0> page.'] = 'Оставьте любое поле пустым, чтобы использовать стили электронных писем по умолчанию, настроенные в разделе <0>«Настройки электронной почты»</0> страница.';
...
$Definition['List - Announcements'] = 'Список - Объявления';
$Definition['List - Articles'] = 'Список - Статьи';
$Definition['List - Discussions'] = 'Список - Обсуждения';
$Definition['List - Events'] = 'Список - События';
$Definition['List - Ideas'] = 'Список - Идеи';
$Definition['List - Questions'] = 'Список - Вопросы';
...
$Definition['New comments by users I\'m following'] = 'Новые комментарии от пользователей, на которых я подписан.';
...
$Definition['New discussions by users I\'m following'] = 'Новые обсуждения пользователей, за которыми я слежу.';
...
$Definition['New events by users I\'m following'] = 'Новые события от пользователей, на которых я подписан.';
...
$Definition['New Post Button'] = 'Кнопка «Новая запись»';
...
$Definition['No users followed'] = 'Никто из пользователей не подписался.';
...
$Definition['Original Post'] = 'Оригинальный пост';
...
$Definition['Post List'] = 'Список сообщений';
$Definition['Post Management'] = 'Управление почтой';
$Definition['Post Meta'] = 'Мета-теги поста';
...
$Definition['Post Tags'] = 'Теги для постов';
...
$Definition['Questions and Answers'] = 'Вопросы и ответы';
...
$Definition['Role Spotlight'] = 'В центре внимания – роль';
...
$Definition['Search and select one or more roles to receive this email'] = 'Найдите и выберите одну или несколько ролей, чтобы получать это письмо.';
$Definition['Search and select one or more users to receive this email.'] = 'Найдите и выберите одного или нескольких пользователей, которым будет отправлено это электронное письмо.';
...
$Definition['Search Widget'] = 'Виджет поиска';
...
$Definition['Select the email template to send.'] = 'Выберите шаблон электронного письма для отправки.';
...
$Definition['Select User'] = 'Выберите пользователя';
...
$Definition['Send an Email After This Rule Runs'] = 'Отправьте электронное письмо после того, как это правило будет выполнено.';
$Definition['Send a Test Email'] = 'Отправить тестовое письмо';
$Definition['Send email'] = 'Отправить электронное письмо';
$Definition['Send email to user'] = 'Отправить электронное письмо пользователю';
...
$Definition['Send the email'] = 'Отправить электронное письмо';
...
$Definition['Site Totals'] = 'Итоги по сайту';
...
$Definition['Specific Roles'] = 'Конкретные роли';
$Definition['Specific Users'] = 'Конкретные пользователи';
...
$Definition['Suggested Answers'] = 'Предложенные ответы';
...
$Definition['System email templates cannot be deleted.'] = 'Системные шаблоны электронных писем удалить невозможно.';
$Definition['System Icon'] = 'Системный значок';

$Definition['Tabbed Posts'] = 'Сообщения с вкладками';
$Definition['Table Layout'] = 'Табличный вид';
$Definition['Tabs Widget'] = 'Виджет вкладок';
$Definition['Tag Cloud'] = 'Облако тегов';
...
$Definition['template name'] = 'название шаблона';
...
$Definition['Text Widget'] = 'Текстовый виджет';
...
$Definition['The display of a post within the tabbed lists of posts.'] = 'Отображение публикации в списках публикаций, отображаемых во вкладках.';
$Definition['The display of a questions in a list of posts.'] = 'Отображение вопросов в списке сообщений.';
$Definition['The display of single post within a list of posts.'] = 'Отображение отдельного сообщения в списке сообщений.';
...
$Definition['The original post of which begins a discussion, question or idea.'] = 'Оригинальный пост, дающий начало дискуссии, вопросу или идее.';
...
$Definition['The title bar of the community which contains the logo, navigation, search and user menu.'] = 'Заголовочная строка сообщества, содержащая логотип, навигацию, поиск и пользовательское меню.';
...
$Definition['The way a single category or nested child categories are displayed.'] = 'Способ отображения отдельной категории или вложенных дочерних категорий.';
...
$Definition['Tiered Tab Widget'] = 'Многоуровневый виджет вкладок';
...
$Definition['Unfollow user'] = 'Отписаться от пользователя';
...
$Definition['Used to display idea type discussions.'] = 'Используется для отображения обсуждений, основанных на различных идеях.';
...
$Definition['User Spotlight'] = 'В центре внимания — пользователь';
...
$Definition['Use this page to create and manage your templates, then configure your <0/> to control when each email is sent and to whom.'] = 'Используйте эту страницу для создания и управления шаблонами, а затем настройте <0/>, чтобы контролировать, когда и кому отправляется каждое электронное письмо.';
...
$Definition['View all followed users'] = 'Просмотреть всех пользователей, на которых подписаны.';
...
$Definition['View User'] = 'Просмотреть пользователя';
...
$Definition['You are receiving this email because you are following this user.'] = 'Вы получили это письмо, потому что подписаны на этого пользователя.';
...
$Definition['You can also include placeholders in your email content—these will be automatically replaced with relevant user or post information when the email is sent. For example, Hello {user.name}! or Check out {discussion.name}.'] = 'Вы также можете добавлять в содержимое электронных писем заполнители — они будут автоматически заменены соответствующей информацией о пользователе или публикации при отправке письма. Например, «Привет, {user.name}!» или «Посмотрите {discussion.name}».';
...
$Definition['{ActivityUserID,user} started a new event: <a href="{Url,html}">{Data.Name,text}</a>'] = '{ActivityUserID,user} запустил новое событие: <a href="{Url,html}">{Data.Name,text}</a>';
$Definition['{ActivityUserID,You} accepted {NotifyUserID,your} answer to a question: <a href="{Url,html}">{Data.Name,text}</a>'] = '{ActivityUserID,You} принял ответ {NotifyUserID,your} на вопрос: <a href="{Url,html}">{Data.Name,text}</a>';
