...
$Definition['%s posts'] = '%s сообщений';
...
$Definition['Are you sure you want to restore 1 item?'] = 'Вы уверены, что хотите восстановить 1 объект?';
...
$Definition['Every edit or deletion is recorded here. Use &lsquo;Restore&rsquo; to undo any change.'] = 'Все манипуляции, как редактирование или удаление записывается здесь. Используйте &lsquo;Восстановление&rsquo;, чтобы отменить любые изменения.';
...
$Definition['The following content has been flagged by users for moderator review.'] = 'Этот контент был помечен пользователи для того, чтобы модератор проверил его.';
...
$Definition['This is the administrative dashboard for your new community. Check out the configuration options to the left: from here you can configure how your community works. <b>Only users in the "Administrator" role can see this part of your community.</b>'] = 'Это административная панель Вашего нового сообщества. В левой части панели Вы можете настроить параметры конфигурации. Сделать это могут <b>только пользователи с привилегиями "Администратора"</b>.';
