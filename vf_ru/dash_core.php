...
$Definition['You can specify a whitelist of trusted domains. (CSP)'] = 'Вы можете указать белый список доверенных доменов (например, yourdomain.com), с которых безопасно загружать JavaScript.';
