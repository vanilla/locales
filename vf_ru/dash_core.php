...
$Definition['. The community forum is what all of your users &amp; customers will see when they visit '] = '. Форум сообщества -  это то, что ваши пользователи увидят при посещении ';
...
$Definition['<strong>Categories</strong>'] = '<strong>Разделы</strong>';
...
$Definition['Are you sure you want to delete this category?'] = 'Вы уверены, что хотите удалить эту категорию?';
...
$Definition['Authors can edit for 1 day after posting'] = 'Автор не сможет редактировать свою публикацию через 1 день после её создания';
$Definition['Authors can edit for 1 month after posting'] = 'Автор не сможет отредактировать свою публикацию через 1 месяц после её создания';
$Definition['Authors can edit for 1 week after posting'] = 'Автор не сможет отредактировать свою публикацию через 1 неделю после её создания';
$Definition['Authors can edit for 5 minutes after posting'] = 'Автор не сможет отредактировать свою публикацию через 5 минут после её создания';
$Definition['Authors can edit for 15 minutes after posting'] = 'Автор не сможет отредактировать свою публикацию через 15 минут после её создания';
$Definition['Authors can edit for 30 minutes after posting'] = 'Автор не сможет отредактировать свою публикацию через 30 минут после её создания';
...
$Definition['Categories are used to help organize discussions.'] = 'Разделы используются для того, чтобы организовать обсуждения. Перетаскивайте разделы друг относительно друга. ';
$Definition['Categories are used to organize discussions.'] = '<strong>Разделы</strong> позволяют организовать обсуждения.';
