...
$Definition['Ban.Action'] = 'Отлучить';
...
$Definition['Ban User'] = 'Отлучить пользователя';
...
$Definition['Notify me when a comment is flagged.'] = 'Уведомлять, когда комментарий получает упрёк.';
