...
$Definition['Banned'] = 'Отлучён';
$Definition['Banned for being abusive.'] = 'Заблокирован, за оскорбления';
$Definition['Banned for spamming.'] = 'Отлучён за спам.';
$Definition['Banned users can no longer access the site.'] = 'Отлучённые пользователи не имеют доступа к сайту.';
