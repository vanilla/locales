...
$Definition['Every edit or deletion is recorded here. Use &lsquo;Restore&rsquo; to undo any change.'] = 'Все манипуляции, как редактирование или удаление записывается здесь. Используйте &lsquo;Восстановить&rsquo;, чтобы отменять любые действия.';
