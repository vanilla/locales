...
$Definition['Every edit or deletion is recorded here. Use &lsquo;Restore&rsquo; to undo any change.'] = 'Все манипуляции, такие как редактирование или удаление записывается здесь. Используйте &lsquo;Восстановить&rsquo;, чтобы отменять любые действия.';
...
$Definition['MobileLogoDescription'] =
    'Логотип мобильного баннера появляется в верхней части вашего сайта. Некоторые темы могут не отображать этот логотип.';
...
$Definition["You need to add the font url’s domain to <0>AllowedDomains</0>, in the site's configuration. <1>Learn more about custom fonts.</1>."] = "Вам нужно добавить домен шрифта в &lt;0&gt; AllowedDomains </0> в настройках сайта. &lt;1&gt; Узнайте больше о пользовательских шрифтах. </1> ,";
