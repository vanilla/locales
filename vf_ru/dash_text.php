...
$Definition["Welcome to Vanilla's theming UI."] = "Добро пожаловать в темный интерфейс Vanilla. На этой странице перечислены все ваши доступные темы, и вы можете копировать или редактировать их.";
$Definition["Some older themes don't support full editing capability."] = "Некоторые старые темы не поддерживают полную возможность редактирования. Чтобы увидеть, что тема поддерживает, вы можете навести курсор на ее название, чтобы увидеть, где изменения вступят в силу.";
...
$Definition["Usercards allow you to get a quick in-line snapshot of a user's information."] = "Карты пользователя позволяют быстро получить оперативный снимок информации о пользователе. При просмотре сообщений и списков лидеров щелкните имя пользователя, чтобы увидеть карточку с основной информацией профиля пользователя без необходимости уходить со страницы. Включите эту функцию, чтобы добавить карточки пользователя в вашу настраиваемую тему.";
$Definition['New Search Page'] = 'Новая страница поиска';
$Definition["Vanilla's new search service is finally here."] = "Наконец-то появилась новая поисковая служба Vanilla. Включите наш новый пользовательский интерфейс страницы поиска, чтобы получить доступ к новейшим функциям поиска, таким как поиск участников, сортировка поиска и выделение терминов.";
