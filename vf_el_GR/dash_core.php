...
Follow the link below to log in.'] = 'Γεια σου φίλε!⏎ ⏎ Ρίξε μια ματιά στο νέο φόρουμ της κοινότητάς μας που μόλις έχει δημιουργηθεί. Είναι για μας ένας σημαντικός χώρος όπου μπορούμε να συζητάμε μεταξύ μας.⏎ ⏎ Ακολούθησε τον παρακάτω σύνδεσμο για να συνδεθείς.';
