...
$Definition['%s Settings'] = '%s Paramètres';
...
$Definition['A message has been sent to your email address with password reset instructions.'] = 'Un message vous a été envoyé avec les instructions pour changer votre mot de passe.';
