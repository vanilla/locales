...
$Definition['Default notification settings can be modified for each followed category in <a href="{url,html}">Manage Followed Categories</a>.'] = 'Les paramètres de notification par défaut peuvent être modifiés pour chaque catégorie suivie dans <a href="{url,html}">Gestion des catégories suivies</a>.';
...
$Definition['The email digest delivers the week\'s top content from the categories you follow into your email inbox once per week. <a href="{url,html}">Manage Followed Categories</a>.'] = 'Une fois par semaine, le résumé par e-mail vous livre dans votre boîte aux lettres électronique le contenu le plus important de la semaine dans les catégories que vous suivez. <a href="{url,html}">Gérer les catégories suivies</a>.';
