...
';
$Definition['This setting loads the page before executing Javascript.'] = 'Ce paramètre charge la page avant d\'exécuter le Javascript, ce qui peut améliorer votre référencement.<br><strong>**Avertissement : l\'activation de cette fonction peut entraîner des erreurs Javascript sur votre site.**</strong>';
