...
$Definition['Add a new tracked keyword'] = 'Ajouter un nouveau mot-clé suivi';
$Definition['Add Keyword'] = 'Ajouter un mot-clé';
$Definition['Add limits to image upload dimensions in discussions and comments.'] = 'Ajouter des limites aux dimensions de téléchargement d\'images dans les discussions et les commentaires.';
...
$Definition['Allow links to be transformed'] = 'Permettre aux liens d\'être transformés en représentations intégrées dans les publications et les commentaires. Par exemple, un lien YouTube sera transformé en vidéo intégrée.';
...
';
$Definition['all time sentiment'] = 'sentiment général au fil du temps';
$Definition['Anonymize IP Addresses'] = 'Anonymiser les adresses IP';
$Definition['API Overview'] = 'Vue d\'ensemble de l\'API';
...
$Definition['Automatically save drafts of unpublished posts, questions, ideas and comments.'] = 'Enregistrer automatiquement les brouillons des publications, des questions, des idées et des commentaires non postés.';
...
';
$Definition['Avatars will have their thumbnails saved at this size.'] = 'Les avatars verront leurs vignettes sauvegardées à cette taille.';

$Definition['Background'] = 'Contexte
';
$Definition['Background Image'] = 'Image de fond';
$Definition['Balanced to Positive'] = 'D\'équilibré à positif';
$Definition['Be creative! Try naming your ranks after things that the community talks about.'] = 'Soyez créatifs ! Essayez de donner à vos classements le nom de choses dont la communauté parle.';
...
';
$Definition['Buttons & Inputs'] = 'Boutons et éléments d\'entrée';
...
$Definition['Calibrated Sentiment Distribution Preview'] = 'Aperçu de la répartition des sentiments calibrés';
...
$Definition['Center Aligned'] = 'Aligné sur le centre';
$Definition['Changes to the set day will take affect the following week.'] = 'Les modifications apportées au jour fixé prendront effet la semaine suivante.';
$Definition['Changes will apply to newly uploaded avatars only.'] = 'Les changements s\'appliqueront uniquement aux avatars nouvellement téléchargés.
';
$Definition['Change the sizes that avatar images are saved at.'] = 'Modifiez la taille à laquelle les images des avatars sont enregistrées.
';
...
$Definition['Checkboxes allow admins to perform batch actions on a number of discussions or comments at the same time.'] = 'Les cases à cocher permettent aux administrateurs d\'effectuer des actions par lots sur un certain nombre de discussions ou de commentaires en même temps.';
$Definition['Check out our %s'] = 'Consultez notre %s';
$Definition['Check out our <0>documentation</0>, or ask our <1>community of experts</1>.'] = 'Consultez notre <0>documentation</0> ou demandez aux <1>experts de notre communauté</1>.';
...
$Definition['Choose a page to serve as the subcommunity homepage.'] = 'Choisissez une page qui servira de page d\'accueil de la sous-communauté.';
...
$Definition['Disable the "New Embed System" lab on the <0>Vanilla Labs Page</0>'] = 'Désactivez le lab « Nouveau système d\'intégration » sur la page <0>Vanilla Labs</0>';
...
$Definition['Email digests will be sent on the selected day every week.'] = 'Les résumés par e-mail seront envoyés chaque semaine à la date fixée.';
$Definition['Email sent from the application will be addressed from this email address'] = 'Les e-mails envoyés à partir de l\'application seront transmis à partir de cette adresse e-mail';
$Definition['Email sent from the application will be addressed from this name'] = 'Les e-mails envoyés à partir de l\'application seront transmis à partir de ce nom';
$Definition['Email Settings'] = 'Paramètres de l\'e-mail';
$Definition['Embed Settings'] = 'Paramètres d\'intégration';
...
$Definition['Enables advanced editing of posts in several formats, including WYSIWYG, simple HTML, Markdown, and BBCode.'] = 'Permet une édition avancée des messages dans plusieurs formats, y compris WYSIWYG, HTML simple, Markdown et BBCode.
';
...
$Definition['Extremely Negative to Negative'] = 'D\'extrêmement négatif à négatif';
...
$Definition['For example, you can ban all users with emails addresses from "example.com" by adding an email-type ban with the value "*@example.com".'] = 'Vous pouvez par exemple exclure tous les utilisateurs possédant des adresses similaires à « exemple.com » en ajoutant une exclusion d\'e-mail type avec pour valeur « *@exemple.com ».';
...
$Definition['FullAnonymization.Description'] = '<strong>L\'anonymisation complète</strong> remplace chaque adresse IP par 0.0.0.0, ce qui a pour effet d\'interdire à l\'application tout accès aux adresses IP. Les règles d\'interdiction des adresses IP ne fonctionneront pas du tout dans ce cas.';
$Definition['Full Bleed'] = 'Fond perdu';
...
$Definition['Garden.Privacy.IPs.Description'] = 'Les adresses IP des utilisateurs sont en général recueillies dans le cadre de règles d\'interdiction automatisées, de la modération et de la prévention des spams. En activant l\'anonymisation de l\'adresse IP, toutes les adresses IP enregistrées sur le site seront rendues anonymes, quel que soit l\'objectif poursuivi, et l\'efficacité de ces outils s\'en trouvera réduite. Les modifications apportées à ce paramètre ne sont pas rétroactives.';
$Definition['Garden.Profiles.Edit permission to change their own avatars from their profile pages in Vanilla.'] = 'Autorisation Garden.Profiles.Edit de modification de leurs propres avatars à partir de leurs pages de profil dans Vanilla.';
...
$Definition['Global Styles'] = 'Styles généraux
';
...
';
$Definition['Highly Positive'] = 'Fortement positif';
...
$Definition['If a user does not visit the site within this time period they will be automatically signed out.'] = 'Si un utilisateur ne se rend pas sur le site pendant cette période, il sera automatiquement déconnecté.';
...
';
$Definition['If you are new to HTML and/or CSS, here are some tutorials to get you started:'] = 'Si vous êtes novice en matière de HTML ou de CSS, voici quelques tutoriels pour vous aider à démarrer :
';
...
$Definition['If you want to embed your forum, enable embedding.'] = 'Si vous souhaitez intégrer votre forum ou utiliser les commentaires de Vanilla dans votre blog, vous devez activer l\'intégration. Si vous n\'utilisez pas l\'intégration, nous vous recommandons de ne pas activer ce paramètre.
';
$Definition['Image (Mobile)'] = 'Image (mobile)';
$Definition['Import'] = 'Importer';
$Definition['Importing to Vanilla'] = 'Importer vers Vanilla';
$Definition['In additon to the widgets there are also'] = 'En plus des widgets, il y a aussi des <0>styles généraux</0>. Pour modifier les styles généraux, cliquez n\'importe où ailleurs sur la page, par exemple sur ce texte.';
...
$Definition['Internationalization & Localization'] = 'International et localisation';
$Definition['Invalid URL'] = 'Adresse URL invalide';
$Definition['Invitation email failed to send: %'] = 'Bien que l\'invitation ait été créée avec succès, l\'e-mail n\'a pas été envoyé. Le serveur a signalé l\'erreur suivante : %s';
...
$Definition['It is a good idea to keep the maximum number of characters allowed in a post down to a reasonable size.'] = 'Il est bon de limiter le nombre maximum de caractères autorisés dans un courrier à une taille raisonnable.
';

$Definition['Keyword'] = 'Mot-clé';
$Definition['keyword'] = 'mot-clé';
$Definition['Keyword is required.'] = 'Un mot-clé est requis.';
$Definition['Keyword Limit Reached'] = 'Limite de mots-clés atteinte';
$Definition['Keyword Settings'] = 'Paramètres en matière de mots-clés';
...
$Definition['Lockout Time (seconds)'] = 'Temps de verrouillage (secondes)';
...
$Definition['Looking for the Old Embed System?'] = 'Vous recherchez l\'ancien système d\'intégration ?';
...
$Definition['Make this the default subcommunity. Visitors will be directed here first when they access the community.'] = 'Définissez-la comme sous-communauté par défaut. Les visiteurs seront d\'abord redirigés vers cette page lorsqu\'ils accéderont à la communauté.';
...
$Definition['MobileLogoDescription'] = 'Le logo de la bannière mobile apparaît en haut de votre site.';
$Definition['Mobile themes allow you to change the look and feel of your site on smaller devices.'] = 'Les thèmes mobiles vous permettent de modifier l\'aspect et la convivialité de votre site sur des appareils plus petits.
';
$Definition['Most communities stick to positive reactions to encourage participation.'] = 'La plupart des communautés s\'en tiennent à des réactions positives afin d\'encourager la participation.';

$Definition['N.B. The new Layout Editor will inherit the theme set in your Style Guide (formally theme editor). <1>Find out more</1>'] = 'N.B. Le nouvel éditeur de mise en page héritera du thème défini dans votre guide de style (anciennement l\'éditeur de thème). <1>En savoir plus</1>';
$Definition['Need More Help?'] = 'Besoin d\'aide ?';
$Definition['Need more help?'] = 'Besoin d\'aide?';
$Definition['Negative'] = 'Négatif';
$Definition['Negative to Balanced'] = 'De négatif à équilibré';
$Definition['Nested categories deeper than this depth will be placed in a comma-delimited list.'] = 'Les catégories imbriquées dont la profondeur dépasse cette limite seront placées dans une liste délimitée par des virgules.
';
$Definition['New Embed System'] = 'Nouveau système d\'intégration';
$Definition['New keywords will be tracked in analytics. You can choose to turn off tracking after creating this keyword.'] = 'Les nouveaux mots-clés seront suivis dans les analyses. Vous avez la possibilité de désactiver le suivi après avoir créé ce mot-clé.';
...
$Definition['OrgDescription'] = '
Le nom de votre organisation est utilisé pour les microdonnées SEO et JSON+LD';
$Definition['Outline'] = 'Aperçu';
$Definition['Overridden views or themehooks can have unintended side effects and are not previewed.'] = 'Les vues annulées ou les accroches thématiques peuvent avoir des effets secondaires non voulus et ne sont pas prévisualisées.';

$Definition['Partial Anonymization'] = 'Anonymisation partielle';
$Definition['PartialAnonymization.Description'] = '<strong>L\'anonymisation partielle</strong> ne rend anonyme que le dernier octet de l\'adresse IP. Par exemple, 254.230.05.153 deviendrait 254.230.05.0. Cela permet une certaine anonymisation tout en permettant aux règles d\'interdiction d\'IP de fonctionner.';
$Definition['Password.MinLength'] = 'Nombre minimal de caractères autorisés pour les mots de passe des utilisateurs sur les pages de réinitialisation et de création des mots de passe.';
...
$Definition['Positive to Highly Positive'] = 'De positif à très positive';
...
$Definition['Reactions Documentation'] = 'Documentation sur les réactions';
...
$Definition['Recent Post List Page'] = 'Page de la liste des publications récentes';
...
$Definition['Recommend special ranks for admins and mods.'] = 'C\'est une bonne idée d\'avoir des classements spéciaux pour les modérateurs et les administrateurs afin que votre communauté puisse facilement voir qui est en charge.
';
$Definition['Recommend starting with five ranks.'] = 'Il faut éviter d\'avoir trop de classements. Nous vous recommandons de commencer par cinq. Vous pouvez en ajouter d\'autres si votre communauté est vraiment grande.';
...
$Definition['Remove post and categories links from menus. Set post and category related pages to return not found page 404.'] = 'Supprimer les liens vers les publications et les catégories dans les menus. Configurer les pages liées aux publications et aux catégories pour qu\'elles renvoient l\'erreur 404, page non trouvée.';
$Definition['Requires “Flag” reaction permission.'] = 'Requiert une autorisation de réaction « Drapeau ».';
$Definition['Requires “Negative” reaction permission.'] = 'Requiert une autorisation de réaction « négative ».
';
...
$Definition['Search subcommunities.'] = 'Cherchez dans les sous-communautés.';
$Definition['Secondary Button'] = 'Bouton secondaire';
$Definition['Secondary Buttons'] = 'Boutons secondaires
';
$Definition['Security.Hsts.HTTPSWarning'] = 'Avertissement : n\'activez cette fonctionnalité que si vous êtes sûr que tous vos sous-domaines sont configurés en HTTPS avec des certificats valides.';
$Definition['Security.Hsts.IncludeSubDomains'] = 'Lorsqu\'elle est activée, cette règle s\'applique à tous les sous-domaines de votre site.';
$Definition['Security.Hsts.MaxAgeRecommendation'] = 'Une fois que vous voyez que votre site fonctionne comme prévu, nous vous recommandons de commencer avec un âge maximum d\'une semaine, puis de passer à un mois, puis à un an.';
...
$Definition['Selected Home Page Type is a custom layout. You can manage the layout for this subcommunity in <0/>.'] = 'Le type de page d\'accueil sélectionné est une mise en page personnalisée. Vous pouvez gérer la mise en page pour cette sous-communauté dans <0/>.';
...
$Definition['Sentiment Keywords'] = 'Mots-clés en matière de sentiment';
$Definition['Sentiment Level Distribution Adjustment'] = 'Ajustement de la répartition des niveaux de sentiment';
$Definition['Sentiment Settings'] = 'Paramètres en matière de sentiment';
...
$Definition['Site Home Pages'] = 'Pages d\'accueil de site';
...
';
$Definition['Sometimes you want to embed your Vanilla site'] = 'Vous souhaitez parfois intégrer votre site Vanilla dans un autre site. Le système d\'intégration de Vanilla vous offre un moyen simple d\'y parvenir. L\'utilisation d\'un site intégré implique des compromis en matière de performances, alors consultez la documentation pour connaître les alternatives et les cas d\'utilisation idéaux.';
$Definition['Special restriction: Only users with permission Garden.Curation.Manage may use this reaction.'] = 'Restriction spéciale : seuls les utilisateurs ayant l\'autorisation de Garden.Curation.Manage peuvent utiliser cette réaction.
';
$Definition['Specify a partial or full match when creating a ban.'] = 'Spécifiez une correspondance totale ou partielle lorsque vous créez une exclusion.';
...
$Definition['Spoofing'] = 'Fraude en usurpant l\'identité de quelqu\'un';
...
$Definition['Subcommunity Home Pages'] = 'Pages d\'accueil de sous-communauté';

$Definition['Tagging allows users to add a tag to discussions they start in order to make them more discoverable. '] = 'Le balisage permet aux utilisateurs d\'ajouter une balise aux discussions qu\'ils entament afin de les rendre plus faciles à découvrir.
';
...
$Definition['Theme preview is limited to displaying the theme\'s template and css.'] = 'La prévisualisation du thème se limite à l\'affichage du modèle du thème et du CSS.';
...
$Definition['The New Embed System'] = 'Le nouveau système d\'intégration';
$Definition['The new embed system has improved performance.'] = 'Le nouveau système d\'intégration offre de meilleures performances, un meilleur défilement et un comportement plus cohérent que l\'ancien système. Les intégrations de commentaires et de wordpress ne sont actuellement pas prises en charge par le nouveau système d\'intégration.';
...
$Definition['The view you were looking for could not be found.'] = 'La vue que vous cherchiez est introuvable.';
$Definition['They work just like regular themes. Once one has been added to the themes folder, you can enable it here.'] = 'Ils fonctionnent comme des thèmes habituels. Une fois qu\'un thème a été ajouté au dossier « thèmes », vous pouvez l\'activer ici.
';
$Definition['This graph visualizes how the content in your community would be distributed based on your calibration adjustment.'] = 'Ce graphique illustre la manière dont le contenu de votre communauté serait réparti en fonction de votre ajustement du calibrage.';
$Definition['This is a style guide of your theme.'] = 'Il s\'agit d\'un guide de style de votre thème. Il contient des exemples d\'éléments visuels utilisés dans l\'ensemble de la demande. Vous pouvez cliquer sur les différents widgets tels que la <0>barre de titre</0> ou la <1>bannière</1> pour modifier leurs propriétés dans le panneau latéral.
';
...
$Definition['This lab cannot be disabled because a custom layout is applied.'] = 'Ce lab ne peut pas être désactivé car une mise en page personnalisée est appliquée.';
...
$Definition['This may be used to include content such as organization name and address in all outgoing emails.'] = 'Ceci peut être utilisé pour ajouter du contenu tel que le nom et l\'adresse de l\'organisation dans tous les e-mails sortants.';
...
$Definition['This page lists the endpoints of your API.'] = 'Cette page énumère les points terminaux de votre API. Cliquez sur les points terminaux pour plus d\'informations. Vous pouvez passer des appels en direct à l\'API à partir de cette page ou en externe à l\'aide d\'un jeton d\'accès.
';
$Definition['This role is personal info. Only users with permission to view personal info will see it.'] = 'Ce rôle est une information personnelle. Seuls les utilisateurs autorisés à consulter les informations personnelles les verront.
';
$Definition['This setting loads the page before executing Javascript.'] = 'Ce paramètre charge la page avant d\'exécuter JavaScript, ce qui peut améliorer votre SEO.<br> <strong>**Attention : activer cette fonctionnalité peut causer des erreurs avec JavaScript sur votre site.**</strong>';
...
$Definition['TouchIconDescription'] = 'L\'icône de contact apparaît lorsque vous mettez un site Web en signet sur l\'écran d\'accueil d\'un appareil Apple. Il s\'agit généralement de 152 pixels. Apple ajoute automatiquement des coins arrondis et un effet d\'éclairage.
';
...
$Definition['Untracked Only'] = 'Non suivi uniquement';
...
$Definition['User inputs are based on the global background and text colors.'] = 'Les entrées de l\'utilisateur sont basées sur le fond global et les couleurs du texte.
';
...
$Definition['Vanilla Messages'] = 'Messages standards';
...
$Definition['Welcome To Your Theme'] = 'Bienvenue sur votre thème';
$Definition['We recommend enabling 1–3 reactions at a time to avoid overwhelming users.'] = 'Nous vous recommandons d\'activer d\'une à trois réactions à la fois pour éviter de submerger les utilisateurs.';
...
$Definition['When enabled, you can <0>manage products</0>, and group subcommunities by those products.'] = 'Lorsque cette option est activée, vous pouvez <0>gérer des produits</0> et regrouper des sous-communautés en fonction de ces produits.';
...
';
$Definition['When you select Full Bleed, your background is transparent.'] = 'Lorsque vous sélectionnez « Fond perdu », votre fond est transparent.
';
...
$Definition['Widget Builder'] = 'Outil de création de widgets';
...
$Definition['You can ban all users with an IP addresses prefixed with "111.111.111" by adding an IP-type ban with the value "111.111.111.*".'] = 'Vous pouvez exclure tous les utilisateurs possédant une adresse IP commençant par « 111.111.111 » en ajoutant une exclusion d\'IP type ayant pour valeur « 111.111.111.* ».';
$Definition['You can ban IP addresses, email addresses and usernames.'] = 'Vous pouvez exclure les adresses IP, les adresses e-mail et les noms d\'utilisateur.';
$Definition['You can choose from one of the different styles this theme offers.'] = 'Vous pouvez choisir l\'un des différents styles proposés par ce thème.
';
...
$Definition['You can only track up to 100 keywords. Untrack some to add new keywords.'] = 'Vous ne pouvez suivre que 100 mots-clés au maximum. Désélectionnez-en certains pour pouvoir en ajouter de nouveaux.';
...
$Definition['You can specify a minimum post length to discourage short posts.'] = 'Vous pouvez spécifier une longueur minimale de poste pour décourager les postes courts.';
