...
$Definition['Digest Settings'] = 'Tetapan Digest';
...
$Definition['Recommended dimensions are about 400px by 300px or smaller with similar ratio.'] = 'Dimensi yang disyorkan ialah kira-kira 400px kali 300px atau lebih kecil dengan nisbah yang serupa.';
...
$Definition['Tagging allows users to add a tag to discussions they start in order to make them more discoverable. '] =
    'Pemberian tag membolehkan pengguna menambahkan teg pada perbincangan yang mereka mulakan untuk menjadikannya lebih mudah ditemui.';
...
$Definition['The database user you specified does not have permission to access the database. Have you created the database yet? The database reported: <code>%s</code>'] =
    'Pengguna pangkalan data yang anda tentukan tidak mempunyai kebenaran untuk mengakses pangkalan data. Adakah anda sudah membuat pangkalan data? Pangkalan data dilaporkan: <code>%s</code>';
...
$Definition['TouchIconDescription'] =
    'Ikon sentuh muncul apabila anda menandai laman web di skrin utama peranti Apple. Ini biasanya berukuran 152 piksel. Apple menambah sudut bulat dan kesan pencahayaan secara automatik.';
