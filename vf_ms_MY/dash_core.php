...
$Definition['%1$s version %2$s is available.'] =
    '%1$s versi %2$s tersedia.';
$Definition["%s is not a valid email address"] =
    "%s bukan alamat e-mel yang sah";
...
$Definition["%s user(s) will be affected by this action."] =
    "%s pengguna akan dipengaruhi oleh tindakan ini.";

$Definition["<0/> will suggest answers on Q&A posts"] =
    "<0/> akan mencadangkan jawapan pada siaran Soal Jawab";
$Definition["<0 /> will not suggest answers on Q&A posts"] =
    "<0 /> tidak akan mencadangkan jawapan pada siaran Soal Jawab";
...
$Definition["1 in 5 is recommended for most communities."] =
    "1 dalam 5 disyorkan untuk kebanyakan komuniti.";
$Definition["1 in 20 is recommended for most communities."] =
    "1 dalam 20 disyorkan untuk kebanyakan komuniti.";
...
] = 'Anda telah mencapai percubaan log masuk maksimum. Sila tunggu %s dan cuba lagi.';
...
$Definition["A unique label name that cannot be changed once saved."] =
    "Nama label unik yang tidak boleh ditukar setelah disimpan.";
...
$Definition['"Accept Answer" if a suggestion answers your question.'] =
    '"Terima Jawapan" jika cadangan menjawab soalan anda.';
...
$Definition["Accepted answer pageview ratio representing a deflected case"] =
    "Nisbah paparan halaman jawapan yang diterima mewakili kes terpesong";
...
$Definition["Add a new Pocket to your site."] =
    "Tambahkan Pocket baru ke laman web anda.";
$Definition[
    ...
    "Tambahkan pautan Zum atau ID mesyuarat untuk menyambungkan acara ini ke Zum dan dayakan butang pendaftaran dan sertai satu klik. Harap maklum jika acara anda memerlukan pendaftaran, anda tidak boleh mengemas kini ID mesyuarat atau pautan anda selepas membuat acara.";
...
$Definition[
    ...
    "Tambahkan maklumat ke dalam bidang dari alamat e-mel untuk membantu menjawab (disyorkan).";
...
$Definition[
    ...
    "Tambahkan domain Kaltura tersuai anda untuk mengubah pautan menjadi video terbenam dalam perbincangan, ulasan atau artikel.";
$Definition[
    "Add your custom Kaltura domain(s) to transform links into embedded videos in posts, comments or articles."
] =
    "Tambahkan domain Kaltura tersuai anda untuk mengubah pautan menjadi video terbenam dalam siaran, ulasan atau artikel.";
...
$Definition["Advanced settings for embedded community elements"] =
    "Tetapan lanjutan untuk elemen komuniti terbenam";
...
$Definition[
    ...
    "Jawapan Cadangan AI menyediakan jawapan yang dicadangkan berdasarkan siaran komuniti dan pangkalan pengetahuan yang dipautkan. Anda boleh menghidupkan atau mematikan ini pada bila-bila masa dengan melawati pilihan profil anda.";
$Definition[
    "Alert users if they click a link in a post that will lead them away from the forum. "
] =
    "Maklumkan pengguna sekiranya mereka mengklik pautan dalam siaran yang akan membawa mereka keluar dari forum.";
...
$Definition["All discussions in this category will be permanently deleted."] =
    "Semua perbincangan dalam kategori ini akan dihapuskan secara kekal.";
...
$Definition[
    ...
    "Semua kandungan pengguna akan diganti dengan mesej yang menyatakan bahawa pengguna telah dihapus.";
...
$Definition["Allow new users to be registered through email."] =
    "Benarkan pengguna baru didaftarkan melalui e-mel.";
$Definition["Allow this connection to issue API access tokens."] =
    "Benarkan sambungan ini mengeluarkan token akses API.";
$Definition["Allow Third-Party Script Execution"] =
    "Benarkan Perlaksanaan Skrip Pihak Ketiga";
$Definition["Allow users to change their own avatars"] =
    "Benarkan pengguna menukar avatar mereka sendiri";
$Definition["Allow users to dismiss this message"] =
    "Benarkan pengguna menolak mesej ini.";
...
$Definition["An enabled message will be visible on the site."] =
    "Mesej yang diaktifkan akan dapat dilihat di laman web ini.";
$Definition["An answer in this the community thread was marked as accepted"] =
    "Jawapan dalam urutan komuniti ini telah ditandai sebagai diterima";
$Definition["An error occurred updating your privacy setting"] =
    "Ralat berlaku semasa mengemas kini tetapan privasi anda";
$Definition["Anonymize Analytics Data by Default"] =
    "Anonimkan Data Analitis secara Lalai";
$Definition["Answers is not available if you have not accepted cookies."] =
    "Jawapan tidak tersedia jika anda belum menerima kuki.";
$Definition["API"] = "API";
...
$Definition["Applicant Role"] =
    "Pilih peranan yang harus diterapkan untuk pemohon baru. Ini hanya berlaku jika anda mempunyai kaedah pendaftaran <b>kelulusan</b> .";
...
$Definition["Are you sure you want to delete %s items forever?"] =
    "Adakah anda pasti mahu memadamkan item %s selamanya?";
$Definition["Are you sure you want to delete 1 item forever?"] =
    "Adakah anda pasti mahu memadamkan 1 item selama-lamanya?";
$Definition[
    "Are you sure you want to delete this badge? This is irreversible and will revoke the badge from all users who have it."
] =
    "Adakah anda pasti mahu memadamkan lencana ini? Ini tidak dapat dipulihkan dan akan menarik balik lencana dari semua pengguna yang memilikinya.";
$Definition["Are you sure you want to delete this category?"] =
    "Adakah anda pasti mahu memadamkan kategori ini?";
$Definition["Are you sure you want to restore %s items?"] =
    "Adakah anda pasti mahu memulihkan item %s?";
$Definition["Are you sure you want to restore 1 item?"] =
    "Adakah anda pasti mahu memulihkan 1 item?";
$Definition[
    "Are you sure you want to turn off all AI Suggested Answers? You can undo this in your profile settings at anytime."
] =
    "Adakah anda pasti mahu mematikan semua Jawapan Cadangan AI? Anda boleh membuat asal ini dalam tetapan profil anda pada bila-bila masa.";
...
] = "Sekurang-kurangnya satu lajur yang kelihatan diperlukan. Tunjukkan atau tambah lajur yang boleh dilihat.";
$Definition["A url-friendly version of the category name for better SEO."] =
    "Versi kategori nama yang mesra url untuk SEO yang lebih baik.";
...
$Definition[
    ...
    "Sebelum mengaktifkan ciri ini, sila ambil perhatian tentang kemungkinan implikasi berikut:";
...
$Definition["Bookmark a discussion using its star icon."] =
    "Tandakan perbincangan menggunakan ikon bintangnya.";
...
$Definition["Browse for a new banner logo if you would like to change it:"] =
    "Cari logo sepanduk baru jika anda ingin menukarnya:";
...
$Definition["Cannot build profile information if user is not defined."] =
    "Tidak dapat membina maklumat profil jika pengguna tidak ditentukan.";
$Definition["Categories &amp; Discussions"] = "Kategori & Perbincangan";
$Definition["Categories to Exclude from AI Answers"] =
    "Kategori untuk Dikecualikan daripada Jawapan AI";
$Definition["Categories are used to organize discussions."] =
    "Kategori digunakan untuk membantu pengguna anda mengatur perbincangan mereka dengan cara yang bermakna bagi komuniti anda.";
$Definition["Categories are used to organize posts."] =
    "Kategori digunakan untuk membantu pengguna anda menyusun siaran mereka dengan cara yang bermakna untuk komuniti anda.";
$Definition["Categories allow you to organize your posts."] =
    "Kategori membolehkan anda menyusun siaran anda.";
...
$Definition["Click here to carry on to your dashboard"] =
    "Klik di sini untuk meneruskan ke papan pemuka anda";
...
$Definition["Community Discussion Categories"] =
    "Kategori Perbincangan Komuniti";
...
$Definition["Configuration settings for password fields in Vanilla"] =
    "Tetapan konfigurasi untuk medan kata laluan dalam Vanila";
$Definition["Configure custom Kaltura domains"] =
    "Konfigurasikan domain Kaltura tersuai";
$Definition["Configure how nested categories are displayed to users."] =
    "Konfigurasikan bagaimana kategori bersarang dipaparkan kepada pengguna.";
$Definition['Configuring Vanilla\'s Homepage'] =
    'Mengkonfigurasi Halaman Utama Vanilla';
$Definition["Confirmation  Body"] = "Badan Pengesahan";
$Definition["Confirm email addresses"] =
    "Wajibkan pengguna mengesahkan alamat e-mel mereka (disyorkan)";
...
$Definition[
    ...
    "Hubungi Kakitangan Vanila untuk mendayakan konfigurasi tapak Soal Jawab. Kemudian dayakan tambahan Soal Jawab dalam bahagian Addons pada papan pemuka.";
$Definition[
    ...
    "Hubungi Kakitangan Vanila untuk mendayakan konfigurasi tapak Soal Jawab. Kemudian dayakan tambahan Soal Jawab dalam bahagian <0/> papan pemuka.";
$Definition["Content Curation"] = "Tempoh Kandungan";
$Definition["Content flagged as spam is stored here for moderator review."] =
    "Kandungan yang ditandai sebagai spam disimpan di sini untuk semakan moderator.";
...
$Definition[
    ...
    "Boleh memperkenalkan kelemahan seperti Skrip Merentas Tapak (XSS) jika skrip awal dikompromi.";
$Definition['Could not find a theme identified by \'%s\''] =
    'Tidak dapat mencari tema yang dikenal pasti oleh \'%s\'';
$Definition["Could not instantiate mail function."] =
    "Tidak dapat menunjukkan fungsi mel.";
...
$Definition["Could not open addon file. Addons must be zip files."] =
    "Tidak dapat membuka fail addon. Addon mestilah fail zip.";
$Definition["Create & organize discussion categories and manage your users."] =
    "Buat & susun kategori perbincangan dan uruskan pengguna anda.";
...
$Definition["Disabled: The pocket will <b>not</b> be displayed."] =
    "Dilumpuhkan: Poket <b>tidak</b> akan dipaparkan.";
...
$Definition["Do not display the categories in the side panel."] =
    "Jangan memaparkan kategori di panel sisi.";
...
$Definition[
    ...
    "Widget Prompt Ringkasan E-mel akan tersedia apabila Ringkasan E-mel didayakan.";
...
$Definition[
    ...
    "Ringkasan e-mel akan dihantar pada hari yang dipilih setiap minggu. Perubahan pada hari yang ditetapkan akan memberi kesan pada minggu berikutnya.";
...
$Definition["Embedding is currently DISABLED."] =
    "Penyematan pada masa ini DILAKUKAN.";
$Definition["Embedding is currently ENABLED."] =
    "Penyematan pada masa ini diaktifkan.";
...
$Definition["Enable sending notification emails"] =
    "Dayakan menghantar e-mel pemberitahuan";
...
$Definition["Enable to only show posts from categories a user follows."] =
    "Dayakan untuk hanya memaparkan siaran daripada kategori yang diikuti pengguna.";
$Definition[
    "Enable to get a preview of our new user management dashboard with improved search and new configuration options."
] =
    "Dayakan untuk mendapatkan pratonton papan pemuka pengurusan pengguna baharu kami dengan carian yang dipertingkatkan dan pilihan konfigurasi baharu.";
...
$Definition[
    ...
    "Mendayakan ciri ini akan mengubah suai Dasar Keselamatan Kandungan anda untuk mempercayai skrip tambahan yang disuntik sebagai kebergantungan oleh skrip tersuai anda.";
$Definition[
...
$Definition["Encourage your friends to join your new community!"] =
    "Galakkan rakan anda untuk menyertai komuniti baru anda!";
$Definition["Enter a comma-delimited list of indexes, starting at 1."] =
    "Masukkan senarai indeks yang dipisahkan koma, bermula pada 1.";
...
$Definition["Enter the email address of the person you would like to invite:"] =
    "Masukkan alamat e-mel orang yang ingin anda jemput:";
$Definition[
    "Enter the url to the page you would like to use as your homepage"
] = "Masukkan url ke halaman yang ingin anda gunakan sebagai halaman utama anda";
$Definition[
    "Enter the url to the page you would like to use as your homepage:"
] = "Masukkan url ke halaman yang ingin anda gunakan sebagai halaman utama anda:";
$Definition["Error sending email. Please review the addresses and try again."] =
    "Ralat semasa menghantar e-mel. Sila semak alamat dan cuba lagi.";
...
$Definition["Exclude archived discussions from the discussions list"] =
    "Kecualikan perbincangan yang diarkibkan dari senarai perbincangan";
$Definition["Existing members send invitations to new members."] =
    "Ahli yang ada menghantar jemputan kepada ahli baru.";
...
$Definition[
    ...
    "Carian luaran menggantikan carian luar kotak Vanilla dengan penyedia carian pihak ketiga pilihan anda.";
...
$Definition["FaviconBrowse"] =
    "Cari favicon baru jika anda ingin menukarnya:";
$Definition["FaviconDescription"] =
    "Favicon laman web anda muncul di bar tajuk penyemak imbas anda. Ia akan dikurangkan dengan tepat.";
...
$Definition[
    ...
    "Contohnya, untuk membenarkan yourdomain.com, www.yourdomain.com dan help.yourdomain.com, anda akan menambah *.yourdomain.com";
$Definition["Force the forum to only be accessible through this url"] =
    "Memaksa forum hanya dapat diakses melalui url ini";
$Definition["Force your forum to be viewed through the Remote Url"] =
    "Paksa forum anda dilihat melalui Url Jauh";
...
$Definition["Full post in email notifications"] =
    "Catatan penuh dalam pemberitahuan e-mel";

$Definition["Garden"] = "Taman";
$Definition["Garden.api.ssoIDPermission.description"] =
    "Peranan dengan izin ini akan dapat mengembangkan ID SSO dalam panggilan API v2.";
...
$Definition[
    ...
    "Menjana Cadangan. Anda akan dimaklumkan apabila mereka bersedia untuk anda semak.";
...
$Definition[
    ...
    "salam. Saya ialah Pembantu Cadangan AI anda, di sini untuk membantu anda mencari artikel dan siaran yang berkaitan untuk menjawab pertanyaan anda. Sila berasa bebas untuk bertanya apa-apa soalan yang anda ada.";
$Definition["guest"] = "tetamu";
$Definition["Guest roles"] =
    "Periksa semua peranan yang harus diterapkan kepada tetamu.";

$Definition["Hash Algorithm"] = "Algoritma Hash";
$Definition["HeadlineFormat.AddUser"] =
    "{ActivityUserID, user} menambahkan akaun untuk {RegardingUserID, user}.";
$Definition["HeadlineFormat.PictureChange"] =
    "{RegardingUserID, You} berubah {ActivityUserID, your} gambar profil.";
$Definition["HeadlineFormat.RegistrationApproval"] =
    "{ActivityUserID, user} meluluskan permohonan untuk {RegardingUserID, user}.";
...
$Definition[
    ...
    "hello! Saya ialah Pembantu Cadangan AI anda, di sini untuk membantu anda mencari artikel dan siaran terbaik untuk menjawab soalan anda. Jangan ragu untuk bertanya apa-apa, saya di sini untuk menjadikan carian anda menyeronokkan dan bermaklumat!";
...
$Definition["Hide discussions from Recent Discussions and Widgets."] =
    "Sembunyikan perbincangan daripada Perbincangan dan Widget Terkini.";
$Definition["Hide posts from Recent Posts Page and Widgets."] =
    "Sembunyikan siaran daripada Halaman Catatan Terkini dan Widget.";
...
$Definition["Hide signatures on embedded comments"] =
    "Sembunyikan tandatangan pada komen yang disertakan";
...
$Definition["How the content is going to be filtered."] =
    "Bagaimana kandungan akan ditapis.";
...
$Definition[
    ...
    "Walau bagaimanapun, ini disertai dengan peningkatan tanggungjawab untuk memastikan keselamatan tapak anda.";
$Definition["Html"] = "HTML";
$Definition["HTML Emails"] = "E-mel HTML";
$Definition["HTTP Strict Transport Security (HSTS) Settings"] =
    "Tetapan Keselamatan Pengangkutan Ketat HTTP (HSTS)";
...
$Definition["If left empty, Email Logo is used."] =
    "Jika dibiarkan kosong, Logo E-mel digunakan.";
$Definition[
    ...
    "Jika anda mempunyai pautan ke dokumen dalaman dalam 'Pautan ke Syarat Penggunaan' di atas, 'Teks Syarat Penggunaan' akan diabaikan. Alih keluar pautan jika anda mahu menggunakan teks ini.";
...
$Definition["Install Vanilla without a .htaccess file."] =
    "Pasang Vanilla tanpa fail .htaccess.";
...
$Definition["It looks like you edited your post. <0/> or <1/>."] =
    "Nampaknya anda telah mengedit siaran anda. <0/> atau <1/>.";
...
$Definition["Large images will be scaled down."] =
    "Gambar besar akan diturunkan ke lebar maksimum %spx dan tinggi maksimum %spx.";
...
$Definition["Make sure you select at least one item before continuing."] =
    "Pastikan anda memilih sekurang-kurangnya satu item sebelum meneruskan.";
$Definition["Add your site to trusted domains."] =
    "Pastikan laman web anda ditambahkan ke %s apabila penyematan diaktifkan.";
...
$Definition["Manage Suggested Answer Sources"] =
    "Urus Sumber Jawapan yang Dicadangkan";
...
$Definition["Mark All Suggested Answers as Accepted"] =
    "Tandakan Semua Jawapan yang Dicadangkan sebagai Diterima";
...
$Definition["Member roles"] =
    "Periksa semua peranan yang harus diterapkan pada pengguna baru / yang diluluskan.";
...
$Definition["Moderators have permission to edit most content."] =
    "Moderator mempunyai kebenaran untuk mengedit kebanyakan kandungan.";
...
$Definition[
    ...
    "Bahasa yang lebih kompleks dan mungkin memperkenalkan beberapa istilah khusus industri, tetapi masih boleh difahami oleh kebanyakan orang.";
...
$Definition[
    ...
    "Bahasa yang lebih teknikal dan istilah khusus industri -- menganggap tahap kefahaman/kebiasaan Teknologi yang lebih tinggi dengan subjek.";
$Definition["more than %s deep"] = "lebih dari kedalaman %s";
$Definition['Most pockets shouldn\'t be displayed in the dashboard.'] =
    'Sebilangan besar poket tidak boleh dipaparkan di papan pemuka.';
$Definition["Move discussions in this category to a replacement category."] =
    "Alihkan perbincangan dalam kategori ini ke kategori pengganti.";
...
$Definition["Never - Users Must Refresh Page"] =
    "Tidak Pernah - Pengguna Mesti Menyegarkan Halaman";
$Definition["Never display on mobile browsers."] =
    "Jangan sekali-kali dipaparkan pada penyemak imbas mudah alih.";
...
$Definition["New conversations in the last day"] =
    "Perbualan baru pada hari terakhir";
$Definition["New conversations in the last week"] =
    "Perbualan baru pada minggu lalu";
$Definition["New discussions in the last day"] =
    "Perbincangan baru pada hari terakhir";
$Definition["New discussions in the last week"] =
    "Perbincangan baru pada minggu terakhir";
...
$Definition["New users are only registered through SSO plugins."] =
    "Pengguna baru hanya didaftarkan melalui pemalam SSO.";
$Definition[
    'New users are reviewed and approved by an administrator (that\'s you!).'
] = 'Pengguna baru disemak dan diluluskan oleh pentadbir (itu anda!).';
$Definition[
    "New users fill out a simple form and are granted access immediately."
] = "Pengguna baru mengisi borang ringkas dan diberi akses segera.";
...
$Definition["No item options are available for Link display type."] =
    "Tiada pilihan item tersedia untuk jenis paparan Pautan.";
...
$Definition["Notifications will appear here."] =
    "Pemberitahuan akan dipaparkan di sini.";
$Definition["NotifyApplicant"] =
    "Beritahu saya apabila ada yang memohon keahlian.";
$Definition["Notify me when people comment on a discussion."] =
    "Beritahu saya semasa orang mengulas perbincangan.";
$Definition["Notify me when my questions have AI Suggested Answers"] =
    "Beritahu saya apabila soalan saya mempunyai Jawapan Cadangan AI";
$Definition["Notify me when people start new discussions."] =
    "Beritahu saya semasa orang memulakan perbincangan baru.";
...
$Definition["Only display on mobile browsers."] =
    "Hanya dipaparkan di penyemak imbas mudah alih.";
$Definition[
    ...
    'Hanya medan yang merupakan kotak pilihan tunggal, lungsur turun pilihan tunggal, lungsur turun berbilang pilihan atau lungsur turun angka tersedia. Setelah medan dipilih, ia akan dipaparkan di bawah supaya anda boleh memilih jawapan khusus untuk setiap medan profil.';
...
$Definition["Only visible to users with roles with permission."] =
    "Hanya dapat dilihat oleh pengguna dengan peranan dengan izin.";
$Definition[
    "Open cases will only display if the user has a valid Salesforce connection."
] =
    "Kes terbuka hanya akan dipaparkan jika pengguna mempunyai sambungan Salesforce yang sah.";
...
$Definition["Or select an image on your computer (2mb max)"] =
    "Atau pilih gambar di komputer anda (maksimum 2mb)";
...
$Definition["Pageview ratio representing a deflected case"] =
    "Nisbah paparan halaman mewakili kes terpesong";
...
$Definition["Please enter a unique API Label, this one has been used before"] =
    "Sila masukkan Label API yang unik, yang ini telah digunakan sebelum ini";
...
$Definition[
    ...
    "Kemungkinan masalah keserasian dengan pelayar lama, menjejaskan pengalaman pengguna.";
...
$Definition[
    ...
    "Protokol (cth. https://) dan laluan (cth. yourdomain.com/some/path) hendaklah ditinggalkan.";
...
$Definition["Read more in the documentation"] =
    "Baca lebih lanjut dalam dokumentasi";
...
$Definition[
    ...
    "Dimensi yang disyorkan ialah 400px kali 300px atau lebih kecil dengan nisbah yang serupa.";
...
$Definition["Registration is currently closed."] =
    "Pendaftaran ditutup sekarang.";
$Definition["Reload the page to see recent updates."] =
    "Muat semula halaman untuk melihat kemas kini terkini.";
$Definition["Reload the page to access recent updates."] =
    "Muat semula halaman untuk mengakses kemas kini terkini.";
...
$Definition["Require Terms of Service"] =
    "Memerlukan pengguna untuk bersetuju menerima Syarat Perkhidmatan (disyorkan)";
...
$Definition["Reset password and send email notification to user"] =
    "Tetapkan semula kata laluan dan hantarkan pemberitahuan e-mel kepada pengguna";
$Definition["Reset to Default"] = "Tetapkan semula kepada Lalai";
$Definition["Resetting the password for %s."] =
    "Menetapkan semula kata laluan untuk %s.";
...
$Definition["RolePersonalInfo"] =
    "Peranan ini adalah maklumat peribadi. Hanya pengguna yang mempunyai kebenaran untuk melihat maklumat peribadi yang akan melihatnya.";
$Definition["Roles & Permissions"] = "Peranan & Kebenaran";
$Definition['Roles determine user\'s permissions.'] =
    "Setiap pengguna di laman web anda diberikan sekurang-kurangnya satu peranan. Peranan digunakan untuk menentukan apa yang dibenarkan oleh pengguna.";
...
$Definition["Search by user or role."] =
    "Cari pengguna dengan nama atau e-mel, dengan pilihan menggunakan% sebagai wildcard. Anda juga boleh mencari berdasarkan ID pengguna, nama peranan, atau \"dilarang\".";
...
] = "Pilih lajur yang dipaparkan pada senarai halaman urus pengguna.";
...
$Definition[
    ...
    "Hantarkan e-mel pengesahan apabila orang bertanya atau memulakan perbincangan melalui e-mel.";
...
$Definition['Separate each word with a semi-colon ";"'] =
    'Pisahkan setiap perkataan dengan titik koma ";"';
$Definition[
    "Set this interest as default to suggest following its mapped categories and tags to all users."
] =
    "Tetapkan minat ini sebagai lalai untuk mencadangkan mengikut kategori dan tegnya yang dipetakan kepada semua pengguna.";
...
] = "Tunjukkan kepada setiap pengguna senarai idea yang diperibadikan yang mereka buat atau pilih.";
...
] = "Sumber yang dipilih di sini akan tersedia untuk Jawapan Cadangan AI.";
$Definition["Specify one domain per line. Use * for wildcard matches."] =
    "Tentukan satu domain setiap baris. Gunakan * untuk pertandingan wildcard.";
$Definition["Spoof"] = "Palsu";
$Definition["SSO Role"] = "Peranan SSO";
$Definition["SSO roles are always passed through SSO."] =
    "Peranan SSO selalu diteruskan melalui SSO.";
...
$Definition[
    ...
    "Mulakan baris subjek ringkasan dengan set [Tajuk Sepanduk] dalam Penampilan > Penjenamaan & SEO";
...
$Definition[
    ...
    "Gaya dan penampilan visual umum semua e-mel, termasuk ringkasan e-mel, ditetapkan di seluruh tapak pada halaman Tetapan E-mel.";
...
$Definition["Suggestions are only visible to you until you accept the answer"] =
    "Cadangan hanya kelihatan kepada anda sehingga anda menerima jawapannya";
$Definition["Suggestions may only be generated on questions"] =
    "Cadangan hanya boleh dijana pada soalan";
...
$Definition["The first line of content in the email digest after the title."] =
    "Baris pertama kandungan dalam ringkasan e-mel selepas tajuk.";
$Definition["The homepage title is displayed on your home page."] =
    "Tajuk laman utama dipaparkan di laman utama anda. Pilih tajuk yang ingin anda lihat muncul di enjin carian.";
$Definition["The homepage was saved successfully."] =
    "Laman utama berjaya disimpan.";
$Definition["The invitation was removed successfully."] =
    "Jemputan berjaya dikeluarkan.";
...
$Definition["The Key in the XML payload to designate %s."] =
    "Kunci dalam muatan XML untuk menetapkan %s.";
$Definition[
    "The test digest will generate content as if it were this user receiving the digest."
] =
    "Rumusan ujian akan menjana kandungan seolah-olah pengguna ini menerima ringkasan.";
...
$Definition[
    ...
    'Terdapat ralat semasa memuat naik gambar. Logo e-mel anda boleh dimuat naik dalam salah satu jenis fail berikut: gif, jpg, png';
$Definition["There are currently no applicants."] =
    "Tidak ada pemohon buat masa ini.";
$Definition["There is currently %s applicant."] =
    "Terdapat pemohon %s buat masa ini.";
$Definition["There are currently %s applicants."] =
    "Kini terdapat pemohon %s.";
$Definition["There are currently no requests."] =
    "Tidak ada permintaan buat masa ini.";
$Definition["There is currently %s request."] =
    "Terdapat permintaan %s pada masa ini.";
$Definition["There are currently %s requests."] =
    "Terdapat permintaan %s pada masa ini.";
$Definition["There are no items awaiting moderation at this time."] =
    "Tidak ada item yang menunggu penyederhanaan buat masa ini.";
$Definition[
    ...
    "Sudah ada akaun di forum ini menggunakan alamat e-mel anda. Sila buat akaun baru, atau masukkan bukti kelayakan untuk akaun yang ada.";
$Definition["The next three email digest delivery dates"] =
    "Tiga tarikh penghantaran ringkasan e-mel seterusnya";
$Definition["The secret secures the sign in process."] =
    "Rahsia memastikan proses masuk. <b>JANGAN</b> memberikan rahsia kepada sesiapa.";
$Definition["The site description usually appears in search engines."] =
    "Huraian laman web biasanya muncul di enjin carian. Anda harus mencuba keterangan yang panjangnya 100-150 aksara.";
$Definition["The site is currently undergoing scheduled maintenance."] =
    "Laman web ini sedang menjalani penyelenggaraan berjadual.";
$Definition["The specified url code is already in use by another category."] =
    "Kod url yang ditentukan sudah digunakan oleh kategori lain.";
$Definition["The structure was successfully executed."] =
    "Struktur berjaya dilaksanakan.";
$Definition["The update was not successful."] =
    "Kemas kini tidak berjaya.";
$Definition["The update was successful."] = "Kemas kini berjaya.";
$Definition["The url that users go to to register for a new account."] =
    "Url yang digunakan pengguna untuk mendaftar akaun baru.";
$Definition["The url that users use to register for a new account."] =
    "Url yang digunakan pengguna untuk mendaftar untuk akaun baru.";
$Definition["The url that users use to sign in."] =
    "Url yang digunakan pengguna untuk log masuk.";
$Definition["The URL where users can sign up for new accounts on your site"] =
    "URL tempat pengguna boleh mendaftar untuk akaun baru di laman web anda";
$Definition["The URL where users sign in on your site"] =
    "URL tempat pengguna melog masuk di laman web anda";
$Definition["The URL where users sign out of your site"] =
    "URL tempat pengguna keluar dari laman web anda";
$Definition["The user and all related content has been deleted."] =
    "Pengguna dan semua kandungan yang berkaitan telah dipadamkan.";
$Definition["The user content will be completely deleted."] =
    "Kandungan pengguna akan dihapuskan sepenuhnya.";
$Definition["The user content will remain untouched."] =
    "Kandungan pengguna akan tetap tidak tersentuh.";
$Definition["The user has been created successfully"] =
    "Pengguna berjaya dibuat";
...
$Definition[
    ...
    "Ini tidak diperlukan pada kebanyakan tapak kecuali tapak yang menggunakan ciri seperti AdSense dan Pengurus Google Tag.";
$Definition[
    ...
    "Ini ialah ringkasan yang dijana AI daripada siaran perbincangan yang dirujuk yang mungkin menjawab soalan. Ringkasan dibuat dengan cara untuk digunakan sebagai jawapan yang diterima.";
$Definition["This category has custom permissions."] =
    "Kategori ini mempunyai kebenaran tersuai.";
$Definition["This category is archived."] = "Kategori ini diarkibkan.";
$Definition["This connection is in test-mode."] =
    "Sambungan ini berada dalam mod ujian.";
$Definition["This controls how the responses are phrased and spelled."] =
    "Ini mengawal cara respons difrasa dan dieja.";
$Definition["This Database"] = "Pangkalan Data ini";
$Definition["QnAFollowup.Feature.Enabled"] =
    "Ciri ini menghantar e-mel kepada pengarang soalan yang dijawab yang tidak mempunyai jawapan yang diterima.";
$Definition["This forum is currently set to invitation only mode."] =
    "Forum ini kini ditetapkan ke mod undangan sahaja.";
$Definition[
    'This image will be used in category lists and widgets when using the "Icon" style option.'
] =
    'Imej ini akan digunakan dalam senarai kategori dan widget apabila menggunakan pilihan gaya "Ikon".';
$Definition[
    ...
    'Imej ini akan muncul dalam sepanduk kategori ini dan dalam widget kategori apabila menggunakan pilihan gaya "Imej" dan/atau "Latar Belakang". Dimensi yang disyorkan ialah kira-kira 1000px kali 400px atau nisbah yang serupa.';
$Definition["This is a parent category that does not allow discussions."] =
    "Ini adalah kategori ibu bapa yang tidak membenarkan perbincangan.";
$Definition['This is the first time you\'ve visited the discussion forums.'] =
    'Ini adalah kali pertama anda mengunjungi forum perbincangan.';
$Definition[
    "This may be used to include content such as organization name and address in the email digest."
] =
    "Ini boleh digunakan untuk memasukkan kandungan seperti nama dan alamat organisasi dalam ringkasan e-mel.";
$Definition["This name will be shown in the community."] =
    "Nama ini akan ditunjukkan dalam komuniti.";
...
] = "Tema ini tidak dapat dihapus kerana ini adalah tema yang sedang digunakan.";
$Definition["This theme has additional options."] =
    "Tema ini mempunyai pilihan tambahan pada halaman %s.";
$Definition["This theme has customizable text."] =
    "Tema ini mempunyai teks yang boleh anda sesuaikan.";
$Definition[
    ...
    "Ini akan membimbing pengguna lain dengan soalan yang serupa kepada jawapan yang betul dengan lebih cepat dan akan memaparkan Jawapan Cadangan AI dan memautkan bahan yang dirujuk untuk dilihat oleh pengguna lain. Cadangan hanya kelihatan kepada anda sehingga anda menerima jawapannya.";
...
$Definition["Truncate the initial discussion text to this many words."] =
    "Potong teks perbincangan awal dengan banyak perkataan ini.";
...
$Definition["Up to a maximum of 100 items may be displayed."] =
    "Sehingga maksimum 100 item boleh dipaparkan.";
...
$Definition["Use an SMTP server to send email"] =
    "Gunakan pelayan SMTP untuk menghantar e-mel";
$Definition["Use asterisks for wildcards"] =
    'Gunakan tanda bintang untuk wildcard, misalnya "*@gmail.com"';
...
$Definition["Use categories to organize discussions"] =
    "Gunakan kategori untuk mengatur perbincangan";
$Definition["Use Facebook names for usernames."] =
    "Gunakan nama Facebook untuk nama pengguna.";
...
$Definition[
    ...
    "Menggunakan bahasa yang sangat teknikal dan istilah khusus industri yang bertujuan untuk mereka yang mempunyai pemahaman mendalam tentang perkara perkara.";
$Definition[
    "Uses industry-specific terms where necessary, but also provides explanations of definitions to ensure clarity."
] =
    "Menggunakan istilah khusus industri jika perlu, tetapi juga memberikan penjelasan definisi untuk memastikan kejelasan.";
$Definition[
    "Uses simple, everyday language that anyone can understand, regardless of their background or expertise."
] =
    "Menggunakan bahasa seharian yang mudah yang boleh difahami oleh sesiapa sahaja, tanpa mengira latar belakang atau kepakaran mereka.";
$Definition["UserDeleteMessage"] =
    'Padamkan pengguna dan hapus semua kandungan pengguna sepenuhnya. Ini boleh menyebabkan perbincangan terputus. Pilihan terbaik untuk membuang spam.';
$Definition["UserDeletionPrompt"] =
    "Pilih cara menangani semua kandungan yang berkaitan dengan akaun pengguna untuk %s (komen, mesej, dll).";
$Definition["UserKeep"] = "Simpan Kandungan Pengguna";
$Definition["UserKeepMessage"] =
    'Padamkan pengguna tetapi jaga kandungan pengguna.';
...
$Definition[
    ...
    "Pengguna boleh mengikuti kategori untuk melanggan pemberitahuan untuk siaran baharu. Pilih kategori mana yang harus diikuti oleh pengguna baharu secara lalai.";
$Definition["Users that get this reaction get %+d point."] =
    "Pengguna yang mendapat reaksi ini mendapat mat%+d.";
...
$Definition[
    ...
    "Pengguna tidak akan diberi amaran ketika mengikuti pautan yang sesuai dengan Domain yang Dipercayai.";
$Definition[
    "Users will be redirected to this URL after accepting an invitation."
] =
    "Pengguna akan diarahkan ke URL ini setelah menerima jemputan. Ini boleh menjadi URL penuh atau jalan untuk mengarahkan semula dalam laman web.";
...
$Definition[
    ...
    'Pengguna akan diberikan peranan ini sehingga mereka mengesahkan alamat e-mel mereka.';
$Definition["Users with the no ads permission will not see this pocket."] =
    "Pengguna tanpa kebenaran iklan tidak akan melihat poket ini.";
$Definition["UserWipe"] = "Kandungan Pengguna Kosong";
$Definition["UserWipeMessage"] =
    'Padamkan pengguna dan ganti semua kandungan pengguna dengan mesej yang menyatakan bahawa pengguna telah dihapuskan. Ini memberi petunjuk visual bahawa terdapat maklumat yang hilang.';
$Definition["Use the content at this url as your homepage."] =
    'Pilih halaman yang mesti dilihat orang ketika mereka melayari: <strong style="white-space: nowrap;">%s</strong>';
$Definition["Use Vanilla as a commenting system in your site"] =
    "Gunakan Vanilla sebagai sistem komen di laman web anda";
$Definition["Use weekly community email digest"] =
    "Gunakan ringkasan e-mel komuniti mingguan";
$Definition["Untitled"] = "Tanpa tajuk";

$Definition["Value or Pattern"] = "Nilai atau Corak";
$Definition["Vanilla.Archive.Description"] =
    "Anda boleh memilih untuk mengarkibkan perbincangan forum lebih lama daripada tarikh tertentu. Perbincangan yang diarkibkan ditutup dengan berkesan, tidak membenarkan siaran baru.";
$Definition["Vanilla.Categories.MaxDisplayDepth"] =
    'Letakkan kategori bersarang dalam senarai yang dipisahkan koma apabila mereka %1$s';
...
$Definition["View browser compatibility chart"] =
    "Lihat carta keserasian penyemak imbas";
...
] = "Memberi amaran kepada pengguna jika pautan dalam siaran akan menyebabkan mereka keluar dari forum";
$Definition[
    "Warning: All of your data will be lost. Once you delete, there is absolutely no recovery of any kind."
] =
    "Amaran: Semua data anda akan hilang. Sebaik sahaja anda menghapuskan, sama sekali tidak ada pemulihan apa-apa.";
$Definition["Warning: deleting is permanent"] =
    "PERINGATAN: item yang dipadam dikeluarkan dari senarai ini dan tidak dapat dibawa kembali.";
...
$Definition["We only accept urls that begin with http:// or https://"] =
    "Kami hanya menerima url yang bermula dengan http: // atau https: //";
$Definition[
    ...
    "Kami akan berusaha menggunakan pelayan mel tempatan untuk menghantar e-mel secara lalai. Sekiranya anda ingin menggunakan pelayan mel SMTP yang berasingan, anda boleh mengkonfigurasinya di bawah.";
$Definition[
    ...
    "Selamat datang. Saya ialah Pembantu Cadangan AI anda, alat berasaskan pembelajaran mesin yang direka untuk mencari dan mencadangkan artikel dan siaran yang berkaitan sebagai respons kepada pertanyaan anda. Sila masukkan soalan anda dan saya akan memberikan maklumat yang paling sesuai.";
$Definition['What\'s the Buzz?'] = 'Apa itu Buzz?';
$Definition["When enabled, search result will open in a new browser tab."] =
    "Apabila didayakan, hasil carian akan dibuka dalam tab penyemak imbas baharu.";
$Definition[
    "When enabled, your community will have AI Suggestions shown in Q&A. <0/>"
] = "Apabila didayakan, komuniti anda akan mempunyai Cadangan AI ditunjukkan dalam Soal Jawab. <0/>";
$Definition[
    ...
    "Apabila tetapan ini didayakan, butiran pengguna dalam data Analitis akan dianonimkan secara lalai, sehingga pengguna bersetuju dengan kuki Analitis. <0>Ketahui lebih lanjut</0>";
$Definition["Where is your Community Forum?"] =
    "Di mana Forum Komuniti anda?";
$Definition['Who\'s Online Settings'] = 'Tetapan Dalam Talian Siapa';
$Definition["Why am I seeing AI Suggested Answers?"] =
    "Mengapa saya melihat Jawapan Cadangan AI?";
...
$Definition["Yes, the following information can be changed later."] =
    "Ya, maklumat berikut boleh diubah kemudian.";
$Definition["You are connected as %s."] = "Anda dihubungkan sebagai %s.";
$Definition["You are not allowed to use suggestions"] =
    "Anda tidak dibenarkan menggunakan cadangan";
$Definition["You are previewing the %s theme."] =
    "Anda melihat pratonton tema %s.";
$Definition[
    "You can also ban the users that posted the spam and delete all of their posts."
] =
    "Tandai kotak di sebelah pengguna yang menyiarkan spam untuk juga melarangnya dan menghapus semua catatan mereka. <b>Lakukan ini hanya jika anda pasti ini adalah spammer.</b>";
$Definition['You can always use your password at<a href="%1$s">%1$s</a>.'] =
    'Sekiranya anda terkunci dari forum anda, anda selalu boleh log masuk menggunakan e-mel dan kata laluan Vanilla anda yang asli di <a href="%1$s">%1$s</a>';
$Definition[
    "You can ban IP addresses, email domains, and words from usernames using this tool."
] =
    "Anda boleh melarang alamat IP, domain e-mel, dan kata-kata dari nama pengguna menggunakan alat ini.";
$Definition[
    "You can customize the HTML and CSS for this theme on the %s page."
] = "Anda boleh menyesuaikan HTML dan CSS untuk tema ini di halaman %s.";
$Definition[
    "You can either create a new account, or enter your credentials if you have an existing account."
] =
    "Anda boleh membuat akaun baru, atau memasukkan bukti kelayakan anda jika anda mempunyai akaun yang ada.";
$Definition["You can make the categories page your homepage."] =
    'Anda boleh menjadikan halaman kategori anda sebagai halaman utama anda <a href="%s">di sini</a> .';
$Definition[
    "You can search for users by username or email, wildcards are implied."
] = "Anda boleh mencari pengguna dengan nama pengguna atau e-mel, kad bebas adalah tersirat.";
$Definition["You can specify an allow list of trusted domains."] =
    "Anda boleh menentukan senarai domain yang dipercayai yang selamat untuk ubah hala & benam.";
$Definition["You can specify an allow list of trusted domains. (CSP)"] =
    "Anda boleh menentukan senarai membenarkan domain yang dipercayai (cth. yourdomain.com) yang selamat untuk memuatkan javascript daripadanya.";
$Definition[
    'You cannot disable the %1$s plugin because the %2$s plugin requires it in order to function.'
] =
    'Anda tidak dapat mematikan pemalam %1$s kerana pemalam %2$s memerlukannya agar dapat berfungsi.';
$Definition[
    "You cannot remove the only remaining category that allows discussions"
] = "Anda tidak boleh membuang satu-satunya kategori yang membolehkan perbincangan";
$Definition[
    "You can protect your site with an HTTP username/password during development."
] =
    "Anda boleh melindungi laman web anda dengan nama pengguna / kata laluan HTTP semasa pembangunan.";
$Definition[
    "You can send emails in plain text by disabling the toggle below."
] = "Anda boleh menghantar e-mel dalam teks biasa dengan mematikan togol di bawah.";
$Definition["You have %s invitations left for this month."] =
    "Anda mempunyai baki jemputan %s untuk bulan ini.";
$Definition["You have successfully saved interest: <0/>"] =
    "Anda telah berjaya menyimpan minat: <0/>";
$Definition["You must be authenticated in order to use this form."] =
    "Anda mesti disahkan untuk menggunakan borang ini.";
$Definition["You must manually apply this rank."] =
    "Anda mesti menggunakan pangkat ini secara manual.";
$Definition["You must provide at least one recipient"] =
    "Anda mesti menyediakan sekurang-kurangnya satu penerima";
$Definition["You must specify an admin password."] =
    "Anda mesti menentukan kata laluan pentadbir.";
$Definition["You must specify an admin username."] =
    "Anda mesti menentukan nama pengguna pentadbir.";
$Definition[
    ...
    "Fail konfigurasi anda tidak mempunyai kebenaran yang betul. PHP perlu dapat membaca dan menulis ke fail ini: <code>%s</code>";
$Definition['Your default locale won\'t display properly'] =
    'Lokasi lalai anda tidak akan dipaparkan dengan betul sehingga diaktifkan di bawah. Sila aktifkan yang berikut: %s.';
...
$Definition["Your invitations were sent successfully."] =
    "Jemputan anda berjaya dihantar.";
...
$Definition[
    ...
    "Anda meninggalkan editor tema tanpa menyimpan perubahan anda. Pastikan kemas kini anda disimpan sebelum keluar.";
$Definition[
    "You are leaving the Email Settings page without saving your changes. Make sure your updates are saved before exiting."
] =
    "Anda meninggalkan halaman Tetapan E-mel tanpa menyimpan perubahan anda. Pastikan kemas kini anda disimpan sebelum keluar.";
