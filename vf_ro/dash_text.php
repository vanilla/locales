...
$Definition['RichEditor.QuoteEnable.Notes'] = 'Utilizați următoarea opțiune pentru a activa ofertele pentru editorul bogat. Acest lucru se va aplica numai dacă formatatorul implicit este „Rich”.';
...
$Definition['ShareImageDescription'] = 'Când cineva împărtășește un link de pe site-ul dvs., încercăm să surprindem o imagine din pagină. Dacă nu există o imagine pe pagină, atunci vom folosi această imagine. Imaginea trebuie să fie de cel puțin 50 × 50, dar vă recomandăm 200 × 200.';
...
$Definition['This setting loads the page before executing Javascript.'] = 'Această setare încarcă pagina înainte de a executa Javascript, care vă poate îmbunătăți SEO. <br> <strong>** Avertisment: activarea acestei funcții poate provoca erori Javascript pe site-ul dvs. **.</strong>';
