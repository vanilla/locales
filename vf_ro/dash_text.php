...
$Definition['Digest Settings'] = 'Setări Digest';
...
$Definition['Every user in your site is assigned to at least one role. Roles are used to determine what the users are allowed to do.'] = 'Fiecărui utilizator de pe site îi este desemnat cel puțin un rol. Acestea sunt folosite pentru a determina ceea ce le este permis utilizatoriilor să facă';
...
$Definition['Recommended dimensions are about 400px by 300px or smaller with similar ratio.'] = 'Dimensiunile recomandate sunt de aproximativ 400 px pe 300 px sau mai mici, cu un raport similar.';
...
$Definition['The database user you specified does not have permission to access the database. Have you created the database yet? The database reported: <code>%s</code>'] =
    'Utilizatorul de  bază de date specificat nu are permisiunea de a accesa baza de date. Ați creat baza de date? Baza de date a raportat: <code>%s</code>';
...
$Definition['This role is personal info. Only users with permission to view personal info will see it.'] = 'Acest rol reprezintă informații personale. Îl vor vedea numai utilizatorii cu permisiunea de a vizualiza informațiile personale.';
$Definition['This setting loads the page before executing Javascript.'] = 'Această setare încarcă pagina înainte de executarea scriptului Java care poate.să îmbunătățească SEO.<br> <strong>**Avertizare: Activarea acestei funcții poate provoca erori ale scriptului Java pe site.**</strong>';
...
$Definition['Tiled Layout'] = 'Aspect cu gresie';
...
$Definition['Too many addresses! We\'ll send up to %s addresses at once.'] = 'Prea multe adrese! Nu putem trimite decât la %s adrese în același timp.';
...
$Definition['TouchIconDescription'] =
    'Pictograma atingere apare când marcați un site web pe ecranul de pornire al unui dispozitiv Apple. Acestea sunt de obicei 152 pixeli. Apple adaugă automat colțurile rotunjite și efectul de iluminare.';
...
$Definition['User Profile'] = 'Profil utilizator';
...
$Definition['VerifyUser'] = 'Bifați caseta de lângă utilizator pentru a le marca ca <b>verificate,</b> astfel încât postările lor să nu fie marcate din nou ca spam. Acest lucru va restabili, de asemenea, toate postările lor în așteptare.';
...
$Definition['Warning: Loading tables can be slow.'] =
    '<b>Avertisment</b> : configurația serverului dvs. nu acceptă încărcarea rapidă a datelor. Dacă importați un fișier foarte mare (ex. Peste 200.000 de comentarii), poate doriți să luați în considerare schimbarea configurației. Faceți clic <a href="http://vanillaforums.com/porter">aici</a> pentru mai multe informații.';
...
$Definition['You can choose from one of the different styles this theme offers.'] = 'Puteți alege dintre unul dintre stilurile diferite pe care le oferă această temă.';
...
$Definition['You can specify a minimum post length to discourage short posts.'] = 'Puteți specifica o lungime minimă a postării pentru a descuraja postările scurte.';
...
$Definition["This theme cannot be deleted because it is the currently applied theme."] = "Această temă nu poate fi ștearsă deoarece este tema aplicată în acest moment.";
$Definition["Are you sure want to delete this theme? It will be permanently deleted."] = "Sigur doriți să ștergeți această temă? Acesta va fi șters definitiv.";
...
$Definition["When you select Full Bleed, your background is transparent."] = "Când selectați Full Bleed, fundalul dvs. este transparent.";
$Definition["Alignment"] = "Aliniere";
...
$Definition["Alignment (Mobile)"] = "Aliniere (mobil)";
...
$Definition['Check out our <0>documentation</0>, or ask our <1>community of experts</1>.'] = 'Consultați <0>documentația noastră</0> , sau întrebați <1>comunitatea noastră de experți</1> .';
$Definition['Enable and test out the latest Vanilla features.'] = 'Activați și testați cele mai recente caracteristici Vanilla.';
...
$Definition['Disable the "New Embed System" lab on the <0>Vanilla Labs Page</0>'] = 'Dezactivați laboratorul „New Embed System” din pagina <0>Vanilla Labs</0>';
