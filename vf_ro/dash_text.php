...
$Definition['RichEditor.QuoteEnable.Notes'] =
    'Utilizați următoarea opțiune pentru a activa ofertele pentru editorul bogat. Acest lucru se va aplica numai dacă formatatorul implicit este „Rich”.';
...
$Definition['ShareImageDescription'] =
    'Când cineva împărtășește un link de pe site-ul dvs., încercăm să surprindem o imagine din pagină. Dacă nu există o imagine pe pagină, atunci vom folosi această imagine. Imaginea trebuie să fie de cel puțin 50 × 50, dar vă recomandăm 200 × 200.';
...
$Definition['This role is personal info. Only users with permission to view personal info will see it.'] =
    'Acest rol îl reprezintă informațiile personale. Doar utilizatorii cu permisiunea de a vizualiza informațiile personale o vor vedea.';
$Definition['This setting loads the page before executing Javascript.'] =
    'Această setare încarcă pagina înainte de a executa Javascript, care vă poate îmbunătăți SEO. <br> <strong>** Avertisment: activarea acestei funcții poate provoca erori Javascript pe site-ul dvs. **.</strong>';
...
$Definition['Which reactions you use really depends on your community.'] =
    'Ce reacții pe care le utilizați depind într-adevăr de comunitatea dvs., dar vă recomandăm să păstrați în minte câteva puncte.';
...
$Definition["This theme cannot be deleted because it is the currently applied theme."] = "Această temă nu poate fi ștearsă deoarece este tema aplicată în prezent.";
