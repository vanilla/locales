...
$Definition['Allow links to be transformed'] =
    'Tillat at lenker transformeres til innebygde representasjoner i innlegg og kommentarer. For eksempel vil en YouTube-kobling forvandles til en innebygd video.';
...
$Definition['Automatically save drafts of unpublished posts, questions, ideas and comments.'] = 'Lagre automatisk utkast av upubliserte innlegg, spørsmål, ideer og kommentarer.';
...
$Definition['Digest Settings'] = 'Sammendragsinnstillinger';
...
$Definition['FullAnonymization.Description'] = "<strong>Full anonymisering</strong> erstatter hver enkelt IP-adresse med 0.0.0.0, noe som effektivt nekter applikasjonen tilgang til å jobbe med IP-adresser. IP-forbudsregler vil ikke fungere i det hele tatt i dette tilfellet.";
...
$Definition['Recommended dimensions are about 400px by 300px or smaller with similar ratio.'] = 'Anbefalte dimensjoner er omtrent 400 x 300 piksler eller mindre med lignende forhold.';
...
$Definition['SignIn.LockoutTime'] = "Hvor lang tid en bruker er blokkert fra å logge på etter å ha overskredet antall påloggingsforsøk.";
...
$Definition['The database user you specified does not have permission to access the database. Have you created the database yet? The database reported: <code>%s</code>'] =
    'Brukeren av databasen som du spesifiserte, har ikke tilgang til databasen. Har du opprettet databasen nå? Databasen som er rapportert: <code>%s</code>';
...
$Definition['This may be used to include content such as organization name and address in all outgoing emails.'] = 'Dette kan brukes til å inkludere innhold som organisasjonsnavn og adresse i alle utgående e-poster.';
...
$Definition['This setting loads the page before executing Javascript.'] =
    'Denne innstillingen laster siden før Javascript settes i gang, noe som kan forbedre din SEO.<br><strong>**Advarsel: Aktivering av denne funksjonen kan føre til feil med Javascript på siden din.**</strong>';
...
$Definition["Remove post and categories links from menus. Set post and category related pages to return not found page 404."] = "Fjern innlegg og kategorikoblinger fra menyene. Angi innlegg og kategorirelaterte sider til å returnere ikke funnet side 404.";
