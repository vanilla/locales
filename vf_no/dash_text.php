...
$Definition['Garden.Import.Continue.Description'] = 'Det virker som om du er midt i en importering.
   Vennligst velg ett av de følgende alternativene.';
...
$Definition['Warning: Loading tables can be slow.'] = '<b>Advarsel</b>: Konfigureringen av serveren din støtter ikke rask opplasting av data.
Hvis du importerer en veldig stor fil (f.eks. over 200 000 kommentarer), vil du kanskje vurdere å endre konfigureringen din. Klikk <a href="http://vanillaforums.com/porter">her</a> for ytterligere  informasjon.';
