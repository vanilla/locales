...
$Definition['RichEditor.QuoteEnable.Notes'] = 'برای فعال کردن نقل قول ها برای Rich Editor از گزینه زیر استفاده کنید. این تنها در صورتی اعمال می شود که قالب پیش فرض "غنی" باشد.';
...
$Definition['ShareImageDescription'] = 'وقتی شخصی پیوندی از سایت شما به اشتراک می گذارد ، سعی می کنیم تصویری را از صفحه بگیرید. اگر تصویری در صفحه وجود نداشته باشد ، ما به جای آن از این تصویر استفاده خواهیم کرد. تصویر باید حداقل 50 × 50 باشد ، اما 200 200 200 توصیه می کنیم.';
