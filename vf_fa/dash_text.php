...
$Definition['API Overview'] = "بررسی اجمالی API";
...
$Definition['Digest Settings'] = 'تنظیمات خلاصه';
...
$Definition['Most communities stick to positive reactions to encourage participation.'] = 'اکثر جوامع برای تشویق مشارکت به واکنش‌های مثبت پایبند هستند.';
...
$Definition['Quicklinks'] = 'لینک های سریع';
$Definition['Quick-Start Guide to Creating Themes for Vanilla'] = 'راهنماي شروع سريع براي ساخت قالب وانيلا';

$Definition['Rate Limits'] = 'محدودیت‌های نرخ';
$Definition['Reactions Documentation'] = 'مستندات واکنش ها';
...
$Definition['Recommended dimensions are about 400px by 300px or smaller with similar ratio.'] = 'ابعاد توصیه شده حدود 400 پیکسل در 300 پیکسل یا کوچکتر با نسبت مشابه است.';
...
$Definition['Role Tokens'] = 'توکن‌های نقش';
...
$Definition['ShareImageDescription'] =
    'هنگامی که شخصی پیوندی را از سایت شما به اشتراک می گذارد، ما سعی می کنیم تصویری را از صفحه بگیریم. اگر تصویری در صفحه وجود ندارد، به جای آن از این تصویر استفاده می کنیم. تصویر باید حداقل 50×50 باشد، اما ما 200×200 را توصیه می کنیم.';
...
$Definition['Some themes may need to be updated to work with category following. You can disable the feature while you update your theme.'] =
    'ممکن است برخی از تم ها برای کار با دسته زیر به روز شوند. می توانید ویژگی را غیرفعال کنید در حالی که موضوع خود را به روز می کنید.';
$Definition['Special restriction: Only users with permission Garden.Curation.Manage may use this reaction.'] =
    'محدودیت ویژه: فقط کاربران دارای مجوز Garden.Curation.Manage ممکن است از این واکنش استفاده کنند.';
...
$Definition['Spoofing'] = 'کلاهبرداری';
...
$Definition['Tagging allows users to add a tag to discussions they start in order to make them more discoverable. '] =
    'برچسب زدن به کاربران این امکان را می دهد تا برای کشف بیشتر آنها ، برچسبهایی را به مباحثی که شروع می شوند اضافه کنند.';
...
$Definition['The database user you specified does not have permission to access the database. Have you created the database yet? The database reported: <code>%s</code>'] =
    'نام كاربري پايگاه داده كه تعيين كرده ايد مجوز دسترسي به پايگاه داده را ندارد. آيا پايگاه داده را ايجاد كرده ايد؟ پايگاه داده گزارش ميدهد : <code>%s</code>';
...
$Definition['They work just like regular themes. Once one has been added to the themes folder, you can enable it here.'] =
    'آنها درست مانند تم های منظم کار می کنند. هنگامی که یکی به پوشه مضامین اضافه شد ، می توانید آن را در اینجا فعال کنید.';
...
$Definition['This page lists the endpoints of your API.'] =
    'این صفحه نقاط پایانی API شما را لیست می کند. برای اطلاعات بیشتر روی نقاط پایانی کلیک کنید. می توانید از این صفحه یا از طریق خارج از کشور با استفاده از یک نشانه دسترسی تماس های زنده به API برقرار کنید.';
...
$Definition['This setting loads the page before executing Javascript.'] =
    'این تنظیمات قبل از اجرای Javascript می تواند صفحه بارگیری کند که می تواند سئوی شما را بهبود بخشد. <br> <strong>** هشدار: فعال کردن این ویژگی ممکن است باعث ایجاد خطاهای Javascript در سایت شما شود. **</strong>';
...
$Definition['TouchIconDescription'] =
    'نماد لمسی هنگامی که یک وب سایت را در صفحه اصلی یک دستگاه اپل علامت گذاری می کنید ظاهر می شود. اینها معمولاً 152 پیکسل هستند. اپل گوشه های گرد و نورپردازی را به صورت خودکار اضافه می کند.';
...
$Definition['Warning: Loading tables can be slow.'] =
    '<b>هشدار</b> : پیکربندی سرور شما از بارگیری سریع داده پشتیبانی نمی کند. اگر در حال وارد کردن پرونده ای بسیار بزرگ هستید (مثلاً بیش از 200000 نظر) ممکن است بخواهید پیکربندی خود را تغییر دهید. برای اطلاعات بیشتر <a href="http://vanillaforums.com/porter">اینجا را</a> کلیک <a href="http://vanillaforums.com/porter">کنید</a>';
...
$Definition['We recommend enabling 1–3 reactions at a time to avoid overwhelming users.'] = 'توصیه می‌کنیم 1 تا 3 واکنش را در یک زمان فعال کنید تا از زیاده‌روی کاربران جلوگیری شود.';
...
$Definition['When enabled, you can <0>manage products</0>, and group subcommunities by those products.'] = 'وقتی فعال باشد، می‌توانید <0>محصولات را مدیریت کنید</0> و زیرجامعه‌ها را بر اساس آن محصولات گروه‌بندی کنید.';
...
$Definition["This title appears on your site's banner and in your browser's title bar. If a logo is uploaded, it will replace this title on user-facing forum pages. Also, keep in mind some themes may hide this title."] = "این عنوان در بنر سایت شما و در نوار عنوان مرورگر شما ظاهر می شود. اگر لوگویی آپلود شود، جایگزین این عنوان در صفحات فروم کاربر می شود. همچنین، به خاطر داشته باشید که برخی از تم ها ممکن است این عنوان را پنهان کنند.";
...
$Definition["Recent Post List Page"] = "صفحه فهرست پست‌های اخیر";
$Definition["Custom"] = "سفارشی";
$Definition["Category List Page"] = "صفحه فهرست دسته‌بندی‌ها";
$Definition["Home Page Type"] = "نوع صفحه اصلی";
$Definition["Choose a page to serve as the subcommunity homepage."] = "یک صفحه را به عنوان صفحه اصلی زیرجامعه انتخاب کنید.";
$Definition["Selected Home Page Type is a custom layout. You can manage the layout for this subcommunity in <0/>."] = "نوع صفحه اصلی انتخاب شده یک طرح بندی سفارشی است. شما می‌توانید طرح بندی این زیرجامعه را در <0/> مدیریت کنید.";
$Definition["Default Subcommunity"] = "زیرجامعه پیش‌فرض";
$Definition["Make this the default subcommunity. Visitors will be directed here first when they access the community."] = "این را به عنوان زیرجامعه پیش‌فرض انتخاب کنید. بازدیدکنندگان هنگام دسترسی به جامعه، ابتدا به اینجا هدایت می‌شوند.";
$Definition["Post number must be between 3–20."] = "تعداد پست‌ها باید بین ۳ تا ۲۰ باشد.";
$Definition["Pages"] = "صفحات";
$Definition["Widget Builder"] = "سازنده ویجت";
$Definition["Custom Pages"] = "صفحات سفارشی";
$Definition["Site Home Pages"] = "صفحات اصلی سایت";
$Definition["Subcommunity Home Pages"] = "صفحات اصلی زیرجامعه";
$Definition["Choose a theme for this subcommunity.  <0>Read more</0>"] = "یک قالب برای این زیرجامعه انتخاب کنید. <0>ادامه مطلب</0>";
$Definition["Vanilla Messages"] = "پیام‌های وانیلی";
$Definition["From <0/>"] = "از <0/>";
$Definition["Manage Products"] = "مدیریت محصولات";
$Definition["Pages"] = "صفحات";
$Definition["Widget Builder"] = "سازنده ویجت";
$Definition["Custom Pages"] = "صفحات سفارشی";
$Definition["Site Home Pages"] = "صفحات اصلی سایت";
$Definition["Subcommunity Home Pages"] = "صفحات اصلی زیرجامعه";
$Definition["Choose a theme for this subcommunity.  <0>Read more</0>"] = "یک قالب برای این زیرجامعه انتخاب کنید. <0>ادامه مطلب</0>";
$Definition["Search subcommunities."] = "جستجوی زیرجامعه‌ها";
$Definition["The view you were looking for could not be found."] = "منظره‌ای که به دنبالش بودید پیدا نشد.";
$Definition["View Not Found"] = "مشاهده یافت نشد";
$Definition["site"] = "سایت";
$Definition["Selected Home Page Type is a legacy layout."] = "نوع صفحه اصلی انتخاب شده یک طرح‌بندی قدیمی است.";
$Definition["The default home page type can be changed in <0/>."] = "نوع پیش‌فرض صفحه اصلی را می‌توان در <0/> تغییر داد.";

// Sentiment

$Definition["Keyword Settings"] = "تنظیمات کلمات کلیدی";
$Definition["Extremely Negative to Negative"] = "بسیار منفی تا منفی";
$Definition["Negative to Balanced"] = "منفی تا متعادل";
$Definition["Balanced to Positive"] = "متعادل تا مثبت";
$Definition["Positive to Highly Positive"] = "مثبت تا بسیار مثبت";
$Definition["Sentiment Keywords"] = "کلمات کلیدی احساسات";
$Definition["Sentiment Settings"] = "تنظیمات احساسات";
$Definition["Add Keyword"] = "اضافه کردن کلمه کلیدی";
$Definition["Keyword Limit Reached"] = "محدودیت کلمات کلیدی تکمیل شد";
$Definition["You can only track up to 100 keywords. Untrack some to add new keywords."] = "شما فقط می‌توانید تا ۱۰۰ کلمه کلیدی را ردیابی کنید. برای اضافه کردن کلمات کلیدی جدید، برخی را از حالت ردیابی خارج کنید.";
$Definition["Calibrate Sentiment Levels"] = "سطح احساسات را کالیبره کنید";
$Definition["Sentiment Level Distribution Adjustment"] = "تنظیم توزیع سطح احساسات";
$Definition["The 4 sliders represent the points between each sentiment level. Drag the sliders to calibrate the overall sentiment level distribution to your community's content."] = "۴ نوار لغزنده نقاط بین هر سطح احساسات را نشان می‌دهند. نوار لغزنده‌ها را بکشید تا توزیع کلی سطح احساسات با محتوای انجمن شما کالیبره شود.";
$Definition["Calibrated Sentiment Distribution Preview"] = "پیش‌نمایش توزیع احساسات کالیبره شده";
$Definition["(Read Only)"] = "(فقط خواندنی)";
$Definition["This graph visualizes how the content in your community would be distributed based on your calibration adjustment."] = "این نمودار نحوه توزیع محتوا در جامعه شما را بر اساس تنظیم کالیبراسیون شما نشان می‌دهد.";
$Definition["all time sentiment"] = "احساسات همیشگی";
$Definition["keyword"] = "کلمه کلیدی";
$Definition["number of uses"] = "تعداد استفاده‌ها";
$Definition["last use"] = "آخرین استفاده";
$Definition["tracking"] = "ردیابی";
$Definition["Sentiment"] = "احساسات";
$Definition["Tracked Status"] = "وضعیت پیگیری شده";
$Definition["Tracked Only"] = "فقط ردیابی شده";
$Definition["Untracked Only"] = "فقط ردیابی نشده";
$Definition["Strongly Negative"] = "به شدت منفی";
$Definition["Negative"] = "منفی";
$Definition["Positive"] = "مثبت";
$Definition["Highly Positive"] = "بسیار مثبت";
$Definition["Clear all filters"] = "پاک کردن همه فیلترها";
$Definition["Keyword is required."] = "کلمه کلیدی الزامی است.";
$Definition["Maximum length is 100 characters."] = "حداکثر طول ۱۰۰ کاراکتر است.";
$Definition["Keyword"] = "کلمه کلیدی";
$Definition["Add a new tracked keyword"] = "یک کلمه کلیدی ردیابی شده جدید اضافه کنید";
$Definition["New keywords will be tracked in analytics. You can choose to turn off tracking after creating this keyword."] = "کلمات کلیدی جدید در آنالیتیکس ردیابی می‌شوند. می‌توانید پس از ایجاد این کلمه کلیدی، ردیابی را غیرفعال کنید.";
$Definition["Extremely Negative"] = "بسیار منفی";
$Definition["Extremely Positive"] = "بسیار مثبت";
$Definition["Filter by:"] = "فیلتر بر اساس:";
