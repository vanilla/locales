...
$Definition['Condition Type'] = 'گونه‌ی محرومیت';
...
$Definition['Requires: '] = 'نیازمندی‌ها: ';
$Definition['Require users to confirm their email addresses (recommended)'] = 'لازم است که کاربران نشانی رایانامه‌ی خود را تأیید کنند (توصیه شده)';
...
$Definition['SaveLocalePack'] = 'اندوختن';
