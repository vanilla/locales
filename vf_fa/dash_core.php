...
$Definition["The site does not allow you connect with an existing user."] =
    "این سایت به شما اجازه نمی‌دهد با کاربر فعلی ارتباط برقرار کنید.";
...
// Federated Search
$Definition["About Federated Search"] = "درباره جستجوی فدرال";
$Definition["About Search Connectors"] = "درباره اتصالات جستجو";
$Definition["Add"] = "افزودن";
$Definition["Add a custom <0/> search connector"] = "یک رابط جستجوی سفارشی <0/> اضافه کنید";
$Definition["Answer"] = "پاسخ";
$Definition["Apply"] = "بكارگيري";
$Definition["Article"] = "مقاله";
$Definition["Authenticate"] = "احراز هویت";
$Definition["Back"] = "بازگشت";
$Definition["Cancel"] = "لغو";
$Definition["Categories"] = "دسته ها";
$Definition["Client ID is required."] = "ارائه شناسه مشتری الزامی است.";
$Definition["Client Secret is required."] = "ارائه رمز مشتری الزامی است.";
$Definition["Configure"] = "پیکربندی";
$Definition["Cursor pagination uses a url to point to the next page of results. Offset pagination uses a page number and item count to fetch the next page."] = "صفحه‌بندی مکان‌نما از یک آدرس اینترنتی (url) برای اشاره به صفحه بعدی نتایج استفاده می‌کند. صفحه‌بندی افست از شماره صفحه و تعداد آیتم‌ها برای دریافت صفحه بعدی استفاده می‌کند.";
$Definition["Discussions"] = "گفتگوها";
$Definition["Federated Search allows you to include external content within community search results such as knowledge base articles, courses from a learning management system, blog articles and more, to centralize content search within community. <0>Learn more</0>."] = "جستجوی فدرال به شما امکان می‌دهد محتوای خارجی مانند مقالات پایگاه دانش، دوره‌های آموزشی از یک سیستم مدیریت یادگیری، مقالات وبلاگ و موارد دیگر را در نتایج جستجوی انجمن بگنجانید تا جستجوی محتوا در انجمن متمرکز شود. <0>بیشتر بدانید</0> .";
$Definition["Good job! Here is a preview of some of your external articles, listed on your community's Search Results page."] = "آفرین! در اینجا پیش‌نمایشی از برخی از مقالات خارجی شما که در صفحه نتایج جستجوی انجمن شما فهرست شده‌اند، آمده است.";
$Definition["Great!"] = "عالیه!";
$Definition["Groups"] = "گروه";
$Definition["Help Menu"] = "منوی راهنما";
$Definition["Here is what a single result provided by the API looks like:"] = "در اینجا نتیجه‌ای که توسط API ارائه می‌شود را مشاهده می‌کنید:";
$Definition["Idea"] = "ايده";
$Definition["Ideas"] = "ايده";
$Definition["Integrates Salesforce's knowledge base articles into the Vanilla community search, consolidating self-service support resources within the community platform."] = "مقالات پایگاه دانش Salesforce را در جستجوی انجمن Vanilla ادغام می‌کند و منابع پشتیبانی سلف سرویس را در پلتفرم انجمن تثبیت می‌کند.";
...
$Definition["Maximum length is 500 characters."] = "حداکثر طول ۵۰۰ کاراکتر است.";
$Definition["Maximum number of posts to be included in the email digest."] = "حداکثر تعداد پست هایی که باید در خلاصه ایمیل گنجانده شود.";
$Definition["Messages"] = "پيام";
$Definition["Modify <0/> search connector"] = "اصلاح رابط جستجو <0/>";
...
$Definition["Number of posts from groups"] = "تعداد پست های گروه ها";
$Definition["Our Search Connectors will allow you to easily configure the connection between Vanilla and external platforms. Can't find what you're looking for? Let us know which search connectors you need by posting and Idea in our <0>customer community</0>."] = "کانکتورهای جستجوی ما به شما این امکان را می‌دهند که به راحتی ارتباط بین وانیلا و پلتفرم‌های خارجی را پیکربندی کنید. نمی‌توانید آنچه را که به دنبالش هستید پیدا کنید؟ با ارسال پست و ایده در انجمن مشتریان <0> ما، به ما اطلاع دهید که به کدام کانکتورهای جستجو نیاز دارید.</0> .";
$Definition["Please enter some basic information about your custom search connector."] = "لطفا اطلاعات اولیه در مورد رابط جستجوی سفارشی خود را وارد کنید.";
...
$Definition["Response Body"] = "بدن پاسخ";
$Definition["Response Headers"] = "هدرهای پاسخ";
$Definition["Salesforce Article Search"] = "جستجوی مقاله Salesforce";
$Definition["Save"] = "ذخيره";
$Definition["Search Connectors"] = "کانکتورهای جستجو";
$Definition["Site domain is required."] = "دامنه سایت الزامی است.";
$Definition["Some parameters required to search may be unique to your API. Please configure your search connector with these parameters so that the connector can correctly format search queries for your community."] = "برخی از پارامترهای مورد نیاز برای جستجو ممکن است مختص API شما باشند. لطفاً رابط جستجوی خود را با این پارامترها پیکربندی کنید تا رابط بتواند پرس‌وجوهای جستجو را برای انجمن شما به درستی قالب‌بندی کند.";
$Definition["Surfaces Zendesk Help Center knowledge base articles in Vanilla community search to centralize self-service help within community."] = "مقالات پایگاه دانش مرکز راهنمایی Zendesk در Surfaces در جستجوی انجمن Vanilla برای متمرکز کردن کمک سلف سرویس در جامعه.";
$Definition["Tag"] = "برچسب بزنید";
$Definition["Test Custom API"] = "تست API سفارشی";
$Definition["Test your custom API"] = "API سفارشی خود را آزمایش کنید";
$Definition["Test your pagination configuration"] = "پیکربندی صفحه‌بندی خود را آزمایش کنید";
$Definition["The roles that are allowed to access this connector."] = "نقش‌هایی که مجاز به دسترسی به این کانکتور هستند.";
$Definition["This search connector has an invalid configuration."] = "این رابط جستجو پیکربندی نامعتبری دارد.";
$Definition["Tip: These required parameters can usually be found in the documentation for your API"] = "نکته: این پارامترهای مورد نیاز معمولاً در مستندات API شما یافت می‌شوند.";
$Definition["To finish configuring the Search Connector, tell us where to find the following values within the result object."] = "برای تکمیل پیکربندی اتصال‌دهنده جستجو، به ما بگویید که مقادیر زیر را در شیء نتیجه کجا پیدا کنیم.";
$Definition["Visit Site"] = "مشاهده سايت";
$Definition["What kind of pagination does your API use?"] = "API شما از چه نوع صفحه‌بندی استفاده می‌کند؟";
$Definition["When you're ready, use these buttons to check that your pagination configuration functions as expected"] = "وقتی آماده بودید، از این دکمه‌ها برای بررسی عملکرد پیکربندی صفحه‌بندی خود طبق انتظار استفاده کنید.";
$Definition["When you're ready, use this button to test the API and view its results."] = "وقتی آماده بودید، از این دکمه برای آزمایش API و مشاهده نتایج آن استفاده کنید.";
$Definition["Where is the list of results located in this response?"] = "فهرست نتایج در کجای این پاسخ قرار دارد؟";
$Definition["You must configure this search connector to enable it."] = "برای فعال کردن این اتصال جستجو، باید آن را پیکربندی کنید.";
$Definition["You must select at least one role."] = "شما باید حداقل یک نقش را انتخاب کنید.";
$Definition["Zendesk Guide"] = "راهنمای Zendesk";
