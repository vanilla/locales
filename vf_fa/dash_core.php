...
$Definition['Add Ban Rule'] = 'Ban Rule را اضافه کنید';
...
$Definition['If enabled, the full content of posts will be sent in email notifications to users.'] = 'در صورت فعال بودن، محتوای کامل پست‌ها در اعلان‌های ایمیلی برای کاربران ارسال می‌شود.';
