...
$Definition['Add limits to image upload dimensions in discussions and comments.'] = 'Añade límites a las dimensiones en la subida de imágenes en discusiones y comentarios.';
...
$Definition['RichEditor.QuoteEnable.Notes'] = 'Utiliza las siguientes opciones para activar las citas del Editor enriquecido. Esto solo se aplicará si el formateador por defecto es "Enriquecido".';
...
$Definition['This role is personal info. Only users with permission to view personal info will see it.'] = 'Este rol es información personal. Solo los usuarios con permiso para ver información personal podrán verlo.';
$Definition['This setting loads the page before executing Javascript.'] = 'Esta configuración carga la página antes de ejecutar Javascript, lo cual puede mejorar tu posicionamiento web.<br><strong>**Advertencia: habilitar esta función puede provocar errores de Javascript en tu sitio.**</strong>';
