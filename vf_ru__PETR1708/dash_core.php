...
$Definition['BadgeRequestColumnLabel'] = 'Запросъ';
...
$Definition['ForceWysiwyg.Notes1'] = 'Проставьте галочку ниже, чтобы сказать редактору, чтобы изменить форматирование всех старых публикаций на Wysiwyg. ';
$Definition['ForceWysiwyg.Notes2'] = 'Эта настройка будет работать только в том случае, если Wysiwyg был выбран как формат публикаций в окне выше. Цель опции - стандартизировать форматирование редактора. Если старые публикации были созданы с другим форматом, таким как markdown или BBCode, эта настройка изменит его на Wysiwyg при загрузке публикации.';
...
$Definition['permissions.member'] = 'Участникъ';
$Definition['permissions.moderator'] = 'Модераторъ';
...
$Definition['Reinterpret All Posts As Wysiwyg'] = 'Изменить форматирование всех публикаций на Wysiwyg';
...
$Definition['The default banner image across the site. This can be overriden on a per category basis.'] = 'Баннерное изображение сайта по умолчанию. Оно может заменяться на основе категории.';
...
$Definition['Use asterisks for wildcards'] = 'Используйте звездочки для специальных символов, например, ‘*@hotmail.com’';
...
$Definition['You can specify a whitelist of trusted domains.'] = 'Можно указать белый список доверенных доменов (например. yourdomain.com), которые безопасны для перенаправления и внедрения.';
