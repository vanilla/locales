...
$Definition["1 in 5 is recommended for most communities."] =
    "대부분의 지역 사회에서는 5명 중 1명이 권장됩니다.";
$Definition["1 in 20 is recommended for most communities."] =
    "대부분의 지역 사회에서는 20명 중 1명이 권장됩니다.";
...
] = '최대 로그인 시도 횟수에 도달했습니다. %s을(를) 기다렸다가 다시 시도하십시오.';
...
$Definition[
    ...
    "이 이벤트를 Zoom에 연결하고 원클릭 등록 및 참여 버튼을 활성화하려면 Zoom 링크 또는 회의 ID를 추가하세요. 이벤트에 등록이 필요한 경우 이벤트를 만든 후에는 회의 ID 또는 링크를 업데이트할 수 없습니다.";
...
$Definition[
    ...
    "링크를 토론, 댓글, 기사에 임베드된 동영상으로 변형하려면 커스텀 Kaltura 도메일을 추가하세요.";
$Definition[
    "Add your custom Kaltura domain(s) to transform links into embedded videos in posts, comments or articles."
] =
    "게시물, 댓글 또는 기사에 포함된 비디오로 링크를 변환하려면 사용자 정의 Kaltura 도메인을 추가하세요.";
...
$Definition[
    ...
    "AI Suggested Answers는 커뮤니티 게시물과 링크된 지식 기반을 기반으로 제안된 답변을 제공합니다. 프로필 환경 설정을 방문하여 언제든지 켜거나 끌 수 있습니다.";
$Definition[
    "Alert users if they click a link in a post that will lead them away from the forum. "
] =
    "포스트 내의 링크를 클릭할 경우 포럼에서 퇴장당할 수 있음을 경고합니다.";
...
$Definition[
    ...
    "모든 AI 제안 답변을 끄시겠습니까? 언제든지 프로필 설정에서 취소할 수 있습니다.";
...
] = "표시되는 열이 하나 이상 필요합니다. 표시되는 열을 표시하거나 추가합니다.";
...
$Definition[
    ...
    "이 기능을 활성화하기 전에 다음과 같은 잠재적인 영향을 알고 있어야 합니다.";
...
$Definition["Choose who can send out invitations to new members:"] =
    "신규회원에게 초대장을 보낼 수 있는 회원을 선택해 주십시오:";
...
$Definition[
    ...
    "Vanilla 직원에게 문의하여 Q&A 사이트 구성을 활성화하세요. 그런 다음 대시보드의 애드온 섹션에서 Q&A 애드온을 활성화하세요.";
$Definition[
    ...
    "Vanilla 직원에게 문의하여 Q&A 사이트 구성을 활성화하세요. 그런 다음 대시보드의 <0/> 섹션에서 Q&A 애드온을 활성화하세요.";
...
$Definition[
    ...
    "초기 스크립트가 손상된 경우 XSS(교차 사이트 스크립팅)와 같은 취약점이 발생할 수 있습니다.";
...
$Definition[
    ...
    "이메일 다이제스트 프롬프트 위젯은 이메일 다이제스트가 활성화되면 사용할 수 있습니다.";
...
$Definition[
    ...
    "이메일 다이제스트는 매주 선택한 요일에 전송됩니다. 설정된 요일의 변경 사항은 다음 주에 적용됩니다.";
...
$Definition[
    ...
    "이 기능을 활성화하면 사용자 정의 스크립트에 의해 종속성으로 삽입된 추가 스크립트를 신뢰하도록 콘텐츠 보안 정책이 수정됩니다.";
$Definition[
    ...
    '이 기능을 활성화하면 현재 신뢰할 수 있는 도메인 목록에 있는 승인된 스크립트가 다른 스크립트를 동적으로 로드할 수 있도록 사이트의 콘텐츠 보안 정책(CSP)이 수정되고, CSP에 \'strict-dynamic\' 지시문이 추가되어 제3자 통합에 더 많은 유연성을 제공합니다. 콘텐츠.';
...
$Definition[
    ...
    "외부 검색은 바닐라의 기본 검색을 귀하가 선택한 제3자 검색 공급자로 대체합니다.";
...
$Definition["FaviconDescription"] =
    "귀하의 브라우저 검색창에 사이트 파비콘이 나타납니다. 공간에 맞게 적절히 크기가 줄어듭니다.";
...
$Definition[
    ...
    "예를 들어 yourdomain.com, www.yourdomain.com 및 help.yourdomain.com을 허용하려면 *.yourdomain.com을 추가합니다.";
...
$Definition["Garden.api.ssoIDPermission.description"] =
    "해당 권한을 가진 역할은 API v2 콜에서 SSO ID를 확장할 수 있게 됩니다.";
...
$Definition[
    ...
    "안녕하세요. 저는 AI 제안 도우미입니다. 여러분의 질문에 답할 관련 기사와 게시물을 찾는 데 도움을 드리기 위해 왔습니다. 궁금한 사항이 있으면 언제든지 질문해 주세요.";
...
$Definition[
    ...
    "안녕하세요! 저는 여러분의 AI 제안 도우미입니다. 여러분의 질문에 답할 수 있는 최고의 기사와 게시물을 찾는 데 도움을 드립니다. 무엇이든 자유롭게 질문하세요. 저는 여러분의 검색을 재미있고 유익하게 만들기 위해 여기 있습니다!";
...
$Definition[
    ...
    "그러나 이로 인해 사이트 보안을 보장해야 하는 책임이 커집니다.";
...
$Definition[
    ...
    "위의 '이용 약관 링크'에 내부 문서 링크가 있는 경우, '이용 약관 텍스트'는 무시됩니다. 이 텍스트를 사용하려면 링크를 삭제하세요.";
...
$Definition["Large images will be scaled down."] =
    "큰 이미지는 최대 폭 %spx, 최대 높이 %spx로 축소됩니다.   ";
...
$Definition["Add your site to trusted domains."] =
    "임베딩이 활성화되면, 본인 사이트가 %s로 추가된다는 것을 확인하십시오.   ";
...
$Definition["Moderators have permission to edit most content."] =
    "운영자는 포럼의 대부분의 내용을 수정할 수있는 권한을 가지고 있습니다.";
...
$Definition[
    ...
    "좀 더 복잡한 언어로 표현되었으며 업계별 용어가 일부 등장할 수도 있지만 대부분의 사람이 이해할 수 있습니다.";
...
$Definition[
    ...
    "더욱 기술적인 용어와 업계별 용어는 해당 주제에 대한 높은 수준의 기술적 이해/익숙함을 전제로 합니다.";
...
$Definition["Please enter a unique API Label, this one has been used before"] =
    "고유한 API 라벨을 입력하세요. 이전에 사용된 라벨입니다.";
...
$Definition[
    ...
    "이전 브라우저와의 호환성 문제로 인해 사용자 경험에 영향을 미칠 수 있습니다.";
...
$Definition[
    ...
    "프로토콜(예: https://) 및 경로(예: yourdomain.com/some/path)는 생략해야 합니다.";
...
$Definition[
    ...
    "권장 크기는 비슷한 비율로 400px x 300px 또는 그보다 작은 크기입니다.";
...
$Definition["Reload the page to see recent updates."] =
    "최근 업데이트를 보려면 페이지를 새로고침하세요.";
$Definition["Reload the page to access recent updates."] =
    "최근 업데이트에 액세스하려면 페이지를 새로고침하세요.";
...
$Definition["Reset password and send email notification to user"] =
    "패스워드를 재설정하고 사용자에게 이메일 통지를 보냅니다.";
...
$Definition["RolePersonalInfo"] =
    "해당 역할은 개인 정보입니다. 개인 정보를 볼 수 있는 권한이 있는 사용자에게만 해당 정보가 표시됩니다.";
$Definition["Roles & Permissions"] = "역할 및 권한";
$Definition['Roles determine user\'s permissions.'] =
    "포럼의 모든 회원들에게는 하나 이상의 역할(Role)이 할당됩니다.
...
$Definition["Search by user or role."] =
    "와일드카드 %를 선택적으로 사용하여, 이름이나 이메일로 사용자를 검색하세요. 사용자 ID, 역할명, 혹은 “banned”로도 검색할 수 있습니다. ";
...
$Definition[
    ...
    "이 관심사를 기본값으로 설정하면 매핑된 카테고리와 태그를 모든 사용자에게 제안합니다.";
...
] = "각 사용자에게 자신이 만들거나 찬성한 아이디어의 개인화된 목록을 표시합니다.";
...
$Definition[
    ...
    "모양 > 브랜딩 및 SEO에 설정된 [배너 제목]으로 다이제스트 제목 줄을 시작합니다.";
...
$Definition[
    ...
    "이메일 요약을 포함한 모든 이메일의 스타일과 일반적인 시각적 모양은 이메일 설정 페이지에서 사이트 전체에 걸쳐 설정됩니다.";
...
$Definition["Thanks for sticking with us for a full year."] =
    "1년 내내 저희와 함께 해주신 점에 감사드립니다.";
$Definition["Thanks for sticking with us for %s years."] =
    "%s년 동안 저희와 함께 해주신 점에 감사드립니다.";
...
$Definition[
    ...
    "사이트 전체의 기본 배너 이미지입니다. 카테고리별로 재정의할 수 있습니다.";
...
$Definition[
    ...
    '이미지를 업로드하는데 오류가 발생했습니다. 이메일 로고는 다음 파일 형식 중 하나로 업로드 할 수 있습니다: gif, jpg, png';
...
$Definition[
    ...
    "애드센스 및 Google 태그 관리자와 같은 기능을 사용하는 사이트를 제외한 대부분의 사이트에서는 이는 필요하지 않습니다.";
$Definition[
    ...
    "이것은 질문에 답할 수 있는 참조된 토론 게시물에서 AI가 생성한 요약입니다. 요약은 수락된 답변으로 사용될 수 있도록 만들어졌습니다.";
...
$Definition[
    ...
    '이 이미지는 "아이콘" 스타일 옵션을 사용할 때 카테고리 목록 및 위젯에서 사용됩니다.';
$Definition[
    ...
    '이 이미지는 "이미지" 및/또는 "배경" 스타일 옵션을 사용할 때 이 카테고리의 배너와 카테고리 위젯에 나타납니다. 권장 크기는 약 1000x400px 또는 이와 유사한 비율입니다.';
...
$Definition[
    ...
    "이는 이메일 다이제스트에 조직 이름 및 주소와 같은 콘텐츠를 포함하는 데 사용될 수 있습니다.";
...
$Definition[
    ...
    "이렇게 하면 비슷한 질문을 하는 다른 사용자가 더 빨리 올바른 답변을 찾을 수 있으며, AI 제안 답변을 표시하고 다른 사용자가 볼 수 있도록 참조 자료에 대한 링크를 제공합니다. 제안은 답변을 수락할 때까지 본인에게만 표시됩니다.";
...
$Definition["Use an SMTP server to send email"] =
    "SMPT 서버를 사용하여 이메일 발송";
$Definition["Use asterisks for wildcards"] =
    '와일드카드에 별표를 사용하세요. 예 "*@gmail.com"';
...
$Definition[
    ...
    "사용자는 카테고리를 팔로우하여 새 게시물에 대한 알림을 구독할 수 있습니다. 새 사용자가 기본적으로 따라야 하는 범주를 선택합니다.";
...
$Definition[
    ...
    "연결된 링크가 신뢰 도메인일 경우에는 경고를 받지 않습니다.";
$Definition[
    "Users will be redirected to this URL after accepting an invitation."
] =
    "초대에 수락한 후에 사용자는 이 URL로 리디렉션됩니다. 그것은 사이트 내에서 리디렉션되는 전체 URL 또는 경로일 수 있습니다.";
...
$Definition["Users with the no ads permission will not see this pocket."] =
    "광고 제거 권한이 있는 사용자는 이 포켓이 보이지 않습니다. ";
...
$Definition["Vanilla.Archive.Description"] =
    "다음의 기간보다 오래된 글타레는 보관 모드로 전환할 수 있습니다. 보관 모드가 된 글을 수정이 불가능합니다.";
...
] = "포스트 내에 링크가 있을 경우 포럼에서 퇴장당할 수 있음을 경고합니다.";
$Definition[
...
$Definition[
    ...
    "기본적으로 로컬 서버를 통해 이메일을 발송합니다. 별도의 SMTP 메일서버를 구성하려면 아래의 옵션을 사용하십시오.";
$Definition[
    ...
    "환영합니다. 저는 귀하의 AI 제안 도우미입니다. 귀하의 질문에 대한 응답으로 관련 기사와 게시물을 찾아 제안하도록 설계된 머신 러닝 기반 도구입니다. 질문을 입력해 주시면 가장 적합한 정보를 제공해 드리겠습니다.";
$Definition['What\'s the Buzz?'] = 'What\'s the Buzz?';
$Definition["When enabled, search result will open in a new browser tab."] =
    "활성화하면 검색 결과가 새 브라우저 탭에서 열립니다.";
$Definition[
    "When enabled, your community will have AI Suggestions shown in Q&A. <0/>"
] = "이 기능을 활성화하면 커뮤니티의 Q&A에 AI 제안이 표시됩니다. <0/>";
$Definition[
    ...
    "이 설정을 사용하면 사용자가 Analytics 쿠키에 동의할 때까지 Analytics 데이터의 사용자 세부 정보가 기본적으로 익명화됩니다. <0>자세히 알아보기</0>";
...
$Definition['You can always use your password at<a href="%1$s">%1$s</a>.'] =
    '포럼 사용중 로그아웃 되었다면 다음의 경로에서 바닐라 포럼의 이메일 주소와 패스워드를 사용하여 언제든지 로그인 할 수 있습니다: <a href="%1$s">%1$s</a>';
$Definition[
...
$Definition[
    ...
    "당신은 개발하고 있는 중에 HTTP 사용자 이름/비밀번호로 당신의 사이트를 보호할 수 있습니다.";
$Definition[
    "You can send emails in plain text by disabling the toggle below."
] = "아래 토글을 사용하지 않도록 설정하여 일반 텍스트로 이메일을 전송하실 수 있습니다. ";
...
$Definition[
    ...
    "변경 사항을 저장하지 않은 상태로 테마 에디터를 떠나려는 중입니다. 나가시기 전에 변경 사항이 저장해 주세요.";
$Definition[
    "You are leaving the Email Settings page without saving your changes. Make sure your updates are saved before exiting."
] =
    "변경 사항을 저장하지 않고 이메일 설정 페이지를 종료하려고 합니다. 종료하기 전에 업데이트가 저장되었는지 확인하십시오.";
...
$Definition["InputFormatter.Notes1"] =
    "커뮤니티 포스트를 위한 에디터 기본 포맷을 선택하세요. ";
$Definition["InputFormatter.Notes2"] =
    "오래된 포스트를 편집하고 원 포맷 규칙을 로드할 때, 에디터는 해당 포맷을 자동으로 감지합니다. 이 예외와 별개로, 아래 선택된 포스트 포맷이 우선합니다. ";
$Definition["Formatting Posts"] = "게시물 서식 지정";
$Definition["MobileInputFormatter.Notes1"] =
    "모바일 기기를 위한 편집 포맷 지정 ";
$Definition["MobileInputFormatter.Notes2"] =
    "모바일 기기가 동일한 경험을 보유해야 한다면, 위와 같이 동일한 것을 지정하세요. 사용자가 모바일 편집으로 문제를 보고하면, 이것은 변경을 위한 좋은 옵션입니다.  ";
$Definition["Note:"] = "주의:";
...
$Definition[
    ...
    "이렇게 하면 Zoom 통합 소유자를 대신하여 Zoom 회의가 생성되고 등록된 사용자인 경우 공동 호스트로 추가합니다. 등록된 Zoom 사용자가 아니거나 통합을 설정한 조직에 속하지 않은 경우 이 이벤트는 호스트 없이는 Zoom 기능이 제한될 수 있습니다.";
$Definition['You cannot update this event\'s Zoom URL or ID.'] =
    '이 이벤트의 Zoom URL이나 ID를 업데이트할 수 없습니다.';
...
$Definition["A user registers or logs in with email domain:"] =
    "사용자는 이메일 도메인을 사용하여 등록하거나 로그인합니다.";
$Definition["A user registers or updates a profile field:"] =
    "사용자가 프로필 필드를 등록하거나 업데이트합니다.";
...
$Definition["Create and manage automations to easily manage posts and users."] =
    "게시물과 사용자를 쉽게 관리할 수 있도록 자동화를 만들고 관리합니다.";
...
$Definition[
    ...
    "미리보기 데이터를 로드하는 데 실패했습니다. 트리거 및 작업 값을 확인하세요.";
...
] = "다중 선택 필드는 사용자가 기준 중 하나라도 충족하는 경우 트리거됩니다.";
...
$Definition[
    ...
    "참고: 해당 작업은 이미 연관된 작업이 적용된 <0 />에는 영향을 미치지 않습니다.";
...
$Definition[
    ...
    "규칙이 활성화되면 해당 작업이 적용됩니다. 앞으로 트리거 기준을 충족하는 다른 <0 />에게도 해당 작업이 적용됩니다.";
$Definition[
    "This will not affect any <0 /> right now. It will affect those that meet the criteria in future."
] =
    "이는 현재 어떤 <0 />에도 영향을 미치지 않습니다. 이는 향후 기준을 충족하는 항목에 영향을 미칩니다.";
...
$Definition[
    ...
    "150개 이상의 자동화 규칙을 추가할 수 없습니다. 일부 규칙을 삭제하고 다시 시도하세요.";
...
$Definition["Manage Icon helptext"] =
    "여기에서 시스템 및 과거 아이콘을 관리할 수 있습니다. 업로드할 때 아이콘이 SVG 형식이고 viewBox 속성을 포함하고 색상 #000000을 사용하여 테마 설정 및 사용자 상호 작용에 따라 동적으로 색상을 지정할 수 있는지 확인하세요. 각 유형의 아이콘은 한 번에 하나만 활성화할 수 있습니다.";
...
$Definition[
    ...
    "이전 버전의 아이콘은 여기에서 확인할 수 있으며 언제든지 복원할 수 있습니다.";
...
$Definition[
    ...
    "이 색상은 아이콘 색상을 미리 보는 데 사용됩니다. 업로드한 아이콘에서 #000000을 사용하는 것을 대체합니다. 실제 응용 프로그램에서 색상은 동적입니다.";
...
$Definition[
    ...
    "직원 권한이 있는 모든 사용자는 토론 내용을 확인하고 해결됨 또는 미해결로 표시할 수 있습니다. 또한, 분류 대시보드에 접속하여 자신의 카테고리를 관리할 수 있습니다.";
...
$Definition[
    ...
    "모든 게시물 해결은 커뮤니티의 모든 기존 게시물을 해결합니다. 이 대량 작업은 웹훅이나 분석 기능을 트리거하지 않습니다.";
...
$Definition[
    ...
    "새로운 커뮤니티 관리 시스템에서는 사용자 정의 신고 사유, 에스컬레이션, 할당 및 자동화 규칙을 사용할 수 있습니다. 이 기능을 활성화하면 신고 접수가 새로운 시스템을 사용하도록 변경됩니다. <0>자세히 알아보기</0> .";
$Definition[
    ...
    "이렇게 하면 커뮤니티의 모든 기존 게시물이 해결됩니다. 이 대량 작업은 웹훅이나 로그 분석을 트리거하지 않습니다. 계속하시겠습니까?";
...
$Definition["This setting must be enabled to use Custom Discussion Threads."] =
    "사용자 정의 토론 스레드를 사용하려면 이 설정을 활성화해야 합니다.";
$Definition[
    ...
    "커뮤니티 콘텐츠가 생성되기 전에 자동으로 관리하는 설정을 구성하세요. 자동 스팸 감지, 특정 카테고리 게시물 승인 요구, 특정 키워드 또는 문구를 사용한 게시물 승인 요구 등의 옵션을 선택할 수 있습니다.";
...
] = "Cloudflare 챌린지를 우회하기 위해 등록한 이후 경과 일수";
...
$Definition[
    ...
    "다음 키워드나 문구가 포함된 게시물은 관리자의 승인이 필요합니다.";
$Definition["No keywords are currently set to require premoderation."] =
    "현재 사전 검토가 필요한 키워드가 설정되어 있지 않습니다.";
...
$Definition[
    ...
    "Akismet을 활성화하여 지원자 등록 및 검증되지 않은 사용자의 모든 게시물에서 스팸을 필터링합니다. <0/>";
$Definition[
    ...
    "Stopforumspam을 활성화하면 커뮤니티 사용자를 신고된 스패머 목록과 비교하여 해당 게시물을 스팸으로 신고하거나 완전히 거부할 수 있습니다. 신고 및 거부 기준은 <0> 애드온 설정에서 관리됩니다.</0> <1/>에서 자세히 알아보세요.";
$Definition[
...
$Definition[
    ...
    "이 옵션을 활성화하면 원래 게시자의 답변에 OP 표시가 나타납니다.";
...
$Definition[
    ...
    "각 게시물에 사용자 배지를 표시합니다. 높은 순위 순으로 최대 5개의 배지를 표시할 수 있습니다.";
...
$Definition[
    ...
    "메타 태그는 Google Search Console 및 기타 서비스의 도메인 확인에 사용됩니다. 소스에서 필요한 메타 태그를 복사하여 새 줄에 붙여넣으세요.";
$Definition[
    ...
    "여기에서 귀하의 사이트를 어떻게 설명할지 잠깐 시간을 내어 생각해 보세요. 사이트에 의미있는 제목과 간략한 설명을 붙이면 검색 엔진에서 귀하의 위치에 도움이 될 수 있습니다. ";
...
$Definition["This layout cannot be deleted because it is a layout template."] =
    "이 레이아웃은 레이아웃 템플릿이므로 삭제할 수 없습니다.";
