...
$Definition['Tagging allows users to add a tag to discussions they start in order to make them more discoverable. '] =
    '태그를 사용하면 사용자가 토론에 태그를 추가하여 더 쉽게 찾을 수 있습니다.';
...
$Definition['The database user you specified does not have permission to access the database. Have you created the database yet? The database reported: <code>%s</code>'] =
    '귀하가 명시한 데이터베이스 사용자는 데이터베이스를 사용할 권한이 없습니다. 데이터베이스를 생성하셨습니까? 보고된 데이터베이스: <code>%s</code>';
...
$Definition['They work just like regular themes. Once one has been added to the themes folder, you can enable it here.'] =
    '그들은 일반적인 테마처럼 작동합니다. 테마 폴더에 테마가 추가되면 여기에서 활성화 할 수 있습니다.';
...
$Definition['This page lists the endpoints of your API.'] =
    '이 페이지는 API의 엔드 포인트를 나열합니다. 자세한 정보는 엔드 포인트를 클릭하십시오. 이 페이지에서 또는 외부에서 액세스 토큰을 사용하여 API를 실시간으로 호출 할 수 있습니다.';
...
$Definition['This setting loads the page before executing Javascript.'] =
    '이 설정은 귀하의 SEO를 향상시킬 수 있는 자바스크립트를 실행하기 전에 해당 페이지를 로드합니다.<br><strong>**경고: 이 기능을 활성화하면 귀하의 사이트에서 자바스크립트 오류가 발생할 수 있습니다.**</strong>
';
...
$Definition['TouchIconDescription'] =
    'Apple 장치의 홈 화면에서 웹 사이트를 북마크하면 터치 아이콘이 나타납니다. 이들은 일반적으로 152 픽셀입니다. Apple은 둥근 모서리와 조명 효과를 자동으로 추가합니다.';
...
$Definition['Warning: Loading tables can be slow.'] =
    '<b>경고</b> : 서버 구성은 빠른 데이터로드를 지원하지 않습니다. 매우 큰 파일 (예 : 200,000 개 이상의 주석)을 가져 오는 경우 구성 변경을 고려할 수 있습니다. 자세한 내용은 <a href="http://vanillaforums.com/porter">여기</a> 를 클릭 <a href="http://vanillaforums.com/porter">하십시오</a> .';
