...
$Definition['Although the invitation was created successfully, the email failed to send. The server reported the following error: %s'] = '초대가 성공적으로 생성되었지만 이메일 전송을 하지 못했습니다. 서버에서 다음의 에러를 보고했습니다: %s';
...
$Definition['Garden.Import.Continue.Description'] = '가져오기 하는 중으로 보입니다.
   다음 옵션 중 한 가지를 선택하세요.';
...
$Definition['Warning: Loading tables can be slow.'] = '<b>경고</b>: 귀하의 서버 환경설정은 빠른 데이터 로딩을 지원하지 않습니다.
