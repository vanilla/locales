...
$Definition['If enabled, the full content of posts will be sent in email notifications to users.'] =
    '사용 설정하면 게시물의 전체 내용이 이메일 알림으로 사용자에게 전송됩니다.';
...
$Definition['ShareImageDescription'] =
    '누군가 귀하의 사이트에서 링크를 공유하면 Google은 페이지에서 이미지를 가져 오려고 시도합니다. 페이지에 이미지가 없으면이 이미지를 대신 사용합니다. 이미지는 50 × 50 이상이어야하지만 200 × 200을 권장합니다.';
...
$Definition['This role is personal info. Only users with permission to view personal info will see it.'] =
    '이 역할은 개인 정보입니다. 개인 정보를 볼 권한이있는 사용자 만 볼 수 있습니다.';
$Definition['This setting loads the page before executing Javascript.'] =
    '이 설정은 자바 스크립트를 실행하기 전에 페이지를로드하여 SEO를 개선 할 수 있습니다. <br> <strong>** 경고 :이 기능을 사용하면 사이트에서 Javascript 오류가 발생할 수 있습니다. **</strong>';
