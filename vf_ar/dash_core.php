...
$Definition["The site does not allow you connect with an existing user."] =
    "الموقع لا يسمح لك بالتواصل مع مستخدم موجود.";
...
// Federated Search
$Definition["About Federated Search"] = "حول البحث الفيدرالي";
$Definition["About Search Connectors"] = "حول موصلات البحث";
$Definition["Add"] = "إضافة";
$Definition["Add a custom <0/> search connector"] = "إضافة موصل بحث مخصص <0/>";
$Definition["Answer"] = "جواب";
$Definition["Apply"] = "إستخدم";
$Definition["Article"] = "مقالة";
$Definition["Authenticate"] = "المصادقة";
$Definition["Back"] = "العودة";
$Definition["Cancel"] = "إلغاء";
$Definition["Categories"] = "الأقسام";
$Definition["Client ID is required."] = "معرف العميل مطلوب.";
$Definition["Client Secret is required."] = "يجب إدخال سر العميل.";
$Definition["Configure"] = "تكوين";
$Definition["Cursor pagination uses a url to point to the next page of results. Offset pagination uses a page number and item count to fetch the next page."] = "يستخدم ترقيم الصفحات بالمؤشر عنوان URL للإشارة إلى الصفحة التالية من النتائج. يستخدم الترقيم الإزاحي رقم الصفحة وعدد العناصر لعرض الصفحة التالية.";
$Definition["Discussions"] = "مناقشات";
$Definition["Federated Search allows you to include external content within community search results such as knowledge base articles, courses from a learning management system, blog articles and more, to centralize content search within community. <0>Learn more</0>."] = "يتيح لك البحث الفيدرالي تضمين محتوى خارجي ضمن نتائج بحث المجتمع مثل مقالات قاعدة المعرفة، والدورات التدريبية من نظام إدارة التعلم، ومقالات المدونة والمزيد، لمركزية البحث عن المحتوى داخل المجتمع. <0>تعرف على المزيد</0> .";
$Definition["Good job! Here is a preview of some of your external articles, listed on your community's Search Results page."] = "أحسنت! إليك معاينة لبعض مقالاتك الخارجية، المدرجة في صفحة نتائج البحث الخاصة بمجتمعك.";
$Definition["Great!"] = "عظيم!";
$Definition["Groups"] = "مجموعات";
$Definition["Help Menu"] = "قائمة المساعدة";
$Definition["Here is what a single result provided by the API looks like:"] = "هذا هو الشكل الذي تبدو عليه النتيجة الفردية التي توفرها واجهة برمجة التطبيقات:";
$Definition["Idea"] = "الفكرة";
$Definition["Ideas"] = "أفكار";
$Definition["Integrates Salesforce's knowledge base articles into the Vanilla community search, consolidating self-service support resources within the community platform."] = "دمج مقالات قاعدة المعرفة الخاصة بـ Salesforce في بحث مجتمع Vanilla، مما يؤدي إلى توحيد موارد دعم الخدمة الذاتية داخل منصة المجتمع.";
$Definition["Knowledge Bases"] = "قواعد المعرفة ";
$Definition["Label is required."] = "يجب أن يكون هناك ملصق.";
$Definition["Loading"] = "جارِ التحميل";
$Definition["Maximum length is 100 characters."] = "الحد الأقصى للطول هو 100 حرف.";
$Definition["Maximum length is 500 characters."] = "الحد الأقصى للطول هو 500 حرف.";
$Definition["Maximum number of posts to be included in the email digest."] = "الحد الأقصى لعدد المشاركات التي سيتم تضمينها في ملخص البريد الإلكتروني.";
$Definition["Messages"] = "الرسائل";
$Definition["Modify <0/> search connector"] = "تعديل موصل البحث <0/>";
...
$Definition["Number of posts from groups"] = "عدد المشاركات من المجموعات";
$Definition["Our Search Connectors will allow you to easily configure the connection between Vanilla and external platforms. Can't find what you're looking for? Let us know which search connectors you need by posting and Idea in our <0>customer community</0>."] = "ستتيح لك موصلات البحث لدينا تكوين الاتصال بسهولة بين منصة فانيلا والمنصات الخارجية. لم تجد ما تبحث عنه؟ أخبرنا بموصلات البحث التي تحتاجها من خلال النشر ومشاركة أفكارك في <0>مجتمع عملائنا</0> .";
$Definition["Please enter some basic information about your custom search connector."] = "الرجاء إدخال بعض المعلومات الأساسية حول موصل البحث المخصص الخاص بك.";
...
$Definition["Response Body"] = "نص الاستجابة";
$Definition["Response Headers"] = "رؤوس الاستجابة";
$Definition["Salesforce Article Search"] = "البحث عن المقالات في Salesforce";
$Definition["Save"] = "حفظ";
$Definition["Search Connectors"] = "موصلات البحث";
$Definition["Site domain is required."] = "يجب أن يكون نطاق الموقع مطلوبًا.";
$Definition["Some parameters required to search may be unique to your API. Please configure your search connector with these parameters so that the connector can correctly format search queries for your community."] = "قد تكون بعض المعلمات المطلوبة للبحث فريدة لواجهة برمجة التطبيقات (API) لديك. يُرجى تهيئة موصل البحث لديك بهذه المعلمات ليتمكن الموصل من تنسيق استعلامات البحث لمجتمعك بشكل صحيح.";
$Definition["Surfaces Zendesk Help Center knowledge base articles in Vanilla community search to centralize self-service help within community."] = "يوفر مركز مساعدة Zendesk مقالات قاعدة المعرفة في البحث المجتمعي Vanilla لتجميع المساعدة الذاتية داخل المجتمع.";
$Definition["Tag"] = "العلامة";
$Definition["Test Custom API"] = "اختبار واجهة برمجة التطبيقات المخصصة";
$Definition["Test your custom API"] = "اختبار واجهة برمجة التطبيقات المخصصة الخاصة بك";
$Definition["Test your pagination configuration"] = "اختبار تكوين الترقيم الخاص بك";
$Definition["The roles that are allowed to access this connector."] = "الأدوار المسموح لها بالوصول إلى هذا الموصل.";
$Definition["This search connector has an invalid configuration."] = "يحتوي موصل البحث هذا على تكوين غير صالح.";
$Definition["Tip: These required parameters can usually be found in the documentation for your API"] = "نصيحة: يمكن عادةً العثور على هذه المعلمات المطلوبة في وثائق واجهة برمجة التطبيقات الخاصة بك";
$Definition["To finish configuring the Search Connector, tell us where to find the following values within the result object."] = "لإكمال تكوين موصل البحث، أخبرنا عن مكان العثور على القيم التالية داخل كائن النتيجة.";
$Definition["Visit Site"] = "زيارة الموقع";
$Definition["What kind of pagination does your API use?"] = "ما نوع الترقيم الصفحي الذي يستخدمه واجهة برمجة التطبيقات الخاصة بك؟";
$Definition["When you're ready, use these buttons to check that your pagination configuration functions as expected"] = "عندما تكون مستعدًا، استخدم هذه الأزرار للتأكد من أن تكوين الترقيم الخاص بك يعمل كما هو متوقع";
$Definition["When you're ready, use this button to test the API and view its results."] = "عندما تكون مستعدًا، استخدم هذا الزر لاختبار واجهة برمجة التطبيقات وعرض نتائجها.";
$Definition["Where is the list of results located in this response?"] = "أين توجد قائمة النتائج في هذه الاستجابة؟";
$Definition["You must configure this search connector to enable it."] = "يجب عليك تكوين موصل البحث هذا لتمكينه.";
$Definition["You must select at least one role."] = "يجب عليك تحديد دور واحد على الأقل.";
$Definition["Zendesk Guide"] = "دليل زينديسك";
