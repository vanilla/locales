...
$Definition['%1$s version %2$s is available.'] =
    '%1$s الإصدار %2$s متوفر.';
$Definition["%s is not a valid email address"] =
    "%s ليس بريدا إلكترونيا سليما";
...
$Definition["%s user(s) will be affected by this action."] =
    "%s مستخدم سيتأثرون بهذا الطلب.";

$Definition["<0/> will suggest answers on Q&A posts"] =
    "<0/> سيقترح إجابات على مشاركات الأسئلة والأجوبة";
$Definition["<0 /> will not suggest answers on Q&A posts"] =
    "لن يقترح <0 /> إجابات على مشاركات الأسئلة والأجوبة";
...
$Definition["1 in 5 is recommended for most communities."] =
    "يوصى بـ 1 من 5 لمعظم المجتمعات.";
$Definition["1 in 20 is recommended for most communities."] =
    "يوصى بـ 1 من 20 لمعظم المجتمعات.";
...
] = 'لقد وصلت إلى الحد الأقصى من محاولات تسجيل الدخول. الرجاء الانتظار%s وحاول مرة أخرى.';
...
$Definition["A unique label name that cannot be changed once saved."] =
    "اسم تسمية فريد لا يمكن تغييره بعد حفظه.";
...
$Definition['"Accept Answer" if a suggestion answers your question.'] =
    '"قبول الإجابة" إذا كان الاقتراح يجيب على سؤالك.';
...
$Definition["Accepted answer pageview ratio representing a deflected case"] =
    "نسبة مشاهدة صفحة الإجابة المقبولة التي تمثل حالة منحرفة";
...
$Definition[
    ...
    "أضف رابط Zoom أو معرف اجتماع لربط هذا الحدث بـ Zoom وتمكين أزرار التسجيل والانضمام بنقرة واحدة. لاحظ أنه إذا كان الحدث يتطلب التسجيل، فلن تتمكن من تحديث معرف الاجتماع أو الرابط بعد إنشاء الحدث.";
...
$Definition[
    ...
    "أضف عنوان البريد في حقل من، للردود البريدية (يفضل هذا)";
...
$Definition[
    ...
    "أضف مجال (مجالات) كالتورا المخصص لتحويل الروابط إلى مقاطع فيديو مضمنة في المناقشات أو التعليقات أو المقالات.";
$Definition[
    "Add your custom Kaltura domain(s) to transform links into embedded videos in posts, comments or articles."
] =
    "أضف نطاقات Kaltura المخصصة الخاصة بك لتحويل الروابط إلى مقاطع فيديو مضمنة في المنشورات أو التعليقات أو المقالات.";
...
$Definition["Advanced settings for embedded community elements"] =
    "إعدادات متقدمة لعناصر المنتدى المغروسة Embedded";
...
$Definition["AI Suggestions are not enabled"] =
    "اقتراحات الذكاء الاصطناعي غير مفعلة";
$Definition[
    ...
    "توفر ميزة \"الإجابات المقترحة من AI\" إجابات مقترحة استنادًا إلى مشاركات المجتمع وقواعد المعرفة المرتبطة. يمكنك تشغيل هذه الميزة أو إيقاف تشغيلها في أي وقت من خلال زيارة تفضيلات ملفك الشخصي.";
$Definition[
    "Alert users if they click a link in a post that will lead them away from the forum. "
] =
    "قم بتنبيه المستخدمين إذا نقروا على رابط في منشور سيؤدي بهم إلى الابتعاد عن المنتدى.";
$Definition["Alive"] = "حي";
...
$Definition["All discussions in this category will be permanently deleted."] =
    "كل المواضيع في هذا القسم سيتم حذفها نهائيا.";
...
$Definition[
    ...
    "كل مكونات المستخدم سيتم إستبدالها برسالة تفيد أن المستخدم قد تم حذفه.";
...
$Definition["Allow new users to be registered through email."] =
    "يمكن الأعضاء الجدد التسجيل بإستخدام عنوان البريد.";
$Definition["Allow this connection to issue API access tokens."] =
    "اسمح لهذا الاتصال بإصدار رموز الوصول إلى واجهة برمجة التطبيقات.";
$Definition["Allow Third-Party Script Execution"] =
    "السماح بتنفيذ البرنامج النصي لجهة خارجية";
$Definition["Allow users to change their own avatars"] =
    "السماح للمستخدمين بتغيير الصور الرمزية الخاصة بهم";
$Definition["Allow users to dismiss this message"] =
    "السماح للمستخدمين بتجاهُل هذه الرسالة.";
...
$Definition["Applicant Role"] =
    "حدد دور المشترك الجديد. هذا يعمل فقط في حالة إستخدام طريقة <b>إعتماد</b> التسجيل.";
...
$Definition["Are you sure you want to delete %s items forever?"] =
    "هل أنت متأكد من رغبتك في حذف %s حذف نهائي؟";
$Definition["Are you sure you want to delete 1 item forever?"] =
    "هل أنت متأكد من رغبتك في حذف عنصر 1 حذف نهائي؟";
$Definition[
    "Are you sure you want to delete this badge? This is irreversible and will revoke the badge from all users who have it."
] =
    "هل أنت متأكد من رغبتك في حذف هذا الوسام؟ هذا النشاط غير قابل للتراجع وسوف يجرد كل المستخدمين الحاليين منه.";
...
$Definition["Are you sure you want to restore %s items?"] =
    "هل أنت متأكد من رغبتك في إسترجاع %s عناصر؟";
$Definition["Are you sure you want to restore 1 item?"] =
    "هل أنت متأكد من رغبتك في إسترجاع عنصر 1؟";
$Definition[
    "Are you sure you want to turn off all AI Suggested Answers? You can undo this in your profile settings at anytime."
] =
    "هل أنت متأكد من أنك تريد إيقاف تشغيل جميع الإجابات المقترحة من الذكاء الاصطناعي؟ يمكنك التراجع عن هذا في إعدادات ملفك الشخصي في أي وقت.";
...
] = "مطلوب عمود مرئي واحد على الأقل. إظهار عمود مرئي أو إضافته.";
$Definition["A url-friendly version of the category name for better SEO."] =
    "رابط قسم أكثر توافقا مع محركات البحث";
...
$Definition[
    ...
    "قبل تفعيل هذه الميزة، يرجى العلم بالآثار المحتملة التالية:";
...
$Definition["Bookmark a discussion using its star icon."] =
    "علّم النقاش باستخدام أيقونة النجمة الخاصة به";
...
$Definition["Browse for a new banner logo if you would like to change it:"] =
    "استعرض بحثًا عن شعار بانر جديد إذا كنت ترغب في تغييره:";
...
$Definition["Cannot build profile information if user is not defined."] =
    "لا يمكن بناء معلومات ملف التعريف إذا لم يتم تعريف المستخدم.";
$Definition["Categories &amp; Discussions"] = "الفئات والمناقشات";
$Definition["Categories to Exclude from AI Answers"] =
    "الفئات التي يجب استبعادها من إجابات الذكاء الاصطناعي";
$Definition["Categories are used to organize discussions."] =
    "تُستخدم التصنيفات لمساعدة مستخدميك في تنظيم مناقشاتهم بطريقة هادفة ومفيدة لمجتمعك.";
$Definition["Categories are used to organize posts."] =
    "تُستخدم الفئات لمساعدة المستخدمين على تنظيم منشوراتهم بطريقة مفيدة لمجتمعك.";
$Definition["Categories allow you to organize your posts."] =
    "تتيح لك الفئات تنظيم منشوراتك.";
...
$Definition["Click here to carry on to your dashboard"] =
    "انقر هنا لمواصلة لوحة القيادة الخاصة بك";
...
$Definition[
    ...
    "اتصل بفريق Vanilla Staff لتمكين تكوين موقع الأسئلة والأجوبة. ثم قم بتمكين الوظيفة الإضافية للأسئلة والأجوبة في قسم الوظائف الإضافية بلوحة المعلومات.";
$Definition[
    ...
    "اتصل بفريق Vanilla Staff لتمكين تكوين موقع الأسئلة والأجوبة. ثم قم بتمكين الوظيفة الإضافية للأسئلة والأجوبة في قسم <0/> من لوحة المعلومات.";
$Definition["Content Curation"] = "العناية بالمحتوى";
$Definition["Content flagged as spam is stored here for moderator review."] =
    "يتم تخزين المحتوى الذي تم وضع علامة عليه كرسائل غير مرغوب فيها هنا لمراجعة المشرف.";
...
$Definition[
    ...
    "يمكن أن يعرض ثغرات أمنية مثل البرمجة النصية عبر المواقع (XSS) في حالة اختراق البرامج النصية الأولية.";
$Definition['Could not find a theme identified by \'%s\''] =
    'تعذر العثور على سمة محددة بواسطة \'%s\'';
$Definition["Could not instantiate mail function."] =
    "لا يمكن مثيل وظيفة البريد الإلكتروني.";
...
$Definition["Could not open addon file. Addons must be zip files."] =
    "تعذر فتح ملف الملحق. يجب أن تكون الإضافات ملفات مضغوطة.";
$Definition["Create & organize discussion categories and manage your users."] =
    "إنشاء وتنظيم فئات المناقشة وإدارة المستخدمين.";
...
$Definition["Do not display the categories in the side panel."] =
    "لا تعرض الفئات في اللوحة الجانبية.";
...
$Definition[
    ...
    "ستكون أداة مطالبة ملخص البريد الإلكتروني متاحة عند تمكين ملخص البريد الإلكتروني.";
...
$Definition[
    ...
    "سيتم إرسال ملخصات البريد الإلكتروني في اليوم المحدد كل أسبوع. وستدخل التغييرات التي تطرأ على اليوم المحدد حيز التنفيذ في الأسبوع التالي.";
...
$Definition["Enable sending notification emails"] =
    "تمكين إرسال رسائل البريد الإلكتروني الإخطار";
...
$Definition["Enable to only show posts from categories a user follows."] =
    "قم بتمكين عرض المشاركات من الفئات التي يتابعها المستخدم فقط.";
$Definition[
    "Enable to get a preview of our new user management dashboard with improved search and new configuration options."
] =
    "قم بتمكين الحصول على معاينة للوحة معلومات إدارة المستخدم الجديدة الخاصة بنا مع بحث محسّن وخيارات تكوين جديدة.";
...
$Definition[
    ...
    "سيؤدي تمكين هذه الميزة إلى تعديل سياسة أمان المحتوى الخاصة بك لتثق في البرامج النصية الإضافية التي يتم إدخالها كتبعيات بواسطة البرامج النصية المخصصة الخاصة بك.";
$Definition[
...
$Definition["Encourage your friends to join your new community!"] =
    "شجع أصدقائك للانضمام إلى مجتمعك الجديد!";
$Definition["Enter a comma-delimited list of indexes, starting at 1."] =
    "أدخل قائمة من الفهارس مفصولة بفواصل ، بدءًا من 1.";
...
$Definition["Enter the email address of the person you would like to invite:"] =
    "أدخل عنوان البريد الإلكتروني للشخص الذي ترغب في دعوته:";
$Definition[
    "Enter the url to the page you would like to use as your homepage"
] = "أدخل عنوان URL للصفحة التي تريد استخدامها كصفحتك الرئيسية";
$Definition[
    "Enter the url to the page you would like to use as your homepage:"
] = "أدخل عنوان URL للصفحة التي تريد استخدامها كصفحتك الرئيسية:";
$Definition["Error sending email. Please review the addresses and try again."] =
    "لقد حدث خطأ أثناء إرسال البريد الإلكتروني. يُرجى مراجعة العناوين وإعادة المحاولة مرةً أخرى.";
...
$Definition["Exclude archived discussions from the discussions list"] =
    "استبعاد المناقشات المؤرشفة من قائمة المناقشات";
$Definition["Existing members send invitations to new members."] =
    "يرسل الأعضاء الحاليون دعوات إلى الأعضاء الجدد.";
...
$Definition[
    ...
    "يستبدل البحث الخارجي بحث Vanilla الجاهز بموفر بحث خارجي من اختيارك.";
...
$Definition["FaviconBrowse"] =
    "تصفح بحثًا عن رمز مفضل جديد إذا كنت ترغب في تغييره:";
$Definition["FaviconDescription"] =
    "ستظهر أيقونة الموقع الخاص بك في شريط عنوان متصفحك. وسيتم تصغيرها بشكل مناسب.";
...
$Definition[
    ...
    "على سبيل المثال ، للسماح لـ yourdomain.com و www.yourdomain.com و help.yourdomain.com ، يمكنك إضافة * .yourdomain.com";
$Definition["Force the forum to only be accessible through this url"] =
    "إجبار المنتدى على الوصول إليه فقط من خلال عنوان URL هذا";
...
$Definition["Full post in email notifications"] =
    "آخر كامل في إشعارات البريد الإلكتروني";

$Definition["Garden"] = "حديقة";
$Definition["Garden.api.ssoIDPermission.description"] =
    "ستتمكن الأدوار التي لديها هذا الإذن من توسيع معرفات الدخول الموحّد في مكالمات API v2.";
...
$Definition[
    ...
    "إنشاء الاقتراحات. سيتم إعلامك عندما تكون جاهزة للمراجعة.";
...
$Definition[
    ...
    "تحياتي. أنا مساعد الاقتراحات بالذكاء الاصطناعي، هنا لمساعدتك في العثور على مقالات ومنشورات ذات صلة للإجابة على استفساراتك. لا تتردد في طرح أي أسئلة قد تكون لديك.";
$Definition["guest"] = "ضيف";
$Definition["Guest roles"] =
    "تحقق من جميع الأدوار التي يجب تطبيقها على الضيوف.";

$Definition["Hash Algorithm"] = "خوارزمية التجزئة";
$Definition["HeadlineFormat.AddUser"] =
    "{ActivityUserID,user} أضاف حسابًا لـ {RegardingUserID,user}.";
$Definition["HeadlineFormat.PictureChange"] =
    "{RegardingUserID,You} غيرت صورة الملف الشخصي {ActivityUserID,your}.";
$Definition["HeadlineFormat.RegistrationApproval"] =
    "وافقت {ActivityUserID,user} على طلبات {RegardingUserID,user}.";
...
$Definition[
    ...
    "مرحبًا بك! أنا مساعد الاقتراحات بالذكاء الاصطناعي، هنا لمساعدتك في العثور على أفضل المقالات والمشاركات للإجابة على أسئلتك. لا تتردد في طرح أي سؤال، فأنا هنا لجعل بحثك ممتعًا وغنيًا بالمعلومات!";
...
$Definition["Hide discussions from Recent Discussions and Widgets."] =
    "إخفاء المناقشات من أحدث المناقشات والأدوات.";
$Definition["Hide posts from Recent Posts Page and Widgets."] =
    "إخفاء المشاركات من صفحة المشاركات الأخيرة والأدوات.";
...
$Definition["Hide signatures on embedded comments"] =
    "إخفاء التوقيعات في التعليقات المضمنة";
...
$Definition["If left empty, Email Logo is used."] =
    "إذا تركت فارغة، فسيتم استخدام شعار البريد الإلكتروني.";
$Definition[
    ...
    "إذا كان لديك رابط لمستند داخلي في قسم \"رابط شروط الاستخدام\" أعلاه، فسيتم تجاهل \"نص شروط الاستخدام\". يُرجى إزالة الرابط إذا كنت ترغب في استخدام هذا النص.";
...
$Definition["Install Vanilla without a .htaccess file."] =
    "قم بتثبيت الفانيليا بدون ملف htaccess.";
...
$Definition["Introducing Vanilla Reactions and Badges"] =
    "تقديم ردود الفعل والشارات الفانيليا";
...
$Definition["It looks like you edited your post. <0/> or <1/>."] =
    "يبدو أنك قمت بتعديل مشاركتك. <0/> أو <1/>.";
...
$Definition["Large images will be scaled down."] =
    "سوف يتم تصغير حجم الصور الكبيرة حتى نصل إلى أقصى عرض لـ %spx وأقصى ارتفاع لـ %spx.";
...
$Definition["List of discussion IDs to delete."] =
    "قائمة معرفات المناقشة المراد حذفها.";
...
$Definition["Make sure you select at least one item before continuing."] =
    "تأكد من تحديد عنصر واحد على الأقل قبل المتابعة.";
$Definition["Add your site to trusted domains."] =
    "تأكد من إضافة موقعك إلى %s عندما يتم تفعيل التضمين.";
...
$Definition["Mark All Suggested Answers as Accepted"] =
    "قم بتمييز جميع الإجابات المقترحة على أنها مقبولة";
...
$Definition["Moderators have permission to edit most content."] =
    "المشرفون لديهم إذن لتعديل معظم المحتوى.";
...
$Definition[
    ...
    "لغة أكثر تعقيدًا وقد تقدم بعض المصطلحات الخاصة بالصناعة، ولكنها لا تزال مفهومة لمعظم الناس.";
...
$Definition["Never - Users Must Refresh Page"] =
    "مطلقًا - يجب على المستخدمين تحديث الصفحة";
$Definition["Never display on mobile browsers."] =
    "لا تعرض على متصفحات الجوال.";
...
$Definition["New users are only registered through SSO plugins."] =
    "يتم تسجيل المستخدمين الجدد فقط من خلال مكونات SSO الإضافية.";
$Definition[
    'New users are reviewed and approved by an administrator (that\'s you!).'
] = 'تتم مراجعة المستخدمين الجدد والموافقة عليهم من قبل المسؤول (هذا أنت!).';
$Definition[
    "New users fill out a simple form and are granted access immediately."
] = "يملأ المستخدمون الجدد نموذجًا بسيطًا ويتم منحهم حق الوصول على الفور.";
...
$Definition["No item options are available for Link display type."] =
    "لا تتوفر خيارات عنصر لنوع عرض الرابط.";
...
$Definition[
    ...
    'تتوفر فقط الحقول التي تحتوي على مربع اختيار واحد أو قائمة منسدلة ذات اختيار واحد أو قائمة منسدلة ذات اختيار متعدد أو قائمة منسدلة رقمية. بمجرد تحديد الحقول، ستظهر أدناه حتى تتمكن من اختيار إجابات محددة لكل حقل من حقول الملف الشخصي.';
...
$Definition["Only visible to users with roles with permission."] =
    "يمكن رؤيته فقط بواسطة المستخدمين الذين لديهم وظائف بإذن.";
$Definition[
    "Open cases will only display if the user has a valid Salesforce connection."
] =
    "لن يتم عرض الحالات المفتوحة إلا إذا كان لدى المستخدم اتصال Salesforce صالح.";
...
$Definition["Or select an image on your computer (2mb max)"] =
    "أو اختر صورة من جهازك (الحد الأقصى 2MB).";
...
$Definition["Pageview ratio representing a deflected case"] =
    "نسبة مشاهدة الصفحة التي تمثل حالة منحرفة";
...
$Definition["Please enter a unique API Label, this one has been used before"] =
    "الرجاء إدخال عنوان API فريد ، وقد تم استخدام هذا من قبل";
...
$Definition[
    ...
    "مشاكل التوافق المحتملة مع المتصفحات القديمة، مما يؤثر على تجربة المستخدم.";
...
$Definition[
    ...
    "يجب حذف البروتوكولات (مثل https: //) والمسارات (مثل yourdomain.com/some/path).";
...
$Definition[
    ...
    "الأبعاد الموصى بها هي 400 بكسل × 300 بكسل أو أصغر بنسبة مماثلة.";
...
$Definition["Reload the page to see recent updates."] =
    "أعد تحميل الصفحة لمشاهدة التحديثات الأخيرة.";
$Definition["Reload the page to access recent updates."] =
    "أعد تحميل الصفحة للوصول إلى التحديثات الأخيرة.";
...
$Definition["Reset password and send email notification to user"] =
    "إعادة تعيين كلمة المرور وإرسال إشعار بالبريد الإلكتروني للمستخدم";
$Definition["Reset to Default"] = "إعادة تعيين إلى الافتراضي";
$Definition["Resetting the password for %s."] =
    "إعادة تعيين كلمة المرور لـ %s.";
...
$Definition['Roles determine user\'s permissions.'] =
    "يتم تعيين كل مستخدم في موقعك لدور واحد على الأقل. تستخدم الأدوار لتحديد ما يسمح للمستخدمين القيام به.";
...
$Definition["Search by user or role."] =
    "ابحث عن الأعضاء باستخدام الاسم أو البريد الإلكتروني، وكذلك بإمكانك استخدام % كبدل. وكذلك بإمكانك البحث باستخدام رقم العضوية، اسم المجموعة أو “محظور”.";
...
] = "حدد الأعمدة التي يتم عرضها في قائمة صفحات إدارة المستخدمين.";
$Definition["Selection will affect the item options available."] =
    "سيؤثر التحديد على خيارات العنصر المتاحة.";
...
$Definition[
    ...
    "أرسل رسالة تأكيد عند يسأل أحدهم سؤال أو يبدأ محادثة عبر البريد.";
...
$Definition['Separate each word with a semi-colon ";"'] =
    'افصل بين كل كلمة وأخرى بفاصلة منقوطة "؛"';
$Definition[
    "Set this interest as default to suggest following its mapped categories and tags to all users."
] =
    "قم بتعيين هذا الاهتمام كإعداد افتراضي لاقتراح متابعة الفئات والعلامات المخصصة له لجميع المستخدمين.";
...
] = "اعرض لكل مستخدم قائمة مخصصة بالأفكار التي ابتكرها أو أيدها.";
...
$Definition[
    ...
    "ابدأ سطر موضوع الملخص مع تعيين [Banner Title] في المظهر > العلامة التجارية وتحسين محركات البحث";
...
$Definition[
    ...
    "يتم تعيين الأنماط والمظهر المرئي العام لجميع رسائل البريد الإلكتروني، بما في ذلك ملخص البريد الإلكتروني، على مستوى الموقع في صفحة إعدادات البريد الإلكتروني.";
...
$Definition["Suggestions are only visible to you until you accept the answer"] =
    "الاقتراحات لن تكون مرئية لك إلا بعد قبول الإجابة";
$Definition["Suggestions may only be generated on questions"] =
    "لا يجوز إنشاء الاقتراحات إلا على الأسئلة";
...
$Definition[
    ...
    'لقد حدث خطأ ما أثناء تحميّل الصورة. يمكنك تحميّل شعار بريدك الإلكتروني بأي نوع من أنواع الملفات التالية: gif, jpg, png';
$Definition["There are currently no applicants."] =
    "لا يوجد حاليا أي المتقدمين.";
$Definition["There is currently %s applicant."] =
    "يوجد حالياً %s متقدماً. ";
$Definition["There are currently %s applicants."] =
    "يوجد حالياً %s متقدمين. ";
$Definition["There are currently no requests."] =
    "لا توجد حالياً أية طلبات. ";
...
$Definition["There are no items awaiting moderation at this time."] =
    "لا توجد عناصر في انتظار الإشراف في الوقت الحالي.";
$Definition[
    ...
    "يوجد بالفعل حساب في هذا المنتدى باستخدام عنوان بريدك الإلكتروني. يرجى إنشاء حساب جديد ، أو إدخال بيانات الاعتماد للحساب الحالي.";
$Definition["The next three email digest delivery dates"] =
    "مواعيد تسليم ملخصات البريد الإلكتروني الثلاثة القادمة";
...
$Definition["The url that users go to to register for a new account."] =
    "عنوان url الذي يذهب المستخدمون إليه للتسجيل في حساب جديد.";
$Definition["The url that users use to register for a new account."] =
    "عنوان url الذي يستخدمه المستخدمون للتسجيل لحساب جديد.";
$Definition["The url that users use to sign in."] =
    "عنوان url الذي يستخدمه المستخدمون لتسجيل الدخول.";
$Definition["The URL where users can sign up for new accounts on your site"] =
    "عنوان URL حيث يمكن للمستخدمين الاشتراك للحصول على حسابات جديدة على موقعك";
...
$Definition["The user and all related content has been deleted."] =
    "تم حذف المستخدم وجميع المحتويات ذات الصلة.";
...
$Definition[
    ...
    "وهذا ليس ضروريًا في معظم المواقع باستثناء تلك التي تستخدم ميزات مثل AdSense وGoogle Tag Manager.";
$Definition[
    ...
    "هذا ملخص تم إنشاؤه بواسطة الذكاء الاصطناعي من منشور المناقشة المشار إليه والذي قد يجيب على السؤال. تم إنشاء الملخص بطريقة يمكن استخدامه كإجابة مقبولة.";
$Definition["This category has custom permissions."] =
    "هذه الفئة لديها أذونات مخصصة.";
$Definition["This category is archived."] = "تمت أرشفة هذه الفئة.";
$Definition["This connection is in test-mode."] =
    "هذا الإتصال في حالة الإختبار";
$Definition["This controls how the responses are phrased and spelled."] =
    "يتحكم هذا في كيفية صياغة الردود وتهجئتها.";
$Definition["This Database"] = "قاعدة البيانات هذه";
$Definition["QnAFollowup.Feature.Enabled"] =
    "ترسل هذه الميزة رسائل بريد إلكتروني إلى مؤلفي الأسئلة التي تمت الإجابة عليها والتي ليس لها إجابة مقبولة.";
$Definition["This forum is currently set to invitation only mode."] =
    "هذا المنتدى مضبوط حاليًا على وضع الدعوة فقط.";
$Definition[
    'This image will be used in category lists and widgets when using the "Icon" style option.'
] =
    'سيتم استخدام هذه الصورة في قوائم الفئات وعناصر واجهة المستخدم عند استخدام خيار نمط "الرمز".';
$Definition[
    ...
    'ستظهر هذه الصورة في لافتة هذه الفئة وفي أدوات الفئة عند استخدام خيارات نمط "الصورة" و / أو "الخلفية". الأبعاد الموصى بها هي حوالي 1000 × 400 بكسل أو نسبة مماثلة.';
$Definition["This is a parent category that does not allow discussions."] =
    "هذه فئة رئيسية لا تسمح بإجراء مناقشات.";
...
$Definition[
    ...
    "يمكن استخدام هذا لتضمين محتوى مثل اسم المؤسسة وعنوانها في ملخص البريد الإلكتروني.";
$Definition["This name will be shown in the community."] =
    "سيتم عرض هذا الاسم في المجتمع.";
$Definition["This page requires Javascript."] =
    "تتطلب هذه الصفحة جافا سكريبت.";
...
] = "لا يمكن حذف هذه السمة لأنها السمة المطبقة حالياً.";
$Definition["This theme has additional options."] =
    "يحتوي هذا السمة على خيارات إضافية في صفحة %s.";
$Definition["This theme has customizable text."] =
    "يحتوي هذا المظهر على نص يمكنك تخصيصه.";
$Definition[
    ...
    "سيساعد هذا المستخدمين الآخرين الذين لديهم أسئلة مماثلة على الوصول إلى الإجابات الصحيحة بشكل أسرع، كما سيعرض الإجابة المقترحة من الذكاء الاصطناعي ويربط المواد المرجعية ليتمكن المستخدمون الآخرون من رؤيتها. لن تكون الاقتراحات مرئية إلا لك حتى تقبل الإجابة.";
...
$Definition["Truncate the initial discussion text to this many words."] =
    "اختصار نص المناقشة الأولية إلى هذه الكلمات العديدة.";
...
$Definition["Up to a maximum of 100 items may be displayed."] =
    "يمكن عرض ما يصل إلى 100 عنصر كحد أقصى.";
...
$Definition["Use an SMTP server to send email"] =
    "استخدم خادم SMTP لإرسال البريد الإلكتروني";
$Definition["Use asterisks for wildcards"] =
    'استخدم العلامات النجمية لحرف البدل ، مثل  "*@gmail.com"';
...
$Definition["Use categories to organize discussions"] =
    "استخدم الفئات لتنظيم المناقشات";
$Definition["Use Facebook names for usernames."] =
    "استخدم أسماء Facebook لأسماء المستخدمين.";
...
$Definition[
    ...
    "يستخدم لغة تقنية للغاية ومصطلحات خاصة بالصناعة مخصصة لأولئك الذين لديهم فهم عميق للموضوع.";
$Definition[
    "Uses industry-specific terms where necessary, but also provides explanations of definitions to ensure clarity."
] =
    "يستخدم المصطلحات الخاصة بالصناعة عند الضرورة، ولكنه يقدم أيضًا تفسيرات للتعريفات لضمان الوضوح.";
$Definition[
    "Uses simple, everyday language that anyone can understand, regardless of their background or expertise."
] =
    "يستخدم لغة بسيطة يومية يمكن لأي شخص أن يفهمها، بغض النظر عن خلفيته أو خبرته.";
$Definition["UserDeleteMessage"] =
    'احذف المستخدم وأزل جميع محتويات المستخدم بالكامل. قد يتسبب هذا في أن تكون المناقشات مفككة. أفضل خيار لإزالة البريد المزعج.';
$Definition["UserDeletionPrompt"] =
    "اختر كيفية معالجة كل المحتوى المرتبط بحساب المستخدم لـ %s (التعليقات والرسائل وما إلى ذلك).";
$Definition["UserKeep"] = "الحفاظ على محتوى المستخدم";
$Definition["UserKeepMessage"] =
    'احذف المستخدم ولكن احتفظ بمحتوى المستخدم.';
...
$Definition[
    ...
    "يمكن للمستخدمين متابعة الفئات للاشتراك في إشعارات المنشورات الجديدة. حدد الفئات التي يجب على المستخدمين الجدد اتباعها بشكل افتراضي.";
$Definition["Users that get this reaction get %+d point."] =
    "يحصل المستخدمون الذين يحصلون على رد الفعل هذا على نقطة %+d";
$Definition["Users that get this reaction get %+d points."] =
    "المستخدمون الذين يحصلون على رد الفعل هذا يحصلون على نقاط %+d";
$Definition[
    "Users will not be warned when following links that match a Trusted Domain."
] =
    "لن يتم تحذير المستخدمين عند اتباع روابط تتوافق مع نطاق موثوق به.";
$Definition[
    "Users will be redirected to this URL after accepting an invitation."
] =
    "سيتم إعادة توجيه المستخدمين إلى عنوان URL هذا بعد قبول الدعوة. يمكن أن يكون عنوان URL كاملاً أو مساراً لإعادة التوجيه داخل الموقع.";
$Definition["User Summary"] = "ملخص المستخدم";
$Definition[
    'Users will be assigned to this role until they\'ve confirmed their email addresses.'
] =
    'سيتم تعيين المستخدمين لهذا الدور حتى يؤكدوا عناوين بريدهم الإلكتروني.';
$Definition["Users with the no ads permission will not see this pocket."] =
    "لن يتمكن المستخدمون الذين ليس لديهم إذن لنشر أية إعلانات من رؤية هذا الجيب.";
$Definition["UserWipe"] = "UserWipe";
$Definition["UserWipeMessage"] =
    'احذف المستخدم واستبدل كل محتوى المستخدم برسالة تفيد بحذف المستخدم. هذا يعطي إشارة مرئية بأن المعلومات مفقودة.';
$Definition["Use the content at this url as your homepage."] =
    'اختر الصفحة التي يجب أن يراها الأشخاص عند زيارتهم: <strong style="white-space: nowrap;">%s</strong>';
$Definition["Use Vanilla as a commenting system in your site"] =
    "استخدم الفانيليا كنظام تعليق في موقعك";
$Definition["Use weekly community email digest"] =
    "استخدم ملخص البريد الإلكتروني الأسبوعي للمجتمع";
$Definition["Untitled"] = "بلا عنوان";

$Definition["Value or Pattern"] = "قيمة أو نمط";
$Definition["Vanilla.Archive.Description"] =
    "يمكنك اختيار أرشفة مناقشات المنتدى الأقدم من تاريخ معين. تم إغلاق المناقشات المؤرشفة بشكل فعال ، مما لا يسمح بأي مشاركات جديدة.";
$Definition["Vanilla.Categories.MaxDisplayDepth"] =
    'ضع الفئات المتداخلة في قائمة مفصولة بفواصل عندما تكون %1$s';
...
] = "قم بتحذير المستخدمين إذا كان رابط في منشور سيؤدي بهم إلى مغادرة المنتدى";
$Definition[
    "Warning: All of your data will be lost. Once you delete, there is absolutely no recovery of any kind."
] =
    "تحذير: ستفقد جميع بياناتك. بمجرد الحذف ، لا يوجد أي استرداد من أي نوع على الإطلاق.";
$Definition["Warning: deleting is permanent"] =
    "تحذير: تتم إزالة العناصر المحذوفة من هذه القائمة ولا يمكن إعادتها.";
...
$Definition["We only accept urls that begin with http:// or https://"] =
    "نقبل فقط عناوين url التي تبدأ بـ http: // أو https: //";
$Definition[
    ...
    "سنحاول استخدام خادم البريد المحلي لإرسال البريد الإلكتروني افتراضيًا. إذا كنت ترغب في استخدام خادم بريد SMTP منفصل ، فيمكنك تكوينه أدناه.";
$Definition[
    ...
    "مرحبًا بك. أنا مساعد الاقتراحات بالذكاء الاصطناعي، وهي أداة تعتمد على التعلم الآلي ومصممة لتحديد واقتراح المقالات والمنشورات ذات الصلة ردًا على استفساراتك. يرجى إدخال أسئلتك وسأقدم لك المعلومات الأكثر ملاءمة.";
$Definition['What\'s the Buzz?'] = 'ما هو طنين؟';
$Definition["When enabled, search result will open in a new browser tab."] =
    "عند التمكين، سيتم فتح نتيجة البحث في علامة تبويب جديدة بالمتصفح.";
$Definition[
    "When enabled, your community will have AI Suggestions shown in Q&A. <0/>"
] = "عند تمكين هذا الخيار، سيتمكن مجتمعك من عرض اقتراحات الذكاء الاصطناعي في الأسئلة والأجوبة. <0/>";
$Definition[
    ...
    "عند تمكين هذا الإعداد ، سيتم إخفاء هوية تفاصيل المستخدم في بيانات Analytics افتراضيًا ، حتى يوافق المستخدم على ملفات تعريف ارتباط Analytics. <0> معرفة المزيد</0>";
...
$Definition["Why am I seeing AI Suggested Answers?"] =
    "لماذا أرى إجابات مقترحة من الذكاء الاصطناعي؟";
...
$Definition["Yes, the following information can be changed later."] =
    "نعم ، يمكن تغيير المعلومات التالية لاحقًا.";
$Definition["You are connected as %s."] = "أنت متصل ك %s.";
$Definition["You are not allowed to use suggestions"] =
    "لا يجوز لك استخدام الاقتراحات";
$Definition["You are previewing the %s theme."] =
    "أنت تقوم بمعاينة سمة %s.";
$Definition[
    "You can also ban the users that posted the spam and delete all of their posts."
] =
    "حدد المربع بجوار المستخدم الذي نشر البريد العشوائي لحظره وحذف جميع مشاركاته. <b>لا تفعل ذلك إلا إذا كنت متأكدًا أن هؤلاء هم مرسلو الرسائل غير المرغوب فيها.</b>";
$Definition['You can always use your password at<a href="%1$s">%1$s</a>.'] =
    'إذا تم حظر دخولك إلى المنتدى الخاص بك ، يمكنك دائمًا تسجيل الدخول باستخدام بريدك الإلكتروني الأصلي للفانيلا وكلمة المرور على <a href="%1$s">%1$s</a>';
$Definition[
    "You can ban IP addresses, email domains, and words from usernames using this tool."
] =
    "يمكنك حظر عناوين IP ونطاقات البريد الإلكتروني والكلمات من أسماء المستخدمين باستخدام هذه الأداة.";
$Definition[
    "You can customize the HTML and CSS for this theme on the %s page."
] = "يمكنك تخصيص HTML و CSS لهذا السمة في صفحة %s.";
$Definition[
    "You can either create a new account, or enter your credentials if you have an existing account."
] =
    "يمكنك إما إنشاء حساب جديد ، أو إدخال بيانات الاعتماد الخاصة بك إذا كان لديك حساب موجود.";
$Definition["You can make the categories page your homepage."] =
    'يمكنك جعل صفحة الفئات الخاصة بك صفحتك الرئيسية <a href="%s">هنا</a> .';
$Definition[
    "You can search for users by username or email, wildcards are implied."
] = "يمكنك البحث عن المستخدمين عن طريق اسم المستخدم أو البريد الإلكتروني ، يتم تضمين أحرف البدل.";
$Definition["You can specify an allow list of trusted domains."] =
    "يمكنك تحديد قائمة بالمجالات الموثوقة الآمنة لعمليات إعادة التوجيه والتضمين.";
$Definition["You can specify an allow list of trusted domains. (CSP)"] =
    "يمكنك تحديد القائمة البيضاء لأسماء النطاقات الموثوقة (مثل: yourdomain.com) التي تعتبر آمنة ليتم تحميل أكواد جافاسكريبت/JavaScript منها.";
$Definition[
    'You cannot disable the %1$s plugin because the %2$s plugin requires it in order to function.'
] =
    'لا يمكنك تعطيل المكون الإضافي %1$s لأن المكون الإضافي %2$s يتطلبه ليعمل.';
$Definition[
    "You cannot remove the only remaining category that allows discussions"
] = "لا يمكنك إزالة الفئة الوحيدة المتبقية التي تسمح بالمناقشات";
$Definition[
    "You can protect your site with an HTTP username/password during development."
] =
    "يمكنك حماية موقعك باستخدام اسم مستخدم / كلمة مرور بنظام HTTP أثناء التطوير.";
$Definition[
    "You can send emails in plain text by disabling the toggle below."
] = "يمكنك إرسال رسائل البريد الإلكتروني في هيئة نص عادي عن طريق تعطيل التبديل أدناه.";
$Definition["You have %s invitations left for this month."] =
    "يتبقى لديك دعوات %s لهذا الشهر.";
$Definition["You have successfully saved interest: <0/>"] =
    "لقد قمت بحفظ الفائدة بنجاح: <0/>";
$Definition["You must be authenticated in order to use this form."] =
    "يجب أن تتم المصادقة عليك لاستخدام هذا النموذج.";
$Definition["You must manually apply this rank."] =
    "يجب أن تضيف هذة الرتبية يدويا.";
$Definition["You must provide at least one recipient"] =
    "يجب عليك تقديم مستلم واحد على الأقل";
$Definition["You must specify an admin password."] =
    "يجب عليك تحديد كلمة مرور المسؤول.";
$Definition["You must specify an admin username."] =
    "يجب عليك تحديد اسم مستخدم مسؤول.";
$Definition[
    ...
    "لا يحتوي ملف التكوين الخاص بك على الأذونات الصحيحة. يحتاج PHP إلى أن يكون قادرًا على القراءة والكتابة إلى هذا الملف: <code>%s</code>";
$Definition['Your default locale won\'t display properly'] =
    'لن يتم عرض اللغة الافتراضية الخاصة بك بشكل صحيح حتى يتم تمكينها أدناه. يرجى تمكين ما يلي: %s.';
...
$Definition[
    ...
    "أنت تغادر محرر الموضوع بدون حفظ التغييرات. تأكد من حفظ تحديثاتك قبل الخروج.";
$Definition[
    "You are leaving the Email Settings page without saving your changes. Make sure your updates are saved before exiting."
] =
    "أنت تغادر صفحة إعدادات البريد الإلكتروني بدون حفظ التغييرات. تأكد من حفظ التحديثات الخاصة بك قبل الخروج.";
