...
$Definition['You can also include placeholders in your email content—these will be automatically replaced with relevant user or post information when the email is sent. For example, Hello {user.name}! or Check out {discussion.name}.'] = 'يمكنك أيضًا تضمين عناصر نائبة في محتوى بريدك الإلكتروني، وسيتم استبدالها تلقائيًا بمعلومات المستخدم أو المنشور ذات الصلة عند إرسال البريد الإلكتروني. على سبيل المثال، مرحبًا {اسم المستخدم}! أو تفضل بزيارة {اسم المناقشة}.';
