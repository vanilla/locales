...
$Definition['If enabled, the full content of posts will be sent in email notifications to users.'] = 'في حالة التمكين ، سيتم إرسال المحتوى الكامل للمشاركات في إشعارات البريد الإلكتروني للمستخدمين.';
...
$Definition['RichEditor.QuoteEnable.Notes'] = 'استخدم الخيار التالي لتمكين علامات الاقتباس لـ Rich Editor. لن يتم تطبيق ذلك إلا إذا كان المُنسق الافتراضي هو "Rich".';
...
$Definition['ShareImageDescription'] = 'عندما يشارك شخص ما رابطًا من موقعك ، فإننا نحاول التقاط صورة من الصفحة. إذا لم تكن هناك صورة على الصفحة ، فسنستخدم هذه الصورة بدلاً من ذلك. يجب أن تكون الصورة 50 × 50 على الأقل ، لكننا نوصي 200 × 200.';
...
$Definition['This setting loads the page before executing Javascript.'] = 'يقوم هذا الإعداد بتحميل الصفحة قبل تنفيذ Javascript مما يمكن أن يحسن SEO الخاص بك. <br> <strong>** تحذير: قد يؤدي تمكين هذه الميزة إلى حدوث أخطاء جافا سكريبت على موقعك. **</strong>';
