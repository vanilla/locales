...
$Definition['This page lists the endpoints of your API.'] =
    'تسرد هذه الصفحة نقاط نهاية API الخاصة بك. انقر نقاط النهاية لمزيد من المعلومات. يمكنك إجراء مكالمات مباشرة إلى واجهة برمجة التطبيقات من هذه الصفحة أو خارجيًا باستخدام رمز وصول.';
...
$Definition['Which reactions you use really depends on your community.'] =
    'تعتمد ردود الفعل التي تستخدمها حقًا على مجتمعك ، لكننا نوصي بوضع بضع نقاط في الاعتبار.';
