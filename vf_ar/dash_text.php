...
$Definition['Digest Settings'] = 'إعدادات الملخص';
...
$Definition['Recommended dimensions are about 400px by 300px or smaller with similar ratio.'] = 'تبلغ الأبعاد الموصى بها حوالي 400 بكسل × 300 بكسل أو أصغر بنسبة مماثلة.';
...
$Definition['Tagging allows users to add a tag to discussions they start in order to make them more discoverable. '] =
    'يسمح وضع العلامات للمستخدمين بإضافة علامة إلى المناقشات التي يبدأونها لجعلهم أكثر قابلية للاكتشاف.';
...
$Definition['The database user you specified does not have permission to access the database. Have you created the database yet? The database reported: <code>%s</code>'] =
    'ليس لدى مستخدم قاعدة البيانات الذي حددته إذن بالوصول إلى قاعدة البيانات. هل قمت بإنشاء قاعدة البيانات حتى الآن؟ ذكرت قاعدة البيانات: <code>%s</code>';
...
$Definition['They work just like regular themes. Once one has been added to the themes folder, you can enable it here.'] =
    'إنهم يعملون مثل المواضيع العادية. بمجرد إضافة واحد إلى مجلد السمات ، يمكنك تمكينه هنا.';
...
$Definition['This may be used to include content such as organization name and address in all outgoing emails.'] = 'يمكن استخدام هذا لتضمين محتوى مثل اسم المؤسسة وعنوانها في جميع رسائل البريد الإلكتروني الصادرة.';
...
$Definition['This title appears on your site\'s banner and in your browser\'s title bar. If a logo is uploaded, it will replace this title on user-facing forum pages. Also, keep in mind some themes may hide this title.'] = 'يظهر هذا العنوان على شعار موقعك وفي شريط عنوان المتصفح الخاص بك. إذا تم تحميل شعار، فسوف يحل محل هذا العنوان في صفحات المنتدى التي يواجهها المستخدم. ضع في اعتبارك أيضًا أن بعض السمات قد تخفي هذا العنوان.';
...
$Definition['TouchIconDescription'] =
    'يظهر رمز اللمس عند وضع إشارة مرجعية على موقع ويب على الشاشة الرئيسية لجهاز Apple. هذه عادة 152 بكسل. تضيف Apple الزوايا الدائرية وتأثير الإضاءة تلقائيًا.';
...
$Definition['Warning: Loading tables can be slow.'] =
    '<b>تحذير</b> : تكوين الخادم الخاص بك لا يدعم التحميل السريع للبيانات. إذا كنت تقوم باستيراد ملف كبير جدًا (على سبيل المثال ، أكثر من 200000 تعليق) ، فقد تحتاج إلى تغيير تكوينك. انقر <a href="http://vanillaforums.com/porter">هنا</a> لمزيد من المعلومات.';
