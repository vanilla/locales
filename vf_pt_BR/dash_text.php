...
$Definition['Allow links to be transformed'] = 'Permita que os links sejam transformados em representações incorporadas em discussões e comentários. Por exemplo, um link do YouTube se transformará em um vídeo incorporado.';
$Definition['Allow users with the %s permission to change their own avatars from their profile pages in Vanilla.'] = 'Permita que os usuários com permissão %s alterem seus próprios avatares de suas páginas de perfil no Vanilla.';
...
$Definition['Be creative! Try naming your ranks after things that the community talks about.'] = 'Seja criativo! Tente nomear seus rankings usando como exemplo assuntos discutidos na comunidade.';
...
$Definition['Checkboxes allow admins to perform batch actions on a number of discussions or comments at the same time.'] = 'As caixas de seleção permitem que os administradores executem diversas ações em várias discussões ou comentários ao mesmo tempo.';
...
$Definition['Garden.Profiles.Edit permission to change their own avatars from their profile pages in Vanilla.'] = 'Garden.Perfis.Edite a permissão para alterar seus próprios avatares de suas páginas de perfil no Vanilla.';
...
$Definition['Here are the ranks that users can achieve on your site.'] = 'Aqui estão os rankings que os usuários podem alcançar no seu site. Você pode personalizar esses rankings e até adicionar novos. Aqui estão algumas dicas.';
...
$Definition['It is a good idea to keep the maximum number of characters allowed in a post down to a reasonable size.'] = 'É uma boa idéia manter o número máximo de caracteres permitido em uma postagem em uma quantidade razoável.';
...
$Definition['Mobile themes allow you to change the look and feel of your site on smaller devices.'] = 'Os temas para celular permitem alterar a aparência do seu site em dispositivos menores.';

$Definition['Need More Help?'] = 'Precisando de mais ajuda?';
$Definition['Nested categories deeper than this depth will be placed in a comma-delimited list.'] = 'Categorias mais profundas serão colocadas em uma lista delimitada por vírgula.';
...
$Definition['Recommend special ranks for admins and mods.'] = 'É uma boa idéia ter classificações especiais para moderadores e administradores, para que sua comunidade possa ver facilmente quem está no comando.';
$Definition['Recommend starting with five ranks.'] = 'Você não quer ter muitas fileiras. Recomendamos começar com cinco. Você pode adicionar mais se sua comunidade for realmente grande.';
...
$Definition['ShareImageDescription'] = 'Quando alguém compartilha um link do seu site, tentamos obter uma imagem da página. Se não houver uma imagem na página, usaremos essa imagem. A imagem deve ter pelo menos 50 × 50, mas recomendamos 200 × 200.';
...
$Definition['Some themes may need to be updated to work with category following. You can disable the feature while you update your theme.'] = 'Alguns temas podem precisar ser atualizados para funcionar com a categoria a seguir. Você pode desativar o recurso enquanto atualiza seu tema.';
$Definition['Special restriction: Only users with permission Garden.Curation.Manage may use this reaction.'] = 'Restrição especial: Somente usuários com permissão Garden.Curation.Manage podem usar esta reação.';
...
$Definition['Tagging allows users to add a tag to discussions they start in order to make them more discoverable. '] = 'A marcação permite que os usuários adicionem uma tag às discussões iniciadas para torná-las mais detectáveis.';
...
$Definition['This setting loads the page before executing Javascript.'] = 'Essa configuração carrega a página antes de executar o Javascript, o que pode melhorar seu SEO. <br> <strong>** Aviso: ativar esse recurso pode causar erros de Javascript no seu site. **</strong>';
...
$Definition['TouchIconDescription'] = 'O ícone de toque aparece quando você adiciona um site aos favoritos na tela inicial de um dispositivo Apple. Estes são geralmente 152 pixels. A Apple adiciona cantos arredondados e efeito de iluminação automaticamente.';
...
$Definition['Which reactions you use really depends on your community.'] = 'Quais reações você usa realmente dependem da sua comunidade, mas recomendamos ter alguns pontos em mente.';
