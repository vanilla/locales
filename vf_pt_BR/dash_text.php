...
$Definition['Allow links to be transformed'] = 'Permita que links sejam transformados em representações incorporadas em postagens e comentários. Por exemplo, um link do YouTube se transformará em um vídeo incorporado.';
...
$Definition['This setting loads the page before executing Javascript.'] = 'Esta configuração carrega a página antes de executar Javascript, o que pode melhorar o seu SEO.<br><strong>**Aviso: Ativar esse recurso pode causar erros de Javascript no seu site.**</strong>';
