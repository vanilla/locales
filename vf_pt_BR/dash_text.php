...
$Definition['MobileLogoDescription'] = 'O logotipo do banner para celular aparece na parte superior do seu site. Alguns temas podem não exibir este logotipo.';
...
$Definition['Overridden views or themehooks can have unintended side effects and are not previewed.'] = 'Vistas ou temas substituídos podem ter efeitos indesejados e não serão visualizados.';
...
$Definition['Recommend special ranks for admins and mods.'] = 'É uma boa idéia ter classificações especiais para moderadores e administradores, para que sua comunidade possa ver facilmente quem é o responsável.';
...
$Definition['Some themes may need to be updated to work with category following. You can disable the feature while you update your theme.'] = 'Alguns temas podem precisar ser atualizados para funcionar com a sequência de categorias. Você pode desativar o recurso enquanto atualiza seu tema.';
$Definition['Special restriction: Only users with permission Garden.Curation.Manage may use this reaction.'] = 'Restrição especial: Somente usuários com permissão Garden.Curation.Admin podem usar esta reação.';
