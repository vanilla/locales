...
$Definition['Alert users if they click a link in a post that will lead them away from the forum. 
    ...
    'Alerte os usuários caso eles cliquem em um link em uma postagem que os afastará do fórum.
...
$Definition['Allow links to be tranformed into embedded representations in discussions and comments. 
    ...
    'Permita que os links sejam transformados em representações embutidas em discussões e comentários. 
Por exemplo, um link do YouTube se transformará em um vídeo incorporado.';
...
$Definition['Don\'t use too many reactions. You don\'t want to give your users information overload.'] =
    'Não use muitas reações. Você não deseja sobrecarregar seus usuários com muitas informações.';
...
$Definition['Failed to connect to the database with the username and password you entered. Did you mistype them? The database reported: <code>%s</code>'] = 'Falha ao se conectar ao banco de dados com o nome de usuário e senha inseridos. Você digitou direito? O banco de dados relatou: <code>%s</ code>';
...
$Definition['If you want to embed your forum or use Vanilla\'s comments in your blog then you need to enable embedding. 
    ...
    'Se você deseja incorporar seu fórum ou usar os comentários do Vanilla em seu blog, é necessário habilitar a incorporação.
     Se você não estiver usando incorporação, recomendamos deixar essa configuração desativada.';
...
$Definition['It\'s a good idea to have special ranks for moderators and administrators so that your community can easily see who\'s in charge.'] =
    'É uma boa idéia ter classificações especiais para moderadores e administradores, para que sua comunidade possa ver facilmente quem é o responsável.';
...
$Definition['Not getting what you expect when you preview your theme?'] = 'Não tem o resultado esperado quando visualiza seu tema?';
$Definition['Notify me when people comment on my addons.'] = 'Notifique-me quando pessoas comentarem em meus complementos.';

$Definition['Once enabled, only members will see inside your community.'] = 'Uma vez ativado, apenas os membros verão o conteúdo de sua comunidade.';
$Definition['Overridden views or themehooks can have unintended side effects and are not previewed.'] =
    'Vistas ou temas substituídos podem ter efeitos indesejados e não serão visualizados.';
...
$Definition['Some browsers support a color for the address bar. Mobile only.'] = 'Alguns navegadores suportam uma cor para a barra de endereço. Apenas para celular.';
$Definition['Some themes may need to be updated to work with category following. You can disable the feature while you update your theme.'] =
    'Alguns temas podem precisar ser atualizados para funcionar com a sequência de categorias. Você pode desativar o recurso enquanto atualiza seu tema.';
$Definition['Special restriction: Only users with permission Garden.Curation.Manage may use this reaction.'] =
    'Restrição especial: Somente usuários com permissão Garden.Curation.Admin podem usar esta reação.';
$Definition['Specify a partial or full match when creating a ban.'] = 'Especifique uma correspondência parcial ou completa ao criar um banimento.';
$Definition['Spend a little time thinking about how you describe your site here.'] = 'Pare e pense um pouco em como descrever seu site aqui. Dê ao seu site um título significativo e uma descrição concisa, isso pode melhorar a sua posição nos motores de busca.';
$Definition['Spruce up your emails by adding a logo and customizing the colors.'] = 'Enfeite seus e-mails adicionando um logotipo e personalizando as cores.';
$Definition['Start Import'] = 'Começar iImportação';
$Definition['Start the first discussion.'] = 'Role a bola em sua comunidade <a href="{/post/discussion,url}">começando a primeira discussão</a> agora.';
...
$Definition['The touch icon appears when you bookmark a website on the homescreen of an Apple device. These are usually 152 pixels. 
    ...
    'O ícone de touch aparece quando você adiciona um site aos favoritos na tela inicial de um dispositivo Apple. Estes são geralmente 152 pixels.
     A Apple adiciona cantos arredondados e efeito de iluminação automaticamente.';
...
$Definition['This page lists the endpoints of your API. Click endpoints for more information. You can make live calls to the API from this page or externally using an access token.'] =
    'Esta página lista os pontos finais da sua API. Clique em terminais para obter mais informações. Você pode fazer chamadas ao vivo para a API a partir desta página ou externamente usando um token de acesso.';
$Definition['This setting loads the page before executing Javascript which can improve your SEO.
    ...
    'Essa configuração carrega a página antes de executar o Javascript, o que pode melhorar seu SEO.
    <br><strong> ** Aviso: ativar esse recurso pode causar erros de Javascript no seu site. **</strong>';
...
$Definition['Use the following option to enable quotes for the Rich Editor. This will only apply if the default formatter is "Rich".'] =
    'Use a opção a seguir para ativar as citações para o Editor de Texto Enriquecido. Isso só será aplicado se o formatador-padrão for "Rich".';
...
$Definition['Warning: Loading tables can be slow.'] = '<B> Aviso </ b>: a configuração do servidor não suporta o carregamento rápido de dados.
Se você estiver importando um arquivo muito grande (ex. Mais de 200.000 comentários), seria bom considerar a alteração da sua configuração. Clique <a href="http://vanillaforums.com/porter">aqui </a> para obter mais informações.';
...
$Definition['When someone shares a link from your site we try and grab an image from the page. 
    ...
    'Quando alguém compartilha um link do seu site, tentamos pegar uma imagem da página.
     Se não houver uma imagem na página, usaremos essa imagem. A imagem deve ter pelo menos 50×50, mas recomendamos 200×200.';
$Definition['Which reactions you use really depends on your community, but we recommend keeping a couple of points in mind.'] =
    'As reações que você usa realmente dependem da sua comunidade, mas recomendamos ter alguns pontos em mente.';
...
$Definition['You don\'t want to have too many ranks. We recommend starting with five. You can add more if your community is really large.'] =
    'Você não quer ter muitos rankings. Recomendamos começar com cinco. Você pode adicionar mais se sua comunidade for realmente grande.';
