...
$Definition['Activity.AboutUpdate.FullHeadline'] = '%1$s обновив профіль %6$s.';
$Definition['Activity.AboutUpdate.ProfileHeadline'] = '%1$s обновил(а) профіль %6$s.';
$Definition['Activity.AddedToConversation.FullHeadline'] = '%1$s додав вас до %8$s.';
$Definition['Activity.AddedToConversation.ProfileHeadline'] = '%1$s додав вас до %8$s.';
$Definition['Activity.BookmarkComment.FullHeadline'] = '%1$s прокоментував ваше %8$s.';
$Definition['Activity.BookmarkComment.ProfileHeadline'] = '%1$s прокоментував ваше %8$s.';
...
$Definition['Activity.DiscussionComment.FullHeadline'] = '%1$s прокоментував %8$s від %3$s.';
$Definition['Activity.DiscussionComment.ProfileHeadline'] = '%1$s прокоментував %4$sе %8$s.';
$Definition['Activity.DiscussionMention.FullHeadline'] = '%1$s згадав %3$s в %8$s.';
$Definition['Activity.DiscussionMention.ProfileHeadline'] = '%1$s згадав %3$s в %8$s.';
$Definition['Activity.Import.FullHeadline'] = '%1$s імпортував дані.';
$Definition['Activity.Import.ProfileHeadline'] = '%1$s імпортував дані.';
$Definition['Activity.Join.FullHeadline'] = '%1$s тепер з нами.';
$Definition['Activity.Join.ProfileHeadline'] = '%1$s тепер з нами.';
$Definition['Activity.JoinApproved.FullHeadline'] = '%1$s затвердив заявку від %4$s.';
$Definition['Activity.JoinApproved.ProfileHeadline'] = '%1$s затвердив заявку від %4$s.';
$Definition['Activity.JoinCreated.FullHeadline'] = '%3$s створив аккаунт для %1$s.';
$Definition['Activity.JoinCreated.ProfileHeadline'] = '%3$s створив аккаунт для %1$s.';
$Definition['Activity.JoinInvite.FullHeadline'] = '%1$s прийняв запрошення від %4$s.';
$Definition['Activity.JoinInvite.ProfileHeadline'] = '%1$s прийняв запрошення від %4$s.';
$Definition['Activity.NewDiscussion.FullHeadline'] = '%1$s розпочали %8$s.';
$Definition['Activity.NewDiscussion.ProfileHeadline'] = '%1$s розпочав(ла) %8$s.';
...
$Definition['Activity.RoleChange.FullHeadline'] = '%1$s змінив %4$s права.';
$Definition['Activity.RoleChange.ProfileHeadline'] = '%1$s змінив %4$s права.';
$Definition['Activity.SignIn.FullHeadline'] = '%1$s онлайн.';
$Definition['Activity.SignIn.ProfileHeadline'] = '%1$s онлайн.';
$Definition['Activity.WallComment.FullHeadline'] = '%1$s написали в %4$s %5$s.';
$Definition['Activity.WallComment.ProfileHeadline'] = '%1$s написав(ла):';
...
$Definition['UsernameError'] = 'Ім\'я користувача може складатися тільки з букв, цифр та прогалин, і повинно бути від 3 до 20 символів довжиною.';
