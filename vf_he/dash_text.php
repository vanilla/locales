...
$Definition['API Overview'] = "סקירת API";
...
$Definition['Digest Settings'] = 'הגדרות תקציר';
...
$Definition['Most communities stick to positive reactions to encourage participation.'] = 'רוב הקהילות נצמדות לתגובות חיוביות כדי לעודד השתתפות.';
...
$Definition['Quicklinks'] = 'קישורים מהירים';
$Definition['Quick-Start Guide to Creating Themes for Vanilla'] = 'מדריך מהיר ליצירה של ערכות נושא ל-Vanilla';

$Definition['Rate Limits'] = 'מגבלות קצב';
$Definition['Reactions Documentation'] = 'תיעוד תגובות';
...
$Definition['Recommended dimensions are about 400px by 300px or smaller with similar ratio.'] = 'הממדים המומלצים הם בערך 400 פיקסלים על 300 פיקסלים או פחות עם יחס דומה.';
...
$Definition['Role Tokens'] = 'אסימוני תפקידים';
...
$Definition['Tagging allows users to add a tag to discussions they start in order to make them more discoverable. '] =
    'תיוג מאפשר למשתמשים להוסיף תג לדיונים שהם מתחילים בכדי להפוך אותם לגלויים יותר.';
...
$Definition['This setting loads the page before executing Javascript.'] =
    'הגדרה זו טוענת את הדף קודם לביצוע Javascript שיכול לשפר את ה-SEO שלך. <br><strong>**אזהרה: הפיכת תכונה זו לזמינה עלולה לגרום שגיאות Javascript באתר שלך.**</strong>';
...
$Definition['TouchIconDescription'] =
    'סמל המגע מופיע כשאתה מסמן סימניות באתר במסך הבית של מכשיר אפל. לרוב מדובר על 152 פיקסלים. אפל מוסיפה פינות מעוגלות ואפקט תאורה באופן אוטומטי.';
...
$Definition['Warning: Loading tables can be slow.'] =
    '<b>אזהרה</b> : תצורת השרת שלך אינה תומכת בטעינת נתונים מהירה. אם אתה מייבא קובץ גדול מאוד (למשל מעל 200,000 תגובות), אולי כדאי לך לשקול לשנות את התצורה שלך. לחץ <a href="http://vanillaforums.com/porter">כאן</a> למידע נוסף.';
...
$Definition['We recommend enabling 1–3 reactions at a time to avoid overwhelming users.'] = 'אנו ממליצים להפעיל 1-3 תגובות בכל פעם כדי להימנע מהציף של משתמשים.';
...
$Definition['When enabled, you can <0>manage products</0>, and group subcommunities by those products.'] = 'כאשר הפעולה מופעלת, ניתן <0>לנהל מוצרים</0> , ולקבץ קהילות משנה לפי מוצרים אלה.';
...
$Definition["Welcome to Vanilla's theming UI."] = "ברוכים הבאים לממשק העיצוב של Vanilla. דף זה מפרט את כל הנושאים הזמינים שלך, ומאפשר לך להעתיק או לערוך אותם.";
...
$Definition["Usercards allow you to get a quick in-line snapshot of a user's information."] = "כרטיסי משתמש מאפשרים לך לקבל תמונת מצב מהירה של המידע של המשתמש. בעת צפייה בפוסטים ובלוחות הישגים, לחץ על שם המשתמש כדי לראות כרטיס המציג את פרטי הפרופיל הבסיסיים של המשתמש ללא צורך לנווט מהדף. אפשר תכונה זו כדי להוסיף כרטיסי משתמש לערכת הנושא המותאמת אישית שלך.";
$Definition['New Search Page'] = 'דף חיפוש חדש';
$Definition["Vanilla's new search service is finally here."] = "שירות החיפוש החדש של Vanilla סוף סוף כאן. אפשר את ממשק המשתמש החדש של דף החיפוש שלנו כדי לקבל גישה לתכונות החיפוש החדשות ביותר כגון חיפוש חברים, מיון חיפוש והדגשת מונחים.";
...
$Definition["Recent Post List Page"] = "דף רשימת פוסטים אחרונים";
$Definition["Custom"] = "מִנְהָג";
$Definition["Category List Page"] = "דף רשימת קטגוריות";
$Definition["Home Page Type"] = "סוג דף הבית";
$Definition["Choose a page to serve as the subcommunity homepage."] = "בחר דף שישמש כדף הבית של תת-הקהילה.";
$Definition["Selected Home Page Type is a custom layout. You can manage the layout for this subcommunity in <0/>."] = "סוג דף הבית שנבחר הוא פריסה מותאמת אישית. ניתן לנהל את הפריסה עבור תת-קהילה זו ב- <0/>.";
$Definition["Default Subcommunity"] = "תת-קהילת ברירת מחדל";
$Definition["Make this the default subcommunity. Visitors will be directed here first when they access the community."] = "הפוך את הקהילה הזו לתת-הקהילה המוגדרת כברירת מחדל. מבקרים יופנו לכאן תחילה כאשר ייגשו לקהילה.";
$Definition["Post number must be between 3–20."] = "מספר הפוסט חייב להיות בין 3 ל-20.";
$Definition["Pages"] = "דפים";
$Definition["Widget Builder"] = "בונה ווידג'טים";
$Definition["Custom Pages"] = "דפים מותאמים אישית";
$Definition["Site Home Pages"] = "דפי הבית של האתר";
$Definition["Subcommunity Home Pages"] = "דפי בית של תת-קהילות";
$Definition["Choose a theme for this subcommunity.  <0>Read more</0>"] = "בחר נושא עבור תת-קהילה זו. <0>קרא עוד</0>";
$Definition["Vanilla Messages"] = "הודעות וניל";
$Definition["From <0/>"] = "מאת <0/>";
$Definition["Manage Products"] = "ניהול מוצרים";
$Definition["Pages"] = "דפים";
$Definition["Widget Builder"] = "בונה ווידג'טים";
$Definition["Custom Pages"] = "דפים מותאמים אישית";
$Definition["Site Home Pages"] = "דפי הבית של האתר";
$Definition["Subcommunity Home Pages"] = "דפי בית של תת-קהילות";
$Definition["Choose a theme for this subcommunity.  <0>Read more</0>"] = "בחר נושא עבור תת-קהילה זו. <0>קרא עוד</0>";
$Definition["Search subcommunities."] = "חפש תת-קהילות.";
$Definition["The view you were looking for could not be found."] = "לא ניתן היה למצוא את הנוף שחיפשת.";
$Definition["View Not Found"] = "תצוגה לא נמצאה";
$Definition["site"] = "אֲתַר";
$Definition["Selected Home Page Type is a legacy layout."] = "סוג דף הבית שנבחר הוא פריסה מדור קודם.";
$Definition["The default home page type can be changed in <0/>."] = "ניתן לשנות את סוג דף הבית המוגדר כברירת מחדל ב- <0/>.";

// Sentiment

$Definition["Keyword Settings"] = "הגדרות מילות מפתח";
$Definition["Extremely Negative to Negative"] = "שלילי ביותר עד שלילי";
$Definition["Negative to Balanced"] = "שלילי עד מאוזן";
$Definition["Balanced to Positive"] = "מאוזן לחיובי";
$Definition["Positive to Highly Positive"] = "חיובי עד חיובי מאוד";
$Definition["Sentiment Keywords"] = "מילות מפתח לסנטימנט";
$Definition["Sentiment Settings"] = "הגדרות סנטימנט";
$Definition["Add Keyword"] = "הוסף מילת מפתח";
$Definition["Keyword Limit Reached"] = "הגעת למגבלת מילות המפתח";
$Definition["You can only track up to 100 keywords. Untrack some to add new keywords."] = "ניתן לעקוב אחר עד 100 מילות מפתח בלבד. בטל את המעקב אחר חלק מהן כדי להוסיף מילות מפתח חדשות.";
$Definition["Calibrate Sentiment Levels"] = "כיול רמות סנטימנט";
$Definition["Sentiment Level Distribution Adjustment"] = "התאמת התפלגות רמת הסנטימנט";
$Definition["The 4 sliders represent the points between each sentiment level. Drag the sliders to calibrate the overall sentiment level distribution to your community's content."] = "4 המחוונים מייצגים את הנקודות בין כל רמת סנטימנט. גררו את המחוונים כדי לכייל את התפלגות רמות הסנטימנט הכוללת לתוכן הקהילה שלכם.";
$Definition["Calibrated Sentiment Distribution Preview"] = "תצוגה מקדימה של התפלגות סנטימנט מכוילת";
$Definition["(Read Only)"] = "(קריאה בלבד)";
$Definition["This graph visualizes how the content in your community would be distributed based on your calibration adjustment."] = "גרף זה מציג באופן ויזואלי כיצד התוכן בקהילה שלך יחולק בהתבסס על התאמת הכיול שלך.";
$Definition["all time sentiment"] = "סנטימנט כל הזמנים";
$Definition["keyword"] = "מילת מפתח";
$Definition["number of uses"] = "מספר שימושים";
$Definition["last use"] = "שימוש אחרון";
$Definition["tracking"] = "מַעֲקָב";
$Definition["Sentiment"] = "רֶגֶשׁ";
$Definition["Tracked Status"] = "סטטוס מעקב";
$Definition["Tracked Only"] = "מעקב בלבד";
$Definition["Untracked Only"] = "לא במעקב בלבד";
$Definition["Strongly Negative"] = "שלילי מאוד";
$Definition["Negative"] = "שְׁלִילִי";
$Definition["Positive"] = "חִיוּבִי";
$Definition["Highly Positive"] = "חיובי מאוד";
$Definition["Clear all filters"] = "נקה את כל המסננים";
$Definition["Keyword is required."] = "נדרשת מילת מפתח.";
$Definition["Maximum length is 100 characters."] = "האורך המקסימלי הוא 100 תווים.";
$Definition["Keyword"] = "מילת מפתח";
$Definition["Add a new tracked keyword"] = "הוסף מילת מפתח חדשה במעקב";
$Definition["New keywords will be tracked in analytics. You can choose to turn off tracking after creating this keyword."] = "מילות מפתח חדשות יעברו מעקב בניתוח הנתונים. ניתן לבחור לכבות את המעקב לאחר יצירת מילת מפתח זו.";
$Definition["Extremely Negative"] = "שלילי ביותר";
$Definition["Extremely Positive"] = "חיובי ביותר";
$Definition["Filter by:"] = "סנן לפי:";
