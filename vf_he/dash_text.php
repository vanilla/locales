...
$Definition['This setting loads the page before executing Javascript.'] =
    'הגדרה זו טוענת את הדף לפני ביצוע Javascript שיכול לשפר את ה- SEO שלך. <br> <strong>** אזהרה: הפעלת תכונה זו עלולה לגרום לשגיאות Javascript באתר שלך. **</strong>';
...
$Definition["This theme cannot be deleted because it is the currently applied theme."] = "לא ניתן למחוק נושא זה מכיוון שהוא הנושא המיושם כעת.";
