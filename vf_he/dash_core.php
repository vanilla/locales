...
$Definition['Add Info &amp; Create Account'] = 'הוספת מידע &amp; יצירת חשבון';
...
$Definition['FaviconDescription'] = 'סמל של האתר שלך מופיע בשורת הכותרת של הדפדפן. הוא יוקטן לגודל של 16X16 פיקסלים.';
...
$Definition['ForceWysiwyg.Notes1'] = 'בחירת אפשרות מעל ממירה את על ההודעות הישנות לסגנון עריכה Wysiwyg.';
$Definition['ForceWysiwyg.Notes2'] = 'אם הגדרה Wysiwyg נבחרה למעלה, זה ישפיע על פורמט שליחת ההודעה.
המטרה של האפשרות הזו היא לבצע סטנדרט של עורך ההודעות. אם הודעה הנערכת בפורמט שונה למשל, markdown או BBCode, אפשרות זו תדרוש עריכה בסגנון עורך Wysiwyg.';
...
$Definition['Reinterpret All Posts As Wysiwyg'] = 'להפוך את כל ההודעות לWysiwyg';
...
$Definition['Search by user or role.'] = 'חיפור אחר משתמשים על בסיס שם או דואר אלקטרוני, אפשר להשתמש ב-% כעזר. באפשרותך לחפש משתמשים גם על ידי מספר מזהה , שם תפקיד, או &ldquo;מושעים&rdquo;.';
...
$Definition['UserKeep'] = 'שמירת התוכן של המשתמש';
