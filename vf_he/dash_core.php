...
$Definition['New comments by users I\'m following'] = 'תגובות חדשות של משתמשים שאני עוקב אחריהם';
...
$Definition['New discussions by users I\'m following'] = 'דיונים חדשים של משתמשים שאני עוקב אחריהם';
...
$Definition['New events by users I\'m following'] = 'אירועים חדשים של משתמשים שאני עוקב אחריהם';
...
$Definition['No users followed'] = 'אין משתמשים שעוקבים אחריו';
...
$Definition['Unfollow user'] = 'בטל מעקב אחר משתמש';
...
$Definition['View all followed users'] = 'הצג את כל המשתמשים שעוקבים אחריהם';
...
$Definition['View User'] = 'הצג משתמש';
...
$Definition['You are receiving this email because you are following this user.'] = 'אתה מקבל את האימייל הזה מכיוון שאתה עוקב אחר המשתמש הזה.';
...
$Definition['{ActivityUserID,user} started a new event: <a href="{Url,html}">{Data.Name,text}</a>'] = '{ActivityUserID,user} התחיל אירוע חדש: <a href="{Url,html}">{Data.Name,text}</a>';
