...
// Federated Search
$Definition["About Federated Search"] = "אודות חיפוש מאוחד";
$Definition["About Search Connectors"] = "אודות מחברי חיפוש";
$Definition["Add"] = "הוסף";
$Definition["Add a custom <0/> search connector"] = "הוסף מחבר חיפוש מותאם אישית <0/>";
$Definition["Answer"] = "תשובה";
$Definition["Apply"] = "יישם";
$Definition["Article"] = "מאמר";
$Definition["Authenticate"] = "לְאַמֵת";
$Definition["Back"] = "בחזרה";
$Definition["Cancel"] = "ביטול";
$Definition["Categories"] = "קטגוריות";
$Definition["Client ID is required."] = "נדרש מזהה לקוח.";
$Definition["Client Secret is required."] = "סוד לקוח נדרש.";
$Definition["Configure"] = "הגדרות";
$Definition["Cursor pagination uses a url to point to the next page of results. Offset pagination uses a page number and item count to fetch the next page."] = "דפדוף באמצעות סמן משתמש בכתובת URL כדי להצביע לדף התוצאות הבא. דפדוף באמצעות היסט משתמש במספר עמודים ובספירת פריטים כדי לאחזר את הדף הבא.";
$Definition["Discussions"] = "אחרונים";
$Definition["Federated Search allows you to include external content within community search results such as knowledge base articles, courses from a learning management system, blog articles and more, to centralize content search within community. <0>Learn more</0>."] = "חיפוש מאוחד מאפשר לך לכלול תוכן חיצוני בתוצאות חיפוש קהילתיות כגון מאמרים מבסיס ידע, קורסים ממערכת ניהול למידה, מאמרי בלוג ועוד, כדי לרכז את חיפוש התוכן בתוך הקהילה. <0>למידע נוסף</0> .";
$Definition["Good job! Here is a preview of some of your external articles, listed on your community's Search Results page."] = "עבודה טובה! הנה תצוגה מקדימה של כמה מהמאמרים החיצוניים שלך, המופיעים בדף תוצאות החיפוש של הקהילה שלך.";
$Definition["Great!"] = "גָדוֹל!";
$Definition["Groups"] = "קבוצות";
$Definition["Help Menu"] = "תפריט עזרה";
$Definition["Here is what a single result provided by the API looks like:"] = "כך נראית תוצאה בודדת שמספק ה-API:";
$Definition["Idea"] = "רעיון";
$Definition["Ideas"] = "רעיונות";
$Definition["Integrates Salesforce's knowledge base articles into the Vanilla community search, consolidating self-service support resources within the community platform."] = "משלב את מאמרי מאגר הידע של Salesforce בחיפוש הקהילתי של Vanilla, ומאחד משאבי תמיכה בשירות עצמי בתוך פלטפורמת הקהילה.";
...
$Definition["Maximum length is 500 characters."] = "האורך המקסימלי הוא 500 תווים.";
$Definition["Maximum number of posts to be included in the email digest."] = "מספר מקסימלי של פוסטים שייכללו בתמצית האימייל.";
$Definition["Messages"] = "הודעות";
$Definition["Modify <0/> search connector"] = "שינוי מחבר חיפוש <0/>";
$Definition["My Account"] = "החשבון שלי";
$Definition["Next"] = "הבא";
$Definition["No results found."] = "לא נמצאו תוצאות.";
$Definition["Notifications"] = "התראות";
$Definition["Number of posts from groups"] = "מספר פוסטים מקבוצות";
$Definition["Our Search Connectors will allow you to easily configure the connection between Vanilla and external platforms. Can't find what you're looking for? Let us know which search connectors you need by posting and Idea in our <0>customer community</0>."] = "מחברי החיפוש שלנו יאפשרו לכם להגדיר בקלות את החיבור בין Vanilla לפלטפורמות חיצוניות. לא מצאת את מה שחיפשת? ספר לנו אילו מחברי חיפוש אתה צריך על ידי פרסום רעיון בקהילת <0>הלקוחות שלנו.</0> .";
$Definition["Please enter some basic information about your custom search connector."] = "אנא הזן מידע בסיסי אודות מחבר החיפוש המותאם אישית שלך.";
$Definition["Poll"] = "סקר";
$Definition["Polls"] = "סקרים";
...
$Definition["Response Body"] = "גוף התגובה";
$Definition["Response Headers"] = "כותרות תגובה";
$Definition["Salesforce Article Search"] = "חיפוש מאמרים ב-Salesforce";
$Definition["Save"] = "שמור";
$Definition["Search Connectors"] = "מחברי חיפוש";
$Definition["Site domain is required."] = "נדרש דומיין לאתר.";
$Definition["Some parameters required to search may be unique to your API. Please configure your search connector with these parameters so that the connector can correctly format search queries for your community."] = "ייתכן שחלק מהפרמטרים הנדרשים לחיפוש יהיו ייחודיים ל-API שלך. אנא הגדר את מחבר החיפוש שלך עם פרמטרים אלה כדי שהמחבר יוכל לעצב נכון שאילתות חיפוש עבור הקהילה שלך.";
$Definition["Surfaces Zendesk Help Center knowledge base articles in Vanilla community search to centralize self-service help within community."] = "מאמרי מאגר הידע של מרכז העזרה של Zendesk בחיפוש קהילתי של Vanilla כדי לרכז עזרה בשירות עצמי בתוך הקהילה.";
$Definition["Tag"] = "תָג";
$Definition["Test Custom API"] = "בדיקת API מותאם אישית";
$Definition["Test your custom API"] = "בדוק את ה-API המותאם אישית שלך";
$Definition["Test your pagination configuration"] = "בדוק את תצורת הדפדוף שלך";
$Definition["The roles that are allowed to access this connector."] = "התפקידים המורשים לגשת למחבר זה.";
$Definition["This search connector has an invalid configuration."] = "למחבר חיפוש זה יש תצורה לא חוקית.";
$Definition["Tip: These required parameters can usually be found in the documentation for your API"] = "טיפ: בדרך כלל ניתן למצוא את הפרמטרים הנדרשים בתיעוד של ה-API שלך.";
$Definition["To finish configuring the Search Connector, tell us where to find the following values within the result object."] = "כדי לסיים את הגדרת מחבר החיפוש, ספר לנו היכן למצוא את הערכים הבאים בתוך אובייקט התוצאה.";
$Definition["Visit Site"] = "בקר באתר";
$Definition["What kind of pagination does your API use?"] = "איזה סוג של עמודים משתמש ה-API שלך?";
$Definition["When you're ready, use these buttons to check that your pagination configuration functions as expected"] = "כשתהיה מוכן, השתמש בלחצנים אלה כדי לבדוק שתצורת העמודים שלך פועלת כצפוי";
$Definition["When you're ready, use this button to test the API and view its results."] = "כשתהיה מוכן, השתמש בלחצן זה כדי לבדוק את ה-API ולצפות בתוצאותיו.";
$Definition["Where is the list of results located in this response?"] = "היכן נמצאת רשימת התוצאות בתגובה זו?";
$Definition["You must configure this search connector to enable it."] = "עליך להגדיר מחבר חיפוש זה כדי להפעיל אותו.";
$Definition["You must select at least one role."] = "עליך לבחור לפחות תפקיד אחד.";
$Definition["Zendesk Guide"] = "מדריך זנדסק";
