...
$Definition['default'] = 'за замовчуванням';
$Definition['Default notification settings can be modified for each followed category in <a href="{url,html}">Manage Followed Categories</a>.'] = 'Параметри сповіщень за замовчуванням можна змінити для кожної категорії, за якою ви стежите, у розділі <a href="{url,html}">«Керувати категоріями, за якими ви стежите»</a> .';
...
$Definition['The email digest delivers the week\'s top content from the categories you follow into your email inbox once per week. <a href="{url,html}">Manage Followed Categories</a>.'] = 'Дайджест електронної пошти раз на тиждень доставляє найкращий вміст тижня з категорій, на які ви підписалися, у вашу скриньку вхідних повідомлень. <a href="{url,html}">Керуйте категоріями, за якими сте підписані</a> .';
