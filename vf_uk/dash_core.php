...
$Definition['Enable Rich Quotes'] = 'Увімкнути лапки для форматованого тексту';
$Definition['RichEditor.QuoteEnable.Notes'] = 'Використайте цю опцію, щоб увімкнути лапки для редактора форматованого тексту. Опція застосовуватиметься, лише якщо типовим модулем форматування є "Rich".';
