...
$Definition['Which reactions you use really depends on your community.'] = 'Які реакції ви використовуєте насправді, залежить від вашої спільноти, але ми радимо пам’ятати кілька пунктів.';
