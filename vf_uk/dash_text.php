...
$Definition['This setting loads the page before executing Javascript.'] = 'Цей параметр завантажує сторінку перед виконанням Javascript, що може покращити вашу SEO. <br> <strong>** Попередження: Увімкнення цієї функції може спричинити помилки Javascript на вашому сайті **.</strong>';
