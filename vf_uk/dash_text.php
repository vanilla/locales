...
$Definition['Allow links to be transformed'] =
    'Дозволити перетворення посилань на вбудовані уявлення в дискусіях та коментарях. Наприклад, посилання на YouTube перетвориться на вбудоване відео.';
...
$Definition['Recommend special ranks for admins and mods.'] = 'Хороша ідея мати спеціальні звання для модераторів та адміністраторів, щоб ваша громада змогла легко бачити, хто відповідає.';
$Definition['Recommend starting with five ranks.'] = 'Ви не хочете мати занадто багато рангів. Ми рекомендуємо починати з п’яти. Ви можете додати більше, якщо ваша спільнота дійсно велика.';
...
$Definition['This page lists the endpoints of your API.'] = 'На цій сторінці перелічені кінцеві точки вашого API. Клацніть кінцеві точки для отримання додаткової інформації. Ви можете здійснювати прямі дзвінки в API з цієї сторінки або зовні, використовуючи маркер доступу.';
$Definition['This role is personal info. Only users with permission to view personal info will see it.'] = 'Ця роль є особистою інформацією. Бачитимуть його лише користувачі, які мають дозвіл на перегляд особистої інформації.';
$Definition['This setting loads the page before executing Javascript.'] = 'Це налаштування завантажує сторінку до запуску Javascript, що може оптимізувати ваш SEO.<br><strong>**Увага: Увімкнення цієї функції може спричинити помилки в роботі Javascript на вашому сайті.**</strong>';
