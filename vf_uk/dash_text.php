...
$Definition['Allow links to be transformed'] = 'Дозволити перетворення посилань на вбудовані представлення в публікаціях і коментарях. Наприклад, посилання на YouTube перетвориться на вбудоване відео.';
...
$Definition['ShareImageDescription'] = 'Коли хтось ділиться посиланням з вашого сайту, ми намагаємося захопити зображення зі сторінки. Якщо на сторінці немає зображення, тоді ми використаємо це зображення. Зображення має бути не менше 50 × 50, але ми рекомендуємо 200 × 200.';
...
$Definition['Tagging allows users to add a tag to discussions they start in order to make them more discoverable. '] = 'Використання тегів дозволяє користувачам додавати їх до обговорень, які вони розпочинають, для того аби ці обговорення легше було знайти.';
...
$Definition['The database user you specified does not have permission to access the database. Have you created the database yet? The database reported: <code>%s</code>'] = 'Вказаний вами користувач бази даних не має дозволу на доступ до бази даних. Чи ви вже створили базу даних? База даних повідомила: <code>%s</code>';
...
$Definition['They work just like regular themes. Once one has been added to the themes folder, you can enable it here.'] = 'Вони працюють як звичайні теми. Після додавання в папку тем ви можете ввімкнути його тут.';
...
$Definition['TouchIconDescription'] = 'Піктограма дотику з’являється під час розмітки закладок на веб-сайті на початковому екрані пристрою Apple. Зазвичай це 152 пікселя. Apple додає закруглені кути та ефект освітлення автоматично.';
