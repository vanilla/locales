...
$Definition['Allow links to be transformed'] = 'Дозволити перетворення посилань на вбудовані уявлення в дискусіях та коментарях. Наприклад, посилання на YouTube перетвориться на вбудоване відео.';
$Definition['Allow users with the %s permission to change their own avatars from their profile pages in Vanilla.'] = 'Дозволити користувачам з дозволом %s змінювати власні аватари зі своїх сторінок профілю у Ванілі.';
...
$Definition['Some themes may need to be updated to work with category following. You can disable the feature while you update your theme.'] = 'Для роботи з наступною категорією, можливо, потрібно буде оновити деякі теми. Ви можете відключити цю функцію під час оновлення теми.';
...
$Definition['Special restriction: Only users with permission Garden.Curation.Manage may use this reaction.'] = 'Спеціальне обмеження: Тільки користувачі з дозволом Garden.Curation.Manage можуть використовувати цю реакцію.';
