...
$Definition['Allow links to be transformed'] = 'Позволете връзките да се трансформират в вградени представи в дискусии и коментари. Например, връзка в YouTube ще се трансформира във вградено видео.';
$Definition['Allow users with the %s permission to change their own avatars from their profile pages in Vanilla.'] = 'Позволете на потребителите с разрешението %s да променят собствените си аватари от страниците си с профили във Ванила.';
...
$Definition['Some themes may need to be updated to work with category following. You can disable the feature while you update your theme.'] = 'Може да се наложи някои теми да се актуализират, за да работят със следните категории. Можете да деактивирате функцията, докато актуализирате темата си.';
...
$Definition['Special restriction: Only users with permission Garden.Curation.Manage may use this reaction.'] = 'Специално ограничение: Само потребители с разрешение Garden.Curation.Manage могат да използват тази реакция.';
