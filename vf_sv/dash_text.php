...
$Definition['Recommend special ranks for admins and mods.'] = 'Det är en god idé att ha särskilda rangordningar för moderatorer och administratörer så att ditt community enkelt kan se vem som är ansvarig.';
$Definition['Recommend starting with five ranks.'] = 'Du vill inte ha för många rangordningar. Vi rekommenderar att börja med fem. Du kan lägga till fler om ditt community är riktigt stort.';
...
$Definition['This setting loads the page before executing Javascript.'] = 'Denna inställning innebär att sidan laddas före Javascript, vilket kan ge bättre sökmotoroptimering.<br><strong>**Varning: Detta kan leda till fel med Javascript på din sajt.**</strong>';
