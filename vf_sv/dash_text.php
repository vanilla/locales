...
$Definition['RichEditor.QuoteEnable.Notes'] =
    'Använd följande alternativ för att aktivera citat för Rich Editor. Detta gäller endast om standardformateraren är "Rich".';
...
$Definition['This setting loads the page before executing Javascript.'] =
    'Den här inställningen laddar sidan innan Javascript körs vilket kan förbättra din SEO.<br><strong>**Varning: Att aktivera den här funktionen kan orsaka Javascript-fel på din webbplats.**</strong>';
