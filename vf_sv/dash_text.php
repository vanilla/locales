...
$Definition['RichEditor.QuoteEnable.Notes'] = 'Använd följande alternativ för att aktivera citat för Rich Editor. Detta gäller endast om standardformateraren är "Rich".';
...
$Definition['ShareImageDescription'] = 'När någon delar en länk från din webbplats försöker vi ta en bild från sidan. Om det inte finns en bild på sidan använder vi denna bild istället. Bilden ska vara minst 50×50 men vi rekommenderar 200×200.';
...
$Definition['Tagging allows users to add a tag to discussions they start in order to make them more discoverable. '] = 'Taggning låter användare lägga till en tagg i diskussioner de startar för att göra dem lättare att upptäcka.';
...
$Definition['This setting loads the page before executing Javascript.'] = 'Den här inställningen laddar sidan innan Javascript körs vilket kan förbättra din SEO.<br><strong>**Varning: Att aktivera den här funktionen kan orsaka Javascript-fel på din webbplats.**</strong>';
...
$Definition['Which reactions you use really depends on your community.'] = 'Vilka reaktioner du använder beror på ditt community, men vi rekommenderar att ha ett par saker i åtanke.';
