...
// Federated Search
$Definition["About Federated Search"] = "Informazioni sulla ricerca federata";
$Definition["About Search Connectors"] = "Informazioni sui connettori di ricerca";
$Definition["Add"] = "Aggiungi";
$Definition["Add a custom <0/> search connector"] = "Aggiungi un connettore di ricerca <0/> personalizzato";
$Definition["Answer"] = "Risposta";
$Definition["Apply"] = "Applica";
$Definition["Article"] = "Articolo";
$Definition["Authenticate"] = "Autenticare";
$Definition["Back"] = "Indietro";
$Definition["Cancel"] = "Annulla";
$Definition["Categories"] = "Categorie";
$Definition["Client ID is required."] = "È obbligatorio l'ID client.";
$Definition["Client Secret is required."] = "Il Client Secret è obbligatorio.";
$Definition["Configure"] = "Configurare";
$Definition["Cursor pagination uses a url to point to the next page of results. Offset pagination uses a page number and item count to fetch the next page."] = "La paginazione con cursore utilizza un URL per puntare alla pagina successiva dei risultati. La paginazione offset utilizza un numero di pagina e un conteggio degli elementi per recuperare la pagina successiva.";
$Definition["Discussions"] = "Discussioni";
$Definition["Federated Search allows you to include external content within community search results such as knowledge base articles, courses from a learning management system, blog articles and more, to centralize content search within community. <0>Learn more</0>."] = "La ricerca federata consente di includere contenuti esterni nei risultati di ricerca della community, come articoli della knowledge base, corsi di un sistema di gestione dell'apprendimento, articoli di blog e altro ancora, per centralizzare la ricerca di contenuti all'interno della community. <0>Per maggiori informazioni</0>.";
$Definition["Good job! Here is a preview of some of your external articles, listed on your community's Search Results page."] = "Ottimo lavoro! Ecco un'anteprima di alcuni dei tuoi articoli esterni, elencati nella pagina dei risultati di ricerca della tua community.";
$Definition["Great!"] = "Ottimo!";
$Definition["Groups"] = "Gruppi";
$Definition["Help Menu"] = "Menù Aiuto";
$Definition["Here is what a single result provided by the API looks like:"] = "Ecco come appare un singolo risultato fornito dall'API:";
$Definition["Idea"] = "Idea";
$Definition["Ideas"] = "Idee";
$Definition["Integrates Salesforce's knowledge base articles into the Vanilla community search, consolidating self-service support resources within the community platform."] = "Integra gli articoli della knowledge base di Salesforce nella ricerca della community Vanilla, consolidando le risorse di supporto self-service all'interno della piattaforma della community.";
$Definition["Knowledge Bases"] = "Conoscenze di Base";
$Definition["Label is required."] = "L'etichetta è obbligatoria.";
$Definition["Loading"] = "Caricamento";
$Definition["Maximum length is 100 characters."] = "La lunghezza massima è di 100 caratteri.";
$Definition["Maximum length is 500 characters."] = "La lunghezza massima è di 500 caratteri.";
$Definition["Maximum number of posts to be included in the email digest."] = "Numero massimo di post da includere nel digest email.";
$Definition["Messages"] = "Messaggi";
$Definition["Modify <0/> search connector"] = "Modifica il connettore di ricerca <0/>";
...
$Definition["Number of posts from groups"] = "Numero di post dai gruppi";
$Definition["Our Search Connectors will allow you to easily configure the connection between Vanilla and external platforms. Can't find what you're looking for? Let us know which search connectors you need by posting and Idea in our <0>customer community</0>."] = "I nostri connettori di ricerca ti permetteranno di configurare facilmente la connessione tra Vanilla e piattaforme esterne. Non trovi quello che cerchi? Facci sapere quali connettori di ricerca ti servono pubblicando un'idea nella nostra <0>community clienti</0>.";
$Definition["Please enter some basic information about your custom search connector."] = "Inserisci alcune informazioni di base sul tuo connettore di ricerca personalizzato.";
...
$Definition["Response Body"] = "Corpo di risposta";
$Definition["Response Headers"] = "Intestazioni di risposta";
$Definition["Salesforce Article Search"] = "Ricerca articoli Salesforce";
$Definition["Save"] = "Salva";
$Definition["Search Connectors"] = "Connettori di ricerca";
$Definition["Site domain is required."] = "È obbligatorio il dominio del sito.";
$Definition["Some parameters required to search may be unique to your API. Please configure your search connector with these parameters so that the connector can correctly format search queries for your community."] = "Alcuni parametri richiesti per la ricerca potrebbero essere specifici della tua API. Configura il connettore di ricerca con questi parametri in modo che possa formattare correttamente le query di ricerca per la tua community.";
$Definition["Surfaces Zendesk Help Center knowledge base articles in Vanilla community search to centralize self-service help within community."] = "Espone gli articoli della knowledge base del Centro assistenza Zendesk nella ricerca della community Vanilla per centralizzare l'assistenza self-service all'interno della community.";
$Definition["Tag"] = "Etichetta";
$Definition["Test Custom API"] = "Prova l'API personalizzata";
$Definition["Test your custom API"] = "Prova la tua API personalizzata";
$Definition["Test your pagination configuration"] = "Prova la configurazione della tua paginazione";
$Definition["The roles that are allowed to access this connector."] = "I ruoli a cui è consentito accedere a questo connettore.";
$Definition["This search connector has an invalid configuration."] = "Questo connettore di ricerca ha una configurazione non valida.";
$Definition["Tip: These required parameters can usually be found in the documentation for your API"] = "Suggerimento: questi parametri obbligatori possono solitamente essere trovati nella documentazione della tua API";
$Definition["To finish configuring the Search Connector, tell us where to find the following values within the result object."] = "Per completare la configurazione del connettore di ricerca, indicaci dove trovare i seguenti valori all'interno dell'oggetto risultato.";
$Definition["Visit Site"] = "Visita Sito";
$Definition["What kind of pagination does your API use?"] = "Che tipo di impaginazione utilizza la tua API?";
$Definition["When you're ready, use these buttons to check that your pagination configuration functions as expected"] = "Quando sei pronto, usa questi pulsanti per verificare che la configurazione della paginazione funzioni come previsto";
$Definition["When you're ready, use this button to test the API and view its results."] = "Quando sei pronto, usa questo pulsante per provare l'API e visualizzarne i risultati.";
$Definition["Where is the list of results located in this response?"] = "Dove si trova l'elenco dei risultati in questa risposta?";
$Definition["You must configure this search connector to enable it."] = "Per abilitarlo, è necessario configurare questo connettore di ricerca.";
$Definition["You must select at least one role."] = "Devi selezionare almeno un ruolo.";
$Definition["Zendesk Guide"] = "Guida Zendesk";
