...
$Definition['RichEditor.QuoteEnable.Notes'] = '使用以下选项为 Rich Editor 启用引号。仅当默认格式设置为“Rich”时才适用。';
...
$Definition['This role is personal info. Only users with permission to view personal info will see it.'] = '此角色为个人信息。仅具有查看个人信息权限的用户才能看到它。';
$Definition['This setting loads the page before executing Javascript.'] = '此设置在执行 Javascript 之前加载页面，这可以改善您的搜索引擎优化 (SEO)。<br><strong>**警告：启用此功能可能会导致您的网站出现 Javascript 错误。**</strong>';
...
$Definition['Which reactions you use really depends on your community.'] = '您使用何种反应确实取决于您的社区，但我们建议您牢记几点。';
