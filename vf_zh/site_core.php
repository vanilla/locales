...
$Definition['%s discussion html'] = '%s 场讨论';
$Definition['%s discussions'] = '%s 个话题';
$Definition['%s discussions html'] = '%s 场讨论';
...
$Definition['All members'] = '所有成员';
$Definition['Allow'] = '允许';
$Definition['Allow other members to see your email?'] = '允许其他用户看到您的电子邮件地址？';
$Definition['All Time Leaders'] = '所有管理员';
$Definition['Already Offered'] = '已经提供';
$Definition['Already Warned'] = '已经警告';
$Definition['Also banned for the following:'] = '做了这些事情也会被ban:';
...
$Definition['Confirm My Email Address'] = '确认我的电子邮件地址';
$Definition['Confirm Password'] = '确认密码';
$Definition['Confirm Your Email Address'] = '确认您的电子邮件地址';
...
$Definition['editor.HtmlHelpText'] = '您可以在您的签名中使用 <b><a href="http://htmlguide.drgrog.com/cheatsheet.php" target="_new">Simple HTML</a></b>。';
...
$Definition['Have a great day!'] = '祝您有美好的一天！';
$Definition['he'] = '他';
...
$Definition['HeadlineFormat.ConversationMessage'] = '{ActivityUserID,User}给你发送了一条 <a href="{Url,html}">消息</a>';
...
$Definition['Learn more about %s'] = '多学习大约 ％s';
...
$Definition['Progress on an idea you voted on!'] = '促进一个你表决了的想法！';
...
$Definition['The user isn\'t banned.'] = '该用户没有被ban或因为未知事件被ban。';
$Definition['they'] = '他们';
...
$Definition['This user is also banned for other reasons and may stay banned.'] = '这个人因为一些原因将一直被关小黑屋。';
...
$Definition['ValidateRequired'] = '%s 必填。';
...
$Definition['You can either ask a question or start a discussion.'] = '您可以询问一个问题或发起讨论。在下方选择您要做什么。';
...
$Definition['You need to confirm your email address before you can continue.'] = '您需要先确认您的电子邮件地址，才能继续。';
