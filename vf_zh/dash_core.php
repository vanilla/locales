...
$Definition['Number of days before a follow up email is automatically sent.'] = '自动发送跟进电子邮件的天数。';
...
$Definition['The default banner image across the site. This can be overriden on a per category basis.'] = '网站上默认的横幅图片。可基于每个类别进行覆盖。';
