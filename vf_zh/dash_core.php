...
$Definition['1 Column - Default'] = '1 列 - 默认值';
$Definition['1 Column - Full Width'] = '单列 - 全宽';
$Definition['1 day'] = '1天';
...
$Definition['2 Columns - Default'] = '2 列 - 默认值';
$Definition['2 Columns - Even'] = '2 列 - 偶数';
$Definition['2 weeks after being sent'] = '2周之内';
$Definition['3 Columns - Default'] = '3 列 - 默认值';
$Definition['3 Columns - Even'] = '3列 - 均匀';
...
$Definition['A banner to create a visually distinct area to place header information and begin a search.'] = '横幅用于创建视觉上独立的区域，用于放置标题信息和开始搜索。';
...
$Definition['Admin Options'] = '管理员选项';
...
$Definition['After'] = '之后';
$Definition['A fully customizable fragment to add custom elements and data to your community.'] = '一个完全可定制的片段，可向您的社区添加自定义元素和数据。';
$Definition['A hero banner widget designed to create visually striking headers for your community pages.'] = '一款旨在为您的社区页面创建引人注目的视觉标题的横幅小部件。';
...
$Definition['A list of statistics about the community and its members.'] = '一份关于社区及其成员的统计数据列表。';
$Definition['Alive'] = '正常';
...
$Definition['Article Content'] = '文章内容';
$Definition['Article Count'] = '文章数';
$Definition['Article Header'] = '文章标题';
$Definition['Article Language Picker'] = '文章语言选择器';
$Definition['Article Reactions'] = '文章反响';
$Definition['Articles'] = '文章';
$Definition['Article Table of Contents'] = '文章目录';
$Definition['A single announcement item used to highlight specific posts to members.'] = '用于向成员突出显示特定帖子的单个公告项。';
$Definition['A single category item in a list.'] = '列表中的单个类别项。';
$Definition['A single comment item in a list.'] = '列表中的单个评论项。';
$Definition['A single post item in a list.'] = '列表中的单个帖子条目。';
$Definition['Assets'] = '资产';
...
$Definition['Call To Action'] = '行动号召';
$Definition['Call to Action'] = '行动号召';
...
$Definition['Category Articles'] = '类别文章';
...
$Definition['Category Subcategory List'] = '类别子类别列表';
...
$Definition['Comment Editor'] = '评论编辑器';
...
$Definition['Content Banner'] = '内容横幅';
...
$Definition['Create Post Form'] = '创建帖子表单';
...
$Definition['Custom HTML'] = '自定义 HTML';
$Definition['Custom Icon'] = '自定义图标';
$Definition['Customize AI Persona'] = '自定义 AI 角色';
$Definition['Customize the appearance and content of Call to Action widgets with fragment-specific styling and layout options.'] = '使用片段特定的样式和布局选项，自定义“行动号召”小部件的外观和内容。';
$Definition['Customize the appearance of Rich Text widgets with fragment-specific styling.'] = '使用片段特定的样式自定义富文本小部件的外观。';
$Definition['Customize the search bar widget so that users can search the community.'] = '自定义搜索栏小部件，以便用户可以搜索社区。';
...
$Definition['Display a list of categories and optionally nested child categories.'] = '显示类别列表，并可选择性地显示嵌套子类别。';
$Definition['Display a list of statistics about the community and its members.'] = '显示有关社区及其成员的统计信息列表。';
$Definition['Display a search bar to search the entire community or specific parts of it.'] = '显示搜索栏，以便搜索整个社区或其特定部分。';
$Definition['Display a searchbox on top of the banner image.'] = '在横幅图像上方显示一个搜索框。';
$Definition['Display attention grabbing images, text and links to encourage specific actions.'] = '展示引人注目的图片、文字和链接，以鼓励采取特定行动。';
...
$Definition['Display rich text content with full formatting support.'] = '显示具有完整格式支持的富文本内容。';
...
$Definition['Featured Collections'] = '精选系列';
$Definition['Featured Image'] = '特色图片';
$Definition['Featured Links'] = '特色链接';
...
$Definition['Help Center Article List'] = '帮助中心文章列表';
$Definition['Help Center Article Pages'] = '帮助中心文章页面';
$Definition['Help Center Category Pages'] = '帮助中心分类页面';
$Definition['Help Center Home'] = '帮助中心首页';
$Definition['Help Center Home Pages'] = '帮助中心主页';
$Definition['Help Center Overview'] = '帮助中心概览';
$Definition['Help Center Overview Asset'] = '帮助中心概览资产';
...
$Definition['How a comment is displayed in a list of comments on a post or idea.'] = '评论在帖子或想法的评论列表中如何显示。';
$Definition['How an answer is displayed in a list of answers on a question.'] = '问题答案列表中答案的显示方式。';
...
$Definition['Knowledge Bases List'] = '知识库列表';
$Definition['Knowledge Bases List Asset'] = '知识库列表资产';
...
$Definition['LeaderBoard (Grid)'] = '排行榜（网格）';
$Definition['LeaderBoard (List)'] = '排行榜（列表）';
$Definition['Learn more'] = '了解更多';
$Definition['Learn more.'] = '了解更多。';
$Definition['Learn more about HSTS at %s.'] = '通过 %s 了解更多关于 HSTS 的信息。';
$Definition['Leave any field blank to use your default email styles as configured on the <0>Email Settings</0> page.'] = '如果将任何字段留空，则使用您在“电子邮件设置”中配置的默认<0>电子邮件样式</0>页。';
...
$Definition['List - Announcements'] = '列表 - 公告';
$Definition['List - Articles'] = '列表 - 文章';
$Definition['List - Discussions'] = '列表 - 讨论';
$Definition['List - Events'] = '列表 - 活动';
$Definition['List - Ideas'] = '清单 - 想法';
$Definition['List - Questions'] = '问题列表';
...
$Definition['New comments by users I\'m following'] = '我关注的用户发表了新评论';
...
$Definition['New discussions by users I\'m following'] = '我关注的用户们的新讨论';
...
$Definition['New events by users I\'m following'] = '我关注的用户发布的新活动';
...
$Definition['New Post Button'] = '新帖子按钮';
...
$Definition['No users followed'] = '没有用户关注';
...
$Definition['Post List'] = '帖子列表';
$Definition['Post Management'] = '帖子管理';
$Definition['Post Meta'] = '帖子元数据';
...
$Definition['Search Widget'] = '搜索小部件';
...
$Definition['Suggested Answers'] = '建议答案';
...
$Definition['Tabbed Posts'] = '标签页';
$Definition['Table Layout'] = '如果您想降低报警级别，请尝试解决报警的问题。';
$Definition['Tabs Widget'] = '标签页小部件';
$Definition['Tag Cloud'] = '标签云';
...
$Definition['The display of a post within the tabbed lists of posts.'] = '在标签页式的帖子列表中显示帖子。';
$Definition['The display of a questions in a list of posts.'] = '在帖子列表中显示问题。';
$Definition['The display of single post within a list of posts.'] = '在帖子列表中显示单个帖子。';
...
$Definition['The original post of which begins a discussion, question or idea.'] = '原帖引发讨论、提出问题或表达想法。';
...
$Definition['The title bar of the community which contains the logo, navigation, search and user menu.'] = '社区的标题栏，其中包含徽标、导航、搜索和用户菜单。';
...
$Definition['The way a single category or nested child categories are displayed.'] = '单个类别或嵌套子类别的显示方式。';
...
$Definition['Tiered Tab Widget'] = '分层标签页小部件';
$Definition['Time'] = '时间';
...
$Definition['Unfollow user'] = '取消关注用户';
...
$Definition['Used to display idea type discussions.'] = '用于展示想法类型的讨论。';
...
$Definition['User Spotlight'] = '用户聚焦';
...
$Definition['View all followed users'] = '查看所有关注用户';
...
$Definition['You are receiving this email because you are following this user.'] = '您收到此邮件是因为您关注了此用户。';
...
$Definition['{ActivityUserID,user} started a new event: <a href="{Url,html}">{Data.Name,text}</a>'] = '{ActivityUserID,user} 发起了一个新事件： <a href="{Url,html}">{Data.Name,text}</a>';
$Definition['{ActivityUserID,You} accepted {NotifyUserID,your} answer to a question: <a href="{Url,html}">{Data.Name,text}</a>'] = '您接受了 {ActivityUserID,You} 对问题<a href="{Url,html}">{Data.Name,text}</a>的 {NotifyUserID,your} 回答。';
