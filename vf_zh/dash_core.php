...
// Federated Search
$Definition["About Federated Search"] = "关于联合搜索";
$Definition["About Search Connectors"] = "关于搜索连接器";
$Definition["Add"] = "添加";
$Definition["Add a custom <0/> search connector"] = "添加自定义 <0/> 搜索连接器";
$Definition["Answer"] = "答案";
$Definition["Apply"] = "启用";
$Definition["Article"] = "文章";
$Definition["Authenticate"] = "认证";
$Definition["Back"] = "返回";
$Definition["Cancel"] = "取消";
$Definition["Categories"] = "版块列表";
$Definition["Client ID is required."] = "需要客户端 ID。";
$Definition["Client Secret is required."] = "需要客户端密钥。";
$Definition["Configure"] = "配置";
$Definition["Cursor pagination uses a url to point to the next page of results. Offset pagination uses a page number and item count to fetch the next page."] = "游标分页使用 URL 指向下一页结果。偏移分页使用页码和项目计数来获取下一页。";
$Definition["Discussions"] = "所有话题";
$Definition["Federated Search allows you to include external content within community search results such as knowledge base articles, courses from a learning management system, blog articles and more, to centralize content search within community. <0>Learn more</0>."] = "联合搜索允许您在社区搜索结果中包含外部内容，例如知识库文章、学习管理系统中的课程、博客文章等，从而集中进行社区内的内容搜索。<0>了解更多</0>。";
$Definition["Good job! Here is a preview of some of your external articles, listed on your community's Search Results page."] = "干得好！以下是您社区搜索结果页面上列出的部分外部文章的预览。";
$Definition["Great!"] = "伟大的！";
$Definition["Groups"] = "群";
$Definition["Help Menu"] = "帮助菜单";
$Definition["Here is what a single result provided by the API looks like:"] = "API 提供的单个结果如下所示：";
$Definition["Idea"] = "想法";
$Definition["Ideas"] = "想法";
$Definition["Integrates Salesforce's knowledge base articles into the Vanilla community search, consolidating self-service support resources within the community platform."] = "将 Salesforce 的知识库文章集成到 Vanilla 社区搜索中，整合社区平台内的自助支持资源。";
$Definition["Knowledge Bases"] = "知识库";
$Definition["Label is required."] = "需要标签。";
$Definition["Loading"] = "加载";
$Definition["Maximum length is 100 characters."] = "最大长度为 100 个字符。";
$Definition["Maximum length is 500 characters."] = "最大长度为 500 个字符。";
$Definition["Maximum number of posts to be included in the email digest."] = "电子邮件摘要中包含的最大帖子数。";
$Definition["Messages"] = "消息";
$Definition["Modify <0/> search connector"] = "修改<0/>搜索连接器";
$Definition["My Account"] = "我的帐户";
$Definition["Next"] = "下一页";
$Definition["No results found."] = "未找到结果。";
$Definition["Notifications"] = "通知";
$Definition["Number of posts from groups"] = "来自群组的帖子数";
$Definition["Our Search Connectors will allow you to easily configure the connection between Vanilla and external platforms. Can't find what you're looking for? Let us know which search connectors you need by posting and Idea in our <0>customer community</0>."] = "我们的搜索连接器可让您轻松配置 Vanilla 与外部平台之间的连接。找不到您想要的内容？请在我们的<0>客户社区中发</0>布您的想法，告诉我们您需要哪些搜索连接器。";
$Definition["Please enter some basic information about your custom search connector."] = "请输入有关您的自定义搜索连接器的一些基本信息。";
$Definition["Poll"] = "投票";
$Definition["Polls"] = "投票";
...
$Definition["Response Body"] = "响应主体";
$Definition["Response Headers"] = "响应标头";
$Definition["Salesforce Article Search"] = "Salesforce 文章搜索";
$Definition["Save"] = "保存";
$Definition["Search Connectors"] = "搜索连接器";
$Definition["Site domain is required."] = "需要站点域名。";
$Definition["Some parameters required to search may be unique to your API. Please configure your search connector with these parameters so that the connector can correctly format search queries for your community."] = "某些搜索所需的参数可能对您的 API 来说是唯一的。请使用这些参数配置您的搜索连接器，以便该连接器能够为您的社区正确格式化搜索查询。";
$Definition["Surfaces Zendesk Help Center knowledge base articles in Vanilla community search to centralize self-service help within community."] = "在 Vanilla 社区搜索中显示 Zendesk 帮助中心知识库文章，以集中社区内的自助服务帮助。";
$Definition["Tag"] = "标签";
$Definition["Test Custom API"] = "测试自定义 API";
$Definition["Test your custom API"] = "测试您的自定义 API";
$Definition["Test your pagination configuration"] = "测试你的分页配置";
$Definition["The roles that are allowed to access this connector."] = "允许访问此连接器的角色。";
$Definition["This search connector has an invalid configuration."] = "此搜索连接器的配置无效。";
$Definition["Tip: These required parameters can usually be found in the documentation for your API"] = "提示：这些必需参数通常可以在 API 文档中找到";
$Definition["To finish configuring the Search Connector, tell us where to find the following values within the result object."] = "要完成搜索连接器的配置，请告诉我们在结果对象中哪里可以找到以下值。";
$Definition["Visit Site"] = "访问网站";
$Definition["What kind of pagination does your API use?"] = "您的 API 使用哪种分页？";
$Definition["When you're ready, use these buttons to check that your pagination configuration functions as expected"] = "准备就绪后，使用这些按钮检查分页配置是否按预期运行";
$Definition["When you're ready, use this button to test the API and view its results."] = "准备就绪后，使用此按钮测试 API 并查看其结果。";
$Definition["Where is the list of results located in this response?"] = "此回复中的结果列表位于何处？";
$Definition["You must configure this search connector to enable it."] = "您必须配置此搜索连接器才能启用它。";
$Definition["You must select at least one role."] = "您必须至少选择一个角色。";
