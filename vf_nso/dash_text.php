...
$Definition['Recommend special ranks for admins and mods.'] = 'Ke kgopolo ye botse go ba le maemo a kgethegilego a batsamaisi le balaodi gore setšhaba sa geno se kgone go bona gabonolo gore ke mang yo a ikarabelago.';
$Definition['Recommend starting with five ranks.'] = 'Ga o nyake go ba le maemo a mantši kudu. Re kgothaletša go thoma ka tše hlano. O ka oketša tše dingwe ge e ba setšhaba sa geno se tloga se le se segolo.';
...
$Definition['This page lists the endpoints of your API.'] = 'Letlakala le le lokeletša dintlha tša mafelelo tša API ya gago. Klika dintlha tša mafelelo go hwetša tshedimošo ye ntši. O ka dira megala ye e phelago go API go tšwa letlakaleng le goba ka ntle o šomiša leswao la phihlelelo.';
$Definition['This role is personal info. Only users with permission to view personal info will see it.'] = 'Karolo ye ke info ya motho ka noši. Ke feela badiriši bao ba nago le tumelelo ya go lebelela tshedimošo ya motho ka noši bao ba tlago go e bona.';
