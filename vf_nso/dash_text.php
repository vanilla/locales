...
$Definition['Allow links to be transformed'] = 'Dumelela dikgokagano go fetošwa go ba dikemedi tše di tsentšwego ka gare ga diposo le ditshwayotshwayo. Ka mohlala, kgokagano ya YouTube e tla fetoga go ba bidio yeo e tsentšwego.';
...
$Definition['ShareImageDescription'] = 'Ge motho a abelana kgokagano go tšwa saeteng ya gago re leka go tšea seswantšho go tšwa letlakaleng. Ge go se na seswantšho letlakaleng gona re tla šomiša seswantšho se go e na le moo. Setšoantšo se lokela ho ba bonyane 50 × 50, empa re khothalletsa 200 × 200.';
...
$Definition['Tagging allows users to add a tag to discussions they start in order to make them more discoverable. '] = 'Go swaya go dumelela badiriši go oketša leswao dipoledišanong tšeo ba di thomago e le gore di kgone go utollwa kudu.';
...
$Definition['They work just like regular themes. Once one has been added to the themes folder, you can enable it here.'] = 'Di šoma go fo swana le dihlooho tša ka mehla. Ge e tee e šetše e okeditšwe go foltara ya dihlooho, o ka e kgontšha mo.';
...
$Definition['TouchIconDescription'] = 'Letshwao la go kgoma le tšwelela ge o swaya weposaete skrineng sa gae sa sedirišwa sa Apple. Tše gantši ke dipiksele tše 152. Apple eketsa dikhutlo tse potolohileng le phello ea mabone ka tsela e iketsang.';
