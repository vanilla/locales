...
$Definition['Choose a theme for this subcommunity. <0>Read more</0>'] = 'Kgetha sehlogo sa setšhaba se se senyenyane. <0>Bala ka botlalo</0>';
...
$Definition['Digest Settings'] = 'Dipeakanyo tša Digest';
...
$Definition['Enter the connection settings for your sphinx server below.'] = 'Ngwala dipeakanyo tša kgokagano bakeng sa sebara ya sefinikisi ka mo tlase.';
$Definition['Every edit or deletion is recorded here. Use &lsquo;Restore&rsquo; to undo any change.'] = 'Go ngwala go gongwe le go gongwe go ngwadilwe mo. Diriša &isquo;Bušetša&rsquo; go phumola phetogo efe goba efe.';
$Definition['Everyone who signs up gets a profile page.'] = 'Yo mongwe le yo mongwe yo a ngwadišago tikologong ya geno o hwetša letlakala la sephuthelwana sa setšhaba moo ba ka tsenyago seswantšho sa bona, ba laola dipeakanyo tša bona, le go lekola dilo tše dibotse tikologong. O swanetše <a href="{/profile,url}">tlwaelana le sephuthelwana sa gago gona bjale</a>.';
$Definition['Every user in your site is assigned to at least one role. Roles are used to determine what the users are allowed to do.'] = 'Modiriši yo mongwe le yo mongwe lefelong la gago o abetšwe bonyenyane tema e tee. Ditema di dirišetšwa go bona seo badiriši ba ka dumelelwago go se dira.';
...
$Definition['Failed to connect to the database with the username and password you entered. Did you mistype them? The database reported: <code>%s</code>'] = 'E paletšwe ke go kgokagana le tathapeisi le leina la modiriši le phasewete yeo o e tsentšego. Na o ngwadile e fošagetšego? Tathapeisi e begile: <code>%s</code>';
$Definition['Force the dashboard to only be accessible through this url <em>(not recommended)</em>'] = 'Gapeletša seo se lego pele gore se fihlelelwe ka url ye <em>(ga e kgothaletšwe)</em>';
...
$Definition['FullAnonymization.Description'] = "<strong>Full Anonymization</strong> e tšea sebaka sa aterese ye nngwe le ye nngwe ya IP ka 0.0.0.0 ka mo go atlegilego e gana tirišo phihlelelo efe goba efe ya go šoma ka diaterese tša IP. Melawana ya thibelo ya IP e ka se šome le gatee tabeng ye.";
...
$Definition['Invitations can be sent from users\' profile pages.'] = 'Ge o diriša boingwadišo ka tirišo ya taletšo e tla ba le linki yeo e bitšwago <a href="%s" class="Popup">Ditaletšo tša ka</a> matlakaleng a dikanegelo tša bona.';
$Definition['It appears as though the database you specified does not exist yet. Have you created it yet? Did you mistype the name? The database reported: <code>%s</code>'] = 'Go bonala eka tathapeisi yeo o e kgethilego ga se ya hlwa e eba gona. Na o šetše o e hlamile? Na o ngwadile leina le le fošagetšego? Tathapeisi e begile: <code>%s</code>';
...
$Definition['Managing Users'] = 'Go Laola Badiriši';
...
$Definition['Recommend special ranks for admins and mods.'] =
    'Ke kgopolo ye botse go ba le maemo a kgethegilego a batsamaisi le balaodi gore setšhaba sa geno se kgone go bona gabonolo gore ke mang yo a ikarabelago.';
$Definition['Recommend starting with five ranks.'] =
    'Ga o nyake go ba le maemo a mantši kudu. Re kgothaletša go thoma ka tše hlano. O ka oketša tše dingwe ge e ba setšhaba sa geno se tloga se le se segolo.';
$Definition['Recommended dimensions are about 400px by 300px or smaller with similar ratio.'] = 'Ditekanyo tše di kgothaletšwago di ka ba 400px ka 300px goba tše nnyane ka tekanyo ye e swanago.';
$Definition['Requires “Flag” reaction permission.'] = 'E nyaka tumelelo ya karabelo ya “Flag”.';
$Definition['Requires “Negative” reaction permission.'] = 'E nyaka tumelelo ya karabelo ya “Negative”.';
$Definition['Requires “Positive” reaction permission.'] = 'E nyaka tumelelo ya karabelo ya “Positive”.';
...
$Definition['Security.Hsts.HTTPSWarning'] = 'Temošo: Kgontšha tšobotsi ye fela ge o na le bonnete bja gore didomene tša gago ka moka tše nnyane di beakantšwe bakeng sa HTTPS ka disetifikeiti tše di šomago.';
$Definition['Security.Hsts.IncludeSubDomains'] = 'Ge e kgontšhitšwe, molao wo o šoma go di-subdomain ka moka tša sebaka sa gago le tšona.';
$Definition['Security.Hsts.MaxAgeRecommendation'] = 'Re kgothaletša go thoma ka mengwaga ya max ya beke ye 1 gomme ka morago o e oketše go fihla go kgwedi ye 1 ke moka ngwaga o tee ge o šetše o bona sebaka sa gago se šoma bjalo ka ge go be go letetšwe.';
$Definition['Security.Hsts.SubmitWarning'] = 'Temošo: Ke mo gobotse go thekga go laetša pele ga HSTS bjalo ka mokgwa wo mokaone. Le ge go le bjalo, o swanetše go romela sebaka sa gago go hstspreload.org go netefatša gore se tsentšwe pele ka katlego (ke gore go hwetša tšhireletšo ka botlalo ya peakanyo yeo e reretšwego).';
$Definition['Select the default type for this role, if any.'] = 'Kgetha mohuta wa go se fetoge wa tema ye, ge e le gona.';
...
$Definition['Session Timeout'] = 'Nako ya go Fela ya Sešene';
$Definition['ShareImageDescription'] =
    'Ge motho a abelana kgokagano go tšwa saeteng ya gago re leka go tšea seswantšho go tšwa letlakaleng. Ge go se na seswantšho letlakaleng gona re tla šomiša seswantšho se go e na le moo. Setšoantšo se lokela ho ba bonyane 50 × 50, empa re khothalletsa 200 × 200.';
...
$Definition['SignIn.LockoutTime'] = "Nako yeo modiriši a thibetšwego go tsena ka morago ga go feta palo ya maiteko a go tsena.";
$Definition['Some themes may need to be updated to work with category following. You can disable the feature while you update your theme.'] =
    'Dihlogo tše dingwe di ka swanelwa ke go mpshafatšwa gore di šome le go latela legoro. O ka šitiša tšobotsi ge o dutše o mpshafatša sehlogo sa gago.';
...
$Definition['Tagging allows users to add a tag to discussions they start in order to make them more discoverable. '] =
    'Go swaya go dumelela badiriši go oketša leswao dipoledišanong tšeo ba di thomago e le gore di kgone go utollwa kudu.';
...
$Definition['The database user you specified does not have permission to access the database. Have you created the database yet? The database reported: <code>%s</code>'] =
    'Modiriši wa tathapeisi yo o mo hlalositšego ga a na tumelelo ya go tsena go tathapeisi. Na o šetše o hlamilwe tathapeisi? Tathapeisi e begile: <code>%s</code>';
...
$Definition['Theme preview is limited to displaying the theme\'s template and css.'] = 'Tebelelopele ya sehlogo e lekanyeditšwe go bontšha thempleite ya sehlogo le css.';
...
$Definition['They work just like regular themes. Once one has been added to the themes folder, you can enable it here.'] =
    'Di šoma go fo swana le dihlooho tša ka mehla. Ge e tee e šetše e okeditšwe go foltara ya dihlooho, o ka e kgontšha mo.';
...
$Definition['This may be used to include content such as organization name and address in all outgoing emails.'] = 'Se se ka šomišwa go akaretša diteng tša go swana le leina la mokgatlo le aterese ka go di-imeile ka moka tše di tšwago.';
...
$Definition['This page lists the endpoints of your API.'] =
    'Letlakala le le lokeletša dintlha tša mafelelo tša API ya gago. Klika dintlha tša mafelelo go hwetša tshedimošo ye ntši. O ka dira megala ye e phelago go API go tšwa letlakaleng le goba ka ntle o šomiša leswao la phihlelelo.';
...
$Definition['This setting loads the page before executing Javascript.'] =
    'Peakanyo ye e tsenya letlakala pele o etšwa go Javascript e lego seo se ka kaonefatšago SEO.<br><strong>**Temošo: Go bulela karolo ye go ka mathata a Javascript go wena.**</strong>';
$Definition['Tiled Layout'] = 'Peakanyo ya Dithaele';
...
$Definition['TouchIconDescription'] =
    'Letshwao la go kgoma le tšwelela ge o swaya weposaete skrineng sa gae sa sedirišwa sa Apple. Tše gantši ke dipiksele tše 152. Apple eketsa dikhutlo tse potolohileng le phello ea mabone ka tsela e iketsang.';
...
$Definition['Use the button at the top of the page to create a ban rule.'] = 'Šomiša konope yeo e lego ka godimo ga letlakala go hlama molao wa thibelo.';
...
$Definition['Users may sign into your site using their Twitter account.'] = 'Badiriši ba ka tsena mo saeteng ya gago ba diriša akhaonto ya bona ya Twitter.';
$Definition['User Profile'] = 'Profaele ya Modiriši';
...
$Definition['Verify and restore'] = 'Netefatša le go bušetša';
$Definition['VerifyUser'] = 'Hlahloba lepokisi kgauswi le modiriši go ba swaya bjalo ka ba <b>Netefaditšwego</b> gore dipolelo tša bona di se ke tša swaiwa bjalo ka spam gape. Se se tla bušetša gape diposo tša bona ka moka tšeo di sa emetšego.';
...
$Definition['Warning: Loading tables can be slow.'] =
    '<b>Temošo</b> : Peakanyo ya gago ya seva ga e thekge go laetša datha ka lebelo. Ge o tsenya faele ye kgolo kudu (mohlala, ditshwayotshwayo tša go feta 200,000) o ka nyaka go nagana ka go fetoša peakanyo ya gago. Tobetsa <a href="http://vanillaforums.com/porter">mo</a> go hwetša tshedimošo ka botlalo.';
...
$Definition['We recommend mostly positive reactions to encourage participation.'] = 'Re kgothaletša bontši bja dikarabelo tše dibotse go hlohleletša go tšea karolo.';
...
$Definition['Which reactions you use really depends on your community.'] =
    'Ke dikarabelo dife tšeo o di dirišago di tloga di ithekgile ka setšhaba sa geno, eupša re kgothaletša go gopola dintlha tše mmalwa.';

$Definition['You can ban all users with an IP addresses prefixed with "111.111.111" by adding an IP-type ban with the value "111.111.111.*".'] = 'O ka thibela badiriši ka moka bao ba nago le diaterese tša IP tšeo di eteletšwego pele ka "111.111.111" ka go oketša thibelo ya mohuta wa IP ka boleng bja "111.111.111.*".';
$Definition['You can ban IP addresses, email addresses and usernames.'] = 'O ka thibela diaterese tša IP, diaterese tša imeile le maina a badiriši.';
$Definition['You can choose from one of the different styles this theme offers.'] = 'O ka kgetha go tšwa go ye nngwe ya mekgwa ye e fapanego yeo sehlogo se se e fago.';
...
$Definition['You can specify a minimum post length to discourage short posts.'] = 'O ka laetša bonnyane bja botelele bja poso go nola moko diposo tše kopana.';
...
$Definition["This title appears on your site's banner and in your browser's title bar. If a logo is uploaded, it will replace this title on user-facing forum pages. Also, keep in mind some themes may hide this title."] = "Thaetlele ye e tšwelela go banner ya sebaka sa gago le ka gare ga bara ya thaetlele ya sephephediši sa gago. Ge leswao le tsentšwe, le tla tšea legato la thaetlele ye matlakaleng a foramo ao a lebanego le modiriši. Le gona, gopola gore dihlooho tše dingwe di ka uta sehlogo se.";
...
// Theme Chooser
$Definition["Your mobile theme will be disabled."] = "Sehlogo sa gago sa sellathekeng se tla šitišwa. Go beakanya dihlooho tse fapaneng tsa selefouno le komporong, sebedisa UI ya kgale ya theming.";
...
$Definition["Some older themes don't support full editing capability."] = "Dihlogo tše dingwe tša kgale ga di thekge bokgoni bja go rulaganya ka botlalo. Go bona seo sehlogo se se thekgago o ka bea godimo ga leina la sona go bona moo diphetošo di tlago go šoma gona.";
$Definition["Need More Help?"] = "Na o Nyaka Thušo e Oketšegilego?";
$Definition["Theming Guide"] = "Tlhahlo ya Theming";
...
$Definition['Templates are the standard themes. To customize them, you have to create a copy.'] = 'Dithempleite ke dihlooho maemo a. Go di dira gore di be tša gago, o swanetše go hlama khopi.';
...
$Definition["Are you sure want to delete this theme? It will be permanently deleted."] = "Na o na le bonnete bja gore o nyaka go phumola sehlogo se? E tla phumolwa sa ruri.";

// Preview Page
$Definition["Welcome To Your Theme"] = "O Amogetšwe Go Sehlogo sa Gago";
$Definition["This is a style guide of your theme."] = "Ye ke tlhahlo ya setaele sa sehlogo sa gago. E na le mehlala ya dielemente tša go bonwa tšeo di šomišitšwego go ralala le tirišo. O ka klika godimo ga didirišwa tša go fapafapana tša go swana le <0>Bara ya Thaetlele</0> goba <1>Banner</1> go rulaganya dithoto tša bona ka gare ga phanele ya ka lehlakoreng.";
$Definition["In additon to the widgets there are also"] = "Ka additon go di-widget go na le gape le <0>Ditaele tša Lefase ka Bophara</0> . Go rulaganya ditaele tša lefase ka bophara klika kae goba kae mo letlakaleng, go swana le sengwalwa se.";
$Definition["There are two types of buttons in the application: primary and secondary."] = "Go na le mehuta ye mebedi ya dikonope ka tirišong: ya mathomo le ya bobedi.";
$Definition["Primary Button"] = "Konopo ya Mathomo";
$Definition["Secondary Button"] = "Konopo ya Bobedi";
$Definition["User inputs are based on the global background and text colors."] = "Ditseno tša modiriši di theilwe godimo ga mebala ya lefase ka bophara le ya sengwalwa.";
...
$Definition["Preset"] = "E beakantšwe pele";
...
$Definition["You can upload a Custom Font in your Theming System. Just copy & paste the URL in the field."] = "O ka tsenya Fonte ya Tlwaelo ka go Tshepedišo ya gago ya Sehlogo. E no kopiša & kgomaretša URL ka tšhemong.";
$Definition["You can configure some values differently for different screensizes."] = "O ka beakanya dikelo tše dingwe ka go fapana bakeng sa bogolo bja diskrini bjo bo fapanego.";
$Definition["You need to add the font url’s domain to <0>AllowedDomains</0>, in the site's configuration. <1>Learn more about custom fonts.</1>."] = "O swanetše go oketša domain ya url ya fonte go <0>Didomene tše di Dumeletšwego</0> ka peakanyo ya sebaka. <1>Ithute ka botlalo ka ga difonte tša tlwaelo.</1>";

$Definition["Primary Buttons"] = "Dikonope tša Mathomo";
$Definition["Secondary Buttons"] = "Dikonope tša Bobedi";

$Definition["Button Type"] = "Mohuta wa Konopo";
$Definition["Solid"] = "Tšhipi";
$Definition["Outline"] = "Akaretša";
$Definition["Transparent"] = "Pepeneneng";
...
$Definition["Shadowed"] = "E na le moriti";

$Definition["Full Bleed"] = "Go Tšwa Madi ka Botlalo";
$Definition["When you select Full Bleed, your background is transparent."] = "Ge o kgetha Full Bleed, bokamorago bja gago bo a bonagala.";
$Definition["Alignment"] = "Go logaganya";
...
$Definition["Alignment (Mobile)"] = "Go logaganya (Mobile) .";

// Vanilla Labs
$Definition['Vanilla Labs'] = 'Dilab tša Vanilla';
...
$Definition['This is where you can enable and test out new Vanilla features, pages & components.'] = 'Ke mo o ka kgontšhago le go leka dikarolo tše mpsha tša Vanilla, matlakala & dikarolo.';
$Definition['This lab cannot be disabled because a custom layout is applied.'] = 'Lab ye e ka se šitišwe ka gobane go dirišwa peakanyo ya tlwaelo.';
$Definition['This lab cannot be disabled because it is required by the current theme.'] = 'Lab ye e ka se šitišwe ka gobane e nyakega ke sehlogo sa bjale.';
...
$Definition['Check out our <0>documentation</0>, or ask our <1>community of experts</1>.'] = 'Lekola ditokomane tša rena tša <0></0> , goba botšiša setšhaba sa rena sa <1> sa ditsebi</1> .';
$Definition['Enable and test out the latest Vanilla features.'] = 'Kgontšha le go leka dikarolo tša moragorago tša Vanilla.';
$Definition['The <0/> lab needs to be configured to match your custom theme.'] = 'NB Lab ya <0/> e swanetše go beakanywa go swana le sehlogo sa gago sa tlwaelo. Se se ka dirwa ka go šomiša morulaganyi wa rena yo mofsa wa sehlogo. <1>Hwetša dintlha ka botlalo.</1>';
$Definition['Usercards'] = 'Dikarata tša badiriši';
$Definition["Usercards allow you to get a quick in-line snapshot of a user's information."] = "Dikarata tša badiriši di go dumelela go hwetša seswantšho sa ka pela sa ka gare ga mothaladi sa tshedimošo ya modiriši. Ge o lebelela dipolelo le dipolanka tša baetapele, kgotla leina la mosediriši go bona karata yeo e bontšhago tshedimošo ya motheo ya profaele ya badiriši ntle le go swanelwa ke go sepela kgole le letlakala. Kgontšha tšobotsi ye go oketša dikarata tša modiriši go sehlogo sa gago sa tlwaelo.";
$Definition['New Search Page'] = 'Letlakala le Lefsa la go Nyaka';
$Definition["Vanilla's new search service is finally here."] = "Tirelo e mpsha ya go nyaka ya Vanilla e feleleditše e fihlile. Kgontšha UI ya rena ye mpsha ya letlakala la nyakišišo go hwetša phihlelelo go dikarolo tše mpsha tša nyakišišo tša go swana le Patlo ya Maloko, go hlopha nyakišišo le go hlaola mareo.";
...
$Definition['The New Embed System'] = 'Tshepedišo e Mpsha ya Embed';
$Definition['The new embed system has improved performance.'] = 'Tshepedišo ye mpsha ya go tsenya e kaonafaditše tshepedišo, boitshwaro bjo bo kaonafetšego bja go kgokološa, le boitshwaro bjo bo sa fetogego go feta bja kgale. Ga bjale ditshwayotshwayo le di-embed tša wordpress ga di thekgwe ka go Tshepedišo ye Mpsha ya go Tsenya.';
$Definition['New Embed System'] = 'Tshepedišo e Mpsha ya Embed';
$Definition['See the documentation'] = 'Bona Ditokomane';
$Definition['Looking for the Old Embed System?'] = 'O nyaka Tshepedišo ya Kgale ya Embed?';
$Definition['Disable the "New Embed System" lab on the <0>Vanilla Labs Page</0>'] = 'Thibela lab ya "Tshepedišo ye Mpsha ya go Tsenya" go <0>Letlakala la Dilab tša Vanilla</0>';
$Definition["Sometimes you want to embed your Vanilla site"] = "Ka nako ye nngwe o nyaka go tsenya lefelo la gago la Vanilla ka gare ga lefelo le lengwe. Vanilla o embed tsamaiso e khopo fana ka tsela e bonolo ho seo. Go na le diphetogo tša tshepedišo ge o šomiša lefelo leo le tsentšwego, ka fao hlahloba ditokomane bakeng sa mekgwa ye mengwe le maemo a tšhomišo a mabotse.";
