...
$Definition['Allow links to be transformed'] = 'อนุญาตให้ลิงก์ถูกแปลงเป็นการนำเสนอแบบฝังในการกระทู้และแสดงความคิดเห็น ตัวอย่างเช่นลิงก์ YouTube จะแปลงเป็นวิดีโอที่ฝัง';
$Definition['Allow users with the %s permission to change their own avatars from their profile pages in Vanilla.'] = 'อนุญาตให้ผู้ใช้ที่มีสิทธิ์ %s เปลี่ยนรูปโปรไฟล์ของตนเองจากหน้าโปรไฟล์ใน Vanilla';
...
$Definition['Some themes may need to be updated to work with category following. You can disable the feature while you update your theme.'] = 'ชุดรูปแบบบางอย่างอาจต้องได้รับการอัปเดตเพื่อให้ทำงานกับหมวดหมู่ต่อไปนี้ คุณสามารถปิดการใช้งานคุณสมบัติในขณะที่คุณอัพเดตธีมของคุณ';
...
$Definition['Special restriction: Only users with permission Garden.Curation.Manage may use this reaction.'] = 'ข้อ จำกัด พิเศษ: เฉพาะผู้ใช้ที่ได้รับอนุญาต Garden.Curation.Manage อาจใช้ปฏิกิริยานี้';
