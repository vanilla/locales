...
$Definition['%1$s Version %2$s'] = '%1$s เวอร์ชัน %2$s';
$Definition['%1$s version %2$s is available.'] = '%1$s เวอร์ชัน %2$s พร้อมใช้งาน';
$Definition['%s is not a valid email address'] = '%s ไม่ใช่อีเมลที่ถูกต้อง';
...
$Definition['a full year.'] = 'หนื่งปีเต็ม';
