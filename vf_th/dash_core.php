...
$Definition['You can specify an allow list of trusted domains.'] = 'คุณสามารถระบุรายการที่อนุญาตของโดเมนที่เชื่อถือได้ (เช่น yourdomain.com) ที่ปลอดภัยสำหรับการเปลี่ยนเส้นทางและการฝัง';
