...
$Definition['The default banner image across the site. This can be overridden on a per category basis.'] = 'รูปภาพแบนเนอร์เริ่มต้นทั่วทั้งไซต์ สิ่งนี้สามารถแทนที่ได้ในแต่ละหมวดหมู่';
