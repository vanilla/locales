...
$Definition['Sources that are selected here will be available to AI Suggested Answers. Add additional sources through Federated Search. <0/>'] = 'แหล่งข้อมูลที่เลือกไว้ที่นี่จะพร้อมให้ใช้งานในคำตอบที่แนะนำโดย AI เพิ่มแหล่งข้อมูลเพิ่มเติมผ่านการค้นหาแบบรวม <0/>';
