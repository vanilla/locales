...
$Definition['%s is required'] = 'จำเป็นต้องใช้ %s';
...
$Definition['Add Ban Rule'] = 'เพิ่ม Ban Rule';
...
$Definition['administrator'] = 'ผู้บริหาร';
...
$Definition['Avatar Dimensions'] = 'ขนาดประจำตัว';
...
$Definition['Comment  Body'] = 'ความคิดเห็นของร่างกาย';
...
$Definition['Connections'] = 'สัมพันธ์';
...
$Definition['Hide from the recent discussions page.'] = 'ซ่อนจากหน้าการสนทนาล่าสุด';
...
$Definition['The default banner image across the site. This can be overriden on a per category basis.'] = 'รูปภาพแบนเนอร์เริ่มต้นทั่วทั้งไซต์ สิ่งนี้สามารถแทนที่ได้ในแต่ละหมวดหมู่';
...
$Definition['Use asterisks for wildcards'] = 'ใช้เครื่องหมายดอกจันสำหรับสัญลักษณ์แทนเช่น "*@hotmail.com"';
...
$Definition['You can specify a whitelist of trusted domains.'] = 'คุณสามารถระบุรายชื่อที่อนุญาตของโดเมนที่เชื่อถือได้ (เช่น yourdomain.com) ที่ปลอดภัยสำหรับการเปลี่ยนเส้นทางและการฝัง';
...
$Definition['ForceWysiwyg.Notes1'] = 'ตรวจสอบตัวเลือกด้านล่างเพื่อบอกให้บรรณาธิการทำการแปลโพสต์เก่าทั้งหมดใหม่เป็น Wysiwyg';
$Definition['ForceWysiwyg.Notes2'] = 'การตั้งค่านี้จะมีผลเฉพาะเมื่อเลือก Wysiwyg เป็นรูปแบบโพสต์ด้านบน วัตถุประสงค์ของตัวเลือกนี้คือการทำให้รูปแบบของโปรแกรมแก้ไขเป็นปกติ หากมีการโหลดโพสต์เก่าที่แก้ไขด้วยรูปแบบอื่นเช่น markdown หรือ BBCode ตัวเลือกนี้จะบังคับให้ Wysiwyg';
...
$Definition['Reinterpret All Posts As Wysiwyg'] = 'แปลความหมายของโพสต์ทั้งหมดเป็น Wysiwyg อีกครั้ง';
