...
// Federated Search
$Definition["About Federated Search"] = "เกี่ยวกับการค้นหาแบบรวมศูนย์";
$Definition["About Search Connectors"] = "เกี่ยวกับตัวเชื่อมต่อการค้นหา";
$Definition["Add"] = "เพิ่ม";
$Definition["Add a custom <0/> search connector"] = "เพิ่มตัวเชื่อมต่อการค้นหา <0/> ที่กำหนดเอง";
$Definition["Answer"] = "คำตอบ";
$Definition["Apply"] = "ยืนยัน";
$Definition["Article"] = "บทความ";
$Definition["Authenticate"] = "การตรวจสอบความถูกต้อง";
$Definition["Back"] = "กลับ";
$Definition["Cancel"] = "ยกเลิก";
$Definition["Categories"] = "หมวดหมู่";
$Definition["Client ID is required."] = "จำเป็นต้องมีรหัสลูกค้า";
$Definition["Client Secret is required."] = "จำเป็นต้องมีความลับของไคลเอนต์";
$Definition["Configure"] = "การกำหนดค่า";
$Definition["Cursor pagination uses a url to point to the next page of results. Offset pagination uses a page number and item count to fetch the next page."] = "การแบ่งหน้าแบบเคอร์เซอร์ใช้ URL เพื่อชี้ไปยังหน้าถัดไปของผลลัพธ์ การแบ่งหน้าแบบออฟเซ็ตใช้หมายเลขหน้าและจำนวนรายการเพื่อดึงหน้าถัดไป";
$Definition["Discussions"] = "กระทู้";
$Definition["Federated Search allows you to include external content within community search results such as knowledge base articles, courses from a learning management system, blog articles and more, to centralize content search within community. <0>Learn more</0>."] = "การค้นหาแบบรวมศูนย์ช่วยให้คุณสามารถรวมเนื้อหาภายนอกไว้ในผลการค้นหาชุมชน เช่น บทความฐานความรู้ หลักสูตรจากระบบการจัดการการเรียนรู้ บทความบล็อก และอื่นๆ เพื่อรวมการค้นหาเนื้อหาภายในชุมชน <0>เรียนรู้เพิ่มเติม</0> -";
$Definition["Good job! Here is a preview of some of your external articles, listed on your community's Search Results page."] = "เยี่ยมมาก! นี่คือตัวอย่างบทความภายนอกบางส่วนของคุณ ซึ่งแสดงอยู่ในหน้าผลการค้นหาของชุมชนของคุณ";
$Definition["Great!"] = "ยอดเยี่ยม!";
$Definition["Groups"] = "กลุ่ม";
$Definition["Help Menu"] = "เมนูช่วยเหลือ";
$Definition["Here is what a single result provided by the API looks like:"] = "นี่คือผลลัพธ์เดี่ยวที่จัดทำโดย API:";
$Definition["Idea"] = "ความคิด";
$Definition["Ideas"] = "ความคิดต่าง ๆ";
$Definition["Integrates Salesforce's knowledge base articles into the Vanilla community search, consolidating self-service support resources within the community platform."] = "บูรณาการบทความฐานความรู้ของ Salesforce ลงในการค้นหาชุมชน Vanilla และรวบรวมทรัพยากรการสนับสนุนแบบบริการตนเองภายในแพลตฟอร์มชุมชน";
$Definition["Knowledge Bases"] = "ฐานความรู้";
$Definition["Label is required."] = "จำเป็นต้องมีฉลาก";
$Definition["Loading"] = "กำลังโหลด";
$Definition["Maximum length is 100 characters."] = "ความยาวสูงสุดคือ 100 ตัวอักษร";
$Definition["Maximum length is 500 characters."] = "ความยาวสูงสุดคือ 500 ตัวอักษร";
$Definition["Maximum number of posts to be included in the email digest."] = "จำนวนโพสต์สูงสุดที่จะรวมไว้ในอีเมลสรุป";
$Definition["Messages"] = "ข้อความ";
$Definition["Modify <0/> search connector"] = "แก้ไขตัวเชื่อมต่อการค้นหา <0/>";
...
$Definition["Number of posts from groups"] = "จำนวนโพสจากกลุ่ม";
$Definition["Our Search Connectors will allow you to easily configure the connection between Vanilla and external platforms. Can't find what you're looking for? Let us know which search connectors you need by posting and Idea in our <0>customer community</0>."] = "ตัวเชื่อมต่อการค้นหาของเราจะช่วยให้คุณกำหนดค่าการเชื่อมต่อระหว่าง Vanilla และแพลตฟอร์มภายนอกได้อย่างง่ายดาย หากไม่พบสิ่งที่ต้องการ โปรดแจ้งให้เราทราบว่าคุณต้องการตัวเชื่อมต่อการค้นหาใดโดยโพสต์และแสดงความคิดเห็นในชุมชน <0>ลูกค้าของเรา</0> -";
$Definition["Please enter some basic information about your custom search connector."] = "โปรดกรอกข้อมูลพื้นฐานเกี่ยวกับตัวเชื่อมต่อการค้นหาที่กำหนดเองของคุณ";
...
$Definition["Response Body"] = "เนื้อหาตอบกลับ";
$Definition["Response Headers"] = "ส่วนหัวการตอบกลับ";
$Definition["Salesforce Article Search"] = "การค้นหาบทความ Salesforce";
$Definition["Save"] = "บันทึก";
$Definition["Search Connectors"] = "ตัวเชื่อมต่อการค้นหา";
$Definition["Site domain is required."] = "จำเป็นต้องมีโดเมนไซต์";
$Definition["Some parameters required to search may be unique to your API. Please configure your search connector with these parameters so that the connector can correctly format search queries for your community."] = "พารามิเตอร์บางอย่างที่จำเป็นสำหรับการค้นหาอาจมีลักษณะเฉพาะสำหรับ API ของคุณ โปรดกำหนดค่าตัวเชื่อมต่อการค้นหาของคุณด้วยพารามิเตอร์เหล่านี้ เพื่อให้ตัวเชื่อมต่อสามารถจัดรูปแบบคำค้นหาสำหรับชุมชนของคุณได้อย่างถูกต้อง";
$Definition["Surfaces Zendesk Help Center knowledge base articles in Vanilla community search to centralize self-service help within community."] = "บทความฐานความรู้ของศูนย์ช่วยเหลือ Zendesk ในการค้นหาชุมชน Vanilla เพื่อรวมศูนย์ความช่วยเหลือด้วยตนเองภายในชุมชน";
$Definition["Tag"] = "แท็ก";
$Definition["Test Custom API"] = "ทดสอบ API ที่กำหนดเอง";
$Definition["Test your custom API"] = "ทดสอบ API ที่กำหนดเองของคุณ";
$Definition["Test your pagination configuration"] = "ทดสอบการกำหนดค่าการแบ่งหน้าของคุณ";
$Definition["The roles that are allowed to access this connector."] = "บทบาทที่ได้รับอนุญาตให้เข้าถึงตัวเชื่อมต่อนี้";
$Definition["This search connector has an invalid configuration."] = "ตัวเชื่อมต่อการค้นหานี้มีการกำหนดค่าที่ไม่ถูกต้อง";
$Definition["Tip: These required parameters can usually be found in the documentation for your API"] = "เคล็ดลับ: โดยทั่วไปแล้วพารามิเตอร์ที่จำเป็นเหล่านี้สามารถพบได้ในเอกสารประกอบสำหรับ API ของคุณ";
$Definition["To finish configuring the Search Connector, tell us where to find the following values within the result object."] = "ในการเสร็จสิ้นการกำหนดค่า Search Connector โปรดแจ้งให้เราทราบว่าจะค้นหาค่าต่อไปนี้ภายในวัตถุผลลัพธ์ได้ที่ไหน";
$Definition["Visit Site"] = "ชมหน้าเว็บ";
$Definition["What kind of pagination does your API use?"] = "API ของคุณใช้การแบ่งหน้าประเภทใด";
$Definition["When you're ready, use these buttons to check that your pagination configuration functions as expected"] = "เมื่อคุณพร้อมแล้ว ให้ใช้ปุ่มเหล่านี้เพื่อตรวจสอบว่าการกำหนดค่าการแบ่งหน้าของคุณทำงานตามที่คาดหวังหรือไม่";
$Definition["When you're ready, use this button to test the API and view its results."] = "เมื่อคุณพร้อมแล้ว ให้ใช้ปุ่มนี้เพื่อทดสอบ API และดูผลลัพธ์";
$Definition["Where is the list of results located in this response?"] = "รายการผลลัพธ์ในคำตอบนี้อยู่ที่ไหน";
$Definition["You must configure this search connector to enable it."] = "คุณต้องกำหนดค่าตัวเชื่อมต่อการค้นหานี้เพื่อเปิดใช้งาน";
$Definition["You must select at least one role."] = "คุณจะต้องเลือกอย่างน้อยหนึ่งบทบาท";
$Definition["Zendesk Guide"] = "คู่มือ Zendesk";
