...
$Definition['HeadlineFormat.WallPost'] = '{RegardingUserID,vous} → {ActivityUserID,vous}';
...
$Definition['The default banner image across the site. This can be overriden on a per category basis.'] = 'L\'image de bannière par défaut dans l\'ensemble du site. Elle peut être remplacée pour chaque catégorie.';
...
$Definition['Use asterisks for wildcards'] = 'Utilisez des astérisques pour les caractères de remplacement, Ex. :  ‘*@hotmail.com’';
