...
$Definition['Add limits to image upload dimensions in discussions and comments.'] =
    'Ajoutez des limites de dimensions pour le téléchargement des images dans les discussions et les commentaires. ';
$Definition['AddressBarColorDescription'] = 'Certains navigateurs prennent en charge une couleur pour la barre d\'adresse. Mobile uniquement.';
...
$Definition['Alert users if they click external link.'] = 'Alertez les utilisateurs s\'ils cliquent sur un lien dans un message qui les éloignera du forum. Les utilisateurs ne seront pas avertis lorsqu\'ils suivront des liens qui correspondent à un domaine de confiance';
...
$Definition['Allow links to be transformed'] =
    'Permet de transformer les liens en représentations intégrées dans les messages et les commentaires. Par exemple, un lien YouTube sera transformé en une vidéo intégrée.';
$Definition['Allow users with the %s permission to change their own avatars from their profile pages in Vanilla.'] =
    'Autorisez les utilisateurs disposant de la permission %s à modifier leurs propres avatars depuis leurs pages de profil dans Vanilla.';
$Definition['Anonymize IP Addresses'] = "Anonymiser les adresses IP";
$Definition['API Overview'] = "Présentation de l'API";
...
$Definition['Automatically save drafts of unpublished posts, questions, ideas and comments.'] = 'Sauvegarder automatiquement les brouillons de messages, questions, idées et commentaires non publiés.';
...
$Definition['Be creative! Try naming your ranks after things that the community talks about.'] =
    'Sois créatif! Essayez de nommer vos rangs après des choses dont la communauté parle.';
...
$Definition['Changes will apply to newly uploaded avatars only.'] = 'Les modifications ne s\'appliqueront qu\'aux avatars nouvellement téléchargés.';
$Definition['Change the sizes that avatar images are saved at.'] = 'Modifiez les tailles dans lesquelles les images d\'avatar sont enregistrées.';
$Definition['Changes to the set day will take affect the following week.'] = 'Les modifications du jour fixé  entreront en vigueur la semaine suivante.';
$Definition['Checkboxes allow admins to perform batch actions on a number of discussions or comments at the same time.'] =
    'Les cases à cocher permettent aux administrateurs d\'effectuer des actions par lots sur un certain nombre de discussions ou de commentaires en même temps.';
$Definition['Check out our %s'] = 'Découvrez notre %s';
...
$Definition['Choose the preferred layout for lists of categories. You can edit the Tiled Layout.'] = 'Choisissez la disposition préférée pour les listes de catégories. Vous pouvez modifier la disposition en mosaïque.';
$Definition['Choose the preferred layout for lists of discussions. You can edit the Foundation Layout.'] = 'Choisissez la disposition préférée pour les listes de discussions. Vous pouvez modifier la disposition de base.';
...
$Definition['Embed your community forum into your website to increase engagement...'] = 'Intégrez votre communauté dans votre site web pour augmenter l\'engagement';
$Definition['Email digests will be sent on the selected day every week.'] = 'Les résumés des courriels seront envoyés chaque semaine le jour choisi.';
$Definition['Email sent from the application will be addressed from this email address'] = 'Les courriels envoyés à partir de l\'application auront pour expéditeur cette adresse électronique.';
$Definition['Email sent from the application will be addressed from this name'] = 'Les courriers électroniques envoyés à partir de l\'application seront adressés à partir de ce nom.';
$Definition['Email Settings'] = 'Paramètres du courrier électronique';
$Definition['Enables advanced editing of posts in several formats, including WYSIWYG, simple HTML, Markdown, and BBCode.'] =
    'Permet l\'édition avancée des articles dans plusieurs formats, y compris WYSIWYG, HTML simple, Markdown et BBCode.';
...
$Definition['Foundation Layout'] = 'Disposition de base';
$Definition['FullAnonymization.Description'] = "<strong>L’anonymisation complète</strong> remplace chaque adresse IP par 0.0.0.0, ce qui empêche l’application d’utiliser des adresses IP. Les règles d’interdiction de propriété intellectuelle ne fonctionneront pas du tout dans ce cas.";
$Definition['Full Anonymization'] = "Anonymisation complète";
...
$Definition['Garden.Import.Continue.Description'] = 'Il semble que vous soyez au milieu d\'une importation. Veuillez choisir l\'une des options suivantes.';
...
$Definition['Here are the ranks that users can achieve on your site.'] =
    'Voici les classements que les utilisateurs peuvent atteindre sur votre site. Vous pouvez personnaliser ces classements et même en ajouter de nouveaux. Voici quelques conseils.';
...
$Definition['If you want to embed your forum, enable embedding.'] =
    'Si vous souhaitez intégrer votre forum ou utiliser les commentaires de Vanilla dans votre blog, vous devez activer l\'intégration. Si vous n\'utilisez pas l\'incorporation, nous vous recommandons de laisser ce paramètre désactivé.';
...
$Definition['Invitation email failed to send: %'] = 'Bien que l\'invitation ait été créée avec succès, l\'e-mail n\'a pas pu être envoyé. Le serveur a signalé l\'erreur suivante: %s';
...
$Definition['It is a good idea to keep the maximum number of characters allowed in a post down to a reasonable size.'] =
    'C\'est une bonne idée de garder le nombre maximum de caractères autorisés dans un article à une taille raisonnable.';
...
$Definition['Lockout Time (seconds)'] = "Durée du verrouillage (en secondes)";
...
$Definition['Mobile themes allow you to change the look and feel of your site on smaller devices.'] =
    'Les thèmes mobiles vous permettent de modifier l\'apparence de votre site sur des appareils plus petits.';
$Definition['Most communities stick to positive reactions to encourage participation.'] = 'La plupart des communautés s’en tiennent à des réactions positives pour encourager la participation.';

$Definition['Nested categories deeper than this depth will be placed in a comma-delimited list.'] =
    'Les catégories imbriquées plus profondes que cette profondeur seront placées dans une liste délimitée par des virgules.';
$Definition['No Anonymization'] = 'Pas d’anonymisation';
...
$Definition['Not getting what you expect when you preview your theme?'] = 'Vous n\'obtenez pas ce à quoi vous vous attendiez lorsque vous prévisualisez votre thème?';
$Definition['Notify me when people comment on my addons.'] = 'Notifiez-moi quand des personnes commenteront sur mes extensions.';

$Definition['Once enabled, only members will see inside your community.'] = 'Une fois activé, seuls les membres verront l\'intérieur de votre communauté.';
$Definition['OrgDescription'] = 'Le nom de votre organisation est utilisé pour des micro-données de référencement naturel et JSON-LD';
$Definition['Overridden views or themehooks can have unintended side effects and are not previewed.'] =
    'Les vues ou les crochets de thème remplacés peuvent avoir des effets secondaires involontaires et ne sont pas prévisualisés.';

$Definition['PartialAnonymization.Description'] = "<strong>L'anonymisation partielle</strong> anonymise uniquement le dernier octet de l’adresse IP. Par exemple, 254.230.05.153 deviendrait 254.230.05.0. Cela permet une certaine anonymisation, tout en permettant aux règles d’interdiction d’IP de fonctionner.";
$Definition['Partial Anonymization'] = "Anonymisation partielle";
$Definition['Password.MinLength'] = 'Longueur minimale de caractères autorisée pour les mots de passe des utilisateurs sur les pages de création et de réinitialisation des mots de passe.';
...
$Definition['Reactions Documentation'] = ' Documentation des Réactions';
...
$Definition['Role Tokens'] = 'Jetons de rôle ';
...
$Definition['Security.Hsts.HTTPSWarning'] = 'Attention : n\'activez cette fonctionnalité que si vous êtes sûr que tous vos sous-domaines sont configurés pour le HTTPS avec des certificats valides. ';
$Definition['Security.Hsts.IncludeSubDomains'] = 'Une fois en vigueur, cette règle vaut également pour tous les sous-domaines de votre site. ';
$Definition['Security.Hsts.MaxAgeRecommendation'] = 'Nous recommandons de commencer avec un âge maximal d\'une semaine, puis de l\'augmenter à un mois, puis à un an une fois que vous aurez constaté que votre site fonctionne comme prévu. ';
...
$Definition['Session Timeout'] = 'Expiration de la session';
$Definition['ShareImageDescription'] =
    'Lorsque quelqu\'un partage un lien depuis votre site, nous essayons de récupérer une image de la page. S\'il n\'y a pas d\'image sur la page, nous utiliserons cette image à la place. L\'image doit être d\'au moins 50 × 50, mais nous recommandons 200 × 200.';
...
$Definition['SignIn.LockoutTime'] = "Durée pendant laquelle un utilisateur est empêché de se connecter après avoir dépassé le nombre de tentatives de connexion.";
$Definition['Some themes may need to be updated to work with category following. You can disable the feature while you update your theme.'] =
    'Certains thèmes devront peut-être être mis à jour pour fonctionner avec les catégories suivantes. Vous pouvez désactiver la fonctionnalité pendant que vous mettez à jour votre thème.';
$Definition['Special restriction: Only users with permission Garden.Curation.Manage may use this reaction.'] =
    'Restriction spéciale: seuls les utilisateurs avec l\'autorisation Garden.Curation.Manage peuvent utiliser cette réaction.';
...
$Definition['Spoofing'] = 'Usurpation';
...
$Definition['Tagging allows users to add a tag to discussions they start in order to make them more discoverable. '] =
    'Le balisage permet aux utilisateurs d\'ajouter une balise aux discussions qu\'ils lancent afin de les rendre plus visibles.';
...
$Definition['The database user you specified does not have permission to access the database. Have you created the database yet? The database reported: <code>%s</code>'] =
    'L\'utilisateur de base de données que vous avez spécifié n\'a pas de permission d\'accès sur la base de données. Avez-vous bien créé la base de données ? La base de données renvoie : <code>%s</code>';
...
$Definition['The location of the authentication endpoint.'] = 'L\'emplacement du point de terminaison de l\'authentification.';
...
$Definition['There are no database structure changes required. There may, however, be data changes.'] = 'Il n\'y a pas de changement de structure de base de données nécessaire. Toutefois, il se peut qu\'il y ait des changements de données.';
...
$Definition['The Vanilla Statistics plugin turns your forum\'s dashboard into an analytics reporting tool'] = 'Le module Statistiques de Vanilla transforme le tableau de bord de votre forum en un outil d\'analyse et de rapport statistiques, vous permettant de visualiser l\'activité de votre forum sur des périodes données. Vous pouvez <a href="http://vanillaforums.org/docs/vanillastatistics">en savoir plus sur Vanilla Statistics</a> dans notre documentation.';
$Definition['They work just like regular themes. Once one has been added to the themes folder, you can enable it here.'] =
    'Ils fonctionnent comme des thèmes réguliers. Une fois que l\'un a été ajouté au dossier des thèmes, vous pouvez l\'activer ici.';
...
$Definition['This may be used to include content such as organization name and address in all outgoing emails.'] = 'Il peut être utilisé pour inclure un contenu tel que le nom et l\'adresse de l\'organisation dans tous les courriers électroniques sortants.';
...
$Definition['TouchIconDescription'] =
    'L\'icône tactile apparaît lorsque vous marquez un site Web sur l\'écran d\'accueil d\'un appareil Apple. Ce sont généralement 152 pixels. Apple ajoute automatiquement des coins arrondis et un effet d\'éclairage.';
...
$Definition['VerifyUser'] = 'Cochez la case à côté de l\'utilisateur pour le marquer comme <b>Vérifié</b> afin que ses messages ne soient plus marqués comme spam. Cela rétablira également tous ses messages en attente.';
...
$Definition['Warning: Enabling this feature may cause Javascript errors on your site.'] = 'Attention: l\'activation de cette fonctionnalité peut provoquer des erreurs Javascript sur votre site.';
$Definition['Warning: Loading tables can be slow.'] =
    '<b>Avertissement</b> : la configuration de votre serveur ne prend pas en charge le chargement rapide des données. Si vous importez un très gros fichier (par exemple plus de 200 000 commentaires), vous pouvez envisager de modifier votre configuration. Cliquez <a href="http://vanillaforums.com/porter">ici</a> pour plus d\'informations.';
...
$Definition['We recommend enabling 1–3 reactions at a time to avoid overwhelming users.'] = 'Nous recommandons d’activer une à trois réactions à la fois pour éviter de submerger les utilisateurs.';
$Definition['Webhooks'] = 'Webhooks';
$Definition['When enabled, users may choose to receive notifications from the community'] = 'Lorsque cette option est activée, les utilisateurs peuvent choisir de recevoir des notifications de la part de la communauté.';
$Definition['When enabled, you can <0>manage products</0>, and group subcommunities by those products.'] = 'Lorsque cette option est activée, vous pouvez <0>gérer les produits</0> et regrouper les sous-communautés en fonction de ces produits.';
...
$Definition['You can specify a minimum post length to discourage short posts.'] = 'Vous pouvez spécifier une longueur minimale de publication pour décourager les publications courtes.';
...
$Definition["Your site's favicon appears in your browser's title bar. It will be scaled down appropriately."] = "Le favicône de votre site apparait dans la barre de titre de votre navigateur. Il sera réduit à l'échelle.";
$Definition["The touch icon appears when you bookmark a website on the homescreen of a mobile device. These are usually 152 pixels."] = "L’icône tactile apparaît lorsque vous mettez un site web en signet sur l’écran d’accueil d’un appareil mobile. Elle mesure généralement 152 pixels.";
...
$Definition["Some browsers support a color for the address bar."] = "Certains navigateurs prennent en charge une couleur pour la barre d’adresse.";
$Definition["This setting loads the page before executing Javascript which can improve your SEO."] = "Ce paramètre permet de charger la page avant d’exécuter le Javascript, ce qui peut améliorer votre référencement.";
...
$Definition["Remove discussion and categories links from menus. Set discussion and category related pages to return not found page 404."] = "Supprimer les liens de discussion et de catégories des menus. Configurer les pages liées aux discussions et aux catégories pour qu’elles renvoient une page 404 non trouvée.";
$Definition["Remove post and categories links from menus. Set post and category related pages to return not found page 404."] = "Supprimer des menus les liens vers les messages et catégories. Configurer les pages liées aux messages et aux catégories pour qu’elles renvoient vers la page 404 (page non trouvée).";
...
// Theme Chooser
$Definition["Your mobile theme will be disabled."] = "Votre thème mobile sera désactivé. Pour définir différents thèmes mobiles et de bureau, utilisez l'ancienne interface utilisateur de thème.";
$Definition["Heads Up!"] = "Soyez attentifs !";
$Definition["Welcome to Vanilla's theming UI."] = "Bienvenue dans l'interface utilisateur de thème de Vanilla. Cette page répertorie tous vos thèmes disponibles et vous permet de les copier ou de les modifier.";
$Definition["Some older themes don't support full editing capability."] = "Certains thèmes plus anciens ne prennent pas en charge la capacité d'édition complète. Pour voir ce qu'un thème prend en charge, vous pouvez survoler son nom pour voir où les modifications prendront effet.";
$Definition["Need More Help?"] = "Besoin d'aide?";
$Definition["Theming Guide"] = "Guide de thème";
$Definition["Old Theming UI"] = "Ancienne interface utilisateur de thème";
$Definition["If you have an old theme"] = "Si vous avez un ancien thème et que vous devez définir un thème de bureau et mobile distinct, vous pouvez le faire avec l'ancienne interface utilisateur de thème.";
...
// Preview Page
$Definition["Welcome To Your Theme"] = "Bienvenue dans votre thème";
$Definition["This is a style guide of your theme."] = "Ceci est un guide de style de votre thème. Il contient des exemples des éléments visuels utilisés tout au long de l'application. Vous pouvez cliquer sur les différents widgets tels que la barre de titre <0> </0> ou <1> Bannière </1> pour modifier leurs propriétés dans le panneau latéral.";
$Definition["In additon to the widgets there are also"] = "En plus des widgets, il existe également <0> styles globaux </0> . Pour modifier les styles globaux, cliquez n'importe où ailleurs sur la page, comme ce texte.";
$Definition["There are two types of buttons in the application: primary and secondary."] = "Il existe deux types de boutons dans l'application: primaire et secondaire.";
$Definition["Primary Button"] = "Bouton principal";
$Definition["Secondary Button"] = "Bouton secondaire";
...
// Section Headings
$Definition["Global Styles"] = "Styles globaux";
$Definition["Buttons & Inputs"] = "Boutons et entrées";
$Definition["Buttons"] = "Boutons";
$Definition["Title Bar"] = "Barre de titre";

$Definition["Preset"] = "Préréglage";
$Definition["Dark"] = "Sombre";
$Definition["Light"] = "Lumière";

$Definition["Brand Color"] = "Couleur de la marque";
$Definition["Background"] = "Contexte";
$Definition["Links"] = "Liens";
$Definition["Font"] = "Police de caractère";
$Definition["Border Radius"] = "Rayon de la bordure";
$Definition["Font URL"] = "URL de la police";
$Definition["Font Name"] = "Nom de la police";
$Definition["Invalid URL"] = "URL invalide";
$Definition["You can upload a Custom Font in your Theming System. Just copy & paste the URL in the field."] = "Vous pouvez télécharger une police personnalisée dans votre système de thème. Copiez et collez simplement l'URL dans le champ.";
$Definition["You can configure some values differently for different screensizes."] = "Vous pouvez configurer certaines valeurs différemment pour différentes tailles d'écran.";
...
$Definition["Primary Buttons"] = "Boutons principaux";
$Definition["Secondary Buttons"] = "Boutons secondaires";

$Definition["Button Type"] = "Type de bouton";
$Definition["Solid"] = "Solide";
$Definition["Outline"] = "Contour";
$Definition["Transparent"] = "Transparent";

$Definition["Background"] = "Contexte";
$Definition["Background Image"] = "Image de fond";
$Definition["Choose Image"] = "Choisissez une image";
$Definition["Color Overlay"] = "Superposition de couleurs";
$Definition["Borderless"] = "Sans bordure";
$Definition["Bordered"] = "Bordé";
$Definition["Bordered (Unified)"] = "Bordé (unifié)";
$Definition["Shadowed"] = "Ombré";
...
$Definition["Alignment"] = "Alignement";
$Definition["Left Aligned"] = "Aligné à gauche";
$Definition["Center Aligned"] = "Aligné au centre";
$Definition["Image (Mobile)"] = "Image (mobile)";
$Definition["Alignment (Mobile)"] = "Alignement (mobile)";

// Vanilla Labs
$Definition['Vanilla Labs'] = 'Laboratoires Vanille';
$Definition['Enable and test out the latest Vanilla features.'] = 'Activez et testez les dernières fonctionnalités de Vanilla.';
$Definition['Welcome to Labs!'] = 'Bienvenue dans les laboratoires !';
$Definition['This is where you can enable and test out new Vanilla features, pages & components.'] = 'C\'est ici que vous pouvez activer et tester les nouvelles fonctionnalités, pages et composants de Vanilla.';
$Definition['This lab cannot be disabled because a custom layout is applied.'] = 'Ce laboratoire ne peut pas être désactivé car une mise en page personnalisée est appliquée.';
$Definition['This lab cannot be disabled because it is required by the current theme.'] = 'Cet atelier ne peut pas être désactivé, car il est requis par le thème actuel.';
$Definition['Need more help?'] = 'Besoin d\'aide?';
$Definition['Integrate Foundation Pages & Components Into Your Theme'] = 'Intégrez des pages et des composants de fondation dans votre thème';
$Definition['Check out our <0>documentation</0>, or ask our <1>community of experts</1>.'] = 'Consultez notre <0>documentation</0>, ou demandez à notre <1>communauté d\'experts</1>.';
$Definition['Enable and test out the latest Vanilla features.'] = 'Activez et testez les dernières fonctionnalités de Vanilla.';
$Definition['The <0/> lab needs to be configured to match your custom theme.'] = 'N.B. Le labo <0/> doit être configuré pour correspondre à votre thème personnalisé. Cela peut être fait en utilisant notre nouvel éditeur de thème. <1>En savoir plus.</1>';
...
$Definition['Embed Settings'] = 'Paramètres d\'incorporation';
$Definition['The New Embed System'] = 'Le nouveau système embarqué';
$Definition['The new embed system has improved performance.'] = 'Le nouveau système d\'intégration offre de meilleures performances, un meilleur comportement de défilement et un comportement plus cohérent que l\'ancien système. Actuellement, les intégrations de commentaires et de Wordpress ne sont pas supportées par le nouveau système embarqué.';
$Definition['New Embed System'] = 'Nouveau système embarqué';
$Definition['See the documentation'] = 'Voir la documentation';
$Definition['Looking for the Old Embed System?'] = 'Vous recherchez l\'ancien système embarqué ?';
$Definition['Disable the "New Embed System" lab on the <0>Vanilla Labs Page</0>'] = 'Désactivez le laboratoire « New Embed System » sur la <0>page de Vanilla Labs</0>.';
$Definition["Sometimes you want to embed your Vanilla site"] = "Parfois, vous souhaitez intégrer votre site Vanilla dans un autre site. Le système d'intégration de Vanilla offre un moyen facile de le faire. L'utilisation d'un site intégré implique des compromis en termes de performances. Consultez la documentation pour connaître les alternatives et les cas d'utilisation idéaux.";
$Definition['Layout Editor'] = 'Éditeur de mise en page';
...
$Definition['N.B. The new Layout Editor will inherit the theme set in your Style Guide (formally theme editor). <1>Find out more</1>'] = 'N.B. Le nouvel éditeur de mise en page héritera du thème défini dans votre guide de style (anciennement éditeur de thème). <1>Pour en savoir plus</1>';

// Subcommunity Settings

$Definition["Recent Post List Page"] = "Page de liste des publications récentes";
$Definition["Custom"] = "Personnalisé";
$Definition["Category List Page"] = "Page de liste des catégories";
$Definition["Home Page Type"] = "Type de page d'accueil";
$Definition["Choose a page to serve as the subcommunity homepage."] = "Sélectionnez une page qui servira de page d'accueil à la sous-communauté.";
$Definition["Selected Home Page Type is a custom layout. You can manage the layout for this subcommunity in <0/>."] = "Le type de page d'accueil sélectionné est une mise en page personnalisée. Vous pouvez gérer la mise en page de cette sous-communauté dans <0/>.";
$Definition["Default Subcommunity"] = "Sous-communauté par défaut";
$Definition["Make this the default subcommunity. Visitors will be directed here first when they access the community."] = "Définissez cette sous-communauté comme sous-communauté par défaut. Les visiteurs seront d'abord redirigés vers cette page lorsqu'ils accéderont à la communauté.";
$Definition["Post number must be between 3–20."] = "Le numéro de message doit être compris entre 3 et 20.";
$Definition["Pages"] = "Pages";
$Definition["Widget Builder"] = "Constructeur de widgets";
$Definition["Custom Pages"] = "Pages personnalisées";
$Definition["Site Home Pages"] = "Pages d'accueil du site";
$Definition["Subcommunity Home Pages"] = "Pages d'accueil des sous-communautés";
$Definition["Choose a theme for this subcommunity.  <0>Read more</0>"] = "Choisissez un thème pour cette sous-communauté. <0>Lire la suite</0>";
$Definition["Vanilla Messages"] = "Messages Vanilla";
$Definition["From <0/>"] = "De <0/>";
$Definition["Manage Products"] = "Gérer les produits";
$Definition["Pages"] = "Pages";
$Definition["Widget Builder"] = "Constructeur de widgets";
$Definition["Custom Pages"] = "Pages personnalisées";
$Definition["Site Home Pages"] = "Pages d'accueil du site";
$Definition["Subcommunity Home Pages"] = "Pages d'accueil des sous-communautés";
$Definition["Choose a theme for this subcommunity.  <0>Read more</0>"] = "Choisissez un thème pour cette sous-communauté. <0>Lire la suite</0>";
$Definition["Search subcommunities."] = "Recherchez les sous-communautés.";
$Definition["The view you were looking for could not be found."] = "La vue que vous recherchez n'a pas pu être trouvée.";
$Definition["View Not Found"] = "Vue introuvable";
$Definition["site"] = "site";
$Definition["Selected Home Page Type is a legacy layout."] = "Le type de page d'accueil sélectionné est une mise en page héritée.";
$Definition["The default home page type can be changed in <0/>."] = "Le type de page d'accueil par défaut peut être modifié dans <0/>.";

// Sentiment

$Definition["Keyword Settings"] = "Paramètres des mots-clés";
$Definition["Extremely Negative to Negative"] = "Extrêmement négatif à négatif";
$Definition["Negative to Balanced"] = "Négatif à équilibré";
$Definition["Balanced to Positive"] = "Équilibré à positif";
$Definition["Positive to Highly Positive"] = "Positif à très positif";
$Definition["Sentiment Keywords"] = "Mots clés du sentiment";
$Definition["Sentiment Settings"] = "Paramètres de sentiment";
$Definition["Add Keyword"] = "Ajouter un mot-clé";
$Definition["Keyword Limit Reached"] = "Limite de mots-clés atteinte";
$Definition["You can only track up to 100 keywords. Untrack some to add new keywords."] = "Vous ne pouvez suivre que 100 mots-clés au maximum. Supprimez-en certains pour en ajouter d'autres.";
$Definition["Calibrate Sentiment Levels"] = "Calibrer les niveaux de sentiment";
$Definition["Sentiment Level Distribution Adjustment"] = "Ajustement de la distribution des niveaux de sentiment";
$Definition["The 4 sliders represent the points between each sentiment level. Drag the sliders to calibrate the overall sentiment level distribution to your community's content."] = "Les quatre curseurs représentent les points entre chaque niveau de sentiment. Faites glisser les curseurs pour calibrer la distribution globale des niveaux de sentiment en fonction du contenu de votre communauté.";
$Definition["Calibrated Sentiment Distribution Preview"] = "Aperçu de la distribution des sentiments calibrée";
$Definition["(Read Only)"] = "(Lecture seule)";
$Definition["This graph visualizes how the content in your community would be distributed based on your calibration adjustment."] = "Ce graphique montre comment le contenu de votre communauté serait distribué en fonction de votre ajustement.";
$Definition["all time sentiment"] = "sentiment de tous les temps";
$Definition["keyword"] = "mot-clé";
$Definition["number of uses"] = "nombre d'utilisations";
$Definition["last use"] = "dernière utilisation";
$Definition["tracking"] = "suivi";
$Definition["Sentiment"] = "Sentiment";
$Definition["Tracked Status"] = "Statut suivi";
$Definition["Tracked Only"] = "Suivi uniquement";
$Definition["Untracked Only"] = "Non suivi seulement";
$Definition["Strongly Negative"] = "Fortement négatif";
$Definition["Negative"] = "Négatif";
$Definition["Positive"] = "Positif";
$Definition["Highly Positive"] = "Hautement positif";
$Definition["Clear all filters"] = "Effacer tous les filtres";
$Definition["Keyword is required."] = "Le mot-clé est obligatoire.";
$Definition["Maximum length is 100 characters."] = "La longueur maximale est de 100 caractères.";
$Definition["Keyword"] = "Mot-clé";
$Definition["Add a new tracked keyword"] = "Ajoutez un nouveau mot-clé suivi";
$Definition["New keywords will be tracked in analytics. You can choose to turn off tracking after creating this keyword."] = "Les nouveaux mots-clés seront suivis dans l'analyse. Vous pouvez choisir de désactiver le suivi après avoir créé ce mot-clé.";
$Definition["Extremely Negative"] = "Extrêmement négatif";
$Definition["Extremely Positive"] = "Extrêmement positif";
