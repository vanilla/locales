...
$Definition['Allow links to be transformed'] = 'Permet de transformer les liens en représentations intégrées dans les messages et les commentaires. Par exemple, un lien YouTube sera transformé en une vidéo intégrée.';
...
$Definition['Be creative! Try naming your ranks after things that the community talks about.'] = 'Sois créatif! Essayez de nommer vos rangs après des choses dont la communauté parle.';
...
$Definition['Enables advanced editing of posts in several formats, including WYSIWYG, simple HTML, Markdown, and BBCode.'] = 'Permet l\'édition avancée des articles dans plusieurs formats, y compris WYSIWYG, HTML simple, Markdown et BBCode.';
...
$Definition['Garden.Profiles.Edit permission to change their own avatars from their profile pages in Vanilla.'] = 'Garden.Profiles.Edit l\'autorisation de changer leurs propres avatars à partir de leurs pages de profil dans Vanilla.';
...
$Definition['Here are the ranks that users can achieve on your site.'] = 'Voici les classements que les utilisateurs peuvent atteindre sur votre site. Vous pouvez personnaliser ces classements et même en ajouter de nouveaux. Voici quelques conseils.';
...
$Definition['If you are new to HTML and/or CSS, here are some tutorials to get you started:'] = 'Si vous êtes novice en HTML et / ou CSS, voici quelques tutoriels pour vous aider à démarrer:';
...
$Definition['If you want to embed your forum, enable embedding.'] = 'Si vous souhaitez intégrer votre forum ou utiliser les commentaires de Vanilla dans votre blog, vous devez activer l\'intégration. Si vous n\'utilisez pas l\'incorporation, nous vous recommandons de laisser ce paramètre désactivé.';
...
$Definition['It is a good idea to keep the maximum number of characters allowed in a post down to a reasonable size.'] = 'C\'est une bonne idée de garder le nombre maximum de caractères autorisés dans un article à une taille raisonnable.';
...
$Definition['Mobile themes allow you to change the look and feel of your site on smaller devices.'] = 'Les thèmes mobiles vous permettent de modifier l\'apparence de votre site sur des appareils plus petits.';
...
$Definition['Nested categories deeper than this depth will be placed in a comma-delimited list.'] = 'Les catégories imbriquées plus profondes que cette profondeur seront placées dans une liste délimitée par des virgules.';
...
$Definition['Overridden views or themehooks can have unintended side effects and are not previewed.'] = 'Les vues ou les crochets de thème remplacés peuvent avoir des effets secondaires involontaires et ne sont pas prévisualisés.';
...
$Definition['Recommend special ranks for admins and mods.'] = 'C\'est une bonne idée d\'avoir des rangs spéciaux pour les modérateurs et les administrateurs afin que votre communauté puisse facilement voir qui est responsable.';
$Definition['Recommend starting with five ranks.'] = 'Vous ne voulez pas avoir trop de rangs. Nous vous recommandons de commencer par cinq. Vous pouvez en ajouter si votre communauté est vraiment importante.';
...
$Definition['ShareImageDescription'] = 'Lorsque quelqu\'un partage un lien depuis votre site, nous essayons de récupérer une image de la page. S\'il n\'y a pas d\'image sur la page, nous utiliserons cette image à la place. L\'image doit être d\'au moins 50 × 50, mais nous recommandons 200 × 200.';
...
$Definition['Special restriction: Only users with permission Garden.Curation.Manage may use this reaction.'] = 'Restriction spéciale: seuls les utilisateurs avec l\'autorisation Garden.Curation.Manage peuvent utiliser cette réaction.';
...
$Definition['They work just like regular themes. Once one has been added to the themes folder, you can enable it here.'] = 'Ils fonctionnent comme des thèmes réguliers. Une fois que l\'un a été ajouté au dossier des thèmes, vous pouvez l\'activer ici.';
...
$Definition['This page lists the endpoints of your API.'] = 'Cette page répertorie les points de terminaison de votre API. Cliquez sur points de terminaison pour plus d\'informations. Vous pouvez effectuer des appels en direct vers l\'API à partir de cette page ou en externe à l\'aide d\'un jeton d\'accès.';
...
$Definition['TouchIconDescription'] = 'L\'icône tactile apparaît lorsque vous marquez un site Web sur l\'écran d\'accueil d\'un appareil Apple. Ce sont généralement 152 pixels. Apple ajoute automatiquement des coins arrondis et un effet d\'éclairage.';
