...
$Definition["To access the paragraph format menu, press control, shift, and P. To access the text format menu, press control, shift, and I. Use the arrow keys to navigate in each menu."] = "Pour accéder au menu du format du paragraphe, appuyer sur les touches Ctrl, Shift et P. Pour accéder au menu du format du texte, appuyer sur les touches Ctrl, Shift et I. Utiliser les touches fléchées pour naviguer dans chaque menu.";
