...
$Definition['ForceWysiwyg.Notes1'] = 'Prüfen Sie die Option unten, um den Editor dazu aufzufordern, alle alten Beiträge als Wysiwyg neu zu interpretieren.';
$Definition['ForceWysiwyg.Notes2'] = 'Diese Einstellung ist nur wirksam, falls Wysiwyg als Beitragsformat oben ausgewählt wurde. Der Zweck dieser Option besteht darin, das Editor-Format zu normalisieren. Falls ältere Beiträge, die mit einem anderen Format wie z. B. Markdown oder BBCode bearbeitet wurden, geladen werden, erzwingt diese Option Wysiwyg.';
...
$Definition['Reinterpret All Posts As Wysiwyg'] = 'Alle Beiträge als Wysiwyg neu interpretieren';
