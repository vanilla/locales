...
$Definition['Alert users if they click external link.'] = '如果用戶單擊帖子中的鏈接將使他們離開論壇，則向用戶發出警報。當您跟踪與受信任域匹配的鏈接時，不會警告用戶';
...
$Definition['Automatically save drafts of unpublished posts, questions, ideas and comments.'] = '自動儲存未發布的貼文、問題、想法和評論的草稿。';
...
$Definition['Digest Settings'] = '摘要設定';
...
$Definition['FullAnonymization.Description'] = "<strong>完全匿名化</strong>將每個 IP 地址替換為 0.0.0.0，有效拒絕應用程序對 IP 地址進行任何訪問。在這種情況下，IP 禁止規則根本不起作用。";
...
$Definition['PartialAnonymization.Description'] = "<strong>部分匿名</strong>僅匿名 IP 地址的最後一個八位字節。例如，254.230.05.153 將變為 254.230.05.0。這提供了一定程度的匿名性，同時仍然允許 IP 禁止規則發揮作用。";
...
$Definition['Recommend special ranks for admins and mods.'] =
    '為主持人和管理員設置特殊等級是一個好主意，這樣您的社區就可以輕鬆地看到誰負責。';
$Definition['Recommend starting with five ranks.'] =
    '您不想有太多的排名。我們建議從五個開始。如果您的社區很大，您可以添加更多。';
$Definition['Recommended dimensions are about 400px by 300px or smaller with similar ratio.'] = '建議尺寸約 400 像素 x 300 像素或更小，比例相似。';
$Definition['Requires “Flag” reaction permission.'] = '需要“標誌”反應許可。';
$Definition['Requires “Negative” reaction permission.'] = '需要“負面”反應許可。';
$Definition['Requires “Positive” reaction permission.'] = '需要“正面”反應許可。';
...
$Definition['The database user you specified does not have permission to access the database. Have you created the database yet? The database reported: <code>%s</code>'] =
    '您所指定的資料庫用戶，似乎並沒有使用本資料庫的權限；您確定已經建立資料庫了嗎？資料庫回報的訊息是：<code>%s</code>';
...
$Definition['Theme preview is limited to displaying the theme\'s template and css.'] = '主題預覽僅限於顯示主題的模板和CSS。';
...
$Definition['They work just like regular themes. Once one has been added to the themes folder, you can enable it here.'] =
    '它們就像常規主題一樣工作。將其添加到主題文件夾後，即可在此處啟用它。';
...
$Definition['This may be used to include content such as organization name and address in all outgoing emails.'] = '這可用於在所有外寄電子郵件中包含組織名稱和地址等內容。';
...
$Definition['This page lists the endpoints of your API.'] =
    '該頁面列出了您的API的端點。單擊端點以獲取更多信息。您可以從此頁面或使用訪問令牌從外部對API進行實時調用。';
...
$Definition['This setting loads the page before executing Javascript.'] =
    '此設定會在執行 Javascript 之前先載入頁面以改善您的 SEO。<br><strong>**警告：啟用本功能可能會在您的網站上導致 Javascript 錯誤。**</strong>';
$Definition['Tiled Layout'] = '平鋪佈局';
...
$Definition['TouchIconDescription'] =
    '當您在Apple設備的主屏幕上為網站添加書籤時，將顯示觸摸圖標。這些通常是152像素。蘋果會自動添加圓角和照明效果。';
...
$Definition['Use the button at the top of the page to create a ban rule.'] = '使用頁面頂部的按鈕創建禁止規則。';
...
$Definition['Users may sign into your site using their Twitter account.'] = '用戶可以使用其Twitter帳戶登錄到您的網站。';
$Definition['User Profile'] = '用戶資料';
...
$Definition['Verify and restore'] = '驗證並還原';
$Definition['VerifyUser'] = '選中用戶旁邊的框以將其標記為<b>已驗證，</b>這樣他們的帖子就不會再次被標記為垃圾郵件。這也將恢復所有待處理的帖子。';
...
$Definition['Warning: Loading tables can be slow.'] =
    '<b>警告</b> ：您的服務器配置不支持快速數據加載。如果要導入非常大的文件（例如，超過200,000條註釋），則可能需要考慮更改配置。單擊<a href="http://vanillaforums.com/porter">此處</a>了解更多信息。';
...
$Definition['When enabled, you can <0>manage products</0>, and group subcommunities by those products.'] = '啟用後，您可以<0>管理產品</0>並依這些產品對子社區進行分組。';
$Definition['Whether or not the internal profile fields will be included in this webhook.'] = '內部配置文件字段是否將包含在此 webhook 中。';
$Definition['Whether or not the private profile fields will be included in this webhook.'] = '私有配置文件字段是否將包含在此 webhook 中。';
...
$Definition['You can choose from one of the different styles this theme offers.'] = '您可以從此主題提供的不同樣式中選擇一種。';
...
$Definition['You can specify a minimum post length to discourage short posts.'] = '您可以指定最小帖子長度，以防止短帖子。';
...
$Definition["This title appears on your site's banner and in your browser's title bar. If a logo is uploaded, it will replace this title on user-facing forum pages. Also, keep in mind some themes may hide this title."] = "該標題出現在您網站的橫幅和瀏覽器的標題列中。如果上傳徽標，它將替換面向使用者的論壇頁面上的此標題。另外，請記住某些主題可能會隱藏此標題。";
...
$Definition["Remove post and categories links from menus. Set post and category related pages to return not found page 404."] = "從選單中刪除貼文和類別連結。設定貼文和類別相關頁面以返回未找到頁面 404。";
...
$Definition["Some older themes don't support full editing capability."] = "一些較舊的主題不支持完整的編輯功能。要查看主題支持什麼，您可以將鼠標懸停在其名稱上以查看編輯將在何處生效。";
...
$Definition['Templates are the standard themes. To customize them, you have to create a copy.'] = '模板是標準主題。要自定義它們，您必須創建一個副本。';
...
$Definition["Are you sure want to delete this theme? It will be permanently deleted."] = "您確定要刪除此主題嗎？它將被永久刪除。";
...
$Definition["User inputs are based on the global background and text colors."] = "用戶輸入基於全局背景和文本顏色。";

// Section Headings
$Definition["Global Styles"] = "整體風格";
$Definition["Buttons & Inputs"] = "按鈕和輸入";
$Definition["Buttons"] = "鈕扣";
$Definition["Title Bar"] = "標題欄";

$Definition["Preset"] = "預設值";
$Definition["Dark"] = "黑暗";
$Definition["Light"] = "光";
...
$Definition["Shadowed"] = "陰影的";

$Definition["Full Bleed"] = "全血";
$Definition["When you select Full Bleed, your background is transparent."] = "選擇“全血”時，背景是透明的。";
$Definition["Alignment"] = "對準";
$Definition["Left Aligned"] = "左對齊";
$Definition["Center Aligned"] = "居中對齊";
$Definition["Image (Mobile)"] = "圖片（移動）";
$Definition["Alignment (Mobile)"] = "對齊方式（移動）";

// Vanilla Labs
$Definition['Vanilla Labs'] = '香草實驗室';
$Definition['Enable and test out the latest Vanilla features.'] = '啟用並測試最新的 Vanilla 功能。';
$Definition['Welcome to Labs!'] = '歡迎來到實驗室！';
$Definition['This is where you can enable and test out new Vanilla features, pages & components.'] = '您可以在此處啟用和測試新的 Vanilla 功能、頁面和組件。';
$Definition['This lab cannot be disabled because a custom layout is applied.'] = '由於應用了自定義佈局，因此無法禁用此實驗室。';
$Definition['This lab cannot be disabled because it is required by the current theme.'] = '無法禁用此實驗室，因為當前主題需要它。';
$Definition['Need more help?'] = '需要更多幫助？';
$Definition['Integrate Foundation Pages & Components Into Your Theme'] = '將基礎頁面和組件集成到您的主題中';
$Definition['Check out our <0>documentation</0>, or ask our <1>community of experts</1>.'] = '查看我們的<0>文檔</0>，或詢問我們的<1>專家社區</1>.';
$Definition['Enable and test out the latest Vanilla features.'] = '啟用並測試最新的 Vanilla 功能。';
$Definition['The <0/> lab needs to be configured to match your custom theme.'] = '注意 <0/> 實驗室需要配置以匹配您的自定義主題。這可以使用我們的新主題編輯器來完成。 <1>了解更多。</1>';
$Definition['Usercards'] = '用戶卡';
$Definition["Usercards allow you to get a quick in-line snapshot of a user's information."] = "用戶卡允許您快速獲得用戶信息的內聯快照。查看帖子和排行榜時，單擊用戶名即可查看顯示用戶基本個人資料信息的卡片，而無需離開頁面。啟用此功能可將用戶卡添加到您的自定義主題。";
$Definition['New Search Page'] = '新搜索頁面';
$Definition["Vanilla's new search service is finally here."] = "Vanilla 的新搜索服務終於來了。啟用我們新的搜索頁面 UI 以訪問最新的搜索功能，例如會員搜索、搜索排序和術語突出顯示。";
...
$Definition['The New Embed System'] = '新的嵌入系統';
$Definition['The new embed system has improved performance.'] = '與舊的嵌入系統相比，新的嵌入系統具有改進的性能、改進的滾動行為和更一致的行為。目前，新嵌入系統不支持評論和 wordpress 嵌入。';
$Definition['New Embed System'] = '新的嵌入系統';
$Definition['See the documentation'] = '請參閱文檔';
$Definition['Looking for the Old Embed System?'] = '尋找舊的嵌入系統？';
$Definition['Disable the "New Embed System" lab on the <0>Vanilla Labs Page</0>'] = '在 <0>Vanilla Labs 頁面上禁用“新嵌入系統”實驗室</0>';
$Definition["Sometimes you want to embed your Vanilla site"] = "有時您想將您的 Vanilla 站點嵌入到另一個站點中。 Vanilla 的嵌入系統提供了一種簡單的方法。使用嵌入式站點時需要權衡性能，因此請查看文檔以了解替代方案和理想用例。";
...
$Definition["Recent Post List Page"] = "最新文章列表頁面";
$Definition["Custom"] = "風俗";
$Definition["Category List Page"] = "類別清單頁面";
$Definition["Home Page Type"] = "首頁類型";
$Definition["Choose a page to serve as the subcommunity homepage."] = "選擇一個頁面作為子社群的主頁。";
$Definition["Selected Home Page Type is a custom layout. You can manage the layout for this subcommunity in <0/>."] = "所選首頁類型為自訂佈局。您可以在<0/>中管理此子社群的佈局。";
$Definition["Default Subcommunity"] = "預設子社區";
$Definition["Make this the default subcommunity. Visitors will be directed here first when they access the community."] = "將此設為預設子社群。訪客造訪社區時將首先被引導至此處。";
$Definition["Post number must be between 3–20."] = "貼文數必須介於 3 至 20 之間。";
$Definition["Pages"] = "頁";
$Definition["Widget Builder"] = "小工具產生器";
$Definition["Custom Pages"] = "自訂頁面";
$Definition["Site Home Pages"] = "網站首頁";
$Definition["Subcommunity Home Pages"] = "子社群首頁";
$Definition["Choose a theme for this subcommunity.  <0>Read more</0>"] = "為這個子社區選擇一個主題。 <0>閱讀更多</0>";
$Definition["Vanilla Messages"] = "香草訊息";
$Definition["From <0/>"] = "從<0/>";
$Definition["Manage Products"] = "管理產品";
$Definition["Pages"] = "頁";
$Definition["Widget Builder"] = "小工具產生器";
$Definition["Custom Pages"] = "自訂頁面";
$Definition["Site Home Pages"] = "網站首頁";
$Definition["Subcommunity Home Pages"] = "子社群首頁";
$Definition["Choose a theme for this subcommunity.  <0>Read more</0>"] = "為這個子社區選擇一個主題。 <0>閱讀更多</0>";
$Definition["Search subcommunities."] = "搜尋子社區。";
$Definition["The view you were looking for could not be found."] = "您要尋找的視圖未找到。";
$Definition["View Not Found"] = "查看未找到";
$Definition["site"] = "地點";
$Definition["Selected Home Page Type is a legacy layout."] = "所選首頁類型為舊版版面。";
$Definition["The default home page type can be changed in <0/>."] = "預設首頁類型可以在<0/>中變更。";

// Sentiment

$Definition["Keyword Settings"] = "關鍵字設定";
$Definition["Extremely Negative to Negative"] = "極度負面到負面";
$Definition["Negative to Balanced"] = "負面到平衡";
$Definition["Balanced to Positive"] = "平衡至積極";
$Definition["Positive to Highly Positive"] = "積極至非常積極";
$Definition["Sentiment Keywords"] = "情緒關鍵字";
$Definition["Sentiment Settings"] = "情緒設定";
$Definition["Add Keyword"] = "添加關鍵字";
$Definition["Keyword Limit Reached"] = "關鍵字數量已達上限";
$Definition["You can only track up to 100 keywords. Untrack some to add new keywords."] = "您最多只能追蹤 100 個關鍵字。取消追蹤一些關鍵字即可新增關鍵字。";
$Definition["Calibrate Sentiment Levels"] = "校準情緒水平";
$Definition["Sentiment Level Distribution Adjustment"] = "情緒水平分佈調整";
$Definition["The 4 sliders represent the points between each sentiment level. Drag the sliders to calibrate the overall sentiment level distribution to your community's content."] = "這四個滑塊分別代表各個情緒等級之間的不同點。拖曳滑桿可以調整整體情緒等級分佈，使其與您社群的內容相符。";
$Definition["Calibrated Sentiment Distribution Preview"] = "校準情感分佈預覽";
$Definition["(Read Only)"] = "（唯讀）";
$Definition["This graph visualizes how the content in your community would be distributed based on your calibration adjustment."] = "此圖視覺化了根據您的校準調整，您社群中的內容將如何分佈。";
$Definition["all time sentiment"] = "歷時情懷";
$Definition["keyword"] = "關鍵字";
$Definition["number of uses"] = "使用次數";
$Definition["last use"] = "最後使用";
$Definition["tracking"] = "追蹤";
$Definition["Sentiment"] = "情緒";
$Definition["Tracked Status"] = "追蹤狀態";
$Definition["Tracked Only"] = "僅跟踪";
$Definition["Untracked Only"] = "僅限未追蹤用戶";
$Definition["Strongly Negative"] = "強烈否定";
$Definition["Negative"] = "消極的";
$Definition["Positive"] = "積極的";
$Definition["Highly Positive"] = "高度正面";
$Definition["Clear all filters"] = "清除所有篩選條件";
$Definition["Keyword is required."] = "關鍵字為必填項。";
$Definition["Maximum length is 100 characters."] = "最大長度為 100 個字元。";
$Definition["Keyword"] = "關鍵字";
$Definition["Add a new tracked keyword"] = "新增新的追蹤關鍵字";
$Definition["New keywords will be tracked in analytics. You can choose to turn off tracking after creating this keyword."] = "新關鍵字將被納入分析追蹤。建立關鍵字後，您可以選擇關閉追蹤功能。";
$Definition["Extremely Negative"] = "極為負面";
$Definition["Extremely Positive"] = "非常積極";
$Definition["Filter by:"] = "篩選條件：";
