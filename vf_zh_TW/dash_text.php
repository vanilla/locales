...
$Definition['Allow links to be transformed'] =
    '允許將鏈接轉換為討論和評論中的嵌入式表示形式。例如，YouTube鏈接將轉換為嵌入式視頻。';
...
$Definition['Recommend special ranks for admins and mods.'] = '為主持人和管理員設置特殊等級是一個好主意，這樣您的社區就可以輕鬆地看到誰負責。';
$Definition['Recommend starting with five ranks.'] = '您不想有太多的排名。我們建議從五個開始。如果您的社區很大，您可以添加更多。';
...
$Definition['This page lists the endpoints of your API.'] = '該頁面列出了您的API的端點。單擊端點以獲取更多信息。您可以從此頁面或使用訪問令牌從外部對API進行實時調用。';
$Definition['This role is personal info. Only users with permission to view personal info will see it.'] = '該角色是個人信息。只有具有查看個人信息權限的用戶才能看到它。';
$Definition['This setting loads the page before executing Javascript.'] = '此設定會在執行 Javascript 之前先載入頁面以改善您的 SEO。<br><strong>**警告：啟用本功能可能會在您的網站上導致 Javascript 錯誤。**</strong>';
