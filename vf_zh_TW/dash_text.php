...
$Definition['Allow links to be transformed'] = '允許將連結轉換為帖子和評論中的嵌入表示。例如，YouTube 連結將轉換為嵌入式影片。';
...
$Definition['ShareImageDescription'] = '當有人分享您網站的鏈接時，我們會嘗試從頁面中獲取圖像。如果頁面上沒有圖像，那麼我們將使用該圖像。圖片應至少為50×50，但我們建議為200×200。';
...
$Definition['Tagging allows users to add a tag to discussions they start in order to make them more discoverable. '] = '標記允許用戶將標記添加到他們開始的討論中，以使它們更容易被發現。';
...
$Definition['They work just like regular themes. Once one has been added to the themes folder, you can enable it here.'] = '它們就像常規主題一樣工作。將其添加到主題文件夾後，即可在此處啟用它。';
...
$Definition['TouchIconDescription'] = '當您在Apple設備的主屏幕上為網站添加書籤時，將顯示觸摸圖標。這些通常是152像素。蘋果會自動添加圓角和照明效果。';
