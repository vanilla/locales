...
$Definition['AddonProblems'] = '<h2>有問題嗎？</h2><p>如果外掛組件發生問題，導致您的網站無法使用，您可以透過編輯方式來手動關閉組件：</p>%s';
...
$Definition['Consumer Secret'] = '使用者密碼';
...
$Definition['Could not open addon file. Addons must be zip files.'] = '無法開啟附加檔案；附加檔案必須為zip格式。';
