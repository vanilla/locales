...
$Definition['You must have the MySQL driver for PDO enabled in order for Vanilla to connect to your database.'] = '您必須啟用PDO的MySQL驅動程式，才能讓Vanilla連結您的資料庫。';
$Definition['You must have the PDO module enabled in PHP in order for Vanilla to connect to your database.'] = '您必須在PHP中啟用PDO模組，才能讓Vanilla連結您的資料庫。';
