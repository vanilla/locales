...
$Definition['%s view html'] = '%s 訪問量';
$Definition['%s viewing'] = '%s 在看';
$Definition['%s views'] = '%s 訪問量';
$Definition['%s views html'] = '%s 訪問量';
...
$Definition['Already Warned'] = '已警告';
$Definition['Also banned for the following:'] = '還因爲下列原因被禁用：';
...
$Definition['Banned for the following:'] = '因為下列原因被禁用：';
$Definition['Banned users can no longer access the site.'] = '被封禁的用戶將不能再訪問本站。';
$Definition['Banner'] = '橫幅';
$Definition['BanReason.1'] = '由討論區管理員禁止。';
$Definition['BanReason.2'] = '因為 IP 位址、電子郵件或名稱被禁用。';
$Definition['BanReason.4'] = '由討論區管理員暫時禁止。';
...
$Definition['Forum Signature Settings'] = '論壇簽名設置';
...
$Definition['Who\'s Online in this Category'] = '在該分類下在線上的人';
$Definition['Who\'s Online in this Discussion'] = '在此討論組下在線上的人';
