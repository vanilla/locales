...
$Definition['Bad login, double-check your credentials and try again.'] = '登錄錯誤，請仔細檢查您的憑證後再重試。';
$Definition['Ban'] = '封鎖';
...
$Definition['default'] = '預設';
$Definition['Default notification settings can be modified for each followed category in <a href="{url,html}">Manage Followed Categories</a>.'] = '可以在<a href="{url,html}">“管理關注的類別”</a>中修改每個關注類別的默認通知設置。';
...
$Definition['Invalid user/password provided.'] = '提供的用戶/密碼無效。';
...
$Definition['Notification popup'] = '通知彈出窗口';
...
$Definition['The email digest delivers the week\'s top content from the categories you follow into your email inbox once per week. <a href="{url,html}">Manage Followed Categories</a>.'] = '電子郵件摘要每週一次將您關注的類別中的本週熱門內容髮送到您的電子郵件收件箱中。<a href="{url,html}">管理關注的類別</a>。';
