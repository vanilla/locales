...
$Definition['Comments are between {UserID,you}.'] = '評論是{UserID,您}之間的。';
...
$Definition['Don\'t fold quotes'] = '請勿加入引號';
...
$Definition['Whoops! You\'ll need to register before you can email our site.'] = '糟糕！您需先註冊才可發送電子郵件至我們的網站。';
...
$Definition['You'] = '你';
$Definition['you'] = '你';
$Definition['You\'ve asked questions that have now been answered'] = '<a href="{/discussions/mine?qna=Answered,url}"> 您詢問的問題現在已有回覆 </a>。請確認您要接受／拒絕這個答案。';
