...
$Definition['Advanced Stuff'] = '進階事物';
...
$Definition['Are you ABSOLUTELY sure you want to take this action?'] = '您是否確定絕對要採取這樣的行動？';
...
$Definition['By uploading a file you certify that you have the right to distribute this picture and that it does not violate the Terms of Service.'] = '請確認你擁有上傳的文件的版權，且圖片不違反本站的服務條款。';
...
$Definition['Not much happening here, yet.'] = '這裡什麼也沒發生。';
...
$Definition['There is already an account with the same username (%1$s) or email (%2$s) as you. You can either create a new account, or you can enter the credentials for your existing forum account.'] = '已存在同您用戶名（(%1$s）或電子郵件（%2$s）相同的帳戶。您可以創建新帳戶，或者輸入您現有論壇帳戶的證明依據。';
