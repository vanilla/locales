...
$Definition['There\'s already a %s with the name %s.'] = '已經有名稱為 %2$s 的 %1$s 了。';
...
$Definition['You'] = '你';
$Definition['you'] = '你';
$Definition['You\'re application for this group was denied.'] = '您加入該組的申請已被拒絕。';
$Definition['You\'re banned from joining this group.'] = '您已被禁止加入該組。';
$Definition['You\'ve already created the maximum number of groups.'] = '您已經創建了最大數量的群組。';
$Definition['You\'ve applied to join this group.'] = '您已經申請加入該組。';
...
$Definition['You aren\'t allowed to %s this group.'] = '您不允許 %s 該組。';
