...
$Definition['Allow links to be transformed'] =
    'लिंक को पोस्ट और टिप्पणियों में एम्बेडेड प्रस्तुतिकरण में बदलने की अनुमति दें। उदाहरण के लिए, एक YouTube लिंक एक एम्बेडेड वीडियो में बदल जाएगा।';
...
$Definition['API Overview'] = "एपीआई अवलोकन";
...
$Definition['Automatically save drafts of unpublished posts, questions, ideas and comments.'] = 'अप्रकाशित पोस्ट, प्रश्न, विचार और टिप्पणियों के ड्राफ्ट को स्वचालित रूप से सहेजें।';
...
$Definition['Most communities stick to positive reactions to encourage participation.'] = 'अधिकांश समुदाय भागीदारी को प्रोत्साहित करने के लिए सकारात्मक प्रतिक्रियाओं पर अड़े रहते हैं।';
...
$Definition['Rate Limits'] = 'दर सीमाएँ';
$Definition['Reactions Documentation'] = 'प्रतिक्रियाएँ दस्तावेज़ीकरण';
...
$Definition['Role Tokens'] = 'भूमिका टोकन';
...
$Definition['Some themes may need to be updated to work with category following. You can disable the feature while you update your theme.'] =
    'निम्नलिखित श्रेणी के साथ काम करने के लिए कुछ विषयों को अद्यतन करने की आवश्यकता हो सकती है। आप अपने विषय को अपडेट करते समय सुविधा को अक्षम कर सकते हैं।';
$Definition['Special restriction: Only users with permission Garden.Curation.Manage may use this reaction.'] =
    'विशेष प्रतिबंध: केवल अनुमति गार्डन के साथ उपयोगकर्ता। अवधि। संदेश इस प्रतिक्रिया का उपयोग कर सकते हैं।';
...
$Definition['Tagging allows users to add a tag to discussions they start in order to make them more discoverable. '] =
    'टैगिंग उपयोगकर्ताओं को उन चर्चाओं के लिए एक टैग जोड़ने की अनुमति देता है, जो उन्हें अधिक खोज योग्य बनाने के लिए शुरू करते हैं।';
...
$Definition['They work just like regular themes. Once one has been added to the themes folder, you can enable it here.'] =
    'वे नियमित थीम की तरह ही काम करते हैं। एक बार थीम फ़ोल्डर में एक जोड़ दिए जाने के बाद, आप इसे यहां सक्षम कर सकते हैं।';
...
$Definition['This page lists the endpoints of your API.'] =
    'यह पृष्ठ आपके एपीआई के अंतिम बिंदुओं को सूचीबद्ध करता है। अधिक जानकारी के लिए समापन बिंदु पर क्लिक करें। आप इस पृष्ठ से एपीआई या बाह्य रूप से एक्सेस टोकन का उपयोग करके लाइव कॉल कर सकते हैं।';
...
$Definition['This setting loads the page before executing Javascript.'] =
    'यह सेटिंग जावास्क्रिप्ट को निष्पादित करने से पहले पृष्ठ को लोड करती है जो आपके SEO को बेहतर बना सकती है। <br><strong>** चेतावनी: इस सुविधा को सक्रीय करने से आपकी साइट पर जावास्क्रिप्ट की समस्याएँ हो सकती हैं।**</strong>';
...
$Definition['TouchIconDescription'] =
    'जब आप किसी Apple डिवाइस के होमस्क्रीन पर वेबसाइट को बुकमार्क करते हैं तो टच आइकन दिखाई देता है। ये आमतौर पर 152 पिक्सल होते हैं। Apple स्वचालित रूप से गोल कोनों और प्रकाश प्रभाव जोड़ता है।';
...
$Definition['Warning: Loading tables can be slow.'] =
    '<b>चेतावनी</b> : आपका सर्वर कॉन्फ़िगरेशन तेज़ डेटा लोडिंग का समर्थन नहीं करता है। यदि आप एक बहुत बड़ी फ़ाइल आयात कर रहे हैं (200,000 से अधिक टिप्पणियाँ) तो आप अपने कॉन्फ़िगरेशन को बदलने पर विचार कर सकते हैं। अधिक जानकारी के लिए <a href="http://vanillaforums.com/porter">यहां</a> क्लिक <a href="http://vanillaforums.com/porter">करें</a> ।';
...
$Definition['We recommend enabling 1–3 reactions at a time to avoid overwhelming users.'] = 'हम अत्यधिक उपयोगकर्ताओं से बचने के लिए एक समय में 1-3 प्रतिक्रियाओं को सक्षम करने की सलाह देते हैं।';
...
$Definition['When enabled, you can <0>manage products</0>, and group subcommunities by those products.'] = 'सक्षम होने पर, आप <0>उत्पादों का प्रबंधन कर सकते हैं</0> , और उन उत्पादों के आधार पर उपसमुदायों को समूहित करें।';
...
$Definition["Remove post and categories links from menus. Set post and category related pages to return not found page 404."] = "मेनू से पोस्ट और श्रेणियों के लिंक हटाएँ। पोस्ट और श्रेणी से संबंधित पृष्ठों को नहीं मिला पृष्ठ 404 पर वापस जाने के लिए सेट करें।";
...
$Definition["Recent Post List Page"] = "हालिया पोस्ट सूची पृष्ठ";
$Definition["Custom"] = "रिवाज़";
$Definition["Category List Page"] = "श्रेणी सूची पृष्ठ";
$Definition["Home Page Type"] = "होम पेज प्रकार";
$Definition["Choose a page to serve as the subcommunity homepage."] = "उपसमुदाय होमपेज के रूप में कार्य करने के लिए एक पृष्ठ चुनें.";
$Definition["Selected Home Page Type is a custom layout. You can manage the layout for this subcommunity in <0/>."] = "चयनित होम पेज प्रकार एक कस्टम लेआउट है। आप इस उपसमुदाय के लेआउट को <0/> में प्रबंधित कर सकते हैं।";
$Definition["Default Subcommunity"] = "डिफ़ॉल्ट उपसमुदाय";
$Definition["Make this the default subcommunity. Visitors will be directed here first when they access the community."] = "इसे डिफ़ॉल्ट उपसमुदाय बनाएँ। जब आगंतुक समुदाय में प्रवेश करेंगे, तो उन्हें सबसे पहले यहाँ निर्देशित किया जाएगा।";
$Definition["Post number must be between 3–20."] = "पद संख्या 3-20 के बीच होनी चाहिए।";
$Definition["Pages"] = "पृष्ठों";
$Definition["Widget Builder"] = "विजेट बिल्डर";
$Definition["Custom Pages"] = "कस्टम पेज";
$Definition["Site Home Pages"] = "साइट होम पेज";
$Definition["Subcommunity Home Pages"] = "उपसमुदाय होम पेज";
$Definition["Choose a theme for this subcommunity.  <0>Read more</0>"] = "इस उपसमुदाय के लिए एक थीम चुनें. <0>और पढ़ें</0>";
$Definition["Vanilla Messages"] = "वेनिला संदेश";
$Definition["From <0/>"] = "<0/> से";
$Definition["Manage Products"] = "उत्पाद प्रबंधित करें";
$Definition["Pages"] = "पृष्ठों";
$Definition["Widget Builder"] = "विजेट बिल्डर";
$Definition["Custom Pages"] = "कस्टम पेज";
$Definition["Site Home Pages"] = "साइट होम पेज";
$Definition["Subcommunity Home Pages"] = "उपसमुदाय होम पेज";
$Definition["Choose a theme for this subcommunity.  <0>Read more</0>"] = "इस उपसमुदाय के लिए एक थीम चुनें. <0>और पढ़ें</0>";
$Definition["Search subcommunities."] = "उपसमुदाय खोजें.";
$Definition["The view you were looking for could not be found."] = "आप जिस दृश्य की तलाश कर रहे थे वह नहीं मिला।";
$Definition["View Not Found"] = "दृश्य नहीं मिला";
$Definition["site"] = "साइट";
$Definition["Selected Home Page Type is a legacy layout."] = "चयनित होम पेज प्रकार एक विरासत लेआउट है।";
$Definition["The default home page type can be changed in <0/>."] = "डिफ़ॉल्ट होम पेज प्रकार को <0/> में बदला जा सकता है.";

// Sentiment

$Definition["Keyword Settings"] = "कीवर्ड सेटिंग्स";
$Definition["Extremely Negative to Negative"] = "अत्यंत नकारात्मक से नकारात्मक";
$Definition["Negative to Balanced"] = "नकारात्मक से संतुलित";
$Definition["Balanced to Positive"] = "संतुलित से सकारात्मक";
$Definition["Positive to Highly Positive"] = "सकारात्मक से अत्यधिक सकारात्मक";
$Definition["Sentiment Keywords"] = "भावना कीवर्ड";
$Definition["Sentiment Settings"] = "भावना सेटिंग्स";
$Definition["Add Keyword"] = "कीवर्ड जोड़ें";
$Definition["Keyword Limit Reached"] = "कीवर्ड सीमा पूरी हो गई";
$Definition["You can only track up to 100 keywords. Untrack some to add new keywords."] = "आप अधिकतम 100 कीवर्ड ही ट्रैक कर सकते हैं। नए कीवर्ड जोड़ने के लिए कुछ कीवर्ड अनट्रैक करें।";
$Definition["Calibrate Sentiment Levels"] = "भावना के स्तर को कैलिब्रेट करें";
$Definition["Sentiment Level Distribution Adjustment"] = "भावना स्तर वितरण समायोजन";
$Definition["The 4 sliders represent the points between each sentiment level. Drag the sliders to calibrate the overall sentiment level distribution to your community's content."] = "4 स्लाइडर प्रत्येक भावना स्तर के बीच के बिंदुओं को दर्शाते हैं। अपने समुदाय की सामग्री के लिए समग्र भावना स्तर वितरण को कैलिब्रेट करने के लिए स्लाइडर को खींचें।";
$Definition["Calibrated Sentiment Distribution Preview"] = "कैलिब्रेटेड भावना वितरण पूर्वावलोकन";
$Definition["(Read Only)"] = "(केवल पढ़ने के लिए)";
$Definition["This graph visualizes how the content in your community would be distributed based on your calibration adjustment."] = "यह ग्राफ दर्शाता है कि आपके अंशांकन समायोजन के आधार पर आपके समुदाय में सामग्री किस प्रकार वितरित की जाएगी।";
$Definition["all time sentiment"] = "सर्वकालिक भावना";
$Definition["keyword"] = "कीवर्ड";
$Definition["number of uses"] = "उपयोगों की संख्या";
$Definition["last use"] = "अंतिम उपयोग";
$Definition["tracking"] = "ट्रैकिंग";
$Definition["Sentiment"] = "भाव";
$Definition["Tracked Status"] = "ट्रैक की गई स्थिति";
$Definition["Tracked Only"] = "केवल ट्रैक किया गया";
$Definition["Untracked Only"] = "केवल अनट्रैक्ड";
$Definition["Strongly Negative"] = "दृढ़तापूर्वक नकारात्मक";
$Definition["Negative"] = "नकारात्मक";
$Definition["Positive"] = "सकारात्मक";
$Definition["Highly Positive"] = "अत्यधिक सकारात्मक";
$Definition["Clear all filters"] = "सभी फ़िल्टर साफ़ करें";
$Definition["Keyword is required."] = "कीवर्ड आवश्यक है.";
$Definition["Maximum length is 100 characters."] = "अधिकतम लंबाई 100 अक्षर है.";
$Definition["Keyword"] = "कीवर्ड";
$Definition["Add a new tracked keyword"] = "एक नया ट्रैक किया गया कीवर्ड जोड़ें";
$Definition["New keywords will be tracked in analytics. You can choose to turn off tracking after creating this keyword."] = "नए कीवर्ड एनालिटिक्स में ट्रैक किए जाएँगे। आप यह कीवर्ड बनाने के बाद ट्रैकिंग बंद कर सकते हैं।";
$Definition["Extremely Negative"] = "अत्यंत नकारात्मक";
$Definition["Extremely Positive"] = "अत्यंत सकारात्मक";
