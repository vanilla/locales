...
$Definition['Although the invitation was created successfully, the email failed to send. The server reported the following error: %s'] = 'हालाँकि आमंत्रण सफलतापूर्वक बनाया गया था, लेकिन ईमेल भेजने में विफल रहा। सर्वर ने निम्न त्रुटि की सूचना दी: %s';
...
$Definition['Garden.Import.Continue.Description'] = 'ऐसा प्रतीत होता है जैसे आप किसी आयात के बीच में हैं।
    कृपया निम्न में से कोई एक विकल्प चुनें।';
...
$Definition['Warning: Loading tables can be slow.'] = '<b>चेतावनी</b>: आपका सर्वर कॉन्फ़िगरेशन तेज़ डेटा लोडिंग का समर्थन नहीं करता है।
यदि आप एक बहुत बड़ी फ़ाइल आयात कर रहे हैं (200,000 से अधिक टिप्पणियाँ) तो आप अपने कॉन्फ़िगरेशन को बदलने पर विचार कर सकते हैं। अधिक जानकारी के लिए <a href="http://vanillaforums.com/porter"> यहां </a> पर क्लिक करें।';
