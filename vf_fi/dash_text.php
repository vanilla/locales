...
$Definition['Deleting a role can result in users not having access to the application.'] = '<strong>Huom!</strong> Roolin poistaminen voi aiheuttaa sen, ettei tietyill&auml; k&auml;ytt&auml;jill&auml; ole en&auml;&auml; p&auml;&auml:;sy&auml; palstallesi.';
...
$Definition['Garden.StatisticsDisabled'] = 'Olet konfiguraatiotiedostossasi erikseen poistanut Vanillan tilastoraportit k&auml;yt&ouml;st&auml;.';
$Definition['Garden.StatisticsLocal.Explain'] = 'Vaikuttaa silt&auml;, ett&auml; foorumisi pyörii testiymp&auml;rist&ouml;ss&auml; tai sen IP-osoite on muusta syyst&auml; yksityinen. Oletuksena tilastoja ei ker&auml;t&auml; foorumeista, joiden IP-osoite ei ole julkinen.';
$Definition['Garden.StatisticsLocal.Resolve'] = 'Jos olet varma, ett&auml; foorumisi on internetin kautta tavoitettavissa, voit  t&auml;ss&auml; pakottaa sen raportoimaan tilastotiedot:';
...
$Definition['Marking things as NOT spam will put them back in your forum.'] = 'Sis&auml;ll&ouml;n merkitseminen EI roskaviestiksi tuo sen takaisin n&auml;kyviin foorumissa.';
...
$Definition['Ready-made Vanilla Forum Plugin for WordPress'] = 'Valmis Vanilla Forum-lis&auml;osa WordPressille';
...
$Definition['Restoring your selection removes the items from this list.'] = 'Kun valitset \'Palauta\', kohteet poistetaan tästä luettelosta ja siirret&auml;&auml;n takaisin sivustolle.';
...
$Definition['The banner title appears on the top-left of every page.'] = 'Bannerin otsikko n&auml;kyy sivustosi kaikkien sivujen yl&auml;osassa vasemmalla puolella.';
...
$Definition['Vanilla Export: %s, Source: %s'] = 'Vanilla Vienti: %s, L&auml;hde: %s';
