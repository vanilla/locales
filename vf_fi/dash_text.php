...
$Definition['Recommend special ranks for admins and mods.'] =
    'Moderaattoreilla ja järjestelmänvalvojilla on hyvä olla erikoisluokituksia, jotka kertovat yhteistölle heidän arvojärjestyksestään.';
$Definition['Recommend starting with five ranks.'] =
    'Liikaa luokituksia ei kannata olla. Suosittelemme aloittamaan viidellä. Voit lisätä niitä, jos yhteisösi on poikkeuksellisen suuri.';
...
$Definition['This setting loads the page before executing Javascript.'] =
    'Tämä asetus lataa sivun ennen SEO:tasi parantavan Javascriptin käynnistämistä.<br><strong>**Varoitus: tämän ominaisuuden käyttöönotto voi aiheuttaa Javascript-häiriöitä sivullasi.**</strong>';
...
$Definition['Which reactions you use really depends on your community.'] =
    'Käyttämäsi reaktiot riippuvat paljolti yhteisöstäsi, mutta suosittelemme ottamaan eräät seikat huomioon.';
