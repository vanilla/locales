...
$Definition['RichEditor.QuoteEnable.Notes'] = 'Käytä seuraavia vaihtoehtoja mahdollistaaksesi lainausten käyttö rikastetun tekstin muokkaustyökalussa. Tätä voidaan käyttää ainoastaan, jos oletusarvona on "rikastettu".';
...
$Definition['This setting loads the page before executing Javascript.'] = 'Tämä asetus lataa sivun ennen Javascriptin käyttöä, mikä voi parantaa hakukoneoptimointiasi.<br><strong>**Varoitus: tämän ominaisuuden käyttöönotto voi aiheuttaa Javascript-virheitä sivustollasi.**</strong>';
