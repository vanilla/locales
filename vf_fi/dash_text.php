...
$Definition['<strong>Heads Up!</strong> Deleting a role can result in users not having access to the application.'] = '<strong>Huom!</strong> Roolin poistaminen voi aiheuttaa sen, ettei tietyillä käyttäjillä ole enää pääsyä palstallesi.';
...
$Definition['About.DisableStatistics'] = 'Jos joudut poistamaan raportoinnin käytöstä esimerkiksi business-syistä, tee se lisäämällä oheinen rivi Vanilla-asennuksesi konfiguraatiotiedostoon: <code>$Configuration[\'Garden\'][\'Analytics\'][\'Enabled\'] = FALSE;</code>';
...
$Definition['Define who can upload files on the Roles & Permissions page.'] = 'Määrittele, ketkä voivat ladata ja hallinnoida tiedostoja <a href="%s">Roles & Permissions</a> -sivulla.';
$Definition['Define your forum homepage, upload your logo, and more...'] = 'Määritä foorumin kotisivu, lataa logo jne..';
$Definition['Deleting a role can result in users not having access to the application.'] = '<strong>Huom!</strong> Roolin poistaminen voi aiheuttaa sen, ettei tietyillä käyttäjillä ole enää pääsyä palstallesi.';
$Definition['Deleting forever cannot be undone.'] = 'Poistaminen on hyvä tapa pitää forum siistinä.';
$Definition['Digest Settings'] = 'Tiivistelmäasetukset';
...
$Definition['Every edit or deletion is recorded here. Use &lsquo;Restore&rsquo; to undo any change.'] = 'Jokainen muokkaus ja poisto tallennetaan tänne. Käytä toimintoa ‘Peruuta’ kumotaksesi muutokset.';
...
$Definition['Failed to connect to the database with the username and password you entered. Did you mistype them? The database reported: <code>%s</code>'] = 'Yhdistäminen tietokantaan epäonnistui antamallasi käyttäjätunnuksella ja salasanalla. Tarkista tiedot ainakin kirjoitusvirheiden osalta. Tietokannan vastaus:  <code>%s</code>';
...
$Definition['Prevent spam on your forum by limiting the number of discussions &amp; comments that users can post within a given period of time.'] = 'Ehkäise foorumille tulevia roskaviestejä rajoittamalla sitä, kuinka monta uutta keskustelua ja/tai kommenttia yksittäinen käyttäjä voi lähettää määrätyn ajan puitteissa.';
...
$Definition['Recommended dimensions are about 400px by 300px or smaller with similar ratio.'] = 'Suositeltavat mitat ovat noin 400 x 300 pikseliä tai pienempiä samanlaisilla suhteilla.';
$Definition['Recommend special ranks for admins and mods.'] = 'Moderaattoreilla ja järjestelmänvalvojilla on hyvä olla erikoisluokituksia, jotka kertovat yhteistölle heidän arvojärjestyksestään.';
$Definition['Recommend starting with five ranks.'] = 'Liikaa luokituksia ei kannata olla. Suosittelemme aloittamaan viidellä. Voit lisätä niitä, jos yhteisösi on poikkeuksellisen suuri.';
...
$Definition['Requires “Flag” reaction permission.'] = 'Vaatii “Ilmoita”-reaktiovaltuudet.';
$Definition['Requires “Negative” reaction permission.'] = 'Vaatii "Negatiivinen"-reaktion valtuudet.';
$Definition['Requires “Positive” reaction permission.'] = 'Vaatii "Positiivinen"-reaktiovaltuudet.';
...
$Definition['Search for users by name or enter the name of a role to see all users with that role.'] = 'Etsi käyttäjiä nimellä tai antamalla se rooli, josta haluat listata kaikki käyttäjät.';
...
$Definition['Select the default type for this role, if any.'] = 'Valitse tämän roolin oletustyyppi, jos sellainen on.';
$Definition['Select the import source'] = 'Valitse tuontilähde';
$Definition['Serialized column "%s" failed to be unserialized.'] = 'Serialisoidun sarakkeen "%s" serialisointia ei voitu kumota.';
$Definition['Session Timeout'] = 'Istunto vanhentunut';
...
$Definition['The addon could not be enabled because it generated a fatal error: <pre>%s</pre>'] = 'Lisäosaa ei voitu ottaa käyttöön, koska se tuotti virheen: <pre>%s</pre>';
$Definition['The addon has already been downloaded.'] = 'Lisäosa on jo ladattu.';
$Definition['The banner logo appears at the top of your forum.'] = 'Bannerin logo näkyy sivustosi yläosassa.';
$Definition['The banner title appears on the top-left of every page.'] = 'Bannerin otsikko näkyy sivustosi kaikkien sivujen yläosassa vasemmalla puolella.';
$Definition['The banner title appears on your site\'s banner and in your browser\'s title bar.'] = 'Bannerin otsikko näkyy sivustosi bannerin yhteydessä sekä selaimen otsikkopalkissa. Sen maksipituus on 20 merkkiä. Jos lataat banneriin logon, se korvaa forumin julkisella puolella käyttäjille näkyvän bannerin otsikon. Huomioithan myös että kaikki teemat eivät näytä otsikkoa oletuksena.';
...
$Definition['The database user you specified does not have permission to access the database. Have you created the database yet? The database reported: <code>%s</code>'] =
    'Määrittelemälläsi tietokantakäyttäjällä ei ole käyttöoikeutta tietokantaan. Oletko jo luonut tietokannan? Tietokanta ilmoittaa: <code>%s</code>';
...
$Definition['The Vanilla 2 Exporter'] = 'Vanilla 2 Vientityökalu';
$Definition['The Vanilla Statistics plugin turns your forum\'s dashboard into an analytics reporting tool'] = 'Vanillan statistiikka-lisäosan avulla seuraat forumisi aktiivisuutta helposti suoraan ylläpidon kojelaudalta. Voit tutkia tilastoja eri aikaväleillä. Lisätietoja <a href="http://vanillaforums.org/docs/vanillastatistics">Vanillan statistiikasta</a> löydät dokumentaatiostamme.';
...
$Definition['This role is personal info. Only users with permission to view personal info will see it.'] = 'Tämä rooli sisältää henkilökohtaisia tietoja. Se on ainoastaan henkilökohtaisten tietojen katseluvaltuudet omaavien henkilöiden nähtävissä.';
$Definition['This setting loads the page before executing Javascript.'] = 'Tämä asetus lataa sivun ennen SEO:tasi parantavan Javascriptin käynnistämistä.<br><strong>**Varoitus: tämän ominaisuuden käyttöönotto voi aiheuttaa Javascript-häiriöitä sivullasi.**</strong>';
...
$Definition['TouchIconDescription'] =
    'Kosketuskuvake ilmestyy näkyviin liittäessäsi kirjanmerkin Apple-laitteen kotinäytöllä. Niissä on yleensä 152 pikseliä. Apple lisää pyöristetyt kulmat ja valaistuksen automaattisesti.';
...
$Definition['VerifyUser'] = 'Valitse käyttäjän vieressä oleva valintaruutu merkitäksesi hänet <b>vahvistetuksi,</b> jotta hänen viestinsä ei enää merkitä roskapostiksi. Tämä palauttaa myös kaikki heidän odottavat viestinsä.';
$Definition['Video tutorial on advanced settings'] = 'Lisäasetuksien video-opas';
$Definition['Video tutorial on finding &amp; managing users'] = 'Video-opas roolien ja oikeuksien hallinnasta';
$Definition['Video tutorial on managing appearance'] = 'Video-opas ulkonäön hallintaan';
...
$Definition['Video tutorial on user registration'] = 'Video-opas käyttäjän rekisteröitymisestä';
...
$Definition['You can choose from one of the different styles this theme offers.'] = 'Voit valita yhden tämän teeman tarjoamista erilaisista tyyleistä.';
$Definition['You can connect to multiple sites that support jsConnect.'] = 'Voit liittää useita sivustoja, jotka tukevat jsConnectia.';
...
// Theme Chooser
$Definition["Your mobile theme will be disabled."] = "Matkapuhelimesi teema poistetaan käytöstä. Voit määrittää erilaisia mobiili- ja työpöytäteemoja käyttämällä vanhaa theming-käyttöliittymää.";
...
$Definition["Theming Guide"] = "Theming-opas";
...
$Definition['Templates are the standard themes. To customize them, you have to create a copy.'] = 'Pohjamallit ovat standarditeemoja. Niiden muokkaaminen vaatii kopion luomisen.';
...
$Definition["This theme cannot be deleted because it is the currently applied theme."] = "Tätä teemaa ei voida poistaa, koska se on parhaillaan käytössä.";
$Definition["Are you sure want to delete this theme? It will be permanently deleted."] = "Tahdotko varmasti poistaa tämän teeman? Se poistetaan pysyvästi.";
...
$Definition["There are two types of buttons in the application: primary and secondary."] = "Sovelluksessa on kahdentyyppisiä painikkeita: ensisijainen ja toissijainen.";
$Definition["Primary Button"] = "Ensisijainen painike";
$Definition["Secondary Button"] = "Toissijainen painike";
...
$Definition["Shadowed"] = "Varjostettu";

$Definition["Full Bleed"] = "Ei rajausta";
$Definition["When you select Full Bleed, your background is transparent."] = "Valitessasi \"Ei rajausta\" -vaihtoehdon taustasta tulee läpinäkyvä.";
...
$Definition["Alignment (Mobile)"] = "Suuntaus (mobiili)";
...
$Definition['This lab cannot be disabled because a custom layout is applied.'] = 'Tätä laboratoriota ei voi poistaa käytöstä, koska mukautettua asettelua käytetään.';
...
$Definition['Check out our <0>documentation</0>, or ask our <1>community of experts</1>.'] = 'Tutustu <0>dokumentaatioomme</0> tai kysy <1>asiantuntijayhteisöltämme</1> .';
$Definition['Enable and test out the latest Vanilla features.'] = 'Ota käyttöön ja testaa uusimmat Vanilla -ominaisuudet.';
$Definition['The <0/> lab needs to be configured to match your custom theme.'] = 'Huom. <0/> -laboratorio on määritettävä vastaamaan mukautettua teemaa. Tämä voidaan tehdä käyttämällä uutta teemaeditoria. <1> Lisätietoja.</1>';
...
$Definition["Vanilla's new search service is finally here."] = "Vanillan uusi hakupalvelu on vihdoin täällä. Ota uusi hakusivumme käyttöliittymä käyttöön saadaksesi pääsyn uusimpiin hakuominaisuuksiin, kuten jäsenhakuun, hakujen lajitteluun ja termien korostamiseen.";
...
$Definition['The New Embed System'] = 'Uusi upotusjärjestelmä';
$Definition['The new embed system has improved performance.'] = 'Uuden upotusjärjestelmän suorituskyky on parantunut, vierityskäyttäytyminen on parantunut ja toiminta on johdonmukaisempaa kuin vanha. Uudessa upotusjärjestelmässä ei tällä hetkellä tueta kommentointi- ja wordpress-upotuksia.';
$Definition['New Embed System'] = 'Uusi upotusjärjestelmä';
$Definition['See the documentation'] = 'Katso dokumentaatio';
$Definition['Looking for the Old Embed System?'] = 'Etsitkö vanhaa sulautusjärjestelmää?';
$Definition['Disable the "New Embed System" lab on the <0>Vanilla Labs Page</0>'] = 'Poista "New Embed System" -laboratorio käytöstä <0>Vanilla Labs -sivulta</0>';
