...
$Definition['Allow links to be transformed'] = 'Salli linkkien muuntaminen upotetuiksi esityksiksi viesteissä ja kommenteissa. Esimerkiksi YouTube-linkki muuttuu upotetuksi videoksi.';
...
$Definition['ShareImageDescription'] = 'Jonkun jakaessa linkin sivustoltasi pyrimme ottamaan mukaan kuvan kyseiseltä sivulta. Jos sivulla ei ole kuvia, niin silloin käytössä on tämä kuva. Kuvan on oltava vähintään 50x50-kokoinen, ja suositeltu koko on 200x200. ';
...
$Definition['Tagging allows users to add a tag to discussions they start in order to make them more discoverable. '] = 'Tunnisteiden avulla käyttäjät voivat lisätä tunnisteita aloittamiinsa keskusteluihin helpottaakseen niiden löytämistä.';
...
$Definition['TouchIconDescription'] = 'Kosketuskuvake ilmestyy näkyviin liittäessäsi kirjanmerkin Apple-laitteen kotinäytöllä. Niissä on yleensä 152 pikseliä. Apple lisää pyöristetyt kulmat ja valaistuksen automaattisesti.';
