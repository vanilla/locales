...
$Definition['Choose a role that orphaned users will be assigned to:'] = 'Valitse rooli mikä annetaan käyttäjille oletuksena:';
...
$Definition['Locales allow you to support other languages on your site.'] = 'Lokalisoinnit antavat mahdollisuuden tukea muita kieliä sivustollasi. Ota käyttöön tai pois käytöstä lokalisoinnit, jotka haluat täällä saataville. ';
...
$Definition['Routes are used to redirect users.'] = 'Reittejä käytetään ohjaamaan käyttäjiä uudelleen riippuen pyydetystä osoitteesta. ';
...
$Definition['Spruce up your emails by adding a logo and customizing the colors.'] = 'Viimeistele sähköpostisi lisäämällä logo ja muokkaamalla värejä. ';
$Definition['Start Discussions'] = 'Aloita keskusteluja';
$Definition['Start Import'] = 'Aloita tuonti';
$Definition['Start the first discussion.'] = 'Laita foorumisi toden teolla käyntiin <a href="{/post/discussion,url}">aloittamalla ensimmäinen keskustelu</a> nyt. ';
