...
$Definition['%1$s version %2$s is available.'] =
    '%1$s versio %2$s on saatavilla.';
$Definition["%s is not a valid email address"] =
    "%s on virheellinen sähköpostiosoite";
...
$Definition["%s user(s) will be affected by this action."] =
    "%s jäsen(tä) ovat tämän toiminnon alaisia.";

$Definition["<0/> will suggest answers on Q&A posts"] =
    "<0/> ehdottaa vastauksia K&V-viesteihin";
$Definition["<0 /> will not suggest answers on Q&A posts"] =
    "<0 /> ei ehdota vastauksia K&V-viesteihin";
...
$Definition["1 in 5 is recommended for most communities."] =
    "1/5 suositellaan useimmille yhteisöille.";
$Definition["1 in 20 is recommended for most communities."] =
    "1/20 suositellaan useimmille yhteisöille.";
...
$Definition["[%s] Confirm Your Email Address"] =
    "[%s] | Vahvista sähköpostiosoitteesi";
...
] = 'Olet saavuttanut enimmäiskirjautumisyritysten enimmäismäärän. Odota %s ja yritä uudelleen.';
...
$Definition["A unique label name that cannot be changed once saved."] =
    "Ainutlaatuinen tunnisteen nimi, jota ei voi muuttaa tallennuksen jälkeen.";
...
$Definition['"Accept Answer" if a suggestion answers your question.'] =
    '"Hyväksy vastaus", jos ehdotus vastaa kysymykseesi.';
...
$Definition["Accepted answer pageview ratio representing a deflected case"] =
    "Hyväksytty vastaussivun katselusuhde, joka edustaa poikkeavaa tapausta";
...
$Definition[
    ...
    "Lisää Zoom-linkki tai kokoustunnus yhdistääksesi tämän tapahtuman Zoomiin ja salliaksesi rekisteröinti- ja liittymispainikkeet yhdellä napsautuksella. Huomaa, että jos tapahtumasi vaatii rekisteröitymisen, et voi päivittää kokoustunnustasi tai linkkiäsi tapahtuman luomisen jälkeen.";
...
$Definition[
    ...
    "Lisää mukautetut Kaltura-verkkotunnuksesi muuttaaksesi linkit upotetuiksi videoiksi keskusteluissa, kommenteissa tai artikkeleissa.";
$Definition[
    "Add your custom Kaltura domain(s) to transform links into embedded videos in posts, comments or articles."
] =
    "Lisää mukautetut Kaltura-verkkotunnuksesi muuttaaksesi linkit upotetuiksi videoiksi viesteissä, kommenteissa tai artikkeleissa.";
...
$Definition["Advanced settings for embedded community elements"] =
    "Edistyneet asetukset upotetuille forumin osille";
...
$Definition["AI Suggestions are not enabled"] =
    "AI-ehdotukset eivät ole käytössä";
$Definition[
    ...
    "AI Suggested Answers tarjoaa vastausehdotuksia, jotka perustuvat yhteisön viesteihin ja linkitettyihin tietokantoihin. Voit ottaa tämän käyttöön tai poistaa sen käytöstä milloin tahansa profiiliasetuksissasi.";
$Definition[
    "Alert users if they click a link in a post that will lead them away from the forum. "
] =
    "Varoita käyttäjiä, jos he klikkaavat merkintää, joka vie heidät pois foorumilta.";
...
$Definition["All discussions in this category will be permanently deleted."] =
    "Kaikki keskustelut tässä kategoriassa poistetaan lopullisesti.";
...
$Definition[
    ...
    "Kaikki käyttäjän lähettämä sisältö korvataan viestillä, jossa kerrotaan jäsenen olevan poistettu.";
...
$Definition["Allow this connection to issue API access tokens."] =
    "Anna tälle yhteydelle valtuudet API-käyttöoikeustunnusten myöntämiseen";
$Definition["Allow Third-Party Script Execution"] =
    "Salli kolmannen osapuolen komentosarjan suorittaminen";
$Definition["Allow users to change their own avatars"] =
    "Anna käyttäjien vaihtaa hahmokuviaan";
$Definition["Allow users to dismiss this message"] =
    "Anna käyttäjien sivuuttaa tämä viesti.";
...
$Definition["An enabled message will be visible on the site."] =
    "Sallittu viesti tulee näkyviin sivustolle.";
$Definition["An answer in this the community thread was marked as accepted"] =
    "Vastaus tässä yhteisöketjussa merkittiin hyväksytyksi";
$Definition["An error occurred updating your privacy setting"] =
    "Tietosuoja-asetusta päivitettäessä tapahtui virhe";
$Definition["Anonymize Analytics Data by Default"] =
    "Anonymisoi Analytics-tiedot oletuksena";
$Definition["Answers is not available if you have not accepted cookies."] =
    "Vastaukset eivät ole käytettävissä, jos et ole hyväksynyt evästeitä.";
$Definition["API"] = "API";
...
$Definition["Applicant Role"] =
    "Valitse rooli, jota käytetään jäsenyyttä hakevien uusien käyttäjien kohdalla. Tämä valinta on käytössä vain jos olet valinnut rekisteröitymistavaksi manuaalisen <b>hyväksynnän</b> ylläpidon toimesta.";
...
$Definition["Are you sure you want to delete %s items forever?"] =
    "Oletko varma, että haluat poistaa valitut %s kohteet lopullisesti?";
$Definition["Are you sure you want to delete 1 item forever?"] =
    "Oletko varma, että haluat poistaa valitun kohteen lopullisesti?";
$Definition[
    "Are you sure you want to delete this badge? This is irreversible and will revoke the badge from all users who have it."
] =
    "Oletko varma että haluat poistaa tämän kunniamerkin? Toiminto on peruuttamaton ja poistaa kyseisen merkin myös kaikilta niiltä, joille se on jo myönnetty.";
$Definition["Are you sure you want to delete this category?"] =
    "Oletko varma, että haluat poistaa tämän kategorian?";
$Definition["Are you sure you want to restore %s items?"] =
    "Oletko varma, että haluat palauttaa valitut %s kohdetta?";
$Definition["Are you sure you want to restore 1 item?"] =
    "Oletko varma, että haluat palauttaa valitun kohteen?";
$Definition[
    "Are you sure you want to turn off all AI Suggested Answers? You can undo this in your profile settings at anytime."
] =
    "Oletko varma, että haluat poistaa käytöstä kaikki AI-ehdotukset? Voit peruuttaa tämän milloin tahansa profiiliasetuksistasi.";
$Definition["Assistant Tone of Voice"] = "Assistant Tone of Voice";
...
] = "Vähintään yksi näkyvä sarake vaaditaan. Näytä tai lisää näkyvä sarake.";
$Definition["A url-friendly version of the category name for better SEO."] =
    "Url-ystävällinen versio kategorian nimestä hakukoneita varten.";
...
$Definition[
    ...
    "Ennen kuin otat tämän ominaisuuden käyttöön, ota huomioon seuraavat mahdolliset seuraukset:";
...
$Definition["Bookmark a discussion using its star icon."] =
    "Anna keskustelulle kirjanmerkki tähtikuvakkeen avulla.";
...
$Definition["Browse for a new banner logo if you would like to change it:"] =
    "Selaa bannerin uusi logo koneeltasi vaihtaaksesi sen:";
...
$Definition["Cannot build profile information if user is not defined."] =
    "Profiilin tietoja ei voida luoda jos käyttäjää ei ole määritetty.";
$Definition["Categories &amp; Discussions"] = "Kategoriat & keskustelut";
$Definition["Categories to Exclude from AI Answers"] =
    "Tekoälyvastauksista poissuljettavat luokat";
$Definition["Categories are used to organize discussions."] =
    "Kategoriat auttavat käyttäjiäsi järjestämään keskustelut tavalla, joka on merkityksellinen yhteisöllesi. ";
$Definition["Categories are used to organize posts."] =
    "Luokkien avulla käyttäjät voivat järjestää viestinsä tavalla, joka on merkityksellistä yhteisöllesi.";
$Definition["Categories allow you to organize your posts."] =
    "Luokkien avulla voit järjestää viestisi.";
...
$Definition["Click here to carry on to your dashboard"] =
    "Klikkaa tästä jatkaaksesi paneeliisi";
...
$Definition[
    ...
    "Ota yhteyttä Vanilla Staffiin saadaksesi Q&A-sivuston määritykset käyttöön. Ota sitten Q&A-lisäosa käyttöön kojelaudan Lisäosat-osiossa.";
$Definition[
    ...
    "Ota yhteyttä Vanilla Staffiin saadaksesi Q&A-sivuston määritykset käyttöön. Ota sitten käyttöön Q&A-lisäosa hallintapaneelin <0/>-osiossa.";
$Definition["Content Curation"] = "Sisällön valvonta";
$Definition["Content flagged as spam is stored here for moderator review."] =
    "Sisältö, joka on merkitty roskaviesteiksi, tallennetaan tänne odottamaan ylläpidon arviointia.";
...
$Definition[
    ...
    "Voi aiheuttaa haavoittuvuuksia, kuten Cross-Site Scripting (XSS), jos alkuperäiset komentosarjat vaarantuvat.";
$Definition['Could not find a theme identified by \'%s\''] =
    'Teemaa nimeltä \'%s\' ei löytynyt';
...
$Definition["Could not open addon file. Addons must be zip files."] =
    "Lisäosan tiedostoa ei voitu avata. Lisäosien pitää olla zip-tiedostomuodossa.";
$Definition["Create & organize discussion categories and manage your users."] =
    "Luo ja järjestele keskustelujen kategoroita sekä hallinnoi forumisi käyttäjiä.";
...
$Definition["Disabled: The pocket will <b>not</b> be displayed."] =
    "Pois käytöstä: Taskua <b>ei</b> näytetä.";
...
$Definition["Do not display the categories in the side panel."] =
    "Älä listaa kategorioita sivupaneelissa.";
...
$Definition[
    ...
    "Email Digest Prompt Widget on käytettävissä, kun sähköpostitiivistelmä on käytössä.";
...
$Definition[
    ...
    "Sähköpostitiivistelmät lähetetään valittuna päivänä joka viikko. Muutokset asetettuun päivään tulevat voimaan seuraavalla viikolla.";
...
$Definition["Embedding is currently DISABLED."] =
    "Upottaminen on tällä hetkellä pois käytöstä";
$Definition["Embedding is currently ENABLED."] =
    "Upottaminen on tällä hetkellä käytössä";
...
$Definition["Enable sending notification emails"] =
    "Ota ilmoitussähköpostien lähettäminen käyttöön";
...
$Definition["Enable to only show posts from categories a user follows."] =
    "Ota käyttöön vain käyttäjän seuraamien luokkien viestien näyttäminen.";
$Definition[
    "Enable to get a preview of our new user management dashboard with improved search and new configuration options."
] =
    "Ota käyttöön, niin saat esikatselun uudesta käyttäjähallinnan hallintapaneelistamme, jossa on parannettu haku ja uudet määritysvaihtoehdot.";
...
$Definition[
    ...
    "Tämän ominaisuuden ottaminen käyttöön muuttaa sisällön suojauskäytäntöäsi siten, että se luottaa muihin komentosarjoihin, jotka mukautetut komentosarjat ovat lisänneet riippuvuuksina.";
$Definition[
    ...
    'Tämän ominaisuuden käyttöönotto muuttaa sivustosi sisällön suojauskäytäntöä (CSP) siten, että nykyisen luotettujen verkkotunnusten luettelossasi olevat hyväksytyt skriptit voivat ladata dynaamisesti muita komentosarjoja. Se lisää \'tiukka-dynaamisen\' -ohjeen CSP:hen, mikä tarjoaa enemmän joustavuutta kolmannen osapuolen sisällyttämiseen. sisältö.';
$Definition["Encourage your friends to join your new community!"] =
    "Kannusta ystäviäsi liittymään uuteen yhteisöösi!";
...
$Definition["Enter the email address of the person you would like to invite:"] =
    "Anna kutsuttavan henkilön sähköpostiosoite:";
$Definition[
    "Enter the url to the page you would like to use as your homepage"
] = "Anna sen sivun url jota haluat käytettävän forumin etusivuna";
$Definition[
    "Enter the url to the page you would like to use as your homepage:"
] = "Anna sen sivun url jota haluat käytettävän forumin etusivuna:";
$Definition["Error sending email. Please review the addresses and try again."] =
    "Sähköpostin lähettämisessä tapahtui virhe. Ole hyvä ja tarkasta osoite ja yritä uudelleen.";
...
$Definition["Exclude archived discussions from the discussions list"] =
    "Älä näytä arkistoituja keskusteluja keskusteluiden päänäkymässä.";
$Definition["Existing members send invitations to new members."] =
    "Nykyiset jäsenet voivat kutsua uusia jäseniä kutsu-toiminnallisuudella.";
...
$Definition[
    ...
    "Ulkoinen haku korvaa Vanilla's out of box -haun valitsemallasi kolmannen osapuolen hakupalveluntarjoajalla.";
...
$Definition["FaviconBrowse"] =
    "Selaa omalta koneelta uusi favicon vaihtaaksesi sen:";
$Definition["FaviconDescription"] =
    "Sivustosi favicon näkyy selaimesi otsikkopalkissa. Se skaalataan kokoon sopivaksi.";
...
$Definition[
    ...
    "Jos haluat sallia esimerkiksi verkkotunnuksesi.fi, www.omaverkkotunnus.fi ja ohje.verkkotunnus.fi, lisää *.omaverkkotunnus.com";
$Definition["Force the forum to only be accessible through this url"] =
    "Pakota foorumille pääsy vain tämän linkin kautta";
...
$Definition["Full post in email notifications"] =
    "Koko postaus sähköposti-ilmoituksissa";

$Definition["Garden"] = "Garden";
$Definition["Garden.api.ssoIDPermission.description"] =
    "Tämän luvan omaavat roolit voivat laajentaa SSO-tunnuksia API v2 -puheluissa.";
...
$Definition[
    ...
    "Ehdotusten luominen. Saat ilmoituksen, kun ne ovat valmiita sinun arvioitavaksi.";
...
$Definition[
    ...
    "Tervehdys. Olen tekoälysuositusassistenttisi auttaakseni sinua löytämään osuvia artikkeleita ja viestejä kysymyksiisi vastaamiseksi. Kysy rohkeasti kysymyksiä.";
$Definition["guest"] = "vieras";
$Definition["Guest roles"] =
    "Valitse ne kaikki roolit, joihin vieras/rekisteröitymätön käyttäjä kuuluu.";
...
$Definition["HeadlineFormat.RegistrationApproval"] =
    "{ActivityUserID,user} hyväksyi hakemukset jäsenille {RegardingUserID,user}.";
...
$Definition["Hide discussions from Recent Discussions and Widgets."] =
    "Piilota keskustelut Viimeaikaisista keskusteluista ja widgeteistä.";
$Definition["Hide posts from Recent Posts Page and Widgets."] =
    "Piilota viestit Uusimmat viestit -sivulta ja widgeteistä.";
...
$Definition["Hide signatures on embedded comments"] =
    "Piilota sisällytettyjen kommenttien allekirjoitukset";
...
$Definition[
    ...
    "Tämä lisää kuitenkin vastuuta sivustosi turvallisuuden varmistamisesta.";
$Definition["Html"] = "HTML";
$Definition["HTML Emails"] = "HTML-sähköpostit";
$Definition["HTTP Strict Transport Security (HSTS) Settings"] =
    "HTTP Strict Transport Security (HSTS):n  asetukset";
...
$Definition["If left empty, Email Logo is used."] =
    "Jos jätetään tyhjäksi, käytetään sähköpostilogoa.";
$Definition[
    ...
    "Jos yllä olevassa kohdassa 'Linkki käyttöehtoihin' on linkki sisäiseen asiakirjaan, 'Käyttöehtojen teksti' ohitetaan. Poista linkki, jos haluat käyttää tätä tekstiä.";
...
$Definition["Include full post in email notifications"] =
    "Lisää julkaisu kokonaisuudessaan sähköposti-ilmoituksiin";
...
$Definition["Include featured images with posts in email digest"] =
    "Sisällytä suositeltuja kuvia postauksiin sähköpostitiivistelmään";
$Definition["Include internal profile fields"] =
    "Sisällytä sisäiset profiilikentät";
$Definition["Include private profile fields"] =
    "Sisällytä yksityisen profiilin kentät";
...
$Definition["Install Vanilla without a .htaccess file."] =
    "Asenna Vanilla ilman .htaccess -tiedostoa.";
...
$Definition["It looks like you edited your post. <0/> or <1/>."] =
    "Näyttää siltä, että olet muokannut viestiäsi. <0/> tai <1/>.";
...
$Definition["Large images will be scaled down."] =
    "Isot kuvat skaalataan maksimileveyteen %spx ja maksimikorkeuteen %spx. ";
...
$Definition["Limits: 60 characters, no breaks."] =
    "Rajoitukset: 60 merkkiä, ei taukoa.";
...
$Definition["List of discussion IDs to delete."] =
    "Luettelo poistettavista keskustelutunnuksista.";
...
$Definition["Make sure you select at least one item before continuing."] =
    "Tee ainakin yksi valinta ensin jatkaaksesi.";
$Definition["Add your site to trusted domains."] =
    "Varmista, että sivustosi on lisätty kohteeseen %s upotuksen ollessa päällä.";
...
$Definition["Manage Suggested Answer Sources"] =
    "Hallinnoi ehdotettuja vastauslähteitä";
...
$Definition["Mark All Suggested Answers as Accepted"] =
    "Merkitse kaikki ehdotetut vastaukset hyväksytyiksi";
...
$Definition["Member roles"] =
    "Valitse ne kaikki roolit, joihin uusi/vahvistettu käyttäjä kuuluu.";
...
$Definition["Moderators have permission to edit most content."] =
    "Moderaattoreilla on oikeus muokata suurinta osaa forumin sisällöstä.";
...
$Definition[
    ...
    "Monimutkaisempi kieli ja saattaa sisältää joitain toimialakohtaisia termejä, mutta silti ymmärrettäviä useimmille ihmisille.";
...
$Definition[
    ...
    "Teknisempi kieli ja toimialakohtaiset termit - edellyttää korkeampaa tekniikan tasoa ymmärryksen/aiheen tuntemisen kannalta.";
...
$Definition["Never - Users Must Refresh Page"] =
    "Ei koskaan - Käyttäjien pitää itse päivittää näkymä";
$Definition["Never display on mobile browsers."] =
    "Älä näytä koskaan selattaessa mobiililaitteella.";
...
$Definition["New conversations in the last day"] =
    "Uudet aiheet viimeisen vuorokauden aikana";
$Definition["New conversations in the last week"] =
    "Uudet aiheet kuluneen viikon aikana";
$Definition["New discussions in the last day"] =
    "Uudet keskustelut viimeisen vuorokauden aikana";
$Definition["New discussions in the last week"] =
    "Uudet keskustelut viime viikolla";
...
$Definition["New users are only registered through SSO plugins."] =
    "Uudet jäsenet voivat rekisteröityä vain SSO -pluginien kautta.";
$Definition[
    'New users are reviewed and approved by an administrator (that\'s you!).'
] = 'Uudet jäsenet tarkistetaan ja vahvistetaan erikseen manuaalisesti ylläpidon (eli sinun itsesi!) toimesta. ';
$Definition[
    "New users fill out a simple form and are granted access immediately."
] = "Uudet jäsenet täyttävät rekisteröintilomakkeen tiedot ja pääsevät kirjautumaan sisään välittömästi.";
...
$Definition["No item options are available for Link display type."] =
    "Kohdevaihtoehtoja ei ole saatavilla linkin näyttötyypille.";
...
$Definition["Notifications will appear here."] =
    "Ilmoitukset näkyvät täällä.";
$Definition["NotifyApplicant"] =
    "Lähetä ilmoitus uusista jäsenhakemuksista.";
$Definition["Notify me when people comment on a discussion."] =
    "Lähetä ilmoitus uusista viesteistä keskusteluissa.";
$Definition["Notify me when my questions have AI Suggested Answers"] =
    "Ilmoita minulle, kun kysymyksiini on AI-ehdotuksia";
$Definition["Notify me when people start new discussions."] =
    "Lähetä ilmoitus uusista keskusteluista.";
...
$Definition["Only display on mobile browsers."] =
    "Näytä vain selattaessa mobiililaitteilla.";
$Definition[
    ...
    'Vain kentät, joissa on yksi valintaruutu, yhden valinnan avattava valikko, usean valinnan avattava valikko tai numerovalikko, ovat käytettävissä. Kun kentät on valittu, ne näkyvät alla, jotta voit valita tietyt vastaukset kullekin profiilikentälle.';
...
$Definition["Only visible to users with roles with permission."] =
    "Näkyy vain käyttäjille, joiden asema sallii oikeudet.";
$Definition[
    "Open cases will only display if the user has a valid Salesforce connection."
] =
    "Avoimet tapaukset näytetään vain, jos käyttäjällä on kelvollinen Salesforce -yhteys.";
...
$Definition["Or select an image on your computer (2mb max)"] =
    "tai valitse kuva tietokoneeltasi (maks. 2 Mt)";
...
$Definition["Pageview ratio representing a deflected case"] =
    "Sivun katselusuhde, joka edustaa taipunutta tapausta";
...
$Definition["Please enter a unique API Label, this one has been used before"] =
    "Anna ainutlaatuinen API Label, tätä on käytetty aiemmin";
...
$Definition[
    ...
    "Mahdollisia yhteensopivuusongelmia vanhempien selainten kanssa, jotka vaikuttavat käyttökokemukseen.";
...
$Definition[
    ...
    "Protokollat (esim. https://) ja polut (esim. yourdomain.com/some/path) tulee jättää pois.";
...
$Definition[
    ...
    "Suositeltavat mitat ovat 400 x 300 pikseliä tai pienempiä vastaavalla suhteella.";
...
$Definition["Registration is currently closed."] =
    "Rekisteröityminen on toistaiseksi pois käytöstä.";
$Definition["Reload the page to see recent updates."] =
    "Päivitä sivu nähdäksesi viimeisimmät päivitykset.";
$Definition["Reload the page to access recent updates."] =
    "Päivitä sivu, niin pääset uusimpiin päivityksiin.";
...
$Definition["RolePersonalInfo"] =
    "Tämä rooli sisältää henkilökohtaisia tietoja. Se on ainoastaan henkilökohtaisten tietojen katseluvaltuudet omaavien henkilöiden nähtävissä.";
$Definition["Roles & Permissions"] = "Roolit & oikeudet";
$Definition['Roles determine user\'s permissions.'] =
    "Jokaiselle sivustosi käyttäjälle annetaan ainakin yksi rooli. Roolien avulla määritellään, mitä käyttäjillä on lupa tehdä.";
...
$Definition["Search by user or role."] =
    "Hae käyttäjää nimen tai sähköpostiosoitteen perusteella, jolloin % toimii villinä korttina. Voit tehdä haun myös käyttäjätunnuksen, roolin nimen tai “estetyn” tilan perusteella.";
...
$Definition["Select the location of the pocket."] =
    "Valitse taskulle sijainti.";
$Definition[
    "Select which columns are displayed on the manage users page list."
] = "Valitse, mitkä sarakkeet näytetään käyttäjien hallintasivuluettelossa.";
$Definition["Selection will affect the item options available."] =
    "Valinta vaikuttaa käytettävissä oleviin tuotevaihtoehtoihin.";
...
$Definition['Separate each word with a semi-colon ";"'] =
    'Erottele jokainen sana puolipisteellä ";"';
$Definition[
    "Set this interest as default to suggest following its mapped categories and tags to all users."
] =
    "Aseta tämä kiinnostuksen kohde oletusarvoksi, jos haluat ehdottaa sen yhdistettyjen luokkien ja tunnisteiden seuraamista kaikille käyttäjille.";
...
] = "Näytä jokaiselle käyttäjälle henkilökohtainen luettelo ideoista, jotka hän on luonut tai äänestänyt.";
...
$Definition[
    ...
    "Aloita tiivistelmän aiherivi [Bannerin otsikko], joka on asetettu kohdassa Ulkoasu > Brändäys ja hakukoneoptimointi";
...
$Definition[
    ...
    "Kaikkien sähköpostien tyylit ja yleinen ulkoasu, mukaan lukien sähköpostitiivistelmä, on asetettu koko sivustolle Sähköpostiasetukset-sivulla.";
...
$Definition["Suggestions are only visible to you until you accept the answer"] =
    "Ehdotukset näkyvät vain sinulle, kunnes hyväksyt vastauksen";
$Definition["Suggestions may only be generated on questions"] =
    "Ehdotuksia voidaan luoda vain kysymyksiin";
...
$Definition["TextEnterEmails"] =
    "Kirjoita sähköpostisoitteet tähän erottaen ne pilkulla toisistaan";
$Definition["The %s badge has already been given to %s."] =
    "Kunniamerkki %s on jo myönnetty käyttäjälle %s.";
$Definition["The %s locale pack does not exist."] =
    "Valittua kielitiedostoa %s ei ole olemassa.";
...
$Definition["Thanks for sticking with us for a full year."] =
    "Kiitos, että seuraat meitä koko vuoden ajan.";
$Definition["Thanks for sticking with us for %s years."] =
    "Kiitos, että kiinnitit meitä %s vuoden ajan.";
...
$Definition["The content you were looking for has been deleted."] =
    "Etsimäsi sisältö on poistettu.";
$Definition[
    "The default banner image across the site. This can be overridden on a per category basis."
] =
    "Bannerin oletuskuva koko sivustolla. Tämä voidaan ohittaa luokittain.";
...
$Definition["The email address this test will be sent to."] =
    "Sähköpostiosoite, johon tämä testi lähetetään.";
...
$Definition["The first line of content in the email digest after the title."] =
    "Sähköpostikoosteen ensimmäinen sisältörivi otsikon jälkeen.";
...
$Definition[
    ...
    'Kuvan lähettämisessä tapahtui virhe. Sähköpostilogosi voidaan lisätä joissain seuraavista tiedostotyypeistä: gif, jpg, png
';
$Definition["There are currently no applicants."] =
    "Ei vahvistettavia jäsenhakemuksia tällä hetkellä.";
$Definition["There is currently %s applicant."] =
    "Tällä hetkellä %s hakija.";
$Definition["There are currently %s applicants."] =
    "Tällä hetkellä %s hakijaa.";
$Definition["There are currently no requests."] =
    "Pyyntöjä ei toistaiseksi ole.";
$Definition["There is currently %s request."] =
    "Tällä hetkellä %s pyyntö.";
$Definition["There are currently %s requests."] =
    "Tällä hetkellä %s pyyntöä.";
$Definition["There are no items awaiting moderation at this time."] =
    "Moderoinnin jonossa ei ole mitään tällä hetkellä.";
$Definition[
    ...
    "Annetulla sähköpostiosoiteella löytyy jo käyttäjätili. Ole hyvä ja kirjaudu olemassaolevalla tunnuksellasi tai luo uusi.";
$Definition["The next three email digest delivery dates"] =
    "Seuraavat kolme sähköpostikoosteen toimituspäivää";
...
$Definition["The site is currently undergoing scheduled maintenance."] =
    "Sivustolla on ajastettu huoltotoiminto käynnissä.";
...
$Definition["The url that users go to to register for a new account."] =
    "Osoite johon käyttäjät menevät rekisteröidäkseen uuden tunnuksen.";
$Definition["The url that users use to register for a new account."] =
    "Osoite jota käyttäjät käyttävät rekisteröidäkseen uuden tunnuksen.";
$Definition["The url that users use to sign in."] =
    "Linkki jota käyttäjät käyttävät kirjautuakseen sisään.";
...
$Definition["The URL where users sign in on your site"] =
    "URL jossa käyttäjät kirjautuvat sivullesi sisään";
$Definition["The URL where users sign out of your site"] =
    "URL jossa käyttäjät kirjautuvat sivuiltasi ulos";
...
$Definition["The user has been created successfully"] =
    "Uuden käyttäjän luominen onnistui";
...
$Definition[
    ...
    "Tämä ei ole välttämätöntä useimmilla sivustoilla paitsi niillä, jotka käyttävät ominaisuuksia, kuten AdSense ja Google Tag Manager.";
$Definition[
    ...
    "Tämä on tekoälyn luoma yhteenveto viitatusta keskusteluviestistä, joka saattaa vastata kysymykseen. Yhteenveto luodaan siten, että sitä voidaan käyttää hyväksyttynä vastauksena.";
$Definition["This category has custom permissions."] =
    "Tällä kategorialla on erikseen asetettuja käyttöoikeuksia.";
...
$Definition["This controls how the responses are phrased and spelled."] =
    "Tämä hallitsee vastausten sanamuotoa ja kirjoitusta.";
$Definition["This Database"] = "Tämä tietokanta";
$Definition["QnAFollowup.Feature.Enabled"] =
    "Tämä ominaisuus lähettää sähköpostia vastattujen kysymysten kirjoittajille, joille ei ole hyväksyttyä vastausta.";
...
$Definition[
    ...
    'Tätä kuvaa käytetään luokkaluetteloissa ja widgeteissä, kun käytetään "Kuvake"-tyylivaihtoehtoa.';
$Definition[
    ...
    'Tämä kuva näkyy tämän luokan bannerissa ja luokkawidgeteissä käytettäessä "Kuva"- ja/tai "Tausta"-tyylivaihtoehtoja. Suositellut mitat ovat noin 1 000 x 400 pikseliä tai vastaava suhde.';
...
$Definition[
    ...
    "Tätä voidaan käyttää sisällön, kuten organisaation nimen ja osoitteen, sisällyttämiseen sähköpostitiivistelmään.";
$Definition["This name will be shown in the community."] =
    "Tämä nimi näytetään yhteisössä.";
$Definition["This page requires Javascript."] =
    "Tämä sivu vaatii toimiakseen javascriptin sallimisen.";
...
] = "Tätä teemaa ei voida poistaa, koska se on parhaillaan käytössä.";
...
$Definition["This theme has customizable text."] =
    "Teema sisältää tekstiä, jota voit muokata.";
$Definition[
    ...
    "Tämä opastaa muita käyttäjiä, joilla on samankaltaisia kysymyksiä, löytämään oikeita vastauksia nopeammin ja näyttää tekoälyn ehdotetun vastauksen ja linkittää viitatun materiaalin muiden käyttäjien nähtäville. Ehdotukset näkyvät vain sinulle, kunnes hyväksyt vastauksen.";
...
$Definition["Truncate the initial discussion text to this many words."] =
    "Lyhennä alkuperäisen keskustelun teksti näin moneen sanaan.";
...
$Definition["Up to a maximum of 100 items may be displayed."] =
    "Enintään 100 kohdetta voidaan näyttää.";
...
$Definition["Use an SMTP server to send email"] =
    "Käytä sähköpostien lähettämiseen SMTP-serveriä";
$Definition["Use asterisks for wildcards"] =
    'Käytä asteriskeja jokerimerkkeihin, esim.  "*@gmail.com"';
...
$Definition["Use categories to organize discussions"] =
    "Käytä kategorioita keskustelujen järjestämiseen.";
$Definition["Use Facebook names for usernames."] =
    "Käytä Facebook -tunnuksia käyttäjäniminä.";
...
$Definition[
    ...
    "Käyttää erittäin teknistä kieltä ja toimialakohtaisia termejä, jotka on tarkoitettu niille, jotka ymmärtävät aiheen syvästi.";
$Definition[
    "Uses industry-specific terms where necessary, but also provides explanations of definitions to ensure clarity."
] =
    "Käyttää tarvittaessa toimialakohtaisia termejä, mutta antaa myös määritelmiä selkeyden varmistamiseksi.";
$Definition[
    "Uses simple, everyday language that anyone can understand, regardless of their background or expertise."
] =
    "Käyttää yksinkertaista, jokapäiväistä kieltä, jota kuka tahansa voi ymmärtää taustastaan tai asiantuntemuksestaan riippumatta.";
$Definition["UserDeleteMessage"] =
    'Poista käyttäjä ja kaikki hänen lähettämänsä sisältö. Huomioi että tämä vaihtoehto voi rikkoa keskusteluja. Roskapostin poistamiseen tehokkain valinta.';
$Definition["UserDeletionPrompt"] =
    "Määritä, miten haluat kohdella käyttäjän %s lähettämää sisältöä (kommentit, viestit, jne).";
$Definition["UserKeep"] = "Pidä käyttäjän lähettämä sisältö";
$Definition["UserKeepMessage"] =
    'Poista käyttäjä mutta säilytä hänen lähettämänsä sisältö.';
...
$Definition[
    ...
    "Käyttäjät voivat seurata luokkia ja tilata ilmoituksia uusista viesteistä. Valitse, mitä luokat uusien käyttäjien tulee oletuksena seurata.";
...
$Definition[
    ...
    "Käyttäjiä ei varoiteta, jos he seuraavat linkkejä, jotka liittyvät luotettuihin domaineihin.";
$Definition[
    "Users will be redirected to this URL after accepting an invitation."
] =
    "Kutsun hyväksymisen jälkeen käyttäjät ohjataan tähän osoitteeseen. Kyseessä voi olla täysi URL-osoite tai viittaus samalla sivustolla olevaan sivuun.";
...
$Definition[
    ...
    'Tämä on uusien jäsenien oletusrooli ennen sähköpostiosoitteen vahvistamista.';
$Definition["Users with the no ads permission will not see this pocket."] =
    "Käyttäjät, joilla on ei-mainoksia-oikeudet, eivät näe tätä taskua. ";
...
$Definition["Use the content at this url as your homepage."] =
    'Valitse sivu jonka kävijät oletuksena näkevät vieraillessaan osoitteessa: <strong style="white-space: nowrap;">%s</strong>';
$Definition["Use Vanilla as a commenting system in your site"] =
    "Käytä Vanillaa järjestelmänä kommenteillesi sivustollesi";
$Definition["Use weekly community email digest"] =
    "Käytä viikoittaista yhteisön sähköpostitiivistelmää";
$Definition["Untitled"] = "Nimetön";

$Definition["Value or Pattern"] = "Arvo tai kaava";
$Definition["Vanilla.Archive.Description"] =
    "Voit asettaa arkistoitavaksi keskustelut, jotka ovat ajalta ennen valittua päivämäärää. Arkistoidut kategoriat suljetaan, ilman mahdollisuutta lähettää niihin uusia viestejä tai aiheita.";
$Definition["Vanilla.Categories.MaxDisplayDepth"] =
    'Näytä alakategoriat toisistaan pilkuilla erotettuna listana kun ne ovat %1$s';
...
$Definition["View browser compatibility chart"] =
    "Katso selaimen yhteensopivuustaulukko";
...
] = "Varoita käyttäjiä, jos merkinnän linkki johtaa heidät pois foorumilta";
$Definition[
    "Warning: All of your data will be lost. Once you delete, there is absolutely no recovery of any kind."
] =
    "Varoitus: Kaikki tiedot häviävät. Kun poistat ne, tälle toiminnolle ei ole minkäänlaista palautus mahdollisuutta.";
...
$Definition["We only accept urls that begin with http:// or https://"] =
    "Hyväksymme vain URL-osoitteet, jotka alkavat http:// tai https://";
$Definition[
    ...
    "Yritämme käyttää oletuksena paikallista sähköpostiserveriä. Jos haluat käyttää erillistä SMTP-sähköpostiserveriä, voit asettaa sen ohessa.";
$Definition[
    ...
    "Tervetuloa. Olen AI Suggestion Assistant, koneoppimiseen perustuva työkalu, joka on suunniteltu etsimään ja ehdottamaan olennaisia artikkeleita ja viestejä vastauksena kyselyihisi. Kirjoita kysymyksesi, niin annan sinulle sopivimmat tiedot.";
$Definition['What\'s the Buzz?'] = 'Mistä on kyse?';
$Definition["When enabled, search result will open in a new browser tab."] =
    "Kun tämä on käytössä, hakutulos avautuu uudelle selaimen välilehdelle.";
$Definition[
    "When enabled, your community will have AI Suggestions shown in Q&A. <0/>"
] = "Kun tämä on käytössä, yhteisölläsi on AI-ehdotuksia, jotka näkyvät K&V-osiossa. <0/>";
$Definition[
    ...
    "Kun tämä asetus on käytössä, Analytics-tietojen käyttäjätiedot anonymisoidaan oletusarvoisesti, kunnes käyttäjä hyväksyy Analytics-evästeet. <0>Lisätietoja</0>";
...
$Definition["Why am I seeing AI Suggested Answers?"] =
    "Miksi näen tekoälyn vastausehdotuksia?";
...
$Definition[
    ...
    "Ruksaa valinta sen käyttäjän kohdalla, jonka haluat myös estää ja poistaaksesi samalla käyttäjän kaikki viestit. <b>Tee tämä toiminto vain, jos olet varma, että kyseessä on roskapostittaja.</b>";
...
$Definition[
    ...
    "Voit estää ip-osoitteita, sähköpostiosoitteiden päätteitä, sanoja ja käyttäjätunnuksia tämän työkalun avulla.";
$Definition[
    "You can customize the HTML and CSS for this theme on the %s page."
] = "Voit muokata HTML ja CSS Teeman %s sivulta.";
$Definition[
...
$Definition["You can make the categories page your homepage."] =
    'Voit asettaa kategorianäkymän forumisi kotisivuksi <a href="%s">tästä</a>.';
$Definition[
    "You can search for users by username or email, wildcards are implied."
] = "Voit etsiä käyttäjiä käyttäjänimen tai sähköpostin perusteella, jokerimerkit ovat vihjaita.";
$Definition["You can specify an allow list of trusted domains."] =
    "Voit määrittää luettelon luotetuista verkkotunnuksista, jotka ovat turvallisia uudelleenohjauksille ja upotuksille.";
$Definition["You can specify an allow list of trusted domains. (CSP)"] =
    "Voit määrittää luettelon luotetuista verkkotunnuksista (esim. omaverkkotunnus.com), joista on turvallista ladata javascript.";
$Definition[
...
$Definition[
    ...
    "Työskentelyn aikana voit suojata sivustosi HTTP-käyttäjätunnuksella ja salasanalla.";
$Definition[
    "You can send emails in plain text by disabling the toggle below."
] = "Voit lähettää sähköposteja pelkällä tekstillä ottamalla allaolevan vaihtoehdon pois käytöstä. ";
$Definition["You have %s invitations left for this month."] =
    "Sinulla on tässä kuussa kutsuja jäljellä %s.";
$Definition["You have successfully saved interest: <0/>"] =
    "Koron tallentaminen onnistui: <0/>";
...
$Definition["You must provide at least one recipient"] =
    "Valitse ainakin yksi viestin vastaanottaja";
$Definition["You must specify an admin password."] =
    "Määritä admin-käyttäjän salasana.";
$Definition["You must specify an admin username."] =
    "Määritä admin-käyttäjän käyttäjätunnus.";
$Definition[
    ...
    "Konfigurointitiedostoon ei ole tarvittavia käyttöoikeuksia. PHP on kyettävä lukemaan ja kirjoittamaan tähän tiedostoon: <code>%s</ code>";
$Definition['Your default locale won\'t display properly'] =
    'Oletuskielesi ei näy oikein, ennen kuin se on otettu käyttöön alla. Ota käyttöön seuraava: %s.';
...
$Definition[
    ...
    "Olet poistumassa teemaeditorista tallentamatta muutoksia. Varmista, että päivitykset on tallennettu ennen poistumista.";
$Definition[
    "You are leaving the Email Settings page without saving your changes. Make sure your updates are saved before exiting."
] =
    "Poistut Sähköpostiasetukset-sivulta tallentamatta muutoksiasi. Varmista, että päivityksesi on tallennettu ennen poistumista.";

$Definition["Zendesk Knowledge Bases"] = "Zendesk Knowledge Bases";
