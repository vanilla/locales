...
$Definition['Search by user or role.'] = 'Vyhľadávajte používateľom podľa mena alebo e-mailu, prípadne aj s použitím  % na zástupné znaky. Môžete tiež vyhľadávať podľa používateľského ID, názvu role alebo &ldquo;banned&rdquo;.';
...
$Definition['The default banner image across the site. This can be overriden on a per category basis.'] = 'Predvolený obrázok bannera na webe. Toto je možné prepísať na základe jednotlivých kategórií.';
...
$Definition['Use asterisks for wildcards'] = 'Ako zástupné znaky použite hviezdičky, napr. &lsquo;*@hotmail.com&rsquo;
';
...
$Definition['ForceWysiwyg.Notes1'] = 'Označením možnosti nižšie požiadate editora, aby reinterpretoval všetky staré príspevky ako Wysiwyg.';
$Definition['ForceWysiwyg.Notes2'] = 'Toto nastavenie sa prejaví, iba ak bol ako Post formát vyššie vybraný WYSIWYG. Účelom tejto možnosti je normalizovať formát editora. Ak sa načítajú staršie príspevky upravované v inom formáte, napríklad Markdown alebo BBCode, táto voľba vynúti WYSIWYG.';
...
$Definition['Reinterpret All Posts As Wysiwyg'] = 'Reinterpretovať všetky príspevky ako Wysiwyg';
