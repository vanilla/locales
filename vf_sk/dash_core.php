...
$Definition['New comments by users I\'m following'] = 'Nové komentáre od používateľov, ktorých sledujem';
...
$Definition['New discussions by users I\'m following'] = 'Nové diskusie od používateľov, ktorých sledujem';
...
$Definition['New events by users I\'m following'] = 'Nové udalosti od používateľov, ktorých sledujem';
...
$Definition['No users followed'] = 'Žiadni používatelia nie sú sledovaní';
...
$Definition['Unfollow user'] = 'Prestať sledovať používateľa';
...
$Definition['View all followed users'] = 'Zobraziť všetkých sledovaných používateľov';
...
$Definition['View User'] = 'Zobraziť používateľa';
...
$Definition['You are receiving this email because you are following this user.'] = 'Tento e-mail dostávate, pretože sledujete tohto používateľa.';
...
$Definition['{ActivityUserID,user} started a new event: <a href="{Url,html}">{Data.Name,text}</a>'] = 'Používateľ {ActivityUserID,user} spustil novú udalosť: <a href="{Url,html}">{Data.Name,text}</a>';
$Definition['{ActivityUserID,You} accepted {NotifyUserID,your} answer to a question: <a href="{Url,html}">{Data.Name,text}</a>'] = 'Používateľ {ActivityUserID,You} prijal odpoveď {NotifyUserID,your} na otázku: <a href="{Url,html}">{Data.Name,text}</a>';
