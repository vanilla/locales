...
$Definition['Most communities stick to positive reactions to encourage participation.'] = 'Väčšina komunít sa drží pozitívnych reakcií, aby podporila účasť.';
...
$Definition['Recommend special ranks for admins and mods.'] =
    'Je dobré mať špeciálne rady pre moderátorov a administrátorov, aby vaša komunita mohla ľahko vidieť, kto má na starosti.';
$Definition['Recommend starting with five ranks.'] =
    'Nechcete mať príliš veľa hodností. Odporúčame začať s piatimi. Ak je vaša komunita naozaj veľká, môžete pridať viac.';
...
$Definition['This page lists the endpoints of your API.'] =
    'Na tejto stránke sú uvedené koncové body vášho rozhrania API. Kliknutím na koncové body získate ďalšie informácie. Z tejto stránky môžete uskutočňovať živé hovory do rozhrania API alebo navonok pomocou prístupového tokenu.';
...
$Definition['This setting loads the page before executing Javascript.'] =
    'Toto nastavenie načíta stránku pred spustením Javascriptu, čo môže vylepšiť vaše SEO. <br> <strong> ** Varovanie: Povolenie tejto funkcie môže spôsobiť chyby Javascriptu na vašej stránke ** </strong>';
