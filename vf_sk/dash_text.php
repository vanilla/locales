...
$Definition['Digest Settings'] = 'Nastavenia súhrnu';
...
$Definition['Recommended dimensions are about 400px by 300px or smaller with similar ratio.'] = 'Odporúčané rozmery sú približne 400 x 300 pixelov alebo menšie s podobným pomerom.';
...
$Definition['Tagging allows users to add a tag to discussions they start in order to make them more discoverable. '] =
    'Značkovanie umožňuje používateľom pridať značku do diskusií, ktoré začínajú, aby boli lepšie viditeľné.';
...
$Definition['The database user you specified does not have permission to access the database. Have you created the database yet? The database reported: <code>%s</code>'] =
    'Zadaný používateľ databázy nemá povolenie na prístup k databáze. Už ste vytvorili databázu? Databáza hlási: <code>%s</code>';
...
$Definition['They work just like regular themes. Once one has been added to the themes folder, you can enable it here.'] =
    'Fungujú rovnako ako bežné témy. Po pridaní do priečinka motívov ho môžete povoliť tu.';
...
$Definition['This may be used to include content such as organization name and address in all outgoing emails.'] = 'Toto možno použiť na zahrnutie obsahu, ako je názov organizácie a adresa, do všetkých odchádzajúcich e-mailov.';
...
$Definition['This role is personal info. Only users with permission to view personal info will see it.'] = 'Táto rola je osobná informácia. Zobrazí sa iba užívateľom, ktorí majú povolenie na zobrazenie osobných informácií.';
$Definition['This setting loads the page before executing Javascript.'] = 'Toto nastavenie načíta stránku pred spustením Javascriptu, čo môže vylepšiť vaše SEO. <br> <strong> ** Varovanie: Povolenie tejto funkcie môže spôsobiť chyby Javascriptu na vašej stránke ** </strong>';
...
$Definition['This title appears on your site\'s banner and in your browser\'s title bar. If a logo is uploaded, it will replace this title on user-facing forum pages. Also, keep in mind some themes may hide this title.'] = 'Tento názov sa zobrazí na banneri vašej stránky a v záhlaví vášho prehliadača. Ak je nahrané logo, nahradí tento názov na používateľských stránkach fóra. Majte tiež na pamäti, že niektoré témy môžu skrývať tento názov.';
...
$Definition['TouchIconDescription'] =
    'Dotyková ikona sa zobrazí, keď si na domácej obrazovke zariadenia Apple uložíte záložku. Zvyčajne sú to 152 pixelov. Apple pridáva zaoblené rohy a svetelný efekt automaticky.';
...
$Definition['Warning: Loading tables can be slow.'] =
    '<b>Výstraha</b> : Konfigurácia servera nepodporuje rýchle načítanie údajov. Ak importujete veľmi veľký súbor (napr. Viac ako 200 000 komentárov), môžete zvážiť zmenu konfigurácie. Kliknite <a href="http://vanillaforums.com/porter">sem</a> pre viac informácií.';
...
$Definition['Welcome to Vanilla\'s theming UI.'] = 'Vitajte v tematickom používateľskom rozhraní Vanilla. Táto stránka obsahuje zoznam všetkých vašich dostupných tém a umožňuje vám ich kopírovať alebo upravovať.';
...
$Definition["Theming Guide"] = "Sprievodca motívmi";
...
$Definition["Usercards allow you to get a quick in-line snapshot of a user's information."] = "Používateľské karty vám umožňujú získať rýchly prehľad informácií o používateľovi. Pri prezeraní príspevkov a rebríčkov kliknutím na používateľské meno zobrazíte kartu so základnými profilovými informáciami používateľov bez toho, aby ste museli opustiť stránku. Povoľte túto funkciu, ak chcete do vlastného motívu pridať používateľské karty.";
$Definition['New Search Page'] = 'Nová stránka vyhľadávania';
$Definition["Vanilla's new search service is finally here."] = "Nová vyhľadávacia služba Vanilla je konečne tu. Povoľte naše nové používateľské rozhranie stránky vyhľadávania, aby ste získali prístup k najnovším funkciám vyhľadávania, ako je vyhľadávanie členov, triedenie vyhľadávania a zvýrazňovanie výrazov.";
