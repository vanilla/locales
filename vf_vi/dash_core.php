...
$Definition['%1$s version %2$s is available.'] =
    '%1$s phiên bản %2$s có sẵn.';
$Definition["%s is not a valid email address"] =
    "%s không phải là địa chỉ email hợp lệ";
...
$Definition["%s user(s) will be affected by this action."] =
    "có %s thành viên sẽ bị ảnh hưởng bởi thao tác này";

$Definition["<0/> will suggest answers on Q&A posts"] =
    "<0/> sẽ gợi ý câu trả lời trên các bài đăng Hỏi & Đáp";
$Definition["<0 /> will not suggest answers on Q&A posts"] =
    "<0 /> sẽ không gợi ý câu trả lời trên các bài đăng Hỏi & Đáp";
...
$Definition["1 in 5 is recommended for most communities."] =
    "Mức 1 trong 5 được khuyến nghị cho hầu hết các cộng đồng.";
$Definition["1 in 20 is recommended for most communities."] =
    "Tỷ lệ khuyến nghị là 1 trên 20 cho hầu hết các cộng đồng.";
...
$Definition["[%s] Confirm Your Email Address"] =
    "[%s] Xác nhận lại địa chỉ thư của bạn";
...
$Definition["A unique label name that cannot be changed once saved."] =
    "Tên nhãn duy nhất không thể thay đổi sau khi đã lưu.";
...
$Definition['"Accept Answer" if a suggestion answers your question.'] =
    '"Chấp nhận câu trả lời" nếu gợi ý trả lời được câu hỏi của bạn.';
...
$Definition["Accepted answer pageview ratio representing a deflected case"] =
    "Tỷ lệ lượt xem trang câu trả lời được chấp nhận thể hiện trường hợp bị lệch";
...
$Definition[
    ...
    "Thêm liên kết Zoom hoặc ID cuộc họp để kết nối sự kiện này với Zoom và bật nút đăng ký và tham gia bằng một cú nhấp chuột. Lưu ý nếu sự kiện của bạn yêu cầu đăng ký, bạn không thể cập nhật ID cuộc họp hoặc liên kết sau khi tạo sự kiện.";
...
$Definition[
    ...
    "Thêm thông tin vào các trường trong địa chỉ thư để giúp các bài trả lời (khuyến cáo).";
...
$Definition[
    ...
    "Thêm (các) miền Kaltura tùy chỉnh của bạn để chuyển các liên kết thành video nhúng trong các cuộc thảo luận, nhận xét hoặc bài viết.";
$Definition[
    "Add your custom Kaltura domain(s) to transform links into embedded videos in posts, comments or articles."
] =
    "Thêm tên miền Kaltura tùy chỉnh của bạn để chuyển đổi liên kết thành video nhúng trong bài đăng, bình luận hoặc bài viết.";
...
$Definition[
    ...
    "AI Suggested Answers cung cấp các câu trả lời được đề xuất dựa trên các bài đăng của cộng đồng và cơ sở kiến thức được liên kết. Bạn có thể bật hoặc tắt tính năng này bất kỳ lúc nào bằng cách truy cập tùy chọn hồ sơ của mình.";
$Definition[
    "Alert users if they click a link in a post that will lead them away from the forum. "
] =
    "Cảnh báo người dùng nếu họ nhấp vào một đường link trong một bài đăng sẽ đưa họ ra khỏi diễn đàn.";
...
$Definition["All discussions in this category will be permanently deleted."] =
    "Tất cả các bài viết trong danh mục này sẽ bị xóa vĩnh viễn";
...
$Definition[
    ...
    "Tất cả các nội dung trao đổi sẽ bị thay thế bằng một thông điệp thông báo thành viên đã bị xóa.";
...
$Definition["Allow new users to be registered through email."] =
    "Cho phép thành viên mới được đăng ký thông qua thư.";
$Definition["Allow this connection to issue API access tokens."] =
    "Cho phép kết nối này phát hành token truy cập API.";
$Definition["Allow Third-Party Script Execution"] =
    "Cho phép thực thi tập lệnh của bên thứ ba";
$Definition["Allow users to change their own avatars"] =
    "Cho phép người dùng thay đổi avatar của riêng họ";
$Definition["Allow users to dismiss this message"] =
    "Cho phép người dùng loại bỏ thông báo này.";
...
$Definition["An enabled message will be visible on the site."] =
    "Một thông báo được bật sẽ hiển thị trên website.";
$Definition["An answer in this the community thread was marked as accepted"] =
    "Một câu trả lời trong chủ đề cộng đồng này đã được đánh dấu là đã chấp nhận";
$Definition["An error occurred updating your privacy setting"] =
    "Đã xảy ra lỗi khi cập nhật cài đặt quyền riêng tư của bạn";
$Definition["Anonymize Analytics Data by Default"] =
    "Ẩn danh dữ liệu Analytics theo mặc định";
$Definition["Answers is not available if you have not accepted cookies."] =
    "Câu trả lời sẽ không khả dụng nếu bạn chưa chấp nhận cookie.";
$Definition["API"] = "API";
...
$Definition["Applicant Role"] =
    "Lựa chọn vai trò sẽ áp dụng cho người xin vào vị trí. Nó chỉ áp dụng cho tính năng  <b>chấp nhận</b> đăng ký.";
...
$Definition["Are you sure you want to delete %s items forever?"] =
    "Bạn có muốn xóa %s mục vĩnh viễn?";
$Definition["Are you sure you want to delete 1 item forever?"] =
    "Bạn có muốn xóa 1 mục vĩnh viễn?";
$Definition[
    "Are you sure you want to delete this badge? This is irreversible and will revoke the badge from all users who have it."
] =
    "Bạn có chắc chắn muốn xóa huân chương? Thao tác này sẽ không thể hoàn tác và sẽ xóa huân chương của tất cả các thành viên đang có nó.";
...
$Definition["Are you sure you want to restore %s items?"] =
    "Bạn có muốn khôi phục %s mục hay không?";
$Definition["Are you sure you want to restore 1 item?"] =
    "Bạn có muốn khôi phục 1 mục không?";
$Definition[
    "Are you sure you want to turn off all AI Suggested Answers? You can undo this in your profile settings at anytime."
] =
    "Bạn có chắc chắn muốn tắt tất cả Câu trả lời được đề xuất của AI không? Bạn có thể hoàn tác việc này trong cài đặt hồ sơ của mình bất kỳ lúc nào.";
...
] = "Cần có ít nhất một cột hiển thị. Hiển thị hoặc thêm cột hiển thị.";
$Definition["A url-friendly version of the category name for better SEO."] =
    "Một phiên bản liên kết thân thiện của dành mục sẽ rất có ích cho việc SEO";
...
$Definition[
    ...
    "Trước khi kích hoạt tính năng này, vui lòng lưu ý những tác động tiềm ẩn sau:";
...
$Definition["Bookmark a discussion using its star icon."] =
    "Đánh dấu trang một thảo luận bằng biểu tượng ngôi sao của nó.";
...
$Definition["Browse for a new banner logo if you would like to change it:"] =
    "Chọn một biểu trưng biểu ngữ mới nếu bạn muốn thay đổi nó:";
...
$Definition["Cannot build profile information if user is not defined."] =
    "Không thể xây dựng hồ sơ thông tin nếu người dùng không xác định.";
$Definition["Categories &amp; Discussions"] = "Danh mục & bài viết";
$Definition["Categories to Exclude from AI Answers"] =
    "Các danh mục cần loại trừ khỏi câu trả lời của AI";
$Definition["Categories are used to organize discussions."] =
    "Danh mục được dùng để giúp thành viên của bạn tổ chức các bài viết một cách có ý nghĩa cho cộng đồng của bạn.";
$Definition["Categories are used to organize posts."] =
    "Danh mục được sử dụng để giúp người dùng sắp xếp bài đăng theo cách có ý nghĩa đối với cộng đồng của bạn.";
$Definition["Categories allow you to organize your posts."] =
    "Danh mục cho phép bạn sắp xếp bài đăng của mình.";
...
$Definition["Check out the full list of video tutorials here."] =
    "Xem danh sách đầy đủ các đoạn phim hướng dẫn tại đây";
...
$Definition["Click here to carry on to your dashboard"] =
    "Bấm vào đây để đưa lên bảng tin";
...
$Definition["Configuration settings for password fields in Vanilla"] =
    "Cài đặt cấu hình cho các trường mật khẩu trong Vanilla";
$Definition["Configure custom Kaltura domains"] =
    "Định cấu hình các miền Kaltura tùy chỉnh";
$Definition["Configure how nested categories are displayed to users."] =
    "Cấu hình cách các danh mục lồng nhau được hiển thị cho người dùng.";
$Definition['Configuring Vanilla\'s Homepage'] =
    'Cấu hình Trang chủ của Vanilla';
$Definition["Confirmation  Body"] = "Xác nhận nội dung";
$Definition["Confirm email addresses"] =
    "Yêu cầu thành viên phải xác nhận địa chỉ thư (khuyến khích)";
...
$Definition[
    ...
    "Liên hệ với Vanilla Staff để bật cấu hình trang web Hỏi & Đáp. Sau đó bật tiện ích bổ sung Hỏi & Đáp trong phần Tiện ích bổ sung của bảng điều khiển.";
$Definition[
    ...
    "Liên hệ với Vanilla Staff để bật cấu hình trang web Hỏi & Đáp. Sau đó bật tiện ích bổ sung Hỏi & Đáp trong phần <0/> của bảng điều khiển.";
$Definition["Content Curation"] = "Tổng hợp Nội dung";
$Definition["Content flagged as spam is stored here for moderator review."] =
    "Nội dung bị gắn cờ là thư rác được lưu trữ ở đây để người điều hành xem xét.";
...
$Definition[
    ...
    "Có thể gây ra các lỗ hổng như Cross-Site Scripting (XSS) nếu các tập lệnh ban đầu bị xâm phạm.";
$Definition['Could not find a theme identified by \'%s\''] =
    'Không thể tìm thấy giao diện được chỉ định bởi \'%s\'';
$Definition["Could not instantiate mail function."] =
    "Không thể khởi tạo tính năng thư.";
...
$Definition["Could not open addon file. Addons must be zip files."] =
    "Không thể mở tập tin addon. Addon phải là tập tin zip.";
$Definition["Create & organize discussion categories and manage your users."] =
    "Tạo & tổ chức các danh mục bài viết và quản lý các thành viên của bạn.";
...
$Definition["Disabled: The pocket will <b>not</b> be displayed."] =
    "Vô hiệu hóa: Túi sẽ <b>không</b> được hiển thị.";
...
$Definition["Do not display the categories in the side panel."] =
    "Không hiển thị các mục trong bảng điều khiển.";
...
$Definition[
    ...
    "Tiện ích nhắc nhở thông báo qua email sẽ khả dụng khi bật Thông báo qua email.";
...
$Definition[
    ...
    "Email tóm tắt sẽ được gửi vào ngày đã chọn hàng tuần. Những thay đổi trong ngày đã đặt sẽ có hiệu lực vào tuần tiếp theo.";
...
$Definition["Embedding is currently DISABLED."] =
    "Tính năng nhúng đã bị tắt.";
$Definition["Embedding is currently ENABLED."] =
    "Tính năng nhúng đang được bật";
...
$Definition["Enable link embeds in discussions and comments"] =
    "Bật liên kết nhúng trong các cuộc thảo luận và bình luận";
$Definition["Enable link embeds in posts and comments"] =
    "Cho phép nhúng liên kết vào bài đăng và bình luận";
...
$Definition["Enable to only show posts from categories a user follows."] =
    "Cho phép chỉ hiển thị các bài đăng từ các danh mục mà người dùng theo dõi.";
$Definition[
    "Enable to get a preview of our new user management dashboard with improved search and new configuration options."
] =
    "Bật để xem trước bảng điều khiển quản lý người dùng mới của chúng tôi với các tùy chọn cấu hình mới và tìm kiếm được cải thiện.";
...
$Definition[
    ...
    "Việc bật tính năng này sẽ sửa đổi Chính sách bảo mật nội dung của bạn để tin cậy các tập lệnh bổ sung được các tập lệnh tùy chỉnh của bạn đưa vào làm phần phụ thuộc.";
$Definition[
...
$Definition["Enter the email address of the person you would like to invite:"] =
    "Nhập địa chỉ thư của người bạn muốn mời:";
$Definition[
    "Enter the url to the page you would like to use as your homepage"
] = "Nhập url đến trang bạn muốn sử dụng làm trang chủ của bạn";
$Definition[
    "Enter the url to the page you would like to use as your homepage:"
] = "Nhập url đến trang bạn muốn sử dụng làm trang chủ của bạn:";
$Definition["Error sending email. Please review the addresses and try again."] =
    "Có lỗi xảy ra khi gửi email. Vui lòng kiểm tra các địa chỉ và thử lại.";
...
$Definition["Exclude archived discussions from the discussions list"] =
    "Loại trừ những bài viết đã được lưu trữ trong danh sách thảo luận";
$Definition["Existing members send invitations to new members."] =
    "Thành viên hiện tại đã gửi một lời mời tới thành viên mới";
...
$Definition[
    ...
    "Tìm kiếm bên ngoài thay thế tìm kiếm sẵn có của Vanilla bằng nhà cung cấp dịch vụ tìm kiếm bên thứ ba mà bạn chọn.";
...
$Definition["FaviconBrowse"] =
    "Duyệt tìm một favicon mới nếu bạn muốn thay đổi nó:";
$Definition["FaviconDescription"] =
    "Biểu tượng của website (favicon) của bạn xuất hiện trong thanh tiêu đề của trình duyệt. Biểu tượng này sẽ được thu nhỏ lại một cách thích hợp.";
...
$Definition[
    ...
    "Ví dụ: để cho phép yourdomain.com, www.yourdomain.com và help.yourdomain.com, bạn sẽ thêm *.yourdomain.com";
$Definition["Force the forum to only be accessible through this url"] =
    "Bắt buộc chỉ có thể truy cập diễn đàn theo liên kết này";
$Definition["Force your forum to be viewed through the Remote Url"] =
    "Bắt buộc chỉ có thể xem diễn đàn thông qua liên kết từ xa";
...
$Definition["Full post in email notifications"] =
    "Bài đầy đủ trong thông báo qua email";

$Definition["Garden"] = "Sân vườn";
$Definition["Garden.api.ssoIDPermission.description"] =
    "Các vai trò có quyền này sẽ có thể mở rộng các SSO ID trong các lệnh gọi API v2.";
...
$Definition[
    ...
    "Đang tạo Đề xuất. Bạn sẽ được thông báo khi chúng đã sẵn sàng để bạn xem xét.";
...
$Definition[
    ...
    "Xin chào. Tôi là Trợ lý gợi ý AI của bạn, ở đây để hỗ trợ bạn tìm các bài viết và bài đăng có liên quan để trả lời các câu hỏi của bạn. Vui lòng thoải mái hỏi bất kỳ câu hỏi nào bạn có thể có.";
$Definition["guest"] = "khách";
$Definition["Guest roles"] =
    "Kiểm tra tất cả các vai trò áp dụng cho khách.";

$Definition["Hash Algorithm"] = "Thuật toán băm";
$Definition["HeadlineFormat.AddUser"] =
    "{ActivityUserID,user} đã thêm một tài khoản cho {RegardingUserID,user}.";
$Definition["HeadlineFormat.PictureChange"] =
    "{RegardingUserID,You} đã thay đổi ảnh đại diện của {ActivityUserID,your}.";
$Definition["HeadlineFormat.RegistrationApproval"] =
    "{ActivityUserID,user} đã cung cấp ứng dụng cho {RegardingUserID,user}.";
...
$Definition[
    ...
    "Xin chào! Tôi là Trợ lý gợi ý AI của bạn, ở đây để giúp bạn tìm các bài viết và bài đăng hay nhất để trả lời các câu hỏi của bạn. Hãy thoải mái hỏi bất cứ điều gì, tôi ở đây để giúp việc tìm kiếm của bạn trở nên thú vị và bổ ích!";
...
$Definition["Hide discussions from Recent Discussions and Widgets."] =
    "Ẩn các cuộc thảo luận khỏi Thảo luận và Widget gần đây.";
$Definition["Hide posts from Recent Posts Page and Widgets."] =
    "Ẩn bài viết khỏi Trang bài viết gần đây và Tiện ích.";
...
$Definition["How the content is going to be filtered."] =
    "Nội dung sẽ được lọc như thế nào.";
...
$Definition[
    ...
    "Tuy nhiên, điều này đi kèm với trách nhiệm gia tăng để đảm bảo tính bảo mật cho trang web của bạn.";
$Definition["Html"] = "HTML";
$Definition["HTML Emails"] = "Các email HTML";
$Definition["HTTP Strict Transport Security (HSTS) Settings"] =
    "Cài đặt HTTP Strict Transport Security (HSTS - Bảo mật Thông tin truyền tải nghiêm ngặt HTTP)";
...
$Definition["If left empty, Email Logo is used."] =
    "Nếu để trống, Logo Email sẽ được sử dụng.";
$Definition[
    ...
    "Nếu bạn có liên kết đến tài liệu nội bộ trong 'Liên kết đến Điều khoản sử dụng' ở trên, 'Văn bản Điều khoản sử dụng' sẽ bị bỏ qua. Xóa liên kết nếu bạn muốn sử dụng văn bản này.";
...
$Definition["Install Vanilla without a .htaccess file."] =
    "Cài đặt Vanilla mà không có một tập tin htaccess.";
...
$Definition["Introducing Vanilla Reactions and Badges"] =
    "Giới thiệu hệ thống huy hiệu của Vanilla Reaction";
$Definition["Invalid category for deletion."] =
    "Xóa một danh mục không tồn tại";
...
$Definition["It looks like you edited your post. <0/> or <1/>."] =
    "Có vẻ như bạn đã chỉnh sửa bài đăng của mình. <0/> hoặc <1/>.";
...
$Definition["Large images will be scaled down."] =
    "Các hình ảnh kích cỡ lớn sẽ được giảm kích thước xuống mức chiều rộng tối đa là %spx và chiều cao tối đa là %spx.";
...
$Definition["Limits: 60 characters, no breaks."] =
    "Giới hạn: 60 ký tự, không ngắt quãng.";
...
$Definition["Limit the pocket to one or more roles or permissions."] =
    "Hạn chế túi cho một hoặc nhiều vai trò, quyền.";
$Definition["Limit"] = "Giới hạn";
$Definition["List of discussion IDs to delete."] =
    "Danh sách ID thảo luận cần xóa.";
...
$Definition["Make sure you select at least one item before continuing."] =
    "Đảm bảo rằng bạn chọn ít nhất một mục trước khi tiếp tục.";
$Definition["Add your site to trusted domains."] =
    "Hãy đảm bảo trang web của bạn đã được thêm vào %s khi tính năng nhúng được bật.";
...
$Definition["Manage Suggested Answer Sources"] =
    "Quản lý nguồn câu trả lời được đề xuất";
...
$Definition["Mark All Suggested Answers as Accepted"] =
    "Đánh dấu tất cả các câu trả lời được đề xuất là đã chấp nhận";
...
$Definition["Member roles"] =
    "Kiểm tra tất cả các vai trò được áp dụng cho người dùng mới /đã được chấp thuận.";
...
$Definition["Moderators have permission to edit most content."] =
    "Điều phối viên có quyền chỉnh sửa hầu hết nội dung.";
...
$Definition[
    ...
    "Ngôn ngữ phức tạp hơn và có thể đưa ra một số thuật ngữ chuyên ngành, nhưng hầu hết mọi người vẫn có thể hiểu được.";
...
$Definition[
    ...
    "Nhiều ngôn ngữ kỹ thuật và thuật ngữ chuyên ngành hơn -- giả định rằng người dùng có trình độ hiểu biết/quen thuộc cao hơn với chủ đề này.";
$Definition["more than %s deep"] = "Sâu nhiều hơn %s";
$Definition['Most pockets shouldn\'t be displayed in the dashboard.'] =
    'Hầu hết túi không nên được hiển thị trong bảng điều khiển.';
$Definition["Move discussions in this category to a replacement category."] =
    "Di chuyển các bài viết trong này này vào một danh mục thay thế.";
...
$Definition["Never - Users Must Refresh Page"] =
    "Không bao giờ - người dùng phải làm mới trang";
$Definition["Never display on mobile browsers."] =
    "Không bao giờ hiển thị trên trình duyệt di động.";
...
$Definition["New users are only registered through SSO plugins."] =
    "Người dùng mới chỉ được đăng ký thông qua SSO plugins.";
$Definition[
    'New users are reviewed and approved by an administrator (that\'s you!).'
] = 'Người dùng mới được xem xét và được chấp thuận bởi một quản trị viên (đó là bạn!).';
$Definition[
    "New users fill out a simple form and are granted access immediately."
] = "Người dùng mới điền vào một mẫu đơn giản và được cấp quyền truy cập ngay lập tức.";
...
$Definition["No item options are available for Link display type."] =
    "Không có tùy chọn mục nào cho loại hiển thị Liên kết.";
...
$Definition["NotifyApplicant"] =
    "Thông báo cho tôi khi bất cứ ai áp dụng cho các thành viên.";
$Definition["Notify me when people comment on a discussion."] =
    "Thông báo cho tôi khi có người nhận xét về một bài viết.";
$Definition["Notify me when my questions have AI Suggested Answers"] =
    "Thông báo cho tôi khi câu hỏi của tôi có AI Gợi ý câu trả lời";
$Definition["Notify me when people start new discussions."] =
    "Thông báo cho tôi khi mọi người bắt đầu một bài đăng mới.";
...
$Definition["Number of days before a follow-up email is automatically sent."] =
    "Số ngày trước khi email tiếp theo được tự động gửi.";
...
$Definition["Number input must be between 1 and 100."] =
    "Số đầu vào phải nằm trong khoảng từ 1 đến 100.";
...
$Definition["Only display on mobile browsers."] =
    "Chỉ hiển thị trên trình duyệt điện thoại di động.";
$Definition[
    ...
    'Chỉ có các trường là hộp kiểm đơn, danh sách thả xuống chọn đơn, danh sách thả xuống chọn nhiều hoặc danh sách thả xuống số mới khả dụng. Sau khi chọn các trường, chúng sẽ xuất hiện bên dưới để bạn có thể chọn câu trả lời cụ thể cho từng trường hồ sơ.';
...
$Definition["Only visible to users with roles with permission."] =
    "Chỉ hiển thị cho những người dùng đảm nhận các vai trò có quyền.";
$Definition[
    "Open cases will only display if the user has a valid Salesforce connection."
] =
    "Các trường hợp mở sẽ chỉ hiển thị nếu người dùng có kết nối Salesforce hợp lệ.";
...
$Definition["Or select an image on your computer (2mb max)"] =
    "Hoặc chọn một hình ảnh trên máy tính của bạn (tối đa 2 mb)";
...
$Definition["Pageview ratio representing a deflected case"] =
    "Tỷ lệ xem trang đại diện cho trường hợp lệch hướng";
...
$Definition["Please enter a unique API Label, this one has been used before"] =
    "Vui lòng nhập Nhãn API duy nhất, nhãn này đã được sử dụng trước đây";
...
$Definition[
    ...
    "Có thể xảy ra sự cố tương thích với các trình duyệt cũ hơn, ảnh hưởng đến trải nghiệm người dùng.";
...
$Definition[
    ...
    "Nên bỏ qua các giao thức (ví dụ: https://) và đường dẫn (ví dụ: yourdomain.com/some/path).";
...
$Definition[
    ...
    "Kích thước khuyến nghị là 400px x 300px hoặc nhỏ hơn với tỷ lệ tương tự.";
...
$Definition["Reload the page to see recent updates."] =
    "Tải lại trang để xem các cập nhật gần đây.";
$Definition["Reload the page to access recent updates."] =
    "Tải lại trang để truy cập các bản cập nhật gần đây.";
...
$Definition['Roles determine user\'s permissions.'] =
    "Mọi thành viên sử dụng trang web của bạn được phân cho ít nhất một vai trò. Vai trò được sử dụng để xác định những gì những người sử dụng được cho phép làm.";
...
$Definition["Search by user or role."] =
    "Tìm kiếm người dùng theo tên hoặc địa chỉ email, có thể tùy chọn dùng % làm một ký tự đại diện. Bạn cũng có thể tìm kiếm theo ID người dùng, tên một vai trò, hoặc “banned”.";
...
] = "Chọn cột nào được hiển thị trên danh sách trang quản lý người dùng.";
$Definition["Selection will affect the item options available."] =
    "Lựa chọn sẽ ảnh hưởng đến các tùy chọn mục có sẵn.";
...
$Definition[
    ...
    "Gửi một thư xác nhận khi mọi người hỏi một câu hỏi hoặc bắt đầu một bài viết qua thư.";
...
$Definition['Separate each word with a semi-colon ";"'] =
    'Tách mỗi từ bằng dấu chấm phẩy ";"';
$Definition[
    "Set this interest as default to suggest following its mapped categories and tags to all users."
] =
    "Đặt sở thích này làm mặc định để đề xuất theo dõi các danh mục và thẻ được ánh xạ tới tất cả người dùng.";
...
] = "Hiển thị cho mỗi người dùng danh sách ý tưởng được cá nhân hóa mà họ đã tạo hoặc ủng hộ.";
...
] = "Các nguồn được chọn ở đây sẽ có sẵn cho AI Suggested Answers.";
$Definition["Specify one domain per line. Use * for wildcard matches."] =
    "Nêu rõ một tên miền mỗi dòng. Dùng dấu * cho các kết quả khớp với ký tự đại diện.";
$Definition["Spoof"] = "Giả mạo";
$Definition["SSO Role"] = "Vai trò SSO";
$Definition["SSO roles are always passed through SSO."] =
    "Các vai trò SSO luôn được chuyển qua SSO.";
...
$Definition[
    ...
    "Bắt đầu dòng chủ đề tóm tắt với [Tiêu đề biểu ngữ] được đặt trong Giao diện > Thương hiệu & SEO";
...
$Definition[
    ...
    "Kiểu và hình thức trực quan chung của tất cả email, bao gồm cả thông báo email, được đặt trên toàn trang trên trang Cài đặt Email.";
...
$Definition["Suggestions are only visible to you until you accept the answer"] =
    "Gợi ý chỉ hiển thị cho đến khi bạn chấp nhận câu trả lời";
$Definition["Suggestions may only be generated on questions"] =
    "Gợi ý chỉ có thể được tạo ra trên các câu hỏi";
...
$Definition[
    ...
    'Có lỗi xảy ra khi tải lên hình ảnh. Lô-gô email của bạn có để được tải lên theo một trong các dạng tệp sau đây: gif, jpg, png';
$Definition["There are currently no applicants."] =
    "Hiện có không có ứng viên.";
$Definition["There is currently %s applicant."] =
    "Hiện có %s người đăng ký.";
...
$Definition[
    ...
    "Đã có một tài khoản trong diễn đàn sử dụng địa chỉ thư này. Vui lòng tạo tài khoản mới, hoặc nhập các thông tin đăng nhập cho tài khoản hiện tại.";
$Definition["The next three email digest delivery dates"] =
    "Ba ngày gửi email tóm tắt tiếp theo";
$Definition["The secret secures the sign in process."] =
    "Mã bí mật nhằm bảo mật quá trình đăng nhập. <b>Không</b> cung cấp mã này cho bất cứ ai.";
$Definition["The site description usually appears in search engines."] =
    "Mô tả trang thường xuất hiện trong công cụ tìm kiếm. Bạn nên cố gắng có một mô tả có độ dài 100-150 ký tự.";
$Definition["The site is currently undergoing scheduled maintenance."] =
    "Trang web hiện đang được bảo trì theo lịch.";
$Definition["The specified url code is already in use by another category."] =
    "Mã liên kết chỉ định đang được sử dụng bởi một danh mục khác.";
$Definition["The structure was successfully executed."] =
    "Cấu trúc đã được thực thi thành công.";
...
$Definition[
    ...
    "Điều này không cần thiết trên hầu hết các trang web ngoại trừ những trang đang sử dụng các tính năng như AdSense và Trình quản lý thẻ của Google.";
$Definition[
    ...
    "Đây là bản tóm tắt do AI tạo ra từ bài đăng thảo luận được tham chiếu có thể trả lời câu hỏi. Bản tóm tắt được tạo theo cách có thể được sử dụng làm câu trả lời được chấp nhận.";
$Definition["This category has custom permissions."] =
    "Danh mục này có quyền truy cập tuỳ chỉnh.";
$Definition["This category is archived."] = "Danh mục này được lưu trữ.";
$Definition["This connection is in test-mode."] =
    "Kết nối này đang ở chế độ thử nghiệm.";
$Definition["This controls how the responses are phrased and spelled."] =
    "Phần này kiểm soát cách diễn đạt và đánh vần của câu trả lời.";
$Definition["This Database"] = "Cơ sở dữ liệu này";
$Definition["QnAFollowup.Feature.Enabled"] =
    "Tính năng này gửi email đến tác giả của các câu hỏi đã trả lời mà không có câu trả lời được chấp nhận.";
$Definition["This forum is currently set to invitation only mode."] =
    "Diễn đàn này hiện đang được thiết lập chi có chế độ mời.";
$Definition[
    'This image will be used in category lists and widgets when using the "Icon" style option.'
] =
    'Hình ảnh này sẽ được sử dụng trong danh sách danh mục và tiện ích con khi sử dụng tùy chọn kiểu "Biểu tượng".';
$Definition[
    ...
    'Hình ảnh này sẽ xuất hiện trong biểu ngữ của danh mục này và trong các tiện ích con của danh mục khi sử dụng tùy chọn kiểu "Hình ảnh" và / hoặc "Nền". Kích thước được đề xuất là khoảng 1000px x 400px hoặc tỷ lệ tương tự.';
$Definition["This is a parent category that does not allow discussions."] =
    "Danh mục cha không cho phép tạo bài viết.";
$Definition['This is the first time you\'ve visited the discussion forums.'] =
    'Đây là lần đầu tiên bạn truy cập vào diễn đàn thảo luận.';
$Definition[
    "This may be used to include content such as organization name and address in the email digest."
] =
    "Điều này có thể được sử dụng để bao gồm nội dung như tên và địa chỉ tổ chức trong thông báo email.";
$Definition["This name will be shown in the community."] =
    "Tên này sẽ được hiển thị trong cộng đồng.";
...
] = "Không thể xóa chủ đề này vì đây là chủ đề đang được áp dụng.";
$Definition["This theme has additional options."] =
    "Chủ đề này có các tùy chọn bổ sung trên trang %s.";
$Definition["This theme has customizable text."] =
    "Chủ đề này có văn bản mà bạn có thể tùy chỉnh.";
$Definition[
    ...
    "Điều này sẽ hướng dẫn những người dùng khác có câu hỏi tương tự đến đúng câu trả lời nhanh hơn và sẽ hiển thị Câu trả lời được AI gợi ý và liên kết tài liệu tham khảo để những người dùng khác xem. Các gợi ý chỉ hiển thị cho bạn cho đến khi bạn chấp nhận câu trả lời.";
...
$Definition["Truncate the initial discussion text to this many words."] =
    "Cắt ngắn văn bản thảo luận ban đầu xuống số từ như sau.";
...
$Definition["Up to a maximum of 100 items may be displayed."] =
    "Có thể hiển thị tối đa 100 mục.";
...
$Definition["Use an SMTP server to send email"] =
    "Sử dụng một máy chủ SMTP để gửi thư điện tử";
$Definition["Use asterisks for wildcards"] =
    'Sử dụng dấu sao cho ký tự đại diện, ví dụ như "*@gmail.com"';
...
$Definition["Use categories to organize discussions"] =
    "Sử dụng danh mục để tổ chức các bài viết";
$Definition["Use Facebook names for usernames."] =
    "Sử dụng tên Facebook là tên đăng nhập.";
...
$Definition[
    ...
    "Sử dụng ngôn ngữ chuyên môn cao và các thuật ngữ chuyên ngành dành cho những người có hiểu biết sâu sắc về chủ đề này.";
$Definition[
    "Uses industry-specific terms where necessary, but also provides explanations of definitions to ensure clarity."
] =
    "Sử dụng các thuật ngữ chuyên ngành khi cần thiết, nhưng cũng cung cấp giải thích về các định nghĩa để đảm bảo rõ ràng.";
$Definition[
    "Uses simple, everyday language that anyone can understand, regardless of their background or expertise."
] =
    "Sử dụng ngôn ngữ đơn giản, đời thường mà bất kỳ ai cũng có thể hiểu được, bất kể xuất thân hay chuyên môn của họ.";
$Definition["UserDeleteMessage"] =
    'Xóa người sử dụng và mọi tất cả nội dung của người dùng. Điều này có thể dẫn tới các bài viết bị rời rạc. Đây là lựa chọn tốt nhất để loại bỏ thư rác.';
$Definition["UserDeletionPrompt"] =
    "Chọn cách để xử lý tất cả nội dung liên quan đến tài khoản người dùng cho %s (ý kiến, tin nhắn, vv).";
$Definition["UserKeep"] = "Giữ lại nội dung của thành viên";
$Definition["UserKeepMessage"] =
    'Xóa người dùng nhưng giữ nội dung của người dùng.';
...
$Definition[
    ...
    "Người dùng có thể theo dõi các danh mục để đăng ký nhận thông báo cho bài viết mới. Chọn danh mục mà người dùng mới nên theo dõi theo mặc định.";
$Definition["Users that get this reaction get %+d point."] =
    "Người dùng nhận được phản ứng này có được %+d điểm.";
...
$Definition[
    ...
    "Người dùng sẽ không bị cảnh báo khi bấm vào các đường link khớp với Tên miền Đáng tin cậy.";
$Definition[
    "Users will be redirected to this URL after accepting an invitation."
] =
    "Người dùng sẽ được chuyển hướng đến URL này sau khi chấp nhận một lời mời. Đó có thể là một URL đầy đủ hoặc một đường dẫn để chuyển hướng trong trang web.";
...
$Definition[
    ...
    'Người dùng sẽ được gán cho vai trò này cho đến khi họ đã xác nhận địa chỉ email của họ.';
$Definition["Users with the no ads permission will not see this pocket."] =
    "Người sử dụng với quyền không quảng cáo sẽ không nhìn thấy túi này.";
$Definition["UserWipe"] = "Nội dung trống";
$Definition["UserWipeMessage"] =
    'Xóa người dùng và thay thế tất cả nội dung của người dùng với một tin nhắn cho biết người dùng đã bị xóa. Điều này sẽ cho biết lý do bị thiếu thông tin.';
$Definition["Use the content at this url as your homepage."] =
    'Chọn trang mà người sẽ thấy khi họ truy cập vào: <strong style="white-space: nowrap;"> %s</strong>';
$Definition["Use Vanilla as a commenting system in your site"] =
    "Sử dụng Vanilla như một hệ thống bình luận trên trang của bạn.";
$Definition["Use weekly community email digest"] =
    "Sử dụng thông báo email cộng đồng hàng tuần";
...
$Definition["Vanilla.Archive.Description"] =
    "Bạn có thể chọn để lưu trữ các bài viết cũ hơn một ngày chỉ định. Các bài viết bị lưu trữ nằm ở trạng thái đóng cửa, không cho phép gửi bình luận mới.";
$Definition["Vanilla.Categories.MaxDisplayDepth"] =
    'Đặt các danh mục lồng nhau thành một danh sách sử dụng dấu chấm phẩy để ngăn cách khi chúng là %1$s';
...
$Definition["View browser compatibility chart"] =
    "Xem biểu đồ tương thích trình duyệt";
...
] = "Cảnh báo người dùng nếu một đường link trong một bài đăng sẽ khiến họ rời khỏi diễn đàn";
$Definition[
    "Warning: All of your data will be lost. Once you delete, there is absolutely no recovery of any kind."
] =
    "Chú ý: Tất cả dữ liệu của bạn sẽ bị mất. Một khi bạn đã xóa, sẽ không có cách nào để phục hồi.";
$Definition["Warning: deleting is permanent"] =
    "Chú ý: các mục đã  bị xóa khỏi khỏi danh sách này và không thể đưa trở lại được.";
...
$Definition["We only accept urls that begin with http:// or https://"] =
    "Chúng tôi chỉ chấp nhận liên kết được bắt đầu bằng http:// hoặc https://";
$Definition[
    ...
    "Mặc định chúng tôi sẽ cố gắng sử dụng máy chủ thư cục bộ để gửi thư. Nếu bạn muốn sử dụng một máy chủ thư SMTP riêng biệt, bạn có thể cấu hình nó dưới đây.";
$Definition[
    ...
    "Xin chào. Tôi là Trợ lý gợi ý AI của bạn, một công cụ dựa trên máy học được thiết kế để định vị và gợi ý các bài viết và bài đăng có liên quan để trả lời các câu hỏi của bạn. Vui lòng nhập câu hỏi của bạn và tôi sẽ cung cấp thông tin phù hợp nhất.";
$Definition['What\'s the Buzz?'] = 'Buzz là gì?';
$Definition["When enabled, search result will open in a new browser tab."] =
    "Khi được bật, kết quả tìm kiếm sẽ mở trong tab trình duyệt mới.";
$Definition[
    "When enabled, your community will have AI Suggestions shown in Q&A. <0/>"
] = "Khi được bật, cộng đồng của bạn sẽ có Gợi ý AI được hiển thị trong phần Hỏi & Đáp. <0/>";
$Definition[
    ...
    "Khi cài đặt này được bật, thông tin chi tiết về người dùng trong dữ liệu Analytics sẽ được ẩn danh theo mặc định cho đến khi người dùng đồng ý với cookie Analytics. <0>Tìm hiểu thêm</0>";
$Definition["Where is your Community Forum?"] =
    "Diễn đàn của bạn ở đâu?";
$Definition['Who\'s Online Settings'] = 'Thiết lập ai đang trực tuyến';
$Definition["Why am I seeing AI Suggested Answers?"] =
    "Tại sao tôi lại thấy Câu trả lời được gợi ý của AI?";
...
$Definition["Yes, the following information can be changed later."] =
    "Vâng, các thông tin sau có thể được thay đổi sau này.";
$Definition["You are connected as %s."] = "Bạn được kết nối như %s.";
$Definition["You are not allowed to use suggestions"] =
    "Bạn không được phép sử dụng gợi ý";
$Definition["You are previewing the %s theme."] =
    "Bạn đang xem trước chủ đề %s.";
$Definition[
    "You can also ban the users that posted the spam and delete all of their posts."
] =
    "Đánh dấu vào ô bên cạnh người dùng đã gửi thư rác để cấm họ và xóa tất cả các bài viết của họ. <b>Chỉ làm điều này nếu bạn chắc  chắn đây là những kẻ gửi thư rác.</b>";
$Definition['You can always use your password at<a href="%1$s">%1$s</a>.'] =
    'Nếu bạn chưa bao giờ bị khóa trên diễn đàn bạn có thể đăng nhập bằng cách sử dụng thử điện tử và mật khẩu gốc của Vanilla tại <a href="%1$s"> %1$s</a>';
$Definition[
    "You can ban IP addresses, email domains, and words from usernames using this tool."
] =
    "Bạn có thể cấm địa chỉ IP, tên miền thư điện tử, và các từ trong tên người dùng bằng cách sử dụng công cụ này.";
$Definition[
    "You can customize the HTML and CSS for this theme on the %s page."
] = "Bạn có thể tùy chỉnh HTML và CSS cho chủ đề này trên trang %s.";
$Definition[
    "You can either create a new account, or enter your credentials if you have an existing account."
] =
    "Bạn có thể hoặc tạo một tài khoản mới, hoặc nhập thông tin đăng nhập của bạn nếu bạn đã có sẵn một tài khoản.";
$Definition["You can make the categories page your homepage."] =
    'Bạn có thể tạo trang danh mục và Trang chủ của bạn <a href="%s"> ở đây</a>.';
$Definition[
    "You can search for users by username or email, wildcards are implied."
] = "Bạn có thể tìm kiếm người dùng theo tên người dùng hoặc email, ký tự đại diện được ngụ ý.";
$Definition["You can specify an allow list of trusted domains."] =
    "Bạn có thể chỉ định danh sách các miền đáng tin cậy, an toàn để chuyển hướng và nhúng.";
$Definition["You can specify an allow list of trusted domains. (CSP)"] =
    "Bạn có thể chỉ định danh sách cho phép các miền đáng tin cậy (ví dụ: yourdomain.com) an toàn để tải javascript từ đó.";
$Definition[
    'You cannot disable the %1$s plugin because the %2$s plugin requires it in order to function.'
] =
    'Bạn không thể vô hiệu hóa plugin %1$s vì plugin %2$s plugin yêu cầu nó để hoạt động.';
$Definition[
    "You cannot remove the only remaining category that allows discussions"
] = "Bạn không thể xoá danh mục cho phép tạo bài viết mới";
$Definition[
    "You can protect your site with an HTTP username/password during development."
] =
    "Bạn có thể bảo vệ website của mình bằng một tên người dùng/mật khẩu HTTP trong quá trình phát triển web.";
$Definition[
    "You can send emails in plain text by disabling the toggle below."
] = "Bạn có thể gửi email theo dạng văn bản thuần túy bằng cách tắt phím bật/tắt bên dưới.";
$Definition["You have %s invitations left for this month."] =
    "Bạn có %s  lời mời còn lại trong tháng này.";
$Definition["You have successfully saved interest: <0/>"] =
    "Bạn đã tiết kiệm được lãi suất thành công: <0/>";
$Definition["You must be authenticated in order to use this form."] =
    "Bạn phải được xác nhận để sử dụng mẫu đơn này.";
$Definition["You must manually apply this rank."] =
    "Theo cách thủ công, bạn phải áp dụng xếp hạng này.";
$Definition["You must provide at least one recipient"] =
    "Bạn phải nhập ít nhất một người nhận";
$Definition["You must specify an admin password."] =
    "Bạn phải chỉ định một mật khẩu quản trị.";
$Definition["You must specify an admin username."] =
    "Bạn phải chỉ định tên người quản trị.";
$Definition[
    ...
    "Tập tin cấu hình của bạn không có quyền đúng. PHP cần để có thể đọc và ghi tập tin này: <code>%s</code>";
$Definition['Your default locale won\'t display properly'] =
    'Ngôn ngữ mặc định của bạn hiển thị không chính xác cho tới khi nó được bật. Vui lòng bật: %s.';
...
$Definition[
    ...
    "Bạn đang rời khỏi trình chỉnh sửa chủ đề mà không lưu các thay đổi của bạn. Hãy chắc chắn rằng các cập nhật của bạn được lưu trước khi thoát.";
$Definition[
    "You are leaving the Email Settings page without saving your changes. Make sure your updates are saved before exiting."
] =
    "Bạn đang rời khỏi trang Cài đặt Email mà không lưu các thay đổi của mình. Đảm bảo các cập nhật của bạn được lưu trước khi thoát.";
