...
$Definition['RichEditor.QuoteEnable.Notes'] = 'Sử dụng tùy chọn sau để bật báo giá cho Rich Editor. Điều này sẽ chỉ áp dụng nếu trình định dạng mặc định là "Giàu".';
...
$Definition['This setting loads the page before executing Javascript.'] = 'Cài đặt này tải trang trước khi thực hiện Javascript có thể cải thiện SEO của bạn. <br> <strong>** Cảnh báo: Kích hoạt tính năng này có thể gây ra lỗi Javascript trên trang web của bạn. **</strong>';
