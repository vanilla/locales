...
$Definition['Allow links to be transformed'] = 'Cho phép chuyển đổi liên kết thành biểu diễn nhúng trong bài đăng và bình luận. Ví dụ: liên kết YouTube sẽ chuyển đổi thành video nhúng.';
...
$Definition['This setting loads the page before executing Javascript.'] = 'Tính năng cài đặt này tải trang trước khi chạy Javascript có thể cải thiện SEO của bạn. <br> <strong> ** Cảnh báo: Kích hoạt tính năng này có thể gây ra lỗi Javascript trên trang web của bạn. ** </strong>';
...
$Definition['TouchIconDescription'] = 'Biểu tượng cảm ứng xuất hiện khi bạn đánh dấu một trang web trên màn hình chính của thiết bị Apple. Đây thường là 152 pixel. Apple thêm các góc tròn và hiệu ứng ánh sáng tự động.';
