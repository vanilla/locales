...
$Definition['Digest Settings'] = 'Cài đặt thông báo';
...
$Definition['Recommended dimensions are about 400px by 300px or smaller with similar ratio.'] = 'Kích thước được đề xuất là khoảng 400px x 300px hoặc nhỏ hơn với tỷ lệ tương tự.';
...
$Definition['The database user you specified does not have permission to access the database. Have you created the database yet? The database reported: <code>%s</code>'] =
    'Tài khoản bạn đã chỉ định không có quyền truy cập cơ sở dữ liệu. Bạn đã tạo ra cơ sở dữ liệu chưa? Cơ sở dữ liệu báo cáo: <code>%s</code>';
...
$Definition['This setting loads the page before executing Javascript.'] =
    'Tính năng cài đặt này tải trang trước khi chạy Javascript có thể cải thiện SEO của bạn. <br> <strong> ** Cảnh báo: Kích hoạt tính năng này có thể gây ra lỗi Javascript trên trang web của bạn. ** </strong>';
$Definition['Tiled Layout'] = 'Bố cục lát gạch';
...
$Definition['TouchIconDescription'] =
    'Biểu tượng cảm ứng xuất hiện khi bạn đánh dấu một trang web trên màn hình chính của thiết bị Apple. Đây thường là 152 pixel. Apple thêm các góc tròn và hiệu ứng ánh sáng tự động.';
...
$Definition['User Profile'] = 'Thông tin người dùng';
...
$Definition['VerifyUser'] = 'Chọn hộp bên cạnh người dùng để đánh dấu họ là Đã <b>xác minh</b> để bài đăng của họ không bị đánh dấu là spam nữa. Điều này cũng sẽ khôi phục tất cả các bài đăng đang chờ xử lý của họ.';
...
$Definition['Warning: Loading tables can be slow.'] =
    '<b>Cảnh báo</b> : Cấu hình máy chủ của bạn không hỗ trợ tải dữ liệu nhanh. Nếu bạn đang nhập một tệp rất lớn (ví dụ: hơn 200.000 nhận xét), bạn có thể muốn xem xét thay đổi cấu hình của mình. Nhấn vào <a href="http://vanillaforums.com/porter">đây</a> để biết thêm thông tin.';
...
$Definition['Which reactions you use really depends on your community.'] =
    'Những phản ứng bạn sử dụng thực sự phụ thuộc vào cộng đồng của bạn, nhưng chúng tôi khuyên bạn nên ghi nhớ một vài điểm.';
...
$Definition['You can choose from one of the different styles this theme offers.'] = 'Bạn có thể chọn từ một trong những phong cách khác nhau mà chủ đề này cung cấp.';
...
$Definition['You can specify a minimum post length to discourage short posts.'] = 'Bạn có thể chỉ định độ dài bài tối thiểu để không khuyến khích các bài viết ngắn.';
...
$Definition["Are you sure want to delete this theme? It will be permanently deleted."] = "Bạn có chắc chắn muốn xóa chủ đề này? Nó sẽ bị xóa vĩnh viễn.";
...
$Definition["When you select Full Bleed, your background is transparent."] = "Khi bạn chọn Full Bleed, nền của bạn trong suốt.";
$Definition["Alignment"] = "Sắp xếp";
$Definition["Left Aligned"] = "Căn lề trái";
$Definition["Center Aligned"] = "Trung tâm liên kêt";
$Definition["Image (Mobile)"] = "Hình ảnh (Di động)";
$Definition["Alignment (Mobile)"] = "Sắp xếp (Di động)";

// Vanilla Labs
$Definition['Vanilla Labs'] = 'Phòng thí nghiệm vani';
...
$Definition['Check out our <0>documentation</0>, or ask our <1>community of experts</1>.'] = 'Kiểm tra tài liệu <0> của chúng tôi</0> hoặc hỏi <1> cộng đồng chuyên gia của chúng tôi</1> .';
$Definition['Enable and test out the latest Vanilla features.'] = 'Kích hoạt và thử nghiệm các tính năng mới nhất của Vanilla.';
...
$Definition["Usercards allow you to get a quick in-line snapshot of a user's information."] = "Thẻ người dùng cho phép bạn có được ảnh chụp nhanh nội tuyến về thông tin của người dùng. Khi xem các bài đăng và bảng xếp hạng, hãy nhấp vào tên người dùng để xem thẻ hiển thị thông tin hồ sơ cơ bản của người dùng mà không cần phải điều hướng khỏi trang. Bật tính năng này để thêm thẻ người dùng vào chủ đề tùy chỉnh của bạn.";
$Definition['New Search Page'] = 'Trang tìm kiếm mới';
$Definition["Vanilla's new search service is finally here."] = "Dịch vụ tìm kiếm mới của Vanilla cuối cùng cũng có ở đây. Bật giao diện người dùng trang tìm kiếm mới của chúng tôi để có quyền truy cập vào các tính năng tìm kiếm mới nhất như Tìm kiếm Thành viên, sắp xếp tìm kiếm và tô sáng thuật ngữ.";
...
$Definition['Disable the "New Embed System" lab on the <0>Vanilla Labs Page</0>'] = 'Tắt lab "Hệ thống nhúng mới" trên <0> Trang Vanilla Labs</0>';
