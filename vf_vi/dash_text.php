...
$Definition['This setting loads the page before executing Javascript.'] =
    'Cài đặt này tải trang trước khi thực hiện Javascript có thể cải thiện SEO của bạn. <br> <strong>** Cảnh báo: Kích hoạt tính năng này có thể gây ra lỗi Javascript trên trang web của bạn. **</strong>';
...
$Definition["This theme cannot be deleted because it is the currently applied theme."] = "Chủ đề này không thể bị xóa vì đây là chủ đề hiện đang được áp dụng.";
