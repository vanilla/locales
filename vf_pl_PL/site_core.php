...
$Definition['Activity.AboutUpdate.FullHeadline'] = '%1$s zaktualizowany %6$s profil.';
$Definition['Activity.AboutUpdate.ProfileHeadline'] = '%1$s zaktualizowany %6$s profil.';
$Definition['Activity.AddedToConversation.FullHeadline'] = '%1$s zostałeś dodany do %8$s.';
$Definition['Activity.AddedToConversation.ProfileHeadline'] = '%1$s zostałeś dodany do %8$s.';
$Definition['Activity.BookmarkComment.FullHeadline'] = '%1$s skomentowano twój %8$s.';
$Definition['Activity.BookmarkComment.ProfileHeadline'] = '%1$s skomentowano twój %8$s.';
$Definition['Activity.Comment'] = 'Komentarz';
$Definition['Activity.CommentMention.FullHeadline'] = '%1$s wspomniano %3$s w %8$s.';
$Definition['Activity.CommentMention.ProfileHeadline'] = '%1$s wymieniono %3$s w %8$s.';
$Definition['Activity.ConversationMessage.FullHeadline'] = '%1$s wysłano ci %8$s.';
$Definition['Activity.ConversationMessage.ProfileHeadline'] = '%1$s wysłano ci %8$s.';
$Definition['Activity.DiscussionComment.FullHeadline'] = '%1$s skomentowano %4$s %8$s.';
$Definition['Activity.DiscussionComment.ProfileHeadline'] = '%1$s skomentowano %4$s %8$s.';
$Definition['Activity.DiscussionMention.FullHeadline'] = '%1$s wymieniono %3$s w %8$s.';
$Definition['Activity.DiscussionMention.ProfileHeadline'] = '%1$s wspomniano %3$s w %8$s.';
$Definition['Activity.Import.FullHeadline'] = '%1$s zaimportowano dane.';
$Definition['Activity.Import.ProfileHeadline'] = '%1$s zaimportowano dane.';
$Definition['Activity.Join.FullHeadline'] = '%1$s połączono.';
$Definition['Activity.Join.ProfileHeadline'] = '%1$s połączono.';
$Definition['Activity.JoinApproved.FullHeadline'] = '%1$s zatwierdzono %4$s wniosek o członkostwo.';
$Definition['Activity.JoinApproved.ProfileHeadline'] = '%1$s zatwierdzono %4$s wniosek o członkostwo.';
$Definition['Activity.JoinCreated.FullHeadline'] = '%3$s utworzono konto dla %1$s.';
$Definition['Activity.JoinCreated.ProfileHeadline'] = '%3$s utworzono konto dla %1$s.';
$Definition['Activity.JoinInvite.FullHeadline'] = '%1$s zaakceptowano %4$s zaproszenie do członkostwa.';
$Definition['Activity.JoinInvite.ProfileHeadline'] = '%1$s zaakceptowano %4$s zaproszenie do członkostwa.';
$Definition['Activity.NewDiscussion.FullHeadline'] = '%1$s rozpoczyna się %8$s.';
$Definition['Activity.NewDiscussion.ProfileHeadline'] = '%1$s rozpoczyna się %8$s.';
$Definition['Activity.PictureChange.FullHeadline'] = '%1$s zmieniono %6$s obrazek profilowy.';
$Definition['Activity.PictureChange.ProfileHeadline'] = '%1$s zmieniono %6$s obrazek profilowy.';
$Definition['Activity.RoleChange.FullHeadline'] = '%1$s zmieniono %4$s uprawnienia.';
$Definition['Activity.RoleChange.ProfileHeadline'] = '%1$s zmieniono %4$s uprawnienia.';
$Definition['Activity.SignIn.FullHeadline'] = '%1$s zalogowany.';
$Definition['Activity.SignIn.ProfileHeadline'] = '%1$s zalogowany.';
$Definition['Activity.WallComment.FullHeadline'] = '%1$s napisał(a) na %4$s %5$s.';
$Definition['Activity.WallComment.ProfileHeadline'] = '%1$s napisał(a):';
...
$Definition['Allow other members to see your email?'] = 'Zezwalasz innym użytkownikom na zobaczenie twojego adresu e-mail?';
...
$Definition['Ask Question'] = 'Wyślij dyskusję';
$Definition['Attach a file'] = 'Załącz plik';

$Definition['Back to Discussions'] = 'Powrót do dyskusji';
...
%1$s zostałeś zaprodzony do dołączenia %2$s. Jeśli chcesz dołączyć do nas możesz to zrobić klikając na link:
...
Twije członkostwo zostało zatwierdzone. Zaloguj się za pomocą następującego linku:
...
Miłego dnia!';
$Definition['EmailWelcomeConnect'] = 'Witaj {User.Name},

Zostałeś połączony z {Title}. Oto twoje informacje:
...
Zostałeś zarejestrowany na koncie w {Title}. Oto twoje informacje:
...
$Definition['ErrorCredentials'] = 'Sorry, nie mogliśmy odnaleźć konta, do którego pasowałyby wprowadzone przez Ciebie e-mail i hasło.';
...
$Definition['Most recent by %1$s'] = 'Najpopularniejsze od %1$s';
$Definition['My Bookmarks'] = 'Moje zakładki';
...
$Definition['New Conversation'] = 'Rozpocznij nową konwersację';
$Definition['New Discussion'] = 'Nowa dyskusja';
$Definition['New Message'] = 'Rozpocznij nową konwersację';
...
$Definition['Notify me when people mention me in comments.'] = 'Informuj mnie kiedy ludzie wspominają mnie w komentarzach.';
$Definition['Notify me when people reply to my wall comments.'] = 'Powiadom mnie, gdy ktoś odpowie na mojej ścianie komentarzy.';
$Definition['Notify me when people write on my wall.'] = 'Powiadom mnie, gdy ktoś napisze na mojej ścianie.';
...
$Definition['PasswordRequest'] = 'Witaj %1$s,

Ktoś zażądał zresetowania twojego hasła %2$s. By je zresetować odwiedź ten link:
...
$Definition['Register with %s'] = 'Zastosuj do członka';
...
$Definition['ValidateRequired'] = '%s jest wymagane.';
