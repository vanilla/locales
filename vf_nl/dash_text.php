...
$Definition['Garden.Import.Continue.Description'] = 'Het lijkt alsof je midden in een importering zit.
Kies alsjeblieft een van de volgende opties.';
...
$Definition['Warning: Loading tables can be slow.'] = '<b>Waarschuwing</b>: Je serverconfiguratie ondersteunt niet het snel laden van data.
 Als je een zeer groot bestand aan het importeren bent (bijvoorbeeld meer dan 200.000 reacties) zou je kunnen overwegen om je configuratie te wijzigen. Klik <a href="http://vanillaforums.com/porter">hier</a> voor meer informatie.';
