...
$Definition['AboutEmbedding'] = 'Insluiten maakt het mogelijk een deel van of je gehele community in te sluiten in andere applicaties & websites.';
...
$Definition['Choose how to handle all of the content associated with the user account for %s (comments, messages, etc).'] = 'Kies hoe je alle inhoud die hoort bij de gebruikersaccount voor %s wil behandelen (reacties, berichten etc.)';
...
$Definition['Learn about custom routing.'] = 'Leer over custom routing.';
...
$Definition['Locales allow you to support other languages on your site.'] = 'Locaties maken het mogelijk andere talen op je site te ondersteunen. Schakel locaties die je beschikbaar wilt maken hier  in en uit. ';
...
$Definition['Too many addresses! We\'ll send up to %s addresses at once.'] = 'Te veel adressen! We kunnen tot aan %s adressen per keer sturen.';
