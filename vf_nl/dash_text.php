...
$Definition['RichEditor.QuoteEnable.Notes'] = 'Gebruik de volgende optie om quotes toe te staan voor de Rich Editor. Dit is alleen van toepassing als de standaarformatter \'Rich\' is.';
...
$Definition['ShareImageDescription'] = 'Wanneer iemand een link van je site deelt, proberen we een afbeelding van de pagina te halen. Als er geen afbeelding op de pagina staat, gebruiken we deze afbeelding. De afbeelding moet minimaal 50 × 50 zijn, maar we raden 200 × 200 aan.';
...
$Definition['Tagging allows users to add a tag to discussions they start in order to make them more discoverable. '] = 'Taggen staat gebruikers toe om een tag toe te voegen aan discussies om deze meer zichtbaar te maken.';
...
$Definition['This setting loads the page before executing Javascript.'] = 'Deze instelling laadt de pagina voordat Javascript wordt uitgevoerd, wat uw SEO kan verbeteren. <br><strong> **Waarschuwing: het inschakelen van deze functie kan Javascript-fouten op uw site veroorzaken. **</strong>';
...
$Definition['TouchIconDescription'] = 'Het aanraakpictogram verschijnt wanneer je een website als bladwijzer op het startscherm van een Apple-apparaat plaatst. Dit zijn meestal 152 pixels. Apple voegt automatisch afgeronde hoeken en lichteffecten toe.';
...
$Definition['Which reactions you use really depends on your community.'] = 'Welke reacties je gebruikt is echt afhankelijk van je gemeenschap, maar we adviseren dat je een paar punten in je achterhoofd houdt.';
