...
$Definition['Enable and test out the latest Vanilla features.'] = 'Enable and test out the latest Vanilla features.';
$Definition['N.B. The <0/> lab needs to be configured to match your custom theme.'] = 'N.B. The <0/> lab needs to be configured to match your custom theme. This can be done using our new theme editor. <1>Find out more.</1>';
