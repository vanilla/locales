...
$Definition['When this setting is enabled, user fragments in Analytics data will be anonymized by default, until the user consents to Analytics cookies. Learn more'] = 'When this setting is enabled, user fragments in Analytics data will be anonymized by default, until the user consents to Analytics cookies. Learn more';
