...
$Definition['%1$s version %2$s is available.'] =
    '%1$s različica %2$s je na voljo.';
$Definition["%s is not a valid email address"] =
    "%s ni veljaven e-poštni naslov";
...
$Definition["%s user(s) will be affected by this action."] =
    "To dejanje bo vplivalo na %s uporabnikov.";

$Definition["<0/> will suggest answers on Q&A posts"] =
    "<0/> bo predlagal odgovore na objave vprašanj in odgovorov";
$Definition["<0 /> will not suggest answers on Q&A posts"] =
    "<0 /> ne bo predlagal odgovorov na objave vprašanj in odgovorov";
...
$Definition["1 in 5 is recommended for most communities."] =
    "1 od 5 se priporoča za večino skupnosti.";
$Definition["1 in 20 is recommended for most communities."] =
    "Za večino skupnosti je priporočljiv 1 od 20.";
...
$Definition["[%s] Confirm Your Email Address"] =
    "[%s] Potrdite svoj e-poštni naslov";
...
] = 'Dosegli ste največje število poskusov prijave. Počakajte %s in poskusite znova.';
...
$Definition["A unique label name that cannot be changed once saved."] =
    "Edinstveno ime oznake, ki ga po shranjevanju ni mogoče spremeniti.";
...
$Definition['"Accept Answer" if a suggestion answers your question.'] =
    '»Sprejmi odgovor«, če predlog odgovarja na vaše vprašanje.';
...
$Definition["Accepted answer pageview ratio representing a deflected case"] =
    "Razmerje ogledov strani s sprejetim odgovorom, ki predstavlja odstopanje velikih in malih črk";
...
$Definition["Add a new Pocket to your site."] =
    "Dodajte nov Pocket na svoje spletno mesto.";
$Definition[
    ...
    "Dodajte povezavo Zoom ali ID srečanja, da povežete ta dogodek s Zoomom in omogočite registracijo z enim klikom in gumbe za pridružitev. Upoštevajte, da če vaš dogodek zahteva registracijo, po ustvarjanju dogodka ne morete posodobiti svojega ID-ja sestanka ali povezave.";
...
$Definition[
    ...
    "Dodajte informacije v polje pošiljatelja v e-poštnih naslovih za pomoč pri odgovorih (priporočeno).";
...
$Definition[
    ...
    "Dodajte svoje domene po meri Kaltura, da spremenite povezave v vdelane videoposnetke v razpravah, komentarjih ali člankih.";
$Definition[
    "Add your custom Kaltura domain(s) to transform links into embedded videos in posts, comments or articles."
] =
    "Dodajte svoje domene Kaltura po meri, da povezave pretvorite v vdelane videoposnetke v objavah, komentarjih ali člankih.";
...
$Definition[
    ...
    "AI Suggested Answers nudi predlagane odgovore na podlagi objav skupnosti in povezanih zbirk znanja. To lahko kadar koli vklopite ali izklopite v nastavitvah profila.";
$Definition[
    "Alert users if they click a link in a post that will lead them away from the forum. "
] =
    "Opozorite uporabnike, če kliknejo povezavo v objavi, ki jih bo odpeljala stran od foruma.";
...
$Definition["All discussions in this category will be permanently deleted."] =
    "Vse razprave v tej kategoriji bodo trajno izbrisane.";
...
$Definition[
    ...
    "Vsa uporabniška vsebina bo nadomeščena s sporočilom, da je bil uporabnik izbrisan.";
...
$Definition["Allow new users to be registered through email."] =
    "Dovolite registracijo novih uporabnikov prek e-pošte.";
$Definition["Allow this connection to issue API access tokens."] =
    "Dovoli tej povezavi izdajanje žetonov za dostop do API-ja.";
$Definition["Allow Third-Party Script Execution"] =
    "Dovoli izvajanje skripta tretjih oseb";
$Definition["Allow users to change their own avatars"] =
    "Omogočite uporabnikom, da spremenijo svoje avatarje";
$Definition["Allow users to dismiss this message"] =
    "Dovoli uporabnikom, da opustijo to sporočilo.";
...
$Definition["An enabled message will be visible on the site."] =
    "Na spletnem mestu bo vidno omogočeno sporočilo.";
$Definition["An answer in this the community thread was marked as accepted"] =
    "Odgovor v tej niti skupnosti je bil označen kot sprejet";
$Definition["An error occurred updating your privacy setting"] =
    "Pri posodabljanju vaših nastavitev zasebnosti je prišlo do napake";
$Definition["Anonymize Analytics Data by Default"] =
    "Privzeto anonimiziraj podatke Analytics";
$Definition["Answers is not available if you have not accepted cookies."] =
    "Odgovori niso na voljo, če niste sprejeli piškotkov.";
$Definition["API"] = "API";
...
$Definition["Applicant Role"] =
    "Izberite vlogo, ki jo je treba uporabiti za nove kandidate. To velja le, če imate metodo registracije <b>odobritve</b> .";
...
$Definition["Are you sure you want to delete %s items forever?"] =
    "Ali ste prepričani, da želite za vedno izbrisati %s elemente?";
$Definition["Are you sure you want to delete 1 item forever?"] =
    "Ali ste prepričani, da želite za vedno izbrisati 1 element?";
$Definition[
    "Are you sure you want to delete this badge? This is irreversible and will revoke the badge from all users who have it."
] =
    "Ali ste prepričani, da želite izbrisati to značko? To je nepovratno in bo preklicalo značko vsem uporabnikom, ki jo imajo.";
$Definition["Are you sure you want to delete this category?"] =
    "Ali ste prepričani, da želite izbrisati to kategorijo?";
$Definition["Are you sure you want to restore %s items?"] =
    "Ali ste prepričani, da želite obnoviti %s elementov?";
$Definition["Are you sure you want to restore 1 item?"] =
    "Ali ste prepričani, da želite obnoviti 1 element?";
$Definition[
    "Are you sure you want to turn off all AI Suggested Answers? You can undo this in your profile settings at anytime."
] =
    "Ali ste prepričani, da želite izklopiti vse predlagane odgovore AI? To lahko kadar koli razveljavite v nastavitvah profila.";
...
] = "Potreben je vsaj en viden stolpec. Prikažite ali dodajte viden stolpec.";
$Definition["A url-friendly version of the category name for better SEO."] =
    "URL-ju prijazna različica imena kategorije za boljši SEO.";
...
$Definition[
    ...
    "Preden aktivirate to funkcijo, se zavedajte naslednjih možnih posledic:";
...
$Definition["Bookmark a discussion using its star icon."] =
    "Dodajte razpravo med zaznamke z ikono zvezdice.";
...
$Definition["Browse for a new banner logo if you would like to change it:"] =
    "Poiščite nov logotip pasice, če ga želite spremeniti:";
...
$Definition["Cannot build profile information if user is not defined."] =
    "Podatkov o profilu ni mogoče zgraditi, če uporabnik ni definiran.";
$Definition["Categories &amp; Discussions"] = "Kategorije in razprave";
$Definition["Categories to Exclude from AI Answers"] =
    "Kategorije, ki jih je treba izključiti iz odgovorov AI";
$Definition["Categories are used to organize discussions."] =
    "Kategorije se uporabljajo za pomoč vašim uporabnikom pri organiziranju njihovih razprav na način, ki je pomemben za vašo skupnost.";
$Definition["Categories are used to organize posts."] =
    "Kategorije se uporabljajo za pomoč uporabnikom pri organizaciji objav na način, ki je pomemben za vašo skupnost.";
$Definition["Categories allow you to organize your posts."] =
    "Kategorije vam omogočajo organiziranje objav.";
...
$Definition["Check out the full list of video tutorials here."] =
    "Tukaj si oglejte celoten seznam video vadnic.";
...
$Definition["Click here to carry on to your dashboard"] =
    "Kliknite tukaj, če želite nadaljevati na svojo nadzorno ploščo";
...
$Definition["Community Discussion Categories"] =
    "Skupnostne razpravne kategorije";
...
$Definition["Configuration settings for password fields in Vanilla"] =
    "Konfiguracijske nastavitve za polja z gesli v Vanilla";
$Definition["Configure custom Kaltura domains"] =
    "Konfigurirajte domene Kaltura po meri";
$Definition["Configure how nested categories are displayed to users."] =
    "Konfigurirajte, kako so ugnezdene kategorije prikazane uporabnikom.";
$Definition['Configuring Vanilla\'s Homepage'] =
    'Konfiguriranje domače strani Vanilla';
$Definition["Confirmation  Body"] = "Potrditveno telo";
$Definition["Confirm email addresses"] =
    "Od uporabnikov zahtevaj potrditev svojih e-poštnih naslovov (priporočeno)";
...
$Definition[
    ...
    "Obrnite se na osebje Vanilla, da omogočite konfiguracijo spletnega mesta z vprašanji in odgovori. Nato omogočite dodatek Q&A v razdelku Addons na nadzorni plošči.";
$Definition[
    ...
    "Obrnite se na osebje Vanilla, da omogočite konfiguracijo spletnega mesta z vprašanji in odgovori. Nato omogočite dodatek za vprašanja in odgovore v razdelku <0/> na nadzorni plošči.";
$Definition["Content Curation"] = "Kuriranje vsebine";
$Definition["Content flagged as spam is stored here for moderator review."] =
    "Vsebina, označena kot neželena pošta, je shranjena tukaj za pregled moderatorja.";
...
$Definition[
    ...
    "Če so začetni skripti ogroženi, lahko povzročijo ranljivosti, kot je skriptiranje med spletnimi mesti (XSS).";
$Definition['Could not find a theme identified by \'%s\''] =
    'Ni bilo mogoče najti teme, označene z \'%s\'';
$Definition["Could not instantiate mail function."] =
    "Funkcije pošte ni bilo mogoče ustvariti.";
...
$Definition["Could not open addon file. Addons must be zip files."] =
    "Datoteke dodatka ni bilo mogoče odpreti. Dodatki morajo biti datoteke zip.";
$Definition["Create & organize discussion categories and manage your users."] =
    "Ustvarite in organizirajte kategorije razprav ter upravljajte svoje uporabnike.";
...
$Definition["Disabled: The pocket will <b>not</b> be displayed."] =
    "Onemogočeno: žep <b>ne</b> bo prikazan.";
...
$Definition["Do not display the categories in the side panel."] =
    "Ne prikazujte kategorij na stranski plošči.";
...
$Definition[
    ...
    "Pripomoček za poziv za e-poštni povzetek bo na voljo, ko je omogočen e-poštni povzetek.";
...
$Definition[
    ...
    "E-poštni povzetki bodo poslani na izbrani dan vsak teden. Spremembe nastavljenega dne bodo veljale naslednji teden.";
...
$Definition["Embedding is currently DISABLED."] =
    "Vdelava je trenutno ONEMOGOČENA.";
$Definition["Embedding is currently ENABLED."] =
    "Vdelava je trenutno OMOGOČENA.";
...
$Definition["Enable link embeds in discussions and comments"] =
    "Omogoči vdelavo povezav v razprave in komentarje";
$Definition["Enable link embeds in posts and comments"] =
    "Omogoči vdelavo povezav v objave in komentarje";
...
$Definition["Enable sending notification emails"] =
    "Omogoči pošiljanje obvestil po e-pošti";
...
$Definition["Enable to only show posts from categories a user follows."] =
    "Omogočite prikaz samo objav iz kategorij, ki jim uporabnik sledi.";
$Definition[
    "Enable to get a preview of our new user management dashboard with improved search and new configuration options."
] =
    "Omogočite za predogled naše nove nadzorne plošče za upravljanje uporabnikov z izboljšanim iskanjem in novimi možnostmi konfiguracije.";
...
$Definition[
    ...
    "Če omogočite to funkcijo, boste spremenili vaš pravilnik o varnosti vsebine, da bo zaupal dodatnim skriptom, ki so jih kot odvisnosti vstavili vaši skripti po meri.";
$Definition[
...
$Definition["Encourage your friends to join your new community!"] =
    "Spodbudite svoje prijatelje, da se pridružijo vaši novi skupnosti!";
$Definition["Enter a comma-delimited list of indexes, starting at 1."] =
    "Vnesite z vejicami ločen seznam indeksov, ki se začne pri 1.";
...
$Definition["Enter the email address of the person you would like to invite:"] =
    "Vnesite elektronski naslov osebe, ki jo želite povabiti:";
$Definition[
    "Enter the url to the page you would like to use as your homepage"
] = "Vnesite URL do strani, ki jo želite uporabiti kot domačo stran";
$Definition[
    "Enter the url to the page you would like to use as your homepage:"
] = "Vnesite URL do strani, ki jo želite uporabiti kot domačo stran:";
$Definition["Error sending email. Please review the addresses and try again."] =
    "Napaka pri pošiljanju e-pošte. Preglejte naslove in poskusite znova.";
...
$Definition["Exclude archived discussions from the discussions list"] =
    "Izključi arhivirane razprave s seznama razprav";
$Definition["Existing members send invitations to new members."] =
    "Obstoječi člani pošiljajo vabila novim članom.";
...
$Definition[
    ...
    "Zunanje iskanje nadomešča Vanillino takojšnje iskanje s ponudnikom iskanja tretje osebe po vaši izbiri.";
...
$Definition["FaviconBrowse"] =
    "Prebrskajte za novo priljubljeno ikono, če jo želite spremeniti:";
$Definition["FaviconDescription"] =
    "Ikona priljubljenega mesta se prikaže v naslovni vrstici brskalnika. Ustrezno bo pomanjšan.";
...
$Definition[
    ...
    "Na primer, če želite dovoliti vašadomena.com, www.vašadomena.com in pomoč.vašadomena.com, morate dodati *.vašadomena.com";
$Definition["Force the forum to only be accessible through this url"] =
    "Vsili, da bo forum dostopen samo prek tega naslova URL";
$Definition["Force your forum to be viewed through the Remote Url"] =
    "Prisilite ogled svojega foruma prek oddaljenega URL-ja";
...
$Definition["Full post in email notifications"] =
    "Celotna objava v e-poštnih obvestilih";

$Definition["Garden"] = "Vrt";
$Definition["Garden.api.ssoIDPermission.description"] =
    "Vloge s tem dovoljenjem bodo lahko razširile ID-je SSO v klicih API v2.";
...
$Definition[
    ...
    "Ustvarjanje predlogov. Ko bodo pripravljeni, da jih pregledate, boste obveščeni.";
...
$Definition[
    ...
    "lep pozdrav Sem vaš pomočnik za predloge AI, tukaj, da vam pomagam pri iskanju ustreznih člankov in objav za odgovore na vaša vprašanja. Zastavite kakršna koli vprašanja.";
$Definition["guest"] = "gost";
$Definition["Guest roles"] =
    "Preverite vse vloge, ki jih je treba uporabiti za goste.";

$Definition["Hash Algorithm"] = "Hash algoritem";
$Definition["HeadlineFormat.AddUser"] =
    "{ActivityUserID,user} je dodal račun za {RegardingUserID,user}.";
$Definition["HeadlineFormat.PictureChange"] =
    "{RegardingUserID,You} je spremenil {ActivityUserID,your} sliko profila.";
$Definition["HeadlineFormat.RegistrationApproval"] =
    "{ActivityUserID,user} je odobril aplikacije za {RegardingUserID,user}.";
...
$Definition["Hide discussions from Recent Discussions and Widgets."] =
    "Skrij razprave iz nedavnih razprav in pripomočkov.";
$Definition["Hide posts from Recent Posts Page and Widgets."] =
    "Skrij objave na strani z nedavnimi objavami in v pripomočkih.";
...
$Definition["Hide signatures on embedded comments"] =
    "Skrij podpise na vdelanih komentarjih";
...
$Definition[
    ...
    "Vendar to vključuje večjo odgovornost za zagotavljanje varnosti vašega spletnega mesta.";
$Definition["Html"] = "HTML";
$Definition["HTML Emails"] = "E-poštna sporočila HTML";
$Definition["HTTP Strict Transport Security (HSTS) Settings"] =
    "Nastavitve HTTP Strict Transport Security (HSTS).";
...
$Definition["If left empty, Email Logo is used."] =
    "Če je polje prazno, se uporabi logotip elektronske pošte.";
$Definition[
    ...
    "Če imate v zgornjem razdelku »Povezava do pogojev uporabe« povezavo do internega dokumenta, bo »Besedilo pogojev uporabe« prezrto. Odstranite povezavo, če želite uporabiti to besedilo.";
...
$Definition["Include full post in email notifications"] =
    "Vključite celotno objavo v e-poštna obvestila";
...
$Definition["Include featured images with posts in email digest"] =
    "V izvleček e-pošte vključite predstavljene slike z objavami";
$Definition["Include internal profile fields"] =
    "Vključite interna polja profila";
$Definition["Include private profile fields"] =
    "Vključite zasebna polja profila";
...
$Definition["Install Vanilla without a .htaccess file."] =
    "Namestite Vanilla brez datoteke .htaccess.";
...
$Definition["It looks like you edited your post. <0/> or <1/>."] =
    "Videti je, da ste uredili svojo objavo. <0/> ali <1/>.";
...
$Definition["Large images will be scaled down."] =
    "Velike slike bodo pomanjšane na največjo širino %spx in največjo višino %spx.";
...
$Definition["Limits: 60 characters, no breaks."] =
    "Omejitve: 60 znakov, brez presledkov.";
...
$Definition["Limit the pocket to one or more roles or permissions."] =
    "Omejite žep na eno ali več vlog ali dovoljenj.";
$Definition["Limit"] = "Omejitev";
$Definition["List of discussion IDs to delete."] =
    "Seznam ID-jev razprav za brisanje.";
...
$Definition["Make sure you select at least one item before continuing."] =
    "Prepričajte se, da ste izbrali vsaj en element, preden nadaljujete.";
$Definition["Add your site to trusted domains."] =
    "Prepričajte se, da je vaše spletno mesto dodano v %s, ko je vdelava omogočena.";
...
$Definition["Manage Suggested Answer Sources"] =
    "Upravljanje predlaganih virov odgovorov";
...
$Definition["Mark All Suggested Answers as Accepted"] =
    "Označite vse predlagane odgovore kot sprejete";
...
$Definition["Member roles"] =
    "Preverite vse vloge, ki jih je treba uporabiti za nove/odobrene uporabnike.";
...
$Definition["Moderators have permission to edit most content."] =
    "Moderatorji imajo dovoljenje za urejanje večine vsebine.";
...
$Definition[
    ...
    "Bolj zapleten jezik in lahko uvede nekatere izraze, specifične za panogo, vendar še vedno razumljiv večini ljudi.";
...
$Definition[
    ...
    "Bolj tehnični jezik in izrazi, specifični za panogo -- predpostavljajo višjo raven tehnologije razumevanja/poznavanja vsebine.";
$Definition["more than %s deep"] = "več kot %s globoko";
$Definition['Most pockets shouldn\'t be displayed in the dashboard.'] =
    'Večina žepov ne bi smela biti prikazana na armaturni plošči.';
$Definition["Move discussions in this category to a replacement category."] =
    "Premakni razprave v tej kategoriji v nadomestno kategorijo.";
...
$Definition["Never - Users Must Refresh Page"] =
    "Nikoli – uporabniki morajo osvežiti stran";
$Definition["Never display on mobile browsers."] =
    "Nikoli ne prikaži v mobilnih brskalnikih.";
...
$Definition["New users are only registered through SSO plugins."] =
    "Novi uporabniki se registrirajo samo prek vtičnikov SSO.";
$Definition[
    'New users are reviewed and approved by an administrator (that\'s you!).'
] = 'Nove uporabnike pregleda in odobri administrator (to ste vi!).';
$Definition[
    "New users fill out a simple form and are granted access immediately."
] = "Novi uporabniki izpolnijo preprost obrazec in takoj dobijo dostop.";
...
$Definition["No item options are available for Link display type."] =
    "Za vrsto prikaza povezave ni na voljo nobena možnost elementa.";
...
$Definition["Notifications will appear here."] =
    "Tukaj bodo prikazana obvestila.";
$Definition["NotifyApplicant"] =
    "Obvesti me, ko se kdo prijavi za članstvo.";
$Definition["Notify me when people comment on a discussion."] =
    "Obvesti me, ko ljudje komentirajo razpravo.";
$Definition["Notify me when my questions have AI Suggested Answers"] =
    "Obvesti me, ko bodo moja vprašanja imela odgovore, ki jih predlaga AI";
$Definition["Notify me when people start new discussions."] =
    "Obvesti me, ko ljudje začnejo nove razprave.";
...
$Definition["Only display on mobile browsers."] =
    "Prikaz samo v mobilnih brskalnikih.";
$Definition[
    ...
    'Na voljo so samo polja z enim potrditvenim poljem, spustnim menijem z eno izbiro, spustnim menijem z več izbirami ali številskim spustnim menijem. Ko izberete polja, se prikažejo spodaj, tako da lahko izberete posebne odgovore za vsako polje profila.';
...
$Definition["Only visible to users with roles with permission."] =
    "Vidno samo uporabnikom z vlogami z dovoljenjem.";
$Definition[
    "Open cases will only display if the user has a valid Salesforce connection."
] =
    "Odprti primeri bodo prikazani le, če ima uporabnik veljavno povezavo Salesforce.";
...
$Definition["Or select an image on your computer (2mb max)"] =
    "Ali pa izberite sliko v računalniku (največ 2mb)";
...
$Definition["Pageview ratio representing a deflected case"] =
    "Razmerje ogledov strani, ki predstavlja odklon velikih in malih črk";
...
$Definition["Please enter a unique API Label, this one has been used before"] =
    "Vnesite edinstveno oznako API, ta je bila že uporabljena";
...
$Definition[
    ...
    "Možne težave z združljivostjo s starejšimi brskalniki, ki vplivajo na uporabniško izkušnjo.";
...
$Definition[
    ...
    "Protokoli (npr. https://) in poti (npr. vašadomena.com/nekatera/pot) morajo biti izpuščeni.";
...
$Definition["Read more in the documentation"] =
    "Več si preberite v dokumentaciji";
...
$Definition[
    ...
    "Priporočene mere so 400 x 300 slikovnih pik ali manjše s podobnim razmerjem.";
...
$Definition["Registration is currently closed."] =
    "Registracija je trenutno zaključena.";
$Definition["Reload the page to see recent updates."] =
    "Ponovno naložite stran, da si ogledate nedavne posodobitve.";
$Definition["Reload the page to access recent updates."] =
    "Ponovno naložite stran za dostop do nedavnih posodobitev.";
...
$Definition["RolePersonalInfo"] =
    "Ta vloga je osebni podatek. Videli jih bodo samo uporabniki z dovoljenjem za ogled osebnih podatkov.";
$Definition["Roles & Permissions"] = "Vloge in dovoljenja";
$Definition['Roles determine user\'s permissions.'] =
    "Vsakemu uporabniku na vašem spletnem mestu je dodeljena vsaj ena vloga. Vloge se uporabljajo za določanje, kaj lahko uporabniki počnejo.";
...
$Definition["Search by user or role."] =
    "Iščite uporabnike po imenu ali e-pošti, po želji uporabite % kot nadomestni znak. Iščete lahko tudi po ID-ju uporabnika, imenu vloge ali »prepovedan«.";
...
$Definition["Select the location of the pocket."] =
    "Izberite lokacijo žepa.";
$Definition[
    "Select which columns are displayed on the manage users page list."
] = "Izberite, kateri stolpci so prikazani na seznamu strani za upravljanje uporabnikov.";
$Definition["Selection will affect the item options available."] =
    "Izbira bo vplivala na razpoložljive možnosti elementov.";
...
$Definition[
    ...
    "Pošljite potrditveno e-poštno sporočilo, ko ljudje zastavijo vprašanje ali začnejo razpravo po e-pošti.";
...
$Definition['Separate each word with a semi-colon ";"'] =
    'Vsako besedo ločite s podpičjem ";"';
$Definition[
    "Set this interest as default to suggest following its mapped categories and tags to all users."
] =
    "Nastavite to zanimanje kot privzeto, da vsem uporabnikom predlagate spremljanje preslikanih kategorij in oznak.";
...
] = "Vsakemu uporabniku pokažite prilagojen seznam zamisli, ki jih je ustvaril ali podprl.";
...
] = "Viri, ki so izbrani tukaj, bodo na voljo AI Suggested Answers.";
$Definition["Specify one domain per line. Use * for wildcard matches."] =
    "Določite eno domeno na vrstico. Za ujemanje nadomestnih znakov uporabite *.";
$Definition["Spoof"] = "Prevara";
$Definition["SSO Role"] = "Vloga SSO";
$Definition["SSO roles are always passed through SSO."] =
    "Vloge SSO se vedno posredujejo prek SSO.";
...
$Definition[
    ...
    "Vrstico z zadevo povzetka začnite z [Naslov pasice], nastavljenim v Videz > Blagovna znamka in SEO";
...
$Definition[
    ...
    "Slogi in splošni vizualni videz vseh e-poštnih sporočil, vključno z izvlečki e-poštnih sporočil, so nastavljeni za celotno spletno mesto na strani z nastavitvami e-pošte.";
...
$Definition["Suggestions are only visible to you until you accept the answer"] =
    "Predlogi so vidni samo vam, dokler ne sprejmete odgovora";
$Definition["Suggestions may only be generated on questions"] =
    "Predlogi se lahko ustvarijo samo na vprašanjih";
...
$Definition["The first line of content in the email digest after the title."] =
    "Prva vrstica vsebine v povzetku e-pošte za naslovom.";
$Definition["The homepage title is displayed on your home page."] =
    "Naslov domače strani je prikazan na vaši domači strani. Izberite naslov, za katerega želite, da se pojavi v iskalnikih.";
$Definition["The homepage was saved successfully."] =
    "Domača stran je bila uspešno shranjena.";
$Definition["The invitation was removed successfully."] =
    "Povabilo je bilo uspešno odstranjeno.";
$Definition["The invitation was sent successfully."] =
    "Povabilo je bilo uspešno poslano.";
$Definition["The Key in the XML payload to designate %s."] =
    "Ključ v nosilcu XML za določitev %s.";
$Definition[
    "The test digest will generate content as if it were this user receiving the digest."
] =
    "Testni povzetek bo ustvaril vsebino, kot da bi ta uporabnik prejel povzetek.";
...
$Definition[
    ...
    "Na tem forumu že obstaja račun z vašim e-poštnim naslovom. Ustvarite nov račun ali vnesite poverilnice za obstoječi račun.";
$Definition["The next three email digest delivery dates"] =
    "Naslednji trije datumi dostave povzetka e-pošte";
$Definition["The secret secures the sign in process."] =
    "Skrivnost varuje postopek prijave. <b>NE</b> izdajte skrivnosti nikomur.";
$Definition["The site description usually appears in search engines."] =
    "Opis mesta se običajno pojavi v iskalnikih. Poskusite imeti opis, ki je dolg 100–150 znakov.";
$Definition["The site is currently undergoing scheduled maintenance."] =
    "Na spletnem mestu trenutno potekajo redna vzdrževalna dela.";
$Definition["The specified url code is already in use by another category."] =
    "Navedeno url kodo že uporablja druga kategorija.";
$Definition["The structure was successfully executed."] =
    "Struktura je bila uspešno izvedena.";
$Definition["The update was not successful."] =
    "Posodobitev ni bila uspešna.";
...
$Definition["The url that users go to to register for a new account."] =
    "URL, na katerega gredo uporabniki, da se registrirajo za nov račun.";
$Definition["The url that users use to register for a new account."] =
    "URL, ki ga uporabniki uporabljajo za registracijo za nov račun.";
$Definition["The url that users use to sign in."] =
    "URL, ki ga uporabniki uporabljajo za prijavo.";
$Definition["The URL where users can sign up for new accounts on your site"] =
    "URL, kjer se lahko uporabniki prijavijo za nove račune na vašem spletnem mestu";
$Definition["The URL where users sign in on your site"] =
    "URL, kjer se uporabniki prijavijo na vašem spletnem mestu";
$Definition["The URL where users sign out of your site"] =
    "URL, kjer se uporabniki odjavijo z vašega spletnega mesta";
$Definition["The user and all related content has been deleted."] =
    "Uporabnik in vsa povezana vsebina sta bila izbrisana.";
$Definition["The user content will be completely deleted."] =
    "Uporabniška vsebina bo v celoti izbrisana.";
$Definition["The user content will remain untouched."] =
    "Uporabniška vsebina bo ostala nedotaknjena.";
...
$Definition[
    ...
    "To ni potrebno na večini spletnih mest, razen na tistih, ki uporabljajo funkcije, kot sta AdSense in Google Tag Manager.";
$Definition[
    ...
    "To je povzetek, ustvarjen z umetno inteligenco iz navedene objave v razpravi, ki bi lahko odgovoril na vprašanje. Povzetek je ustvarjen tako, da ga lahko uporabimo kot sprejet odgovor.";
$Definition["This category has custom permissions."] =
    "Ta kategorija ima dovoljenja po meri.";
$Definition["This category is archived."] = "Ta kategorija je arhivirana.";
$Definition["This connection is in test-mode."] =
    "Ta povezava je v testnem načinu.";
$Definition["This controls how the responses are phrased and spelled."] =
    "To nadzoruje, kako so odgovori ubesedeni in črkovani.";
$Definition["This Database"] = "Ta zbirka podatkov";
$Definition["QnAFollowup.Feature.Enabled"] =
    "Ta funkcija pošilja e-poštna sporočila avtorjem odgovorjenih vprašanj, ki nimajo sprejetega odgovora.";
$Definition["This forum is currently set to invitation only mode."] =
    "Ta forum je trenutno nastavljen na način samo s povabilom.";
$Definition[
    'This image will be used in category lists and widgets when using the "Icon" style option.'
] =
    'Ta slika bo uporabljena na seznamih kategorij in pripomočkih, ko uporabljate možnost sloga »Ikona«.';
$Definition[
    ...
    'Ta slika bo prikazana v pasici te kategorije in v pripomočkih kategorije, ko uporabljate možnosti sloga "Slika" in/ali "Ozadje". Priporočene mere so približno 1000 slikovnih pik krat 400 slikovnih pik ali podobno razmerje.';
$Definition["This is a parent category that does not allow discussions."] =
    "To je nadrejena kategorija, ki ne dovoljuje razprav.";
$Definition['This is the first time you\'ve visited the discussion forums.'] =
    'To je prvič, da ste obiskali forume za razprave.';
$Definition[
    "This may be used to include content such as organization name and address in the email digest."
] =
    "To se lahko uporabi za vključitev vsebine, kot sta ime in naslov organizacije, v izvleček e-pošte.";
$Definition["This name will be shown in the community."] =
    "To ime bo prikazano v skupnosti.";
...
] = "Te teme ni mogoče izbrisati, ker je trenutno uporabljena tema.";
$Definition["This theme has additional options."] =
    "Ta tema ima dodatne možnosti na strani %s.";
$Definition["This theme has customizable text."] =
    "Ta tema ima besedilo, ki ga lahko prilagodite.";
$Definition[
    ...
    "To bo druge uporabnike s podobnimi vprašanji hitreje vodilo do pravih odgovorov in bo prikazalo predlagani odgovor AI ter povezalo referenčno gradivo, ki ga bodo lahko videli drugi uporabniki. Predlogi so vidni le vam, dokler ne sprejmete odgovora.";
...
$Definition["Truncate the initial discussion text to this many words."] =
    "Začetno besedilo razprave skrajšajte na toliko besed.";
...
$Definition["Up to a maximum of 100 items may be displayed."] =
    "Prikazanih je lahko največ 100 elementov.";
...
$Definition["Use an SMTP server to send email"] =
    "Za pošiljanje e-pošte uporabite strežnik SMTP";
$Definition["Use asterisks for wildcards"] =
    'Za nadomestne znake uporabite zvezdice, npr. »*@gmail.com«';
...
$Definition["Use categories to organize discussions"] =
    "Uporabite kategorije za organiziranje razprav";
$Definition["Use Facebook names for usernames."] =
    "Uporabite Facebook imena za uporabniška imena.";
...
$Definition[
    ...
    "Uporablja visoko tehnični jezik in izraze, specifične za panogo, namenjene tistim, ki dobro razumejo vsebino.";
$Definition[
    "Uses industry-specific terms where necessary, but also provides explanations of definitions to ensure clarity."
] =
    "Po potrebi uporablja izraze, specifične za panogo, zagotavlja pa tudi razlage definicij za zagotovitev jasnosti.";
$Definition[
    "Uses simple, everyday language that anyone can understand, regardless of their background or expertise."
] =
    "Uporablja preprost, vsakdanji jezik, ki ga lahko razume vsak, ne glede na njihovo ozadje ali strokovnost.";
$Definition["UserDeleteMessage"] =
    'Izbrišite uporabnika in popolnoma odstranite vso uporabnikovo vsebino. To lahko povzroči nepovezane razprave. Najboljša možnost za odstranjevanje neželene pošte.';
$Definition["UserDeletionPrompt"] =
    "Izberite način ravnanja z vso vsebino, povezano z uporabniškim računom za %s (komentarji, sporočila itd.).";
$Definition["UserKeep"] = "Ohranite uporabniško vsebino";
$Definition["UserKeepMessage"] =
    'Izbrišite uporabnika, vendar obdržite njegovo vsebino.';
...
$Definition[
    ...
    "Uporabniki lahko sledijo kategorijam in se naročijo na obvestila o novih objavah. Izberite, katerim kategorijam naj novi uporabniki privzeto sledijo.";
$Definition["Users that get this reaction get %+d point."] =
    "Uporabniki, ki dobijo to reakcijo, dobijo %+d točko.";
$Definition["Users that get this reaction get %+d points."] =
    "Uporabniki, ki prejmejo to reakcijo, prejmejo %+d točk.";
$Definition[
    "Users will not be warned when following links that match a Trusted Domain."
] =
    "Uporabniki ne bodo opozorjeni, ko sledijo povezavam, ki se ujemajo z zaupanja vredno domeno.";
$Definition[
    "Users will be redirected to this URL after accepting an invitation."
] =
    "Uporabniki bodo po sprejetju povabila preusmerjeni na ta URL. Lahko je celoten URL ali pot za preusmeritev znotraj spletnega mesta.";
...
$Definition[
    ...
    'Uporabnikom bo ta vloga dodeljena, dokler ne potrdijo svojih e-poštnih naslovov.';
$Definition["Users with the no ads permission will not see this pocket."] =
    "Uporabniki z dovoljenjem brez oglasov ne bodo videli tega žepa.";
$Definition["UserWipe"] = "Prazna uporabniška vsebina";
$Definition["UserWipeMessage"] =
    'Izbrišite uporabnika in zamenjajte celotno vsebino uporabnika s sporočilom, da je bil uporabnik izbrisan. To daje vizualni znak, da manjkajo informacije.';
$Definition["Use the content at this url as your homepage."] =
    'Izberite stran, ki naj jo ljudje vidijo, ko obiščejo: <strong style="white-space: nowrap;">%s</strong>';
$Definition["Use Vanilla as a commenting system in your site"] =
    "Uporabite Vanilla kot sistem za komentiranje na svojem spletnem mestu";
$Definition["Use weekly community email digest"] =
    "Uporabite tedenski izvleček e-pošte skupnosti";
$Definition["Untitled"] = "Brez naslova";

$Definition["Value or Pattern"] = "Vrednost ali vzorec";
$Definition["Vanilla.Archive.Description"] =
    "Izberete lahko arhiviranje forumskih razprav, starejših od določenega datuma. Arhivirane razprave so dejansko zaprte in ne dovoljujejo novih objav.";
$Definition["Vanilla.Categories.MaxDisplayDepth"] =
    'Ugnezdene kategorije postavite na seznam, ločen z vejicami, ko so %1$s';
...
$Definition["View browser compatibility chart"] =
    "Oglejte si tabelo združljivosti brskalnika";
...
] = "Opozori uporabnike, če bodo zaradi povezave v objavi zapustili forum";
$Definition[
    "Warning: All of your data will be lost. Once you delete, there is absolutely no recovery of any kind."
] =
    "Opozorilo: vsi vaši podatki bodo izgubljeni. Ko enkrat izbrišete, ni več nobene obnovitve.";
$Definition["Warning: deleting is permanent"] =
    "OPOZORILO: izbrisani elementi so odstranjeni s tega seznama in jih ni mogoče vrniti.";
...
$Definition["We only accept urls that begin with http:// or https://"] =
    "Sprejemamo samo naslove URL, ki se začnejo s http:// ali https://";
$Definition[
    ...
    "Za pošiljanje e-pošte bomo poskušali privzeto uporabiti lokalni poštni strežnik. Če želite uporabljati ločen poštni strežnik SMTP, ga lahko konfigurirate spodaj.";
$Definition[
    ...
    "dobrodošli Sem vaš AI Suggestion Assistant, orodje, ki temelji na strojnem učenju in je zasnovano za iskanje in predlaganje ustreznih člankov in objav kot odgovor na vaša vprašanja. Prosimo, vnesite svoja vprašanja in posredoval vam bom najustreznejše informacije.";
$Definition['What\'s the Buzz?'] = 'Kaj je Buzz?';
$Definition["When enabled, search result will open in a new browser tab."] =
    "Ko je omogočeno, se bodo rezultati iskanja odprli v novem zavihku brskalnika.";
$Definition[
    "When enabled, your community will have AI Suggestions shown in Q&A. <0/>"
] = "Ko je omogočeno, bo vaša skupnost imela predloge AI prikazane v vprašanjih in odgovorih. <0/>";
$Definition[
    ...
    "Ko je ta nastavitev omogočena, bodo podrobnosti uporabnika v podatkih Analytics privzeto anonimizirane, dokler uporabnik ne privoli v piškotke Analytics. <0>Več o tem</0>";
$Definition["Where is your Community Forum?"] =
    "Kje je vaš forum skupnosti?";
$Definition['Who\'s Online Settings'] = 'Kdo je na spletu Nastavitve';
$Definition["Why am I seeing AI Suggested Answers?"] =
    "Zakaj vidim odgovore, ki jih predlaga AI?";
...
$Definition["Yes, the following information can be changed later."] =
    "Da, naslednje podatke lahko pozneje spremenite.";
$Definition["You are connected as %s."] = "Povezani ste kot %s.";
$Definition["You are not allowed to use suggestions"] =
    "Ni vam dovoljeno uporabljati predlogov";
$Definition["You are previewing the %s theme."] =
    "Predogledujete si temo %s.";
$Definition[
    "You can also ban the users that posted the spam and delete all of their posts."
] =
    "Potrdite polje poleg uporabnika, ki je objavil vsiljeno pošto, da ga tudi izključite in izbrišete vse njegove objave. <b>To storite samo, če ste prepričani, da gre za pošiljatelje neželene pošte.</b>";
$Definition['You can always use your password at<a href="%1$s">%1$s</a>.'] =
    'Če kdaj ostanete brez dostopa do svojega foruma, se lahko vedno prijavite z izvirnim e-poštnim naslovom in geslom Vanilla na <a href="%1$s">%1$s</a>';
$Definition[
    "You can ban IP addresses, email domains, and words from usernames using this tool."
] =
    "S tem orodjem lahko iz uporabniških imen prepoveš naslove IP, e-poštne domene in besede.";
$Definition[
    "You can customize the HTML and CSS for this theme on the %s page."
] = "HTML in CSS za to temo lahko prilagodite na strani %s.";
$Definition[
    "You can either create a new account, or enter your credentials if you have an existing account."
] =
    "Ustvarite lahko nov račun ali vnesete svoje poverilnice, če že imate račun.";
$Definition["You can make the categories page your homepage."] =
    'Stran s kategorijami lahko naredite za domačo stran <a href="%s">tukaj</a> .';
$Definition[
    "You can search for users by username or email, wildcards are implied."
] = "Uporabnike lahko iščete po uporabniškem imenu ali e-pošti, nadomestni znaki so nakazani.";
$Definition["You can specify an allow list of trusted domains."] =
    "Določite lahko seznam zaupanja vrednih domen, ki so varne za preusmeritve in vdelavo.";
$Definition["You can specify an allow list of trusted domains. (CSP)"] =
    "Določite lahko seznam dovoljenih zaupanja vrednih domen (npr. vašadomena.com), iz katerih je varno naložiti javascript.";
$Definition[
    'You cannot disable the %1$s plugin because the %2$s plugin requires it in order to function.'
] =
    'Vtičnika %1$s ne morete onemogočiti, ker ga vtičnik %2$s potrebuje za delovanje.';
$Definition[
    "You cannot remove the only remaining category that allows discussions"
] = "Ne morete odstraniti edine preostale kategorije, ki dovoljuje razprave";
$Definition[
    "You can protect your site with an HTTP username/password during development."
] =
    "Med razvojem lahko svojo stran zaščitite z uporabniškim imenom/geslom HTTP.";
$Definition[
    "You can send emails in plain text by disabling the toggle below."
] = "E-poštna sporočila lahko pošiljate v navadnem besedilu, tako da onemogočite spodnji gumb.";
$Definition["You have %s invitations left for this month."] =
    "Za ta mesec imate še %s povabil.";
$Definition["You have successfully saved interest: <0/>"] =
    "Uspešno ste shranili zanimanje: <0/>";
$Definition["You must be authenticated in order to use this form."] =
    "Za uporabo tega obrazca morate biti overjeni.";
$Definition["You must manually apply this rank."] =
    "To uvrstitev morate uporabiti ročno.";
$Definition["You must provide at least one recipient"] =
    "Navesti morate vsaj enega prejemnika";
$Definition["You must specify an admin password."] =
    "Določiti morate skrbniško geslo.";
$Definition["You must specify an admin username."] =
    "Določiti morate skrbniško uporabniško ime.";
$Definition[
    ...
    "Vaša konfiguracijska datoteka nima pravilnih dovoljenj. PHP mora imeti možnost branja in pisanja v to datoteko: <code>%s</code>";
$Definition['Your default locale won\'t display properly'] =
    'Vaš privzeti jezik ne bo pravilno prikazan, dokler ni omogočen spodaj. Omogočite naslednje: %s.';
...
$Definition["Your invitations were sent successfully."] =
    "Vaša povabila so bila uspešno poslana.";
...
$Definition[
    ...
    "Zapuščate urejevalnik tem, ne da bi shranili spremembe. Pred izhodom se prepričajte, da so vaše posodobitve shranjene.";
$Definition[
    "You are leaving the Email Settings page without saving your changes. Make sure your updates are saved before exiting."
] =
    "Zapustili ste stran z nastavitvami e-pošte, ne da bi shranili spremembe. Pred izhodom se prepričajte, da so vaše posodobitve shranjene.";
...
$Definition['You can also include placeholders in your email content—these will be automatically replaced with relevant user or post information when the email is sent. For example, Hello {user.name}! or Check out {discussion.name}.'] = 'V vsebino e-poštnega sporočila lahko vključite tudi nadomestne besede – te bodo ob pošiljanju e-poštnega sporočila samodejno zamenjane z ustreznimi podatki o uporabniku ali objavi. Na primer Pozdravljeni {uporabniško.ime}! ali Oglejte si {razprava.ime}.';
