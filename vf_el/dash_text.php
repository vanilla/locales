...
$Definition['Allow links to be transformed'] = 'Να επιτρέπεται η μετατροπή συνδέσμων σε ενσωματωμένες αναπαραστάσεις σε αναρτήσεις και σχόλια. Για παράδειγμα, ένας σύνδεσμος YouTube θα μετατραπεί σε ενσωματωμένο βίντεο.';
...
$Definition['ShareImageDescription'] = 'Όταν κάποιος μοιράζεται έναν σύνδεσμο από τον ιστότοπό σας, προσπαθούμε να τραβήξουμε μια εικόνα από τη σελίδα. Αν δεν υπάρχει εικόνα στη σελίδα, τότε θα χρησιμοποιήσουμε αυτήν την εικόνα. Η εικόνα πρέπει να είναι τουλάχιστον 50 × 50, αλλά προτείνουμε 200 × 200.';
...
$Definition['Tagging allows users to add a tag to discussions they start in order to make them more discoverable. '] = 'Η προσθήκη ετικετών επιτρέπει στους χρήστες να προσθέσουν μια ετικέτα στις συζητήσεις που ξεκινούν προκειμένου να τους καταστήσουν πιο ανιχνεύσιμους.';
...
$Definition['TouchIconDescription'] = 'Το εικονίδιο αφής εμφανίζεται όταν προσθέτετε σελιδοδείκτη σε έναν ιστότοπο στην αρχική οθόνη μιας συσκευής Apple. Αυτά είναι συνήθως 152 pixel. Η Apple προσθέτει αυτόματα στρογγυλεμένες γωνίες και εφέ φωτισμού.';
