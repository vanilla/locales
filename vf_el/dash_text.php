...
$Definition['Recommend special ranks for admins and mods.'] = 'Είναι καλή ιδέα να έχετε ειδικές τάξεις για συντονιστές και διαχειριστές, ώστε η κοινότητά σας να βλέπει εύκολα ποιος είναι υπεύθυνος.';
$Definition['Recommend starting with five ranks.'] = 'Δεν θέλετε να έχετε πάρα πολλές τάξεις. Σας προτείνουμε να ξεκινήσετε με πέντε. Μπορείτε να προσθέσετε περισσότερα αν η κοινότητά σας είναι πραγματικά μεγάλη.';
...
$Definition['This setting loads the page before executing Javascript.'] = 'Αυτή η ρύθμιση φορτώνει τη σελίδα πριν από την εκτέλεση Javascript και μπορεί να βελτιώσει το SEO σας.<br><strong>** Προειδοποίηση: Η ενεργοποίηση αυτής της δυνατότητας μπορεί να προκαλέσει λάθη Javascript στον ιστότοπό σας.**</strong>';
