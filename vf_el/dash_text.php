...
$Definition['This setting loads the page before executing Javascript.'] = 'Αυτή η ρύθμιση φορτώνει τη σελίδα πριν από την εκτέλεση Javascript που μπορεί να βελτιώσει το SEO σας. <br> <strong>** Προειδοποίηση: Η ενεργοποίηση αυτής της λειτουργίας ενδέχεται να προκαλέσει σφάλματα Javascript στον ιστότοπό σας. **</strong>';
