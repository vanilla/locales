...
$Definition['You can place files in your /uploads folder.'] = 'Εάν το αρχείο σας είναι υπερβολικά μεγάλο για να μεταφορτωθεί απευθείας σ\' αυτή τη σελίδα, μπορείτε να το τοποθετήσετε στο φάκελο /μεταφορτώσεις. Σιγουρευτείτε ότι το όνομα αρχείου αρχίζει με τη λέξη <b>εξαγωγή</b> και τελειώνει με μία από τις καταλήξεις <b>.txt, .gz</b>.';
