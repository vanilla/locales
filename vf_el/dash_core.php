...
$Definition['You must have the MySQL driver for PDO enabled in order for Vanilla to connect to your database.'] = 'Πρέπει να έχετε τον οδηγό του MySQL για το PDO ενεργοποιημένο, προκειμένου να συνδεθεί το Vanilla στη βάση δεδομένων σας.';
$Definition['You must have the PDO module enabled in PHP in order for Vanilla to connect to your database.'] = 'Πρέπει να έχετε το PDO module ενεργοποιημένο στην PHP προκειμένου το Vanilla να συνδεθεί στη βάση δεδομένων σας.';
