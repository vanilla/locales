...
$Definition['%s is not a valid email address'] = '%s is e mail adresi geçersiz';
...
$Definition['<strong>Categories</strong> allow you to organize your discussions. Categories can only contain discussions.'] = '<strong>Kategoriler</strong> sana tartışma yapmak için izin veriyor. Kategoriler sadece tartışmalar içerebiliyor.';
