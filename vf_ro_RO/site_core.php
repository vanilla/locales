...
$Definition['%1$s accepted %4$s invitation for membership.'] = '%1$s a acceptat invitatia lui %4$s.';
...
$Definition['%1$s signed in.'] = '%1$s Logat.';
$Definition['%1$s to %2$s'] = '%1$s la %2$s';
$Definition['%1$s to %2$s of %3$s'] = '%1$s la %2$s de %3$s';
$Definition['%1$s updated %6$s profile.'] = '%1$s a updatat %6$s profilul.';
$Definition['%1$s was added to the %2$s %3$s.'] = '%1$s a fost adaugat la %2$s %3$s.';
$Definition['%1$s was removed from the %2$s %3$s.'] = '%1$s a fost scos de la %2$s %3$s.';
$Definition['%1$s was removed from the %2$s %3$s and added to the %4$s %5$s.'] = '%1$s a fost scos de la %2$s %3$s si adaugat la %4$s %5$s.';
$Definition['%1$s wrote on %4$s %5$s.'] = '%1$s a scris la %4$s %5$s.';
$Definition['%3$s approved %2$s membership application.'] = '%3$s a aprobat la %2$s aplicatia de membru.';
...
$Definition['%s deleted this conversation.'] = '%s a sters aceasta conversatie.';
$Definition['%s discussion'] = '%s discutie';
$Definition['%s discussions'] = '%s discutii';
$Definition['%s has been Jailed.'] = '%s a fost trimis la "inchisoare".';
$Definition['%s has left this conversation.'] = '%s a parasit aceasta conversatie.';
$Definition['%s Likes'] = '%s ii Place';
$Definition['%s LOLs'] = '%s Rade';
$Definition['%s mentioned %s in a %s.'] = '%s a fost mentionat %s in o %s.';
...
$Definition['%s tag(s) found.'] = '%s camp(uri) gasite.';
$Definition['%s tags in the system'] = '%s campurii in sistem';
$Definition['%s Up Votes'] = '%s Up Voturi';
$Definition['%s votes'] = '%s voturi';
$Definition['%s was removed from the %s and added to the %s'] = '%s a fost scos de la %s si adaugat la %s';
$Definition['%s WTFs'] = '%s Ce?!';

$Definition['(empty message)'] = '(mesaj gol)';

$Definition['+%s Guests'] = '+%s Invitat';
...
$Definition['Activity.AnswerAccepted.ProfileHeadline'] = 'Activitate.RaspunsAcceptat.HeadlineProfil';
...
$Definition['BanType'] = 'TipulInterziceri';
...
$Definition['Click <a href="%s">here</a> to go back to the discussion.'] = 'Click <a href="%s">aici</a> pentru a merge la discutie.';
...
$Definition['PageViews'] = 'PaginiVizualizate';
