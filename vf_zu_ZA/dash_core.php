...
$Definition['%1$s version %2$s is available.'] =
    '%1$s inguqulo %2$s iyatholakala.';
$Definition["%s is not a valid email address"] =
    "%s akuyona ikheli le-imeyili elivumelekile";
...
$Definition["%s user(s) will be affected by this action."] =
    "%s abasebenzisi (s) bazothinteka kulesi senzo.";

$Definition["<0/> will suggest answers on Q&A posts"] =
    "I-<0/> izophakamisa izimpendulo kokuthunyelwe kwe-Q&A";
$Definition["<0 /> will not suggest answers on Q&A posts"] =
    "<0 /> ngeke iphakamise izimpendulo kokuthunyelwe kwe-Q&A";
...
$Definition["1 in 5 is recommended for most communities."] =
    "Oku-1 koku-5 kuyanconywa emiphakathini eminingi.";
$Definition["1 in 20 is recommended for most communities."] =
    "Oku-1 kokungu-20 kunconywa emiphakathini eminingi.";
...
$Definition["[%s] Confirm Your Email Address"] =
    "[%s] Qinisekisa Ikheli Lakho Le-imeyili";
...
] = 'Ufinyelele ubuningi bemizamo yokungena ngemvume. Sicela ulinde %s bese uzama futhi.';
...
$Definition["A unique label name that cannot be changed once saved."] =
    "Igama lelebula eliyingqayizivele elingenakushintshwa uma selilondoloziwe.";
...
$Definition['"Accept Answer" if a suggestion answers your question.'] =
    '"Yamukela Impendulo" uma isiphakamiso siphendula umbuzo wakho.';
...
$Definition["Accepted answer pageview ratio representing a deflected case"] =
    "Isilinganiso esamukelwe sokubuka ikhasi lempendulo esimela icala elichezukile";
...
$Definition["Add a new Pocket to your site."] =
    "Faka iPocket entsha kusayithi lakho.";
$Definition[
    ...
    "Engeza isixhumanisi Sokusondeza noma i-ID yomhlangano ukuze uxhume lo mcimbi ku-Zoom futhi unike amandla ukubhalisa ngokuchofoza kanye nezinkinobho zokujoyina. Qaphela uma umcimbi wakho udinga ukubhaliswa, awukwazi ukubuyekeza i-ID yakho yomhlangano noma isixhumanisi ngemuva kokudala umcimbi.";
...
$Definition[
    ...
    "Faka imininingwane kwinkambu evela kumakheli e-imeyili ukusiza ngezimpendulo (kunconyiwe).";
...
$Definition[
    ...
    "Engeza isizinda sakho sangokwezifiso se-Kaltura ukuze uguqule izixhumanisi zibe amavidiyo ashumekiwe ezingxoxweni, amazwana noma izihloko.";
$Definition[
    "Add your custom Kaltura domain(s) to transform links into embedded videos in posts, comments or articles."
] =
    "Engeza isizinda sakho sangokwezifiso se-Kaltura ukuze uguqule izixhumanisi zibe amavidiyo ashumekiwe kokuthunyelwe, amazwana noma izindatshana.";
...
$Definition["Advanced settings for embedded community elements"] =
    "Izilungiselelo ezithuthukisiwe zezinto zomphakathi ezifakiwe";
...
$Definition["AI Suggestions are not enabled"] =
    "Iziphakamiso ze-AI azinikiwe amandla";
$Definition[
    ...
    "Izimpendulo Eziphakanyisiwe ze-AI zinikeza izimpendulo eziphakanyisiwe ngokusekelwe kokuthunyelwe komphakathi nezisekelo zolwazi ezixhunyiwe. Ungavula noma ukucime lokhu noma kunini ngokuvakashela iphrofayela yakho okuncamelayo.";
$Definition[
    "Alert users if they click a link in a post that will lead them away from the forum. "
] =
    "Abasebenzisi bezaziso uma bechofoza isixhumanisi kokuthunyelwe okuzoholela kude nesithangami.";
...
$Definition["All discussions in this category will be permanently deleted."] =
    "Zonke izingxoxo ezikulesi sigaba zizosuswa unaphakade.";
...
$Definition[
    ...
    "Konke okuqukethwe komsebenzisi kuzofakwa esikhundleni somlayezo othi umsebenzisi ususiwe.";
...
$Definition["Allow new users to be registered through email."] =
    "Vumela abasebenzisi abasha ukuthi babhaliswe nge-imeyili.";
$Definition["Allow this connection to issue API access tokens."] =
    "Vumela lokhu kuxhumeka kukhiphe amathokheni wokufinyelela we-API.";
$Definition["Allow Third-Party Script Execution"] =
    "Vumela Ukusetshenziswa Kweskripthi Senkampani Yangaphandle";
$Definition["Allow users to change their own avatars"] =
    "Vumela abasebenzisi ukuthi bashintshe ama-avatar abo";
$Definition["Allow users to dismiss this message"] =
    "Vumela abasebenzisi ukuthi bachitha lo mlayezo.";
...
$Definition["An enabled message will be visible on the site."] =
    "Umlayezo onikwe amandla uzobonakala esizeni.";
$Definition["An answer in this the community thread was marked as accepted"] =
    "Impendulo kulolu chungechunge lomphakathi imakwe njengeyamukelwe";
$Definition["An error occurred updating your privacy setting"] =
    "Kwenzeke iphutha ekubuyekezeni izilungiselelo zakho zobumfihlo";
$Definition["Anonymize Analytics Data by Default"] =
    "Yenza ngokuzenzakalela Idatha ye-Analytics ngokuzenzakalelayo";
$Definition["Answers is not available if you have not accepted cookies."] =
    "Izimpendulo azitholakali uma ungakawamukeli amakhukhi.";
...
$Definition["Applicant Role"] =
    "Khetha indima okufanele isetshenziselwe abafakizicelo abasha. Lokhu kusebenza kuphela uma <b>unendlela</b> yokubhalisa <b>yokuvuma</b> .";
...
$Definition["Are you sure you want to delete %s items forever?"] =
    "Uqinisekile ukuthi ufuna ukususa izinto ezi-%s unomphela?";
$Definition["Are you sure you want to delete 1 item forever?"] =
    "Uqinisekile ukuthi ufuna ukususa into eyi-1 unomphela?";
$Definition[
    "Are you sure you want to delete this badge? This is irreversible and will revoke the badge from all users who have it."
] =
    "Uqinisekile ukuthi ufuna ukususa leli bheji? Lokhu akunakuphikwa futhi kuzobuyisa ibheji kubo bonke abasebenzisi abanayo.";
$Definition["Are you sure you want to delete this category?"] =
    "Uqinisekile ukuthi ufuna ukususa lesi sigaba?";
$Definition["Are you sure you want to restore %s items?"] =
    "Uqinisekile ukuthi ufuna ukubuyisa izinto ezingama-%s?";
$Definition["Are you sure you want to restore 1 item?"] =
    "Uqinisekile ukuthi ufuna ukubuyisela into eyi-1?";
$Definition[
    "Are you sure you want to turn off all AI Suggested Answers? You can undo this in your profile settings at anytime."
] =
    "Uqinisekile ukuthi ufuna ukuvala zonke Izimpendulo Eziphakanyisiwe ze-AI? Ungakwazi ukuhlehlisa lokhu kuzilungiselelo zephrofayela yakho nganoma yisiphi isikhathi.";
...
] = "Kudingeka okungenani ikholomu eyodwa ebonakalayo. Bonisa noma engeza ikholomu ebonakalayo.";
$Definition["A url-friendly version of the category name for better SEO."] =
    "Uhlobo lwe-url-friendly lwegama lesigaba se-SEO elingcono.";
...
$Definition[
    ...
    "Ngaphambi kokwenza lesi sici sisebenze, sicela uqaphele okulandelayo okungaba nemithelela:";
...
$Definition["Bookmark a discussion using its star icon."] =
    "Beka i-bookmark engxoxweni usebenzisa isithonjana senkanyezi yayo.";
...
$Definition["Browse for a new banner logo if you would like to change it:"] =
    "Phequlula uphawu lwesibhengezo esisha uma ungathanda ukusiguqula:";
...
$Definition["Cannot build profile information if user is not defined."] =
    "Ayikwazi ukwakha imininingwane yephrofayili uma umsebenzisi engachazwanga.";
$Definition["Categories &amp; Discussions"] = "Izigaba Nezingxoxo";
$Definition["Categories to Exclude from AI Answers"] =
    "Izigaba ezizokhishwa ezimpendulweni ze-AI";
$Definition["Categories are used to organize discussions."] =
    "Izigaba zisetshenziselwa ukusiza abasebenzisi bakho ukuhlela izingxoxo zabo ngendlela enenjongo emphakathini wakho.";
$Definition["Categories are used to organize posts."] =
    "Izigaba zisetshenziselwa ukusiza abasebenzisi bakho ukuhlela okuthunyelwe kwabo ngendlela enomqondo emphakathini wakho.";
$Definition["Categories allow you to organize your posts."] =
    "Izigaba zikuvumela ukuthi uhlele okuthunyelwe kwakho.";
...
$Definition["Check out the full list of video tutorials here."] =
    "Bheka uhlu olugcwele lwezifundo zevidiyo lapha.";
...
$Definition["Click here to carry on to your dashboard"] =
    "Chofoza lapha ukuze uqhubekele kudeshibhodi yakho";
...
$Definition["Community Discussion Categories"] =
    "Izigaba Zezingxoxo Zomphakathi";
...
$Definition["Configuration settings for password fields in Vanilla"] =
    "Izilungiselelo zokucushwa zezinkambu zephasiwedi ku-Vanilla";
$Definition["Configure custom Kaltura domains"] =
    "Lungiselela izizinda ze-Kaltura ngokwezifiso";
$Definition["Configure how nested categories are displayed to users."] =
    "Lungiselela ukuthi izigaba ezidaliwe ziboniswa kanjani kubasebenzisi.";
$Definition['Configuring Vanilla\'s Homepage'] =
    'Ilungiselela ikhasi likaVanilla';
$Definition["Confirmation  Body"] = "Isiqinisekiso Sokuqinisekisa";
$Definition["Confirm email addresses"] =
    "Dinga abasebenzisi ukuthi baqinisekise amakheli abo e-imeyili (anconyiwe)";
...
$Definition[
    ...
    "Xhumana nabasebenzi bakwaVanilla ukuze uthole ukucushwa kwesayithi le-Q&A kunikwe amandla. Bese unika amandla i-addon ye-Q&A engxenyeni ye-Addons kudeshibhodi.";
$Definition[
    ...
    "Xhumana nabasebenzi be-Vanilla ukuze uthole ukucushwa kwesayithi le-Q&A kunikwe amandla. Bese unika amandla i-addon ye-Q&A kusigaba se-<0/> sedeshibhodi.";
$Definition["Content Curation"] = "Isimo Sokuqukethwe";
$Definition["Content flagged as spam is stored here for moderator review."] =
    "Okuqukethwe okumakwe njengogaxekile kugcinwa lapha ukuze kubuyekezwe umongameli.";
...
$Definition[
    ...
    "Ingethula ubungozi obufana ne-Cross-Site Scripting (XSS) uma izikripthi zokuqala zifakwa engcupheni.";
$Definition['Could not find a theme identified by \'%s\''] =
    'Ayikwazanga ukuthola itimu ekhonjwe \'%s\'';
$Definition["Could not instantiate mail function."] =
    "Ayikwazanga ukusebenza ngokuqinile kwemeyili.";
...
$Definition["Could not open addon file. Addons must be zip files."] =
    "Ayikwazanga ukuvula ifayili le-addon. Ama-Addons kumele abe amafayili we-zip.";
$Definition["Create & organize discussion categories and manage your users."] =
    "Dala futhi uhlele izigaba zokuxoxisana futhi uphathe abasebenzisi bakho.";
...
$Definition["Disabled: The pocket will <b>not</b> be displayed."] =
    "Zikhutshaziwe: I ephaketheni <b>kuzokhonjiswa.</b>";
...
$Definition["Display content from followed categories"] =
    "Bonisa okuqukethwe okuvela ezigabeni ezilandelwayo";
$Definition["Display in dashboard. (not recommended)"] =
    "Khombisa kudeshibhodi. (Akunconywa)";
$Definition["Display Open Cases in Profile Page?"] =
    "Khombisa amacala avulekile ekhasini lephrofayela?";
$Definition["Display Options"] = "Bonisa Izinketho";
$Definition["Display records from this subcommunity"] =
    "Bonisa amarekhodi asuka kulo mphakathi ongaphansi";
$Definition["Display root categories as headings."] =
    "Khombisa izigaba zezimpande njengezihloko.";
$Definition[
    "Displays the banner image form the branding page prominently throughout the theme."
] =
    "Ibonisa isithombe sesibhengezo ikhasi lokufaka uphawu ngokugqamile kuyo yonke ingqikithi.";
$Definition["Display a searchbox on top of the banner image."] =
    "Veza ibhokisi lokucinga phezulu kwesithombe sesibhengezo.";
$Definition["Display records from this category."] =
    "Khombisa amarekhodi akulesi sigaba.";
$Definition["Display records from this subcommunity."] =
    "Khombisa amarekhodi avela kulo mphakathi ongaphansi.";
$Definition['Don\'t display for embedded comments.'] =
    'Ungabonisi amazwana angenisiwe.';
...
$Definition["Do not display the categories in the side panel."] =
    "Ungazivezi izigaba eziseceleni kwecala.";
...
$Definition[
    ...
    "I-imeyili Digest Prompt Widget izotholakala uma i-Email Digest inikwe amandla.";
...
$Definition[
    ...
    "Inhlabamkhosi ye-imeyili izothunyelwa ngosuku olukhethiwe njalo ngeviki. Izinguquko osukwini olumisiwe zizothinta isonto elilandelayo.";
...
$Definition["Embedding is currently DISABLED."] =
    "Ukushumeka okwamanje kukhubazekile.";
$Definition["Embedding is currently ENABLED."] =
    "Ukushumeka okwamanje KUYENZIWE.";
...
$Definition["Enable link embeds in discussions and comments"] =
    "Nika amandla ukushumeka kokuxhumeka ezingxoxweni nasemazwaneni";
$Definition["Enable link embeds in posts and comments"] =
    "Nika amandla ukushumeka kwezixhumanisi kokuthunyelwe namazwana";
...
$Definition["Enable sending notification emails"] =
    "Nika amandla ukuthumela ama-imeyili ezaziso";
...
$Definition["Enable to only show posts from categories a user follows."] =
    "Nika amandla ukubonisa kuphela okuthunyelwe okuvela ezigabeni ezilandelwa umsebenzisi.";
$Definition[
    "Enable to get a preview of our new user management dashboard with improved search and new configuration options."
] =
    "Nika amandla ukuthola ukubuka kuqala kwedeshibhodi yethu entsha yokuphatha abasebenzisi ngosesho oluthuthukisiwe nezinketho ezintsha zokumisa.";
...
$Definition[
    ...
    "Ukunika lesi sici amandla kuzoshintsha Inqubomgomo Yokuphepha Kokuqukethwe kwakho ukuze uthembe imibhalo eyengeziwe ejovwe njengokuncika yimibhalo yakho yangokwezifiso.";
$Definition[
    ...
    'Ukunika lesi sici amandla kuzoshintsha Inqubomgomo Yokuphepha Kokuqukethwe (CSP) yesayithi lakho ukuze ivumele izikripthi ezigunyaziwe ohlwini lwakho lwamanje oluthenjiwe ukuze zilayishe ezinye izikripthi ezinamandla, kuzongeza isiyalelo \'esinamandla\' ku-CSP yakho esinikeza ukuguquguquka okwengeziwe ekuhlanganiseni inkampani yangaphandle. okuqukethwe.';
$Definition["Encourage your friends to join your new community!"] =
    "Khuthaza abangani bakho ukuthi bajoyine umphakathi wakho omusha!";
$Definition["Enter a comma-delimited list of indexes, starting at 1."] =
    "Faka uhlu lwezinkomba ezikhefana ngokhefana, luqale ngo-1.";
...
$Definition["Enter the email address of the person you would like to invite:"] =
    "Faka ikheli le-imeyili lomuntu ongathanda ukummema:";
$Definition[
    "Enter the url to the page you would like to use as your homepage"
] = "Faka i-url ekhasini ongathanda ukulisebenzisa njengekhasi lakho lasekhaya";
$Definition[
    "Enter the url to the page you would like to use as your homepage:"
] = "Faka i-url ekhasini ongathanda ukulisebenzisa njengekhasi lakho lasekhaya:";
$Definition["Error sending email. Please review the addresses and try again."] =
    "Iphutha ekuthumeleni i-imeyili. Sicela ubuyekeze amakheli bese uzama futhi.";
...
$Definition["Exclude archived discussions from the discussions list"] =
    "Khipha izingxoxo ezifakwe kungobo yomlando ohlwini lwezingxoxo";
$Definition["Existing members send invitations to new members."] =
    "Amalungu akhona athumela izimemo kumalungu amasha.";
...
$Definition[
    ...
    "Ukusesha kwangaphandle kuthatha indawo yokusesha kwe-Vanilla ngaphandle kwebhokisi ngomhlinzeki wosesho wenkampani yangaphandle oyikhethile.";
...
$Definition["FaviconBrowse"] =
    "Phequlula i-favicon entsha uma ungathanda ukuyiguqula:";
$Definition["FaviconDescription"] =
    "Ifavicon yesayithi lakho ivela kubha yesihloko sesiphequluli sakho. Izokwehliswa ngendlela efanele.";
...
$Definition[
    ...
    "Isibonelo, ukuvumela isizinda sakho.com, www.yourdomain.com, kanye ne-help.yourdomain.com, ungangeza *.yourdomain.com";
$Definition["Force the forum to only be accessible through this url"] =
    "Iphoqa isithangami ukuba sitholakale kuphela ngalesi sikhathi se-url";
$Definition["Force your forum to be viewed through the Remote Url"] =
    "Phoqa iforamu yakho ukuthi ibukwe nge-Reml Url";
...
$Definition["Full post in email notifications"] =
    "Okuthunyelwe okugcwele kuzaziso ze-imeyili";

$Definition["Garden"] = "Ingadi";
$Definition["Garden.api.ssoIDPermission.description"] =
    "Izindima ngale mvume zizokwazi ukukhulisa ama-SSO ID kumakholi we-API v2.";
...
$Definition[
    ...
    "Ukukhiqiza Iziphakamiso. Uzokwaziswa uma sezilungele ukuthi uzibuyekeze.";
...
$Definition[
    ...
    "Sanibonani. Ngingumsizi wakho we-AI Suggestion, lapha ukuze ngikusize ekutholeni izindatshana ezifanele kanye nokuthunyelwe ukuze uphendule imibuzo yakho. Sicela uzizwe ukhululekile ukubuza noma imiphi imibuzo ongase ube nayo.";
$Definition["guest"] = "isivakashi";
$Definition["Guest roles"] =
    "Bheka zonke izindima okufanele zisetshenziswe kubavakashi.";

$Definition["Hash Algorithm"] = "IHash Algorithm";
$Definition["HeadlineFormat.AddUser"] =
    "I- {ActivityUserID,user} ingeze i-akhawunti ye- {RegardingUserID,user}";
$Definition["HeadlineFormat.PictureChange"] =
    "{RegardingUserID, You} ushintshe {ActivityUserID, your} isithombe sephrofayili.";
$Definition["HeadlineFormat.RegistrationApproval"] =
    "{ActivityUserID,user} zivume izicelo ze- {RegardingUserID,user}.";
...
$Definition[
    ...
    "Sawubona! Ngingumsizi wakho we-AI Suggestion, lapha ukuze ngikusize uthole izindatshana ezihamba phambili nokuthunyelwe ukuphendula imibuzo yakho. Zizwe ukhululekile ukubuza noma yini, ngilapha ukuze ngenze ukusesha kwakho kujabulise futhi kufundise!";
...
$Definition["Hide discussions from Recent Discussions and Widgets."] =
    "Fihla izingxoxo Ezingxoxweni Zakamuva Namawijethi.";
$Definition["Hide posts from Recent Posts Page and Widgets."] =
    "Fihla okuthunyelwe okuvela Ekhasini Lokuthunyelwe Kwakamuva Namawijethi.";
...
$Definition["Hide signatures on embedded comments"] =
    "Fihla amasiginesha emazwaneni ashumekiwe";
...
$Definition["How the content is going to be filtered."] =
    "Kuzohlungwa kanjani okuqukethwe.";
...
$Definition[
    ...
    "Nokho, lokhu kuza nomthwalo owengeziwe wokuqinisekisa ukuphepha kwesayithi lakho.";
$Definition["Html"] = "HTML";
$Definition["HTML Emails"] = "Ama-imeyili e-HTML";
$Definition["HTTP Strict Transport Security (HSTS) Settings"] =
    "Izilungiselelo ze-HTTP Ezokuphepha Ezokuphepha (i-HSTS)";
...
$Definition["If left empty, Email Logo is used."] =
    "Uma ishiywe ingenalutho, Ilogo ye-imeyili iyasetshenziswa.";
$Definition[
    ...
    "Uma unesixhumanisi sedokhumenti yangaphakathi kokuthi 'Isixhumanisi Semigomo Yokusebenzisa' ngenhla, 'Umbhalo Wemibandela Yokusebenzisa' ngeke uzitshwe. Susa isixhumanisi uma ufuna ukusebenzisa lo mbhalo.";
...
$Definition["Include full post in email notifications"] =
    "Faka okuthunyelwe okugcwele kwizaziso ze-imeyili";
...
$Definition["Include featured images with posts in email digest"] =
    "Faka izithombe ezifakiwe ezinokuthunyelwe kunhlabamkhosi ye-imeyili";
$Definition["Include internal profile fields"] =
    "Faka nezinkambu zephrofayela yangaphakathi";
$Definition["Include private profile fields"] =
    "Faka phakathi izinkambu zephrofayela eyimfihlo";
...
$Definition["Install Vanilla without a .htaccess file."] =
    "Faka i-Vanilla ngaphandle kwefayela le-.htaccess.";
...
$Definition["It looks like you edited your post. <0/> or <1/>."] =
    "Kubonakala sengathi ukuhlelile okuthunyelwe kwakho. <0/> noma <1/>.";
...
$Definition["Large images will be scaled down."] =
    "Izithombe ezinkulu zizokwehliswa zibekwe kububanzi obukhulu be-%spx nokuphakama okungama-%spx.";
...
$Definition["Limits: 60 characters, no breaks."] =
    "Imikhawulo: izinhlamvu ezingu-60, awekho amakhefu.";
...
$Definition["Limit the pocket to one or more roles or permissions."] =
    "Umkhawulo ephaketheni ubambe iqhaza elilodwa noma amaningi noma izimvume.";
$Definition["Limit"] = "Umkhawulo";
$Definition["List of discussion IDs to delete."] =
    "Uhlu lwama-ID engxoxo azosuswa.";
...
$Definition["Make sure you select at least one item before continuing."] =
    "Qiniseka ukuthi ukhetha okungenani into eyodwa ngaphambi kokuqhubeka.";
$Definition["Add your site to trusted domains."] =
    "Qinisekisa ukuthi isiza sakho sengezwe ku-%s lapho ukushumeka kunikwe amandla.";
...
$Definition["Manage Suggested Answer Sources"] =
    "Phatha Imithombo Yezimpendulo Ephakanyisiwe";
...
$Definition["Mark All Suggested Answers as Accepted"] =
    "Maka Zonke Izimpendulo Eziphakanyisiwe Njengezamukelwe";
...
$Definition["Maximum Category Display Depth"] =
    "Ubukhulu bokukhonjiswa kwesigaba esiphakeme";
$Definition["Max number of %s"] = "Inani le-%s";
$Definition["Max number of images in signature"] =
    "Inombolo enkulu yezithombe ezisayiniwe";
$Definition["Maximum number of posts to be included in the email digest."] =
    "Inombolo enkulu yokuthunyelwe okufanele ifakwe kunhlabamkhosi ye-imeyili.";
...
$Definition["Member roles"] =
    "Hlola zonke izindima okufanele zisetshenziswe kubasebenzisi abasha / abavunyelwe.";
...
$Definition["Moderators have permission to edit most content."] =
    "Abongameli banemvume yokuhlela okuqukethwe okuningi.";
...
$Definition[
    ...
    "Ulimi oluyinkimbinkimbi futhi lungase lwethule amagama athile aqondene nomkhakha othile, kodwa asaqondakala kubantu abaningi.";
...
$Definition[
    ...
    "Ulimi lobuchwepheshe olwengeziwe namatemu aqondene nomkhakha othize -- athatha izinga eliphezuluOfTech lokuqonda/lokujwayela ngesihloko.";
$Definition["more than %s deep"] = "ngaphezu kwe-%s kujule";
$Definition['Most pockets shouldn\'t be displayed in the dashboard.'] =
    'Amaphakethe amaningi akufanele aboniswe kudeshibhodi.';
$Definition["Move discussions in this category to a replacement category."] =
    "Hambisa izingxoxo ezikulesi sigaba isigaba sokungena esikhundleni.";
...
$Definition["Never - Users Must Refresh Page"] =
    "Ungalokothi - Abasebenzisi Kufanele Baqabule Ikhasi";
$Definition["Never display on mobile browsers."] =
    "Ungalokothi ubonise kwiziphequluli zeselula.";
...
$Definition["New conversations in the last day"] =
    "Izingxoxo ezintsha ngosuku lokugcina";
$Definition["New conversations in the last week"] =
    "Izingxoxo ezintsha ngesonto eledlule";
...
$Definition["New users are only registered through SSO plugins."] =
    "Abasebenzisi abasha babhaliswa kuphela ngama-plug we-SSO.";
$Definition[
    'New users are reviewed and approved by an administrator (that\'s you!).'
] = 'Abasebenzisi abasha bayabuyekezwa futhi bavunyelwe ngumlawuli (uwena lowo!).';
$Definition[
    "New users fill out a simple form and are granted access immediately."
] = "Abasebenzisi abasha bagcwalisa ifomu elilula futhi banikezwa ukufinyelela ngokushesha.";
...
$Definition["No item options are available for Link display type."] =
    "Azikho izinketho zento ezitholakalayo zohlobo lwesibonisi sesixhumanisi.";
...
$Definition["Notifications will appear here."] =
    "Izaziso zizovela lapha.";
$Definition["NotifyApplicant"] =
    "Ngazise uma umuntu efaka isicelo sobulungu.";
$Definition["Notify me when people comment on a discussion."] =
    "Ngazise lapho abantu bephawula engxoxweni.";
$Definition["Notify me when my questions have AI Suggested Answers"] =
    "Ngazise uma imibuzo yami inezimpendulo eziphakanyisiwe ze-AI";
$Definition["Notify me when people start new discussions."] =
    "Ngazise lapho abantu beqala izingxoxo ezintsha.";
...
$Definition["Number of blocked registrations"] =
    "Inani lokubhalisa elivinjelwe";
$Definition["Number of days before a follow-up email is automatically sent."] =
    "Inani lezinsuku ngaphambi kokuthi i-imeyili yokulandelela ithunyelwe ngokuzenzakalela.";
...
$Definition["Number input must be between 1 and 100."] =
    "Okokufaka kwenombolo kufanele kube phakathi kuka-1 no-100.";
...
$Definition["Only display on mobile browsers."] =
    "Veza kuphela kwiziphequluli zeselula.";
$Definition[
    ...
    'Izinkambu eziyibhokisi likaqhwishi elilodwa kuphela, ukukhetha phansi okukodwa, okwehlayo okukhethiwe okuningi, noma okwehliswayo kwezinombolo ezitholakalayo. Uma izinkambu sezikhethiwe, zizovela ngezansi ukuze ukhethe izimpendulo eziqondile kunkambu yephrofayela ngayinye.';
...
$Definition["Only visible to users with roles with permission."] =
    "Kubonakala kuphela kubasebenzisi abanezindima ngemvume.";
$Definition[
    "Open cases will only display if the user has a valid Salesforce connection."
] =
    "Amacala avulekile azoboniswa kuphela uma umsebenzisi enokuxhumana okuvumelekile kwe-Salesforce.";
...
$Definition["Or select an image on your computer (2mb max)"] =
    "Noma khetha isithombe kukhompyutha yakho (2mb max)";
...
$Definition["Pageview ratio representing a deflected case"] =
    "Isilinganiso sokubuka ikhasi simele icala elichezukile";
...
$Definition["Please enter a unique API Label, this one has been used before"] =
    "Sicela ufake ilebula ye-API ehlukile, lena ike yasetshenziswa ngaphambilini";
...
$Definition[
    ...
    "Izinkinga ezingaba khona zokusebenzisana neziphequluli ezindala, ezithinta ulwazi lomsebenzisi.";
...
$Definition[
    ...
    "Amaphrothokholi (isb. https://) nezindlela (isb. yourdomain.com/some/path) kufanele zikhishwe.";
...
$Definition[
    ...
    "Ubukhulu obunconyiwe bungu-400px ngo-300px noma buncane ngesilinganiso esifanayo.";
...
$Definition["Registration is currently closed."] =
    "Ukubhalisa okwamanje kuvaliwe.";
$Definition["Reload the page to see recent updates."] =
    "Layisha kabusha ikhasi ukuze ubone izibuyekezo zakamuva.";
$Definition["Reload the page to access recent updates."] =
    "Layisha kabusha ikhasi ukuze ufinyelele izibuyekezo zakamuva.";
...
$Definition["reply to private conversation(s)"] =
    "phendula ezingxoxweni eziyimfihlo";
...
$Definition["Require Terms of Service"] =
    "Idinga abasebenzisi ukuthi bavumelane Nemigomo Yesevisi (kunconyiwe)";
...
$Definition["RolePersonalInfo"] =
    "Le ndima ulwazi lomuntu siqu. Abasebenzisi abanemvume yokubuka imininingwane yabantu kuphela abazoyibona.";
$Definition["Roles & Permissions"] = "Izindima nezimvume";
$Definition['Roles determine user\'s permissions.'] =
    "Wonke umsebenzisi kusayithi lakho unikezwa okungenani indima eyodwa. Izindima zisetshenziselwa ukuthola ukuthi abasebenzisi bavunyelwe ukwenzani.";
...
$Definition["Search by user or role."] =
    "Sesha abasebenzisi ngegama noma i-imeyili, usebenzisa u-% njengekhadi lasendleni. Ungasesha futhi nge-ID yomsebenzisi, igama lendima, noma \"elivinjelwe\".";
...
$Definition["Select the location of the pocket."] =
    "Khetha indawo ephaketheni.";
$Definition[
    "Select which columns are displayed on the manage users page list."
] = "Khetha ukuthi yimaphi amakholomu aboniswa ohlwini lwekhasi labasebenzisi.";
$Definition["Selection will affect the item options available."] =
    "Ukukhetha kuzothinta izinketho zezinto ezitholakalayo.";
...
$Definition[
    ...
    "Thumela i-imeyili yokuqinisekisa lapho abantu bebuza umbuzo noma beqala ingxoxo nge-imeyili.";
...
$Definition['Separate each word with a semi-colon ";"'] =
    'Hlukanisa igama ngalinye ne-semi-colon ";"';
$Definition[
    "Set this interest as default to suggest following its mapped categories and tags to all users."
] =
    "Setha lokhu okuthakaselayo njengokuzenzakalelayo ukuze uphakamise ukulandela izigaba zakhona namathegi kubo bonke abasebenzisi.";
...
] = "Khombisa umsebenzisi ngamunye uhlu olwenziwe ngezifiso lwemibono abayidalile noma abayiphakamisile.";
...
] = "Imithombo ekhethiwe lapha izotholakala ezimpendulweni eziphakanyisiwe ze-AI.";
$Definition["Specify one domain per line. Use * for wildcard matches."] =
    "Cacisa isizinda esisodwa emugqeni ngamunye. Sebenzisa * emidlalweni yamakhadi wasendle.";
$Definition["Spoof"] = "I-Spoof";
$Definition["SSO Role"] = "Indima ye-SSO";
$Definition["SSO roles are always passed through SSO."] =
    "Izindima ze-SSO zihlala zidluliswa nge-SSO.";
...
$Definition[
    ...
    "Qala umugqa wesihloko senhlabamkhosi nge-[Isihloko Sesibhengezo] esisethwe kokuthi Ukubukeka > Ibhrendi ne-SEO";
...
$Definition[
    ...
    "Izitayela nokubonakala okuvamile kwawo wonke ama-imeyili, okuhlanganisa inhlabamkhosi ye-imeyili, kusethwe endaweni yonke ekhasini Lezilungiselelo ze-imeyili.";
...
$Definition["Suggestions are only visible to you until you accept the answer"] =
    "Iziphakamiso zibonakala kuwe kuphela uze wamukele impendulo";
$Definition["Suggestions may only be generated on questions"] =
    "Iziphakamiso zingenziwa kuphela emibuzweni";
...
$Definition["The first line of content in the email digest after the title."] =
    "Umugqa wokuqala wokuqukethwe kunhlabamkhosi ye-imeyili ngemva kwesihloko.";
$Definition["The homepage title is displayed on your home page."] =
    "Isihloko sasekhaya sikhonjiswa ekhasini lakho lasekhaya. Khetha isihloko ongafuna ukusibona sivela ezinjini zokucinga.";
$Definition["The homepage was saved successfully."] =
    "Ikhasi lasekhaya ligcinwe ngempumelelo.";
$Definition["The invitation was removed successfully."] =
    "Isimemo sisuswe ngempumelelo.";
$Definition["The invitation was sent successfully."] =
    "Isimemo sithunyelwe ngempumelelo.";
$Definition["The Key in the XML payload to designate %s."] =
    "Ukhiye ekulayisheni kwe-XML ukuqoka i-%s.";
$Definition[
    "The test digest will generate content as if it were this user receiving the digest."
] =
    "Inhlabamkhosi yokuhlola izokhiqiza okuqukethwe sengathi yilo msebenzisi othola inhlabamkhosi.";
...
$Definition[
    ...
    'Kube khona iphutha lokulayisha isithombe. I-logo yakho ye-imeyili ingalayishwa kwenye yama-filetypes alandelayo: gif, jpg, png';
$Definition["There are currently no applicants."] =
    "Okwamanje abekho abafakizicelo.";
$Definition["There is currently %s applicant."] =
    "Okwamanje kukhona umfakisicelo ongu %s.";
$Definition["There are currently %s applicants."] =
    "Okwamanje kukhona abafakizicelo abasebenza nge-%s.";
$Definition["There are currently no requests."] =
    "Azikho izicelo.";
$Definition["There is currently %s request."] =
    "Kukhona isicelo se-%s.";
$Definition["There are currently %s requests."] =
    "Okwamanje kukhona %s izicelo.";
$Definition["There are no items awaiting moderation at this time."] =
    "Azikho izinto ezilindele ukuhlolwa ngalesi sikhathi.";
$Definition[
    ...
    "Sekuvele kune-akhawunti kule nkundla esebenzisa ikheli lakho le-imeyili. Sicela udale i-akhawunti entsha, noma ufake iziqinisekiso ze-akhawunti ekhona.";
$Definition["The next three email digest delivery dates"] =
    "Amadethi amathathu alandelayo okulethwa kwenhlabamkhosi ye-imeyili";
$Definition["The secret secures the sign in process."] =
    "Imfihlo ivikela inqubo yokungena ngemvume. <b>Unganikezi</b> imfihlo kunoma ngubani.";
$Definition["The site description usually appears in search engines."] =
    "Ukuchazwa kwesiza kuvame ukuvela ezinjini zokusesha. Kufanele uzame ukuba nencazelo enobude obuyi-100-150 yezinhlamvu.";
$Definition["The site is currently undergoing scheduled maintenance."] =
    "Isiza njengamanje sisebenza ngokulungiswa okuhleliwe.";
$Definition["The specified url code is already in use by another category."] =
    "Ikhodi ye-url echaziwe isivele isetshenziswa esinye isigaba.";
$Definition["The structure was successfully executed."] =
    "Isakhiwo senziwa ngempumelelo.";
$Definition["The update was not successful."] =
    "Ukuvuselelwa akuphumelelanga.";
...
$Definition[
    ...
    "Lokhu akudingekile kumasayithi amaningi ngaphandle kwalawo asebenzisa izici ezifana ne-AdSense kanye ne-Google Tag Manager.";
$Definition[
    ...
    "Lesi isifinyezo esikhiqizwe yi-AI kusukela kokuthunyelwe kwengxoxo okubhekiselwe kuyo okungase kuphendule umbuzo. Isifinyezo sidalwe ngendlela yokuthi sisetshenziswe njengempendulo eyamukelwe.";
$Definition["This category has custom permissions."] =
    "Lesi sigaba sinezimvume ezenziwe ngokwezifiso.";
$Definition["This category is archived."] = "Lesi sigaba siyalondolozwa.";
$Definition["This connection is in test-mode."] =
    "Lokhu kuxhuma kumodi yokuhlola.";
$Definition["This controls how the responses are phrased and spelled."] =
    "Lokhu kulawula ukuthi izimpendulo zibhalwa kanjani futhi zipelwe kanjani.";
$Definition["This Database"] = "Le Database";
$Definition["QnAFollowup.Feature.Enabled"] =
    "Lesi sici sithumela ama-imeyili kubabhali bemibuzo ephenduliwe engenampendulo eyamukelekayo.";
$Definition["This forum is currently set to invitation only mode."] =
    "Le nkundla okwamanje isethwe kumodi yokumema kuphela.";
$Definition[
    'This image will be used in category lists and widgets when using the "Icon" style option.'
] =
    'Lesi sithombe sizosetshenziswa ezinhlwini zezigaba namawijethi lapho kusetshenziswa inketho yesitayela ethi "Isithonjana".';
$Definition[
    ...
    'Lesi sithombe sizovela kusibhengezo salesi sigaba kanye nasezinqubweni zesigaba uma usebenzisa izinketho zesitayela "sesithombe" kanye/noma "Ingemuva". Ubukhulu obunconyiwe cishe bungu-1000px ngo-400px noma isilinganiso esifanayo.';
$Definition["This is a parent category that does not allow discussions."] =
    "Lesi isigaba sabazali esingavumeli izingxoxo.";
$Definition['This is the first time you\'ve visited the discussion forums.'] =
    'Kungokokuqala ukuthi uvakashele izinkundla zokuxoxisana.';
$Definition[
    "This may be used to include content such as organization name and address in the email digest."
] =
    "Lokhu kungase kusetshenziselwe ukufaka okuqukethwe okufana negama lenhlangano nekheli enhlabamkhosini ye-imeyili.";
$Definition["This name will be shown in the community."] =
    "Leli gama lizoboniswa emphakathini.";
$Definition["This page requires Javascript."] =
    "Leli khasi lidinga iJavascript.";
...
] = "Le ndatshana ayikwazi ukususwa ngoba yingqikithi esetshenziswayo njengamanje.";
$Definition["This theme has additional options."] =
    "Le ndatshana inezinketho ezingeziwe ekhasini le-%s.";
$Definition["This theme has customizable text."] =
    "Lesi sihloko sinombhalo ongawenza ngezifiso.";
$Definition[
    ...
    "Lokhu kuzoqondisa abanye abasebenzisi abanemibuzo efanayo ezimpendulweni ezifanele ngokushesha futhi kuzobonisa Impendulo Ephakanyisiwe ye-AI futhi kuxhumanise izinto ezikhonjiwe ukuze abanye abasebenzisi babone. Iziphakamiso zibonakala kuwe kuphela uze wamukele impendulo.";
...
$Definition["Truncate the initial discussion text to this many words."] =
    "Nwebisa umbhalo wokuqala wengxoxo kula magama amaningi.";
...
$Definition["Up to a maximum of 100 items may be displayed."] =
    "Izinto ezifika kweziyi-100 zingaboniswa.";
...
$Definition["Use an SMTP server to send email"] =
    "Sebenzisa iseva ye-SMTP ukuthumela i-imeyili";
$Definition["Use asterisks for wildcards"] =
    'Sebenzisa i-asterisks kuma-wildcards, isib. "*@gmail.com"';
...
$Definition["Use categories to organize discussions"] =
    "Sebenzisa izigaba ukuhlela izingxoxo";
$Definition["Use Facebook names for usernames."] =
    "Sebenzisa amagama we-Facebook amagama abasebenzisi.";
...
$Definition[
    ...
    "Isebenzisa ulimi lobuchwepheshe obuphezulu namagama aqondene nomkhakha ahloselwe labo abanokuqonda okujulile kwesihloko.";
$Definition[
    "Uses industry-specific terms where necessary, but also provides explanations of definitions to ensure clarity."
] =
    "Isebenzisa amagama aqondene nemboni lapho kudingeka khona, kodwa futhi inikeza izincazelo zezincazelo ukuze kuqinisekiswe ukucaca.";
$Definition[
    "Uses simple, everyday language that anyone can understand, regardless of their background or expertise."
] =
    "Isebenzisa ulimi olulula, lwansuku zonke olungaqondwa yinoma ubani, kungakhathaliseki isizinda sabo noma ubuchwepheshe.";
$Definition["UserDeleteMessage"] =
    'Susa umsebenzisi bese ususa ngokuphelele konke okuqukethwe komsebenzisi. Lokhu kungenza izingxoxo zingajabuli. Inketho enhle kakhulu yokususa ogaxekile.';
$Definition["UserDeletionPrompt"] =
    "Khetha ukuthi ukuphatha kanjani konke okuqukethwe okuhambisana ne-akhawunti yomsebenzisi ye-%s (imibono, imilayezo, njll).";
$Definition["UserKeep"] = "Gcina Okuqukethwe Komsebenzisi";
$Definition["UserKeepMessage"] =
    'Susa umsebenzisi kepha gcina okuqukethwe ngumsebenzisi.';
...
$Definition[
    ...
    "Abasebenzisi bangalandela izigaba ukuze babhalisele izaziso zokuthunyelwe okusha. Khetha ukuthi yiziphi izigaba abasebenzisi abasha okufanele bazilandele ngokuzenzakalela.";
$Definition["Users that get this reaction get %+d point."] =
    "Abasebenzisi abathola lokhu kusabela bathola iphoyinti le %+d.";
$Definition["Users that get this reaction get %+d points."] =
    "Abasebenzisi abathola lokhu kusabela bathola amaphuzu angu %+d.";
$Definition[
    "Users will not be warned when following links that match a Trusted Domain."
] =
    "Abasebenzisi ngeke baxwayiswe uma kulandela izixhumanisi ezihambelana ne-Domain Ethembekile.";
$Definition[
    "Users will be redirected to this URL after accepting an invitation."
] =
    "Abasebenzisi bazodluliselwa kule URL ngemuva kokwamukela isimemo. Kungaba i-URL ephelele noma indlela yokuqondisa kabusha ngaphakathi kwesiza.";
...
$Definition[
    ...
    'Abasebenzisi bazonikezwa le ndima kuze kube baqinisekisa amakheli abo e-imeyili.';
$Definition["Users with the no ads permission will not see this pocket."] =
    "Abasebenzisi abanemvume yezikhangiso ngeke bayibone ephaketheni le.";
$Definition["UserWipe"] = "Okuqukethwe Komsebenzisi okungenalutho";
$Definition["UserWipeMessage"] =
    'Susa umsebenzisi bese ubuyisela konke okuqukethwe komsebenzisi ngomlayezo othi umsebenzisi ususiwe. Lokhu kunikeza ukukhombisa okubonakalayo ukuthi kukhona imininingwane engekho.';
$Definition["Use the content at this url as your homepage."] =
    'Khetha ikhasi abantu okufanele <strong style="white-space: nowrap;">balibone</strong> uma bevakashela: <strong style="white-space: nowrap;">%s</strong>';
$Definition["Use Vanilla as a commenting system in your site"] =
    "Sebenzisa i-Vanilla njengohlelo lokuphawula kusayithi lakho";
$Definition["Use weekly community email digest"] =
    "Sebenzisa inhlabamkhosi ye-imeyili yomphakathi yangeviki";
$Definition["Untitled"] = "Akunasihloko";

$Definition["Value or Pattern"] = "Inani noma iphethini";
$Definition["Vanilla.Archive.Description"] =
    "Ungakhetha ukufaka kungobo yomlando izingxoxo zesithangami esidala kunosuku oluthile. Izingxoxo ezifakwe kungobo yomlando zivaliwe ngempumelelo, kungavunyelwa okuthunyelwe okusha.";
$Definition["Vanilla.Categories.MaxDisplayDepth"] =
    'Beka izigaba ezidlekezelwe ohlwini oludlalwa kukhefana uma iyi-%1$s';
...
$Definition["View browser compatibility chart"] =
    "Buka ishadi elihambisana nesiphequluli";
...
] = "Xwayisa abasebenzisi uma isixhumanisi eposini sizobenza bashiye isithangami";
$Definition[
    "Warning: All of your data will be lost. Once you delete, there is absolutely no recovery of any kind."
] =
    "Isexwayiso: Yonke imininingwane yakho izolahleka. Uma usususile, akukho ukululama kwanoma yiluphi uhlobo.";
$Definition["Warning: deleting is permanent"] =
    "ISEXWAYISO: izinto ezisusiwe ziyasuswa kulolu hlu futhi azikwazi ukubuyiselwa.";
...
$Definition["We only accept urls that begin with http:// or https://"] =
    "Samukela ama-urls aqala nge-http: // noma i-https: //";
$Definition[
    ...
    "Sizozama ukusebenzisa iseva yemeyili yasendaweni ukuthumela i-imeyili ngokuzenzakalelayo. Uma ufuna ukusebenzisa iseva yemeyili ye-SMTP ehlukile, ungayilungisa ngezansi.";
$Definition[
    ...
    "Siyakwamukela. Ngingumsizi wakho Wesiphakamiso se-AI, ithuluzi elisekelwe emshinini lokufunda elidizayinelwe ukuthola nokuphakamisa ama-athikili afanelekile nokuthunyelwe ekuphenduleni imibuzo yakho. Ngicela ufake imibuzo yakho futhi ngizokunikeza ulwazi olufaneleka kakhulu.";
$Definition['What\'s the Buzz?'] = 'Yini i-Buzz?';
$Definition["When enabled, search result will open in a new browser tab."] =
    "Uma kunikwe amandla, umphumela wosesho uzovuleka kuthebhu entsha yesiphequluli.";
$Definition[
    "When enabled, your community will have AI Suggestions shown in Q&A. <0/>"
] = "Uma inikwe amandla, umphakathi wakho uzoba neziphakamiso ze-AI eziboniswa ku-Q&A. <0/>";
$Definition[
    ...
    "Uma lesi silungiselelo sinikwe amandla, imininingwane yomsebenzisi kudatha ye-Analytics izokwenziwa ingaziwa ngokuzenzakalela, kuze kube yilapho umsebenzisi evuma amakhukhi e-Analytics. <0>Funda kabanzi</0>";
$Definition["Where is your Community Forum?"] =
    "Ikuphi iforamu yakho yomphakathi?";
$Definition['Who\'s Online Settings'] = 'Obani Ezilungiselelo ze-Inthanethi';
$Definition["Why am I seeing AI Suggested Answers?"] =
    "Kungani ngibona Izimpendulo Eziphakanyisiwe ze-AI?";
...
$Definition["Yes, the following information can be changed later."] =
    "Yebo, imininingwane elandelayo ingashintshwa ngokuhamba kwesikhathi.";
$Definition["You are connected as %s."] = "Uxhumeke njenge-%s.";
$Definition["You are not allowed to use suggestions"] =
    "Awuvunyelwe ukusebenzisa iziphakamiso";
$Definition["You are previewing the %s theme."] =
    "Uhlola isihloko se-%s.";
$Definition[
    "You can also ban the users that posted the spam and delete all of their posts."
] =
    "Bheka ibhokisi eliseduze nomsebenzisi othumele ogaxekile ukuze abavimbele futhi asuse konke okuthunyelwe kwabo. <b>Yenza lokhu kuphela uma unesiqiniseko sokuthi laba bangogaxekile.</b>";
$Definition['You can always use your password at<a href="%1$s">%1$s</a>.'] =
    'Uma ukhiyiwe ngaphandle kwesithangami sakho ungahlala ungene ngemvume usebenzisa i-imeyili ne-password yakho ye-Vanilla yangempela kwa <a href="%1$s">%1$s</a>';
$Definition[
    "You can ban IP addresses, email domains, and words from usernames using this tool."
] =
    "Ungavimbela amakheli we-IP, izizinda ze-imeyili, namagama amagama abasebenzisi usebenzisa leli thuluzi.";
$Definition[
    "You can customize the HTML and CSS for this theme on the %s page."
] = "Ungenza ngokwezifiso i-HTML ne-CSS ngalesi sihloko ekhasini le-%s.";
$Definition[
    "You can either create a new account, or enter your credentials if you have an existing account."
] =
    "Ungakha i-akhawunti entsha, noma ufake iziqinisekiso zakho uma une-akhawunti ekhona.";
$Definition["You can make the categories page your homepage."] =
    'Ungenza ikhasi lakho lezigaba libe ikhasi lakho lasekhaya <a href="%s">lapha</a> .';
$Definition[
    "You can search for users by username or email, wildcards are implied."
] = "Ungasesha abasebenzisi ngegama lomsebenzisi noma i-imeyili, amakhadi asendle ayashiwo.";
$Definition["You can specify an allow list of trusted domains."] =
    "Ungacacisa uhlu lwezizinda ezithenjwayo eziphephile ukuqondisa kabusha nokushumeka.";
$Definition["You can specify an allow list of trusted domains. (CSP)"] =
    "Ungacacisa uhlu lokuvumela lwezizinda ezithenjwayo (isb. yourdomain.com) okuphephile ukulayisha i-javascript kuzo.";
$Definition[
    'You cannot disable the %1$s plugin because the %2$s plugin requires it in order to function.'
] =
    'Awukwazi ukukhubaza i-plug ye-%1$s ngoba i-plug ye-%2$s iyidinga ukuze isebenze.';
$Definition[
    "You cannot remove the only remaining category that allows discussions"
] = "Awukwazi ukususa isigaba esisele kuphela esivumela izingxoxo";
$Definition[
    "You can protect your site with an HTTP username/password during development."
] =
    "Ungavikela isiza sakho ngegama lomsebenzisi / iphasiwedi ye-HTTP ngesikhathi sokuthuthuka.";
$Definition[
    "You can send emails in plain text by disabling the toggle below."
] = "Ungathumela ama-imeyili ngombhalo osobala ngokukhubaza ukuguquguquka okungezansi.";
$Definition["You have %s invitations left for this month."] =
    "Unezimemo ezingama-%s ezisele kule nyanga.";
$Definition["You have successfully saved interest: <0/>"] =
    "Ulondoloze ngempumelelo inzuzo: <0/>";
$Definition["You must be authenticated in order to use this form."] =
    "Kufanele ugunyazwe ukuze usebenzise leli fomu.";
$Definition["You must manually apply this rank."] =
    "Kufanele usebenzise lesi simo.";
$Definition["You must provide at least one recipient"] =
    "Kufanele unikeze okungenani umamukeli oyedwa";
$Definition["You must specify an admin password."] =
    "Kufanele uchaze iphasiwedi yokulawula.";
$Definition["You must specify an admin username."] =
    "Kufanele uchaze igama lomsebenzisi lokuphatha.";
$Definition[
    ...
    "Ifayela lakho lokulungiselela alinazo izimvume ezilungile. I-PHP idinga ukukwazi ukufunda nokubhala kuleli fayela: <code>%s</code>";
$Definition['Your default locale won\'t display properly'] =
    'Indawo yakho ezenzakalelayo ngeke iboniswe kahle kuze kube inikezwe amandla ngezansi. Sicela unike amandla okulandelayo: %s.';
...
$Definition["Your invitations were sent successfully."] =
    "Izimemo zakho zithunyelwe ngempumelelo.";
...
$Definition[
    ...
    "Ushiya isihleli setimu ngaphandle kokugcina izinguquko zakho. Qiniseka ukuthi izibuyekezo zakho ziyagcinwa ngaphambi kokuphuma.";
$Definition[
    "You are leaving the Email Settings page without saving your changes. Make sure your updates are saved before exiting."
] =
    "Ushiya ikhasi lezilungiselelo ze-imeyili ngaphandle kokulondoloza izinguquko zakho. Qiniseka ukuthi izibuyekezo zakho zilondoloziwe ngaphambi kokuphuma.";
