...
$Definition['This role is personal info. Only users with permission to view personal info will see it.'] = 'Esta função é informação pessoal. Apenas utilizadores com permissão para visualizar informações pessoais vão ver essas informações.';
$Definition['This setting loads the page before executing Javascript.'] = 'Esta definição carrega a página antes de executar Javascript, o que pode melhorar o seu SEO.<br><strong>**Aviso: ativar esta funcionalidade pode causar erros de Javascript no seu site.**</strong>';
