...
$Definition["%s user(s) will be affected by this action."] =
    "%s felhasználó(k)ra hatással lesz ez a műveletet.";

$Definition["<0/> will suggest answers on Q&A posts"] =
    "A(z) <0/> válaszokat javasol a kérdezz-felelek bejegyzésekre";
$Definition["<0 /> will not suggest answers on Q&A posts"] =
    "A <0 /> nem javasol válaszokat a kérdezz-felelek bejegyzésekre";
...
$Definition["1 in 5 is recommended for most communities."] =
    "A legtöbb közösség számára az 5-ből 1 ajánlott.";
$Definition["1 in 20 is recommended for most communities."] =
    "A legtöbb közösség számára 20-ból 1 ajánlott.";
...
] = 'Elérte a maximális bejelentkezési kísérletet. Kérjük, várjon %s, és próbálja újra.';
...
$Definition["A unique label name that cannot be changed once saved."] =
    "Egyedi címkenév, amely mentés után nem módosítható.";
...
$Definition['"Accept Answer" if a suggestion answers your question.'] =
    '„Accept Answer” (Válasz elfogadása), ha egy javaslat választ ad kérdésére.';
...
$Definition["Accepted answer pageview ratio representing a deflected case"] =
    "Elfogadott válaszok oldalmegtekintési aránya, amely eltérített esetet jelent";
...
$Definition["Add a new Pocket to your site."] =
    "Új Pocket hozzáadása a weboldaladhoz.";
$Definition[
    ...
    "Adjon hozzá egy Zoom hivatkozást vagy értekezletazonosítót, hogy összekapcsolja ezt az eseményt a Zoommal, és engedélyezze az egykattintásos regisztrációt és csatlakozási gombokat. Ne feledje, ha az esemény regisztrációhoz kötött, az esemény létrehozása után nem frissítheti a megbeszélés azonosítóját vagy linkjét.";
...
$Definition[
    ...
    "Adj meg adatokat az email cím honnan mezőjébe, hogy segítséget nyújtson válaszoláskor (javasolt).";
...
$Definition[
    ...
    "Adja hozzá egyéni Kaltura-domainje(ke)t, hogy a linkeket beágyazott videókká alakítsa a beszélgetésekben, megjegyzésekben vagy cikkekben.";
$Definition[
    "Add your custom Kaltura domain(s) to transform links into embedded videos in posts, comments or articles."
] =
    "Adja hozzá egyéni Kaltura-domainje(ke)t, hogy a hivatkozásokat beágyazott videókká alakítsa bejegyzésekben, megjegyzésekben vagy cikkekben.";
...
$Definition[
    ...
    "Az AI Suggested Answers javasolt válaszokat ad a közösségi bejegyzések és a kapcsolódó tudásbázisok alapján. Ezt bármikor be- vagy kikapcsolhatja profilbeállításainál.";
$Definition[
    "Alert users if they click a link in a post that will lead them away from the forum. "
] =
    "Értesíti a felhasználókat, ha egy bejegyzésben olyan hivatkozásra kattintanak, amely elvezeti őket a fórumról.";
...
$Definition["All discussions in this category will be permanently deleted."] =
    "Minden beszélgetés véglegesen törölve lesz ebben a ketgóriában.";
...
$Definition[
    ...
    "Minden felhasználói tartalom le lesz cserélve egy üzenettel, miszerint a felhasználó törölve lett.";
...
$Definition["Allow new users to be registered through email."] =
    "Engedélyezd, hogy új felhasználók emailen keresztül regisztráljanak.";
$Definition["Allow this connection to issue API access tokens."] =
    "Engedélyezze, hogy a kapcsolat API hozzáférési tokeneket adjon ki.";
$Definition["Allow Third-Party Script Execution"] =
    "Harmadik féltől származó szkript-végrehajtás engedélyezése";
$Definition["Allow users to change their own avatars"] =
    "Engedélyezze, hogy a felhasználók lecseréljék saját avatarjukat";
$Definition["Allow users to dismiss this message"] =
    "Tegye lehetővé, hogy a felhasználók mellőzzék ezt az üzenetet.";
...
$Definition["An enabled message will be visible on the site."] =
    "Egy engedélyezett  üzenet lesz látható az oldalon.";
$Definition["An answer in this the community thread was marked as accepted"] =
    "A válasz ebben a közösségi szálban elfogadottként lett megjelölve";
$Definition["An error occurred updating your privacy setting"] =
    "Hiba történt az adatvédelmi beállítás frissítésekor";
$Definition["Anonymize Analytics Data by Default"] =
    "Alapértelmezés szerint anonimizálja az Analytics-adatokat";
$Definition["Answers is not available if you have not accepted cookies."] =
    "A válaszok nem érhetők el, ha nem fogadta el a cookie-kat.";
$Definition["API"] = "API";
...
$Definition["Applicant Role"] =
    "Válaszd ki a szerepkört, amit új jelentkezőkhöz rendelünk hozzá. Ennek csak akkor van jelenősége, ha a regisztrációs mód az: <b>jóváhagyás</b>.";
...
$Definition["Are you sure you want to delete %s items forever?"] =
    "Biztos, hogy örökre törölni akarsz %s elemet?";
$Definition["Are you sure you want to delete 1 item forever?"] =
    "Biztos, hogy örökre törölni akarsz 1 elemet?";
$Definition[
    "Are you sure you want to delete this badge? This is irreversible and will revoke the badge from all users who have it."
] =
    "Biztos, hogy törölni akarod ezt a plecsnit? Vissza nem fordítható folyamat, aminek a végén az összes felhasználótól visszavonásra kerül a plecsni, akinek a birtokában van.";
$Definition["Are you sure you want to delete this category?"] =
    "Biztos, hogy törölni akarod ezt a kategóriát?";
$Definition["Are you sure you want to restore %s items?"] =
    "Biztos, hogy helyre akarsz állítani %s elemet?";
$Definition["Are you sure you want to restore 1 item?"] =
    "Biztos, hogy helyre akarsz állítani 1 elemet?";
$Definition[
    "Are you sure you want to turn off all AI Suggested Answers? You can undo this in your profile settings at anytime."
] =
    "Biztosan kikapcsolja az összes mesterséges intelligencia által javasolt választ? Ezt a profilbeállításokban bármikor visszavonhatod.";
...
] = "Legalább egy látható oszlop szükséges. Látható oszlop megjelenítése vagy hozzáadása.";
$Definition["A url-friendly version of the category name for better SEO."] =
    "A kategória nevének egy url-barát verziója a jobb SEO miatt.";
...
$Definition[
    ...
    "A funkció aktiválása előtt vegye figyelembe a következő lehetséges következményeket:";
...
$Definition["Bookmark a discussion using its star icon."] =
    "Könyvjelzőzz egy beszélgetést ezzel a csillag ikonnal.";
...
$Definition["Browse for a new banner logo if you would like to change it:"] =
    "Tallóz be egy új banner logot, ha meg szeretnéd változtatni:";
...
$Definition["Cannot build profile information if user is not defined."] =
    "Nem készíthetsz profil adatokat ha a felhasználó nem létezik.";
$Definition["Categories &amp; Discussions"] = "Kategóriák & Beszélgetések";
$Definition["Categories to Exclude from AI Answers"] =
    "Az AI-válaszokból kizárandó kategóriák";
$Definition["Categories are used to organize discussions."] =
    "A kategóriák segítenek az ön felhasználóinak csoportosítani a hozzászólásaikat, oly módon, hogy az jelentőséggel bírjon a csoportjuknak.";
$Definition["Categories are used to organize posts."] =
    "A kategóriák segítségével a felhasználók a közösséged számára értelmes módon rendszerezhetik bejegyzéseiket.";
$Definition["Categories allow you to organize your posts."] =
    "A kategóriák lehetővé teszik a bejegyzések rendszerezését.";
...
$Definition["Change the look of All Categories"] =
    'Megváltoztathatod az <b>Összes kategória</b> oldal kinézetét<a href="%s">here</a>.';
$Definition["Change the way that new users register with the site."] =
    "Itt megváltoztathatod a regisztráció típusát.";
$Definition["Change your banner"] = "Változtasd meg a bannered";
$Definition["Changing the Discussions Menu Link"] =
    "A Beszélgetések Menü linkjének a megváltoztatása";
$Definition["Check all permissions that apply for each role"] =
    "Minden jogot ellenőrizz, ami minden egyes szerepkörre vonatkozik";
$Definition["Check all permissions that apply to this role:"] =
    "Nézz meg minden jogosultságot ehhez a feladathoz:";
...
$Definition["Check out the full list of video tutorials here."] =
    "Nézd meg itt az összes oktatóvideó listáját.";
...
$Definition["Click here to carry on to your dashboard"] =
    " az irányítópulton való folytatáshoz kattints ide";
...
$Definition["Configuration settings for password fields in Vanilla"] =
    "A Vanilla jelszómezőinek konfigurációs beállításai";
$Definition["Configure custom Kaltura domains"] =
    "Egyéni Kaltura tartományok konfigurálása";
$Definition["Configure how nested categories are displayed to users."] =
    "Állítsd be, hogyan lássák a felhasználók a beágyazott kategóriákat.";
$Definition['Configuring Vanilla\'s Homepage'] =
    'A Vanilla honlapjának beállítása';
$Definition["Confirmation  Body"] = "Megerősítés törzs";
$Definition["Confirm email addresses"] =
    "Megköveteli, hogy a felhasználók erősítsék meg az email címüket (javasolt)";
...
$Definition[
    ...
    "Lépjen kapcsolatba a Vanilla Staff-al, hogy engedélyezze a kérdések és válaszok webhely konfigurációját. Ezután engedélyezze a Kérdések és válaszok bővítményt az irányítópult Kiegészítők részében.";
$Definition[
    ...
    "Lépjen kapcsolatba a Vanilla Staff-al, hogy engedélyezze a kérdések és válaszok webhely konfigurációját. Ezután engedélyezze a Kérdések és válaszok bővítményt az irányítópult <0/> részében.";
$Definition["Content Curation"] = "Tartalomgondozás";
$Definition["Content flagged as spam is stored here for moderator review."] =
    "Itt tároljuk a spamként megjelölt tartalmat a moderátori felülvizsgálathoz.";
...
$Definition[
    ...
    "Ha a kezdeti szkriptek sérülnek, sérülékenységet okozhat, például a Cross-Site Scripting (XSS).";
$Definition['Could not find a theme identified by \'%s\''] =
    'Nem találok \'%s\'-ként azonosított témát';
$Definition["Could not instantiate mail function."] =
    "Nem tudtam példányosítani az email funkciót.";
...
$Definition["Could not open addon file. Addons must be zip files."] =
    "Nem tudtam az addon file-t megynitni. Az addon-nak zip file-nak kell lennie.";
$Definition["Create & organize discussion categories and manage your users."] =
    "Beszélgetési kategóriák létrehozása és rendszerezése, felhasználók karbantartása.";
...
$Definition["Disabled: The pocket will <b>not</b> be displayed."] =
    "Letiltva: A zseb <b>nem</b> fog megjelenni.";
...
$Definition["Do not display the categories in the side panel."] =
    "Ne jelenítsd meg a kategóriákat az oldalpanelen.";
...
$Definition[
    ...
    "Az Email Digest Prompt Widget akkor lesz elérhető, ha az Email Digest engedélyezve van.";
...
$Definition[
    ...
    "Az e-mail kivonatokat minden héten a kiválasztott napon küldjük el. A beállított nap módosításai a következő héten lépnek életbe.";
...
$Definition["Embedding is currently DISABLED."] =
    "A beágyazás jelenleg LE VAN TILTVA.";
$Definition["Embedding is currently ENABLED."] =
    "A beágyazás jelenleg ENGEDÉLYEZVE van.";
...
$Definition["Enable admin checkboxes on discussions and comments."] =
    "Adminisztrátori kijelölés engedélyezése beszélgetéseken és hozzászólásokon, pl. csoportos törléshez.";
$Definition["Enable checkboxes on discussions and comments"] =
    "Jelölőnégyzetek engedélyezése beszélgetésekben és megjegyzésekben";
$Definition['Enabled %1$s'] = 'Engedélyezett %1$s';
$Definition["Enabled: The pocket will be displayed."] =
    "Engedélyezett: A zseb meg lesz jelenítve";
$Definition["Enable HTML emails"] = "HTML e-mailek engedélyezése";
$Definition["Enable embedding to use blog comments."] =
    "Hogy ez működhessen, engedélyezned kell a beáagyazást.";
...
$Definition["Enable link embeds in discussions and comments"] =
    "Engedélyezze linkek beágyazását beszélgetésekbe és megjegyzésekbe";
$Definition["Enable link embeds in posts and comments"] =
    "Engedélyezze a hivatkozások beágyazását a bejegyzésekben és megjegyzésekben";
...
$Definition["Enable sending notification emails"] =
    "Értesítési e-mailek küldésének engedélyezése";
...
$Definition["Enable to only show posts from categories a user follows."] =
    "Engedélyezze, hogy csak a felhasználó által követett kategóriák bejegyzései jelenjenek meg.";
$Definition[
    "Enable to get a preview of our new user management dashboard with improved search and new configuration options."
] =
    "Engedélyezze, hogy megtekinthesse új felhasználókezelési irányítópultunkat, továbbfejlesztett kereséssel és új konfigurációs lehetőségekkel.";
...
$Definition[
    ...
    "A funkció engedélyezése módosítja a tartalombiztonsági házirendjét, hogy megbízzon az egyéni szkriptek által függőségként bevitt további szkriptekben.";
$Definition[
...
$Definition["Encourage your friends to join your new community!"] =
    "Bátorítsd barátaid, hogy csatlakozzanak az új közösségedhez!";
$Definition["Enter a comma-delimited list of indexes, starting at 1."] =
    "Adj meg vesszővel elválasztott, 1-gyel kezdődő indexeket.";
...
$Definition["Enter the email address of the person you would like to invite:"] =
    "írd be annak az embernek az email címét akit meg akarsz hívni.";
$Definition[
    "Enter the url to the page you would like to use as your homepage"
] = "Add meg azt az urlt, amit a honlapodként fogunk használni";
$Definition[
    "Enter the url to the page you would like to use as your homepage:"
] = "Add meg azt az urlt, amit a honlapodként fogunk használni:";
$Definition["Error sending email. Please review the addresses and try again."] =
    "Hiba az e-mail küldésekor. Kérjük ellenőrizze a címeket és próbálkozzon újra.";
...
$Definition["Exclude archived discussions from the discussions list"] =
    "Ne listázd az archivált beszélgetéseket";
$Definition["Existing members send invitations to new members."] =
    "Az új felhasználó egy meglévő felhasználó meghívója által tud regisztrálni a fórumra.";
...
$Definition[
    ...
    "A külső keresés a Vanilla's out of the box keresést egy általad választott, harmadik féltől származó keresési szolgáltatóra cseréli.";
...
$Definition["FaviconBrowse"] =
    "Tallózd be az új favicont, amit használni szeretnél:";
$Definition["FaviconDescription"] =
    "Az ön webhelyének ikonja megjelenik a böngésző címsorában. Megfelelően kicsinyítésre kerül.";
...
$Definition[
    ...
    "Például a sajatdomain.com, a www.sajatdomain.com és a help.yourdomain.com engedélyezéséhez a *.sajatdomain.com hozzáadása szükséges.";
$Definition["Force the forum to only be accessible through this url"] =
    "Kényszerítsd a fórumot, hogy csak ezen az url-en keresztül lehessen elérni";
$Definition["Force your forum to be viewed through the Remote Url"] =
    "Kényszerítsd a fórumot, hogy csak a Távoli Url-en keresztül lehessen megtekinteni";
...
$Definition["Full post in email notifications"] =
    "Teljes bejegyzés e-mailben";

$Definition["Garden"] = "Garden";
$Definition["Garden.api.ssoIDPermission.description"] =
    "Az ezzel az engedéllyel rendelkező szerepek kibonthatják az SSO azonosítókat API v2 hívásokban.";
...
$Definition[
    ...
    "Javaslatok generálása. Értesítést kap, amikor készen állnak az Ön áttekintésére.";
...
$Definition[
    ...
    "Üdv. Én vagyok az Ön mesterséges intelligencia-javasló asszisztense, és segítek Önnek megfelelő cikkek és bejegyzések megtalálásában, hogy megválaszolja kérdéseit. Bármilyen kérdésed van, nyugodtan tedd fel.";
$Definition["guest"] = "vendég";
$Definition["Guest roles"] =
    "Ellenőrizz minden szerepkört, amit vendégekhez hozzá kell rendelni.";

$Definition["Hash Algorithm"] = "Hash algoritmus";
$Definition["HeadlineFormat.AddUser"] =
    "{ActivityUserID,user} adott {RegardingUserID,user}-nak egy fiókot.";
$Definition["HeadlineFormat.PictureChange"] =
    "{RegardingUserID,You} megváltoztatta {ActivityUserID,your} profil képét.";
$Definition["HeadlineFormat.RegistrationApproval"] =
    "{ActivityUserID,user} jóváhagyta {RegardingUserID,user} jelentkezési kérelmét.";
...
$Definition["Hide discussions from Recent Discussions and Widgets."] =
    "A beszélgetések elrejtése a Legutóbbi beszélgetésekből és a modulokból.";
$Definition["Hide posts from Recent Posts Page and Widgets."] =
    "Bejegyzések elrejtése a Legutóbbi bejegyzések oldalról és a modulokról.";
...
$Definition["Hide signatures on embedded comments"] =
    "Aláírás elrejtése idézett hozzászólásoknál";
...
$Definition["How the content is going to be filtered."] =
    "Hogyan történik a tartalom szűrése.";
...
$Definition[
    ...
    "Ez azonban fokozott felelősséggel jár webhelye biztonságának biztosításában.";
$Definition["Html"] = "HTML";
$Definition["HTML Emails"] = "HTML e-mailek";
$Definition["HTTP Strict Transport Security (HSTS) Settings"] =
    "HTTP Strict Transport Security (HSTS) beállítások";
...
$Definition["If left empty, Email Logo is used."] =
    "Ha üresen hagyja, az E-mail logó kerül felhasználásra.";
$Definition[
    ...
    "Ha a fenti „Felhasználási feltételekre mutató hivatkozás” részben belső dokumentumra mutató hivatkozás található, akkor a „Felhasználási feltételek szövege” szöveget a rendszer figyelmen kívül hagyja. Távolítsa el a hivatkozást, ha ezt a szöveget szeretné használni.";
...
$Definition["Include full post in email notifications"] =
    "Szerepelje a teljes bejegyzés az értesítésekben";
...
$Definition["Include featured images with posts in email digest"] =
    "Kiemelt képeket a bejegyzésekkel együtt az e-mail-összefoglalóban";
$Definition["Include internal profile fields"] =
    "Tartalmazza a belső profilmezőket";
$Definition["Include private profile fields"] =
    "Tartalmazza a privát profilmezőket";
...
$Definition["Install Vanilla without a .htaccess file."] =
    "Vanilla telepítése .htaccess file nélkül.";
...
$Definition["It looks like you edited your post. <0/> or <1/>."] =
    "Úgy tűnik, szerkesztetted a bejegyzésedet. <0/> vagy <1/>.";
...
$Definition["Large images will be scaled down."] =
    "A nagy méretű kép le lesz kicsinyítve maximum %spx szélességre és maximum %spx magasságra.";
...
$Definition["Make sure you select at least one item before continuing."] =
    "Legalább egy elemet válassz ki, mielőtt folytatnád.";
$Definition["Add your site to trusted domains."] =
    "Győződj meg róla, hogy oldalad  %s része legyen, amikor a beágyazás engedélyezve van.";
...
$Definition["Manage Suggested Answer Sources"] =
    "A javasolt válaszforrások kezelése";
...
$Definition["Mark All Suggested Answers as Accepted"] =
    "Jelölje meg az összes javasolt választ elfogadottként";
...
$Definition["Member roles"] =
    "Ellenőrizd le az összes szerepkört, amit új/jóváhagyottt felhasználóhoz kell hozzárendelni.";
...
$Definition["Moderators have permission to edit most content."] =
    "A moderátoroknak a legtöbb tartalom szerkesztéséhez van joguk.";
...
$Definition[
    ...
    "Összetettebb nyelvezet, és bevezethet néhány iparág-specifikus kifejezést, de a legtöbb ember számára mégis érthető.";
...
$Definition[
    ...
    "Technikai nyelvezet és iparág-specifikus kifejezések – a téma magasabb szintű megértését/ismeretét feltételezi.";
$Definition["more than %s deep"] = "több, mint %s mély";
$Definition['Most pockets shouldn\'t be displayed in the dashboard.'] =
    'A legtöbb zsebet nem lenne szabad a vezérlőpulton megjeleníteni.';
$Definition["Move discussions in this category to a replacement category."] =
    "Mozgasd át a kategórián belüli beszélgetéseket egy csere kategóriába.";
...
$Definition["Never - Users Must Refresh Page"] =
    "Sosem - Felhasználónak kell frissítenie az oldalt";
$Definition["Never display on mobile browsers."] =
    "Sose jelenítsd meg mobil böngészőkön.";
...
$Definition["New users are only registered through SSO plugins."] =
    "Az új felhasználókat csak SSO modulokon keresztül lehet regisztrálni.";
$Definition[
    'New users are reviewed and approved by an administrator (that\'s you!).'
] = 'Új felhasználókat egy adminisztrátor hagyja jóvá!(az te vagy!).';
$Definition[
    "New users fill out a simple form and are granted access immediately."
] = "Az új felhasználók kitöltenek egy egyszerű űrlapot és azonnal használhatják a fórumot.";
...
$Definition["No item options are available for Link display type."] =
    "A hivatkozás megjelenítési típusához nem érhetők el elemopciók.";
...
$Definition["Notifications will appear here."] =
    "Az értesítések itt fognak megjelenni.";
$Definition["NotifyApplicant"] =
    "Értesítsenek, ha valaki jelentkezik tagnak.";
$Definition["Notify me when people comment on a discussion."] =
    "Értesítsenek, ha hozzászólnak egy beszélgetéshez";
$Definition["Notify me when my questions have AI Suggested Answers"] =
    "Értesítsen, ha kérdéseimre mesterséges intelligencia javasolt válaszok érkeznek";
$Definition["Notify me when people start new discussions."] =
    "Értesítsenek, ha új beszélgetés indul";
...
$Definition["Number of blocked registrations"] =
    "Zárolt regisztrációk száma";
$Definition["Number of days before a follow-up email is automatically sent."] =
    "Az utólagos e-mail automatikus elküldése előtti napok száma.";
...
$Definition["Number input must be between 1 and 100."] =
    "A számbevitelnek 1 és 100 között kell lennie.";
...
$Definition["Only display on mobile browsers."] =
    "Csak mobil böngészőkön jelenjen meg.";
$Definition[
    ...
    'Csak azok a mezők érhetők el, amelyek egyetlen jelölőnégyzetet, egyszeri kijelölésű legördülő listát, több kijelölésű legördülő listát vagy numerikus legördülő listát tartalmaznak. Miután kiválasztotta a mezőket, azok lent jelennek meg, így minden profilmezőhöz konkrét válaszokat választhat.';
...
$Definition["Only visible to users with roles with permission."] =
    "Csak engedéllyel rendelkező szerepkörökkel rendelkező felhasználók számára látható.";
$Definition[
    "Open cases will only display if the user has a valid Salesforce connection."
] =
    "A nyitott tokok csak akkor jelennek meg, ha a felhasználó érvényes Salesforce kapcsolattal rendelkezik.";
...
$Definition["Or select an image on your computer (2mb max)"] =
    "Vagy válassz egy képet számítógépedről (max. 2mb)";
...
$Definition["Pageview ratio representing a deflected case"] =
    "Az oldalmegtekintési arány eltérített esetet jelent";
...
$Definition["Please enter a unique API Label, this one has been used before"] =
    "Kérjük, adjon meg egy egyedi API-címkét, ezt korábban használták";
...
$Definition[
    ...
    "Lehetséges kompatibilitási problémák régebbi böngészőkkel, amelyek befolyásolják a felhasználói élményt.";
...
$Definition[
    ...
    "A protokollokat (pl. https://) és útvonalakat (pl. yourdomain.com/some/path) ki kell hagyni.";
...
$Definition[
    ...
    "Az ajánlott méretek 400 x 300 képpont vagy kisebbek, hasonló arány mellett.";
...
$Definition["Registration is currently closed."] =
    "Figyelem - A regisztráció jelenleg le van zárva.";
$Definition["Reload the page to see recent updates."] =
    "Töltse be újra az oldalt a legutóbbi frissítések megtekintéséhez.";
$Definition["Reload the page to access recent updates."] =
    "Töltse be újra az oldalt a legutóbbi frissítések eléréséhez.";
...
$Definition["RolePersonalInfo"] =
    "Ez a szerep egy személyes adat. Csak a személyes adatok megnézési engedélyével rendelkező felhasználók láthatják.";
$Definition["Roles & Permissions"] = "Szerepkörök és jogosultságok";
$Definition['Roles determine user\'s permissions.'] =
    "Az oldal minden felhasználójához legalább egy szerepkör hozzá lesz rendelve. A szerepkörök határozzák meg, hogy az oldal egy felhasználója mire képes és mire nem.";
...
$Definition["Search by user or role."] =
    "Keress felhasználókat név vagy e-mail szerint, opcionálisan helyettesítőként használható a %. Kereshetsz felhasználóazonosító, a szerep neve vagy “tiltás” alapján is.";
...
$Definition["Select the location of the pocket."] =
    "Válaszd ki a zseb helyét.";
$Definition[
    "Select which columns are displayed on the manage users page list."
] = "Válassza ki, hogy mely oszlopok jelenjenek meg a felhasználók kezelése oldallistán.";
$Definition["Selection will affect the item options available."] =
    "A kiválasztás befolyásolja az elérhető tétel opciókat.";
...
$Definition[
    ...
    "Küld megerősítő emailt ha feltesznek egy kérdést vagy beszélgetést kezdenek emailben.";
...
$Definition['Separate each word with a semi-colon ";"'] =
    'Válasszon el minden szót pontosvesszővel „ ; ”';
$Definition[
    "Set this interest as default to suggest following its mapped categories and tags to all users."
] =
    "Állítsa be ezt az érdeklődési kört alapértelmezettként, hogy minden felhasználónak javasolja a hozzárendelt kategóriák és címkék követését.";
...
] = "Mutasson minden felhasználónak személyre szabott listát az általuk létrehozott vagy pozitív szavazatokkal rendelkező ötletekről.";
...
] = "Az itt kiválasztott források elérhetők lesznek az AI Javasolt válaszok számára.";
$Definition["Specify one domain per line. Use * for wildcard matches."] =
    "Határozz meg soronként egy domént. Használd a *-ot a helyettesítő egyezésekhez.";
...
$Definition["SSO roles are always passed through SSO."] =
    "Az egyszeri bejelentkezés szerepei mindig az egyszeri bejelentkezésen keresztül kerülnek átadásra.";
...
$Definition[
    ...
    "Indítsa el a kivonat tárgysorát a [Szalaghirdetés címe] beállítással a Megjelenés > Márkaépítés és keresőoptimalizálás menüpontban";
...
$Definition[
    ...
    "Az összes e-mail stílusa és általános vizuális megjelenése, beleértve az e-mailek kivonatát is, az egész webhelyen beállítható az E-mail beállítások oldalon.";
...
$Definition["Suggestions are only visible to you until you accept the answer"] =
    "A javaslatokat csak Ön láthatja, amíg el nem fogadja a választ";
$Definition["Suggestions may only be generated on questions"] =
    "Javaslatok csak kérdésekre generálhatók";
...
$Definition["The first line of content in the email digest after the title."] =
    "A tartalom első sora az e-mail kivonatban a cím után.";
$Definition["The homepage title is displayed on your home page."] =
    "A kezdőlap címe megjelenik a kezdőlapon. Válassz olyan címet, amit a keresőoldalakon is látni szeretnél.";
$Definition["The homepage was saved successfully."] =
    "A honlap sikeresen mentve lett.";
$Definition["The invitation was removed successfully."] =
    "A meghívást sikeresen töröltük.";
$Definition["The invitation was sent successfully."] =
    "A meghívást sikeresen elküldtük.";
$Definition["The Key in the XML payload to designate %s."] =
    "Az XML hasznos teher kulcsa az %s kijelöléséhez.";
$Definition[
    "The test digest will generate content as if it were this user receiving the digest."
] =
    "A teszt kivonat úgy generál tartalmat, mintha ez a felhasználó kapná meg a kivonatot.";
...
$Definition[
    ...
    "Már van fiók ezzel az email címmel a fórumban. Hozz új fiókot létre, vagy add meg a hitelesítő adatait a létező fióknak.";
$Definition["The next three email digest delivery dates"] =
    "A következő három e-mail kivonat kézbesítési dátuma";
$Definition["The secret secures the sign in process."] =
    "A titok biztosítja a bejelentkezési folyamatot. <b>NE</b> add meg azt senki másnak.";
$Definition["The site description usually appears in search engines."] =
    "Az oldal leírása általában megjelenik a keresőmotorokban. Próbálj legalább 100–150 karakter hosszú leírást megadni.";
$Definition["The site is currently undergoing scheduled maintenance."] =
    "Az oldal jelenleg időzített karbantartás alatt van.";
$Definition["The specified url code is already in use by another category."] =
    "A megadott url kódot egy másik kategóriában mar használják.";
$Definition["The structure was successfully executed."] =
    "A szerkezet sikeresen végre lett hajtva.";
$Definition["The update was not successful."] =
    "A frissítés nem volt sikeres.";
...
$Definition["The url that users go to to register for a new account."] =
    "Az url ahová a felhasználók mennek, hogy új fiókért regisztráljanak.";
$Definition["The url that users use to register for a new account."] =
    "Az url, ahol a felhasználól új fiókért regisztrálnak.";
$Definition["The url that users use to sign in."] =
    "Az url, ahol a felhasználók bejelentkeznek.";
$Definition["The URL where users can sign up for new accounts on your site"] =
    "Az URL, ahol a felhasználók az oldaladon új fiókért jelentkezhetnek";
$Definition["The URL where users sign in on your site"] =
    "Az URL, ahol a felhasználók az oldaladra bejelentkeznek";
$Definition["The URL where users sign out of your site"] =
    "Az URL, ahol a felhasználók az oldaladról kijelentkeznek";
$Definition["The user and all related content has been deleted."] =
    "A felhasználó és az összes hozzá kapcsolódó tartalom törölve lett.";
$Definition["The user content will be completely deleted."] =
    "A felhasználói tartalom teljesen törölve lesz.";
$Definition["The user content will remain untouched."] =
    "A felhasználói tartalom nem lesz módosítva.";
...
$Definition[
    ...
    "Ez a legtöbb webhelyen nem szükséges, kivéve azokat, amelyek olyan funkciókat használnak, mint az AdSense és a Google Címkekezelő.";
$Definition[
    ...
    "Ez egy mesterséges intelligencia által generált összefoglaló a hivatkozott vitabejegyzésből, amely választ adhat a kérdésre. Az összefoglaló úgy jön létre, hogy az elfogadott válaszként használható legyen.";
$Definition["This category has custom permissions."] =
    "A kategória egyedi jogosultságokkal rendelkezik.";
$Definition["This category is archived."] = "A kategória archivált.";
$Definition["This connection is in test-mode."] =
    "A kapcsolat teszt üzemmódban van.";
$Definition["This controls how the responses are phrased and spelled."] =
    "Ez szabályozza a válaszok megfogalmazását és helyesírását.";
$Definition["This Database"] = "Ez az adatbázis";
$Definition["QnAFollowup.Feature.Enabled"] =
    "Ez a szolgáltatás e-maileket küld azoknak a válaszoknak a szerzőire, amelyek nem fogadnak el elfogadott választ.";
$Definition["This forum is currently set to invitation only mode."] =
    "A fórum jelenleg csak maghívásos alapon működik.";
$Definition[
    'This image will be used in category lists and widgets when using the "Icon" style option.'
] =
    'Ezt a képet a rendszer a kategórialistákban és a widgetekben fogja használni az „Ikon” stílusopció használatakor.';
$Definition[
    ...
    'Ez a kép megjelenik a kategória szalaghirdetésében és a kategóriamodulokban, ha a „Kép” és/vagy a „Háttér” stílusbeállításokat használja. Az ajánlott méret körülbelül 1000 x 400 képpont vagy hasonló arány.';
$Definition["This is a parent category that does not allow discussions."] =
    "Ez egy olyan szülő kategória, ami nem engedélyez beszélgetéseket.";
$Definition['This is the first time you\'ve visited the discussion forums.'] =
    'Ez az első alkalom, hogy a meglátogattad a fórumot.';
$Definition[
    "This may be used to include content such as organization name and address in the email digest."
] =
    "Ez felhasználható olyan tartalom felvételére, mint a szervezet neve és címe az e-mail kivonatba.";
$Definition["This name will be shown in the community."] =
    "Ez a név megjelenik a közösségben.";
$Definition["This page requires Javascript."] =
    "Az oldalhoz Javascript kell.";
...
] = "Ez a téma nem törölhető, mert ez a jelenleg használt téma.";
$Definition["This theme has additional options."] =
    "A téma további beállításokkal rendelkezik a %s oldalon.";
$Definition["This theme has customizable text."] =
    "Ebben a témaban személyre szabható szöveg van.";
$Definition[
    ...
    "Ezzel gyorsabban elvezeti a hasonló kérdésekkel rendelkező felhasználókat a megfelelő válaszokhoz, és megjeleníti az AI javasolt választ, és linkeli a hivatkozott anyagot, hogy más felhasználók is láthassák. A javaslatokat csak Ön láthatja, amíg el nem fogadja a választ.";
...
$Definition["Truncate the initial discussion text to this many words."] =
    "A beszélgetés kezdő szövegének lerövidítése ennyi szóra.";
...
$Definition["Up to a maximum of 100 items may be displayed."] =
    "Legfeljebb 100 elem jeleníthető meg.";
...
$Definition["Use an SMTP server to send email"] =
    "Használj SMTP szervert email küldésére";
$Definition["Use asterisks for wildcards"] =
    'Helyettesítő karakterként használj csillagot, például: "*@gmail.com"';
...
$Definition["Use categories to organize discussions"] =
    "Használj kategóriákat a beszélgetések rendszerezésére";
$Definition["Use Facebook names for usernames."] =
    "Használj Facebook neveket felhasználói nevekhez.";
...
$Definition[
    ...
    "Erősen technikai nyelvezetet és iparág-specifikus kifejezéseket használ, amelyek azok számára készültek, akik mélyen ismerik a témát.";
$Definition[
    "Uses industry-specific terms where necessary, but also provides explanations of definitions to ensure clarity."
] =
    "Szükség esetén iparág-specifikus kifejezéseket használ, de magyarázatot is ad a definíciókra az egyértelműség érdekében.";
$Definition[
    "Uses simple, everyday language that anyone can understand, regardless of their background or expertise."
] =
    "Egyszerű, hétköznapi nyelvezetet használ, amelyet bárki megérthet, függetlenül a hátterétől és szakértelmétől.";
$Definition["UserDeleteMessage"] =
    'Töröld a felhasználót és szüntesd meg az összes felhasználói tartalmat. Ez összefüggéstelen beszélgetéseket eredményezhet. A legjobb lehetőség spam törlésére.';
$Definition["UserDeletionPrompt"] =
    "Add meg, hogyan kezeljük %s felhasználói fiókjához tartozó összes tartalmat (kommentek, üzenetek, stb.).";
$Definition["UserKeep"] = "Felhasználói tartalom megőrzése";
$Definition["UserKeepMessage"] =
    'Töröld a felhasználót, de őrizd meg a felhasználói tartalmat.';
...
$Definition[
    ...
    "A felhasználók a kategóriákat követve feliratkozhatnak az új bejegyzésekről szóló értesítésekre. Válassza ki, hogy alapértelmezés szerint mely kategóriákat kell követnie az új felhasználóknak.";
$Definition["Users that get this reaction get %+d point."] =
    "Felhasználók, akik ezt a reakciót kapják, %+d pontot kapnak.";
...
$Definition[
    ...
    "A felhasználók nem lesznek, amikor megbízható doménnel egyező hivatkozást követnek.";
$Definition[
    "Users will be redirected to this URL after accepting an invitation."
] =
    "A felhasználók erre az URL-re lesznek átirányítva, miután elfogadják a meghívást. Ez lehet teljes URL vagy egy átirányító útvonal az oldalon.";
...
$Definition[
    ...
    'A felhasználókhoz ez a szerepkör lesz hozzárendelve, ameddig meg nem erősítik az email címüket.';
$Definition["Users with the no ads permission will not see this pocket."] =
    "A hirdetés nélküli engedéllyel rendelkező felhasználók nem fogják látni ezt a zsebet.";
$Definition["UserWipe"] = "Üres felhasználói tartalom";
$Definition["UserWipeMessage"] =
    'Töröld a felhasználót és cseréld le a felhasználó összes tartalmát egy üzenettel, miszerint a felhasználó törölve lett. Ez ad egy látható nyomot, hogy információ hiányzik.';
$Definition["Use the content at this url as your homepage."] =
    'Válaszd ki az oldalt, amit az emberek fognak látni, amikor ide látogatnak: <strong style="white-space: nowrap;">%s</strong>';
$Definition["Use Vanilla as a commenting system in your site"] =
    "Használd a Vanilla-t az oldalad hozzászólási rendszereként";
$Definition["Use weekly community email digest"] =
    "Használjon heti közösségi e-mail-összefoglalót";
$Definition["Untitled"] = "Névtelen";

$Definition["Value or Pattern"] = "Érték vagy minta";
$Definition["Vanilla.Archive.Description"] =
    "A bizonyos dátumnál idősebb beszélgetések automatikusan archiválhatók. Az archivált beszélgetések gyakorlatilag lezártnak tekintendők, nem lehet bennük új hozzászólást létrehozni.";
$Definition["Vanilla.Categories.MaxDisplayDepth"] =
    'Helyezd a beágyazott kategóriákat egy veszővel elválasztott listába, ha %1$s';
...
$Definition["View browser compatibility chart"] =
    "Tekintse meg a böngésző kompatibilitási táblázatát";
...
] = "Figyelmezteti a felhasználókat, ha egy bejegyzésben található hivatkozással elhagyják a fórumot.";
$Definition[
    "Warning: All of your data will be lost. Once you delete, there is absolutely no recovery of any kind."
] =
    "Figyelem: Minden adatod törlésre kerül. Törlés után semmilyen lehetőség nincs a helyreállításra.";
$Definition["Warning: deleting is permanent"] =
    "FIGYELEM: a törölt elemek eltűnnek erről a listáról és nem lehet őket helyreállítani.";
...
$Definition["We only accept urls that begin with http:// or https://"] =
    "Csak olyan url-eket fogadunk el, amik vagy http://-vel, vagy https://-sel kezdődnek";
$Definition[
    ...
    "Megpróbáljuk a helyik mail szervert használni alapértelmezettként email küldéséhez. Ha másik SMTP mail szervert szeretnél használni, itt beállíthatod.";
$Definition[
    ...
    "Üdvözöljük. Én vagyok az Ön mesterséges intelligencia-javaslat-asszisztense, egy gépi tanuláson alapuló eszköz, amelynek célja a releváns cikkek és bejegyzések megtalálása és javaslata az Ön kérdéseire válaszolva. Kérjük, írja meg kérdéseit, és megadom a legmegfelelőbb információt.";
$Definition['What\'s the Buzz?'] = 'Mi a helyzet?';
$Definition["When enabled, search result will open in a new browser tab."] =
    "Ha engedélyezve van, a keresési eredmény egy új böngészőlapon nyílik meg.";
$Definition[
    "When enabled, your community will have AI Suggestions shown in Q&A. <0/>"
] = "Ha engedélyezve van, közössége AI-javaslatokat jelenít meg a Kérdések és válaszok között. <0/>";
$Definition[
    ...
    "Ha ez a beállítás engedélyezve van, az Analytics-adatokban szereplő felhasználói adatok alapértelmezés szerint anonimizáltak mindaddig, amíg a felhasználó beleegyezik az Analytics cookie-k használatába. <0>További információ</0>";
$Definition["Where is your Community Forum?"] =
    "Hol van a közösségi fórumod?";
$Definition['Who\'s Online Settings'] = 'Ki Van Online beállítások';
$Definition["Why am I seeing AI Suggested Answers?"] =
    "Miért látok mesterséges intelligencia által javasolt válaszokat?";
...
$Definition["Yes, the following information can be changed later."] =
    "Igen, az alábbi információt meg lehet változtatni később.";
$Definition["You are connected as %s."] = "Kapcsolódva vagy %s-ként.";
$Definition["You are not allowed to use suggestions"] =
    "Nem használhat javaslatokat";
$Definition["You are previewing the %s theme."] =
    "A %s téma előnézeti képét nézed.";
$Definition[
    "You can also ban the users that posted the spam and delete all of their posts."
] =
    "Kapcsold be a dobozt a spamet posztoló user neve mellett, tiltsd ki és töröld az összes hozzászólását. <b>Csak azokkal tedd ezt meg, akik biztosan spamet küldenek.</b>";
$Definition['You can always use your password at<a href="%1$s">%1$s</a>.'] =
    'Ha valaha is kizárod magad a fórumodból, mindig bejelentkezhetsz  az eredeti Vanilla emaileddel és jelszavaddal az alábbi helyen: <a href="%1$s">%1$s</a>';
$Definition[
    "You can ban IP addresses, email domains, and words from usernames using this tool."
] =
    "Ezzel az eszközzel kitilthatsz IP címeket, email domaineket és felhasználói nevekből alkotott szavakat.";
$Definition[
    "You can customize the HTML and CSS for this theme on the %s page."
] = "Testre szabhatod a téma HTML és CSS részét a(z) %s oldalon.";
$Definition[
    "You can either create a new account, or enter your credentials if you have an existing account."
] =
    "Létrehozhatsz egy új fiókot, vagy megadhatod egy meglévő fiók hitelesítési adatait.";
$Definition["You can make the categories page your homepage."] =
    'Beállíthatod a kategória oldalt a honlapodnak <a href="%s">az alábbi helyen</a>.';
$Definition[
    "You can search for users by username or email, wildcards are implied."
] = "A felhasználókat felhasználónév vagy e-mail-cím alapján keresheti, a helyettesítő karakterek használata esetén.";
$Definition["You can specify an allow list of trusted domains."] =
    "Megadhatja azoknak a megbízható tartományoknak a listáját, amelyek biztonságosak az átirányításokhoz és a beágyazásokhoz.";
$Definition["You can specify an allow list of trusted domains. (CSP)"] =
    "Megadhat egy listát azokról a megbízható tartományokról (pl. yourdomain.com), amelyekről biztonságos a JavaScript betöltése.";
$Definition[
    'You cannot disable the %1$s plugin because the %2$s plugin requires it in order to function.'
] =
    'Nem tilthatod le a %1$s modult, mert a %2$s modulnak szüksége van rá a működéshez.';
$Definition[
    "You cannot remove the only remaining category that allows discussions"
] = "Nem törölheted az egyetlen megmaradt kategóriát, amiben lehet beszélgetéseket létrehozni.";
$Definition[
    "You can protect your site with an HTTP username/password during development."
] =
    "Webhelyedet védheted a fejlesztés alatt egy HTTP felhasználónévvel / jelszóval ";
$Definition[
    "You can send emails in plain text by disabling the toggle below."
] = "Egyszerű szöveggel is küldhet e-maileket ha ezt kikapcsolja lent.";
$Definition["You have %s invitations left for this month."] =
    "Neked %s bs meghívód maradt erre a hónapra";
$Definition["You have successfully saved interest: <0/>"] =
    "Sikeresen elmentette a kamatot: <0/>";
$Definition["You must be authenticated in order to use this form."] =
    "Figyelem - Elöbb hitelesítened kell magad, hogy használhasd a fórumot.";
$Definition["You must manually apply this rank."] =
    "Kézzel kell ezt a rangot megadnod.";
$Definition["You must provide at least one recipient"] =
    "Legalább egy címzettet meg kell adnod";
$Definition["You must specify an admin password."] =
    "Meg kell adnod egy admin felhasználói jelszót.";
$Definition["You must specify an admin username."] =
    "Meg kell adnod egy admin felhasználói nevet.";
$Definition[
    ...
    "Nincs megfelelő jogosultsága a konfigurációs file-odnak. A PHP-nek szüksége van arra, hogy olvasni és írni tudja az alábbi file-t: <code>%s</code>";
$Definition['Your default locale won\'t display properly'] =
    'Az alapértelmezett nyelvi csomag nem fog helyesen megjelenni, csak ha engedélyezed. Kérlek engedélyezd az alábbit: %s.';
...
$Definition["Your invitations were sent successfully."] =
    "A meghívód sikeresen el lett küldve.";
...
$Definition[
    ...
    "A változások mentése nélkül készül bezárni a témaszerkesztőt. A kilépés előtt mentse el a módosításokat.";
$Definition[
    "You are leaving the Email Settings page without saving your changes. Make sure your updates are saved before exiting."
] =
    "A változtatások mentése nélkül hagyja el az E-mail beállítások oldalt. A kilépés előtt győződjön meg arról, hogy a frissítéseket elmentette.";
