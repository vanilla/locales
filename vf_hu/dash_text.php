...
$Definition['Allow links to be transformed'] = 'Engedélyezze a linkek beágyazott reprezentációvá alakítását a bejegyzésekben és megjegyzésekben. Például egy YouTube-link beágyazott videóvá alakul.';
...
$Definition['ShareImageDescription'] = 'Amikor valaki megoszt egy linket az Ön webhelyéről, megpróbálunk képet készíteni az oldalról. Ha nincs kép az oldalon, akkor ezt a képet használjuk helyette. A képnek legalább 50×50-esnek kell lennie, de javasoljuk a 200×200-ast.';
...
$Definition['Tagging allows users to add a tag to discussions they start in order to make them more discoverable. '] = 'A címkézés lehetővé teszi a felhasználók számára, hogy címkét adjanak az indított beszélgetéseknek, hogy könnyebben felfedezhetők legyenek.';
...
$Definition['TouchIconDescription'] = 'Az érintőképernyő ikon jelenik meg, amikor egy webhelyet könyvjelzővel jelöl egy Apple eszköz kezdőképernyőjén. Ezek általában 152 pixel. Az Apple automatikusan hozzáadja a lekerekített sarkokat és a világítási hatást.';
