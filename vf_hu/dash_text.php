...
$Definition['Recommend special ranks for admins and mods.'] = 'Nagyon jó ötlet, ha speciális rangot helyezünk a moderátorok és az adminisztrátorok számára, hogy a közösség könnyen láthassa, ki a felelős.';
$Definition['Recommend starting with five ranks.'] = 'Nem akarod, hogy túl sok rangod legyen. Javasoljuk, hogy ötvel kezdje. Többet adhat hozzá, ha a közösség valóban nagy.';
...
$Definition['This role is personal info. Only users with permission to view personal info will see it.'] = 'Ez a szerep egy személyes adat. Csak a személyes adatok megnézési engedélyével rendelkező felhasználók láthatják.';
$Definition['This setting loads the page before executing Javascript.'] = 'Ez a beállítás a Javascript végrehajtása előtt tölti be az oldalt, és ezzel javul az SEO.<br><strong>**Figyelem: Ennek a funkciónak az engedélyezése Javascript hibákhoz vezethet oldaladon.**</strong>';
