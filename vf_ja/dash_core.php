...
// Federated Search
$Definition["About Federated Search"] = "横断検索について";
$Definition["About Search Connectors"] = "検索コネクタについて";
$Definition["Add"] = "追加";
$Definition["Add a custom <0/> search connector"] = "カスタム<0/>検索コネクタを追加";
$Definition["Answer"] = "回答";
$Definition["Apply"] = "適用";
$Definition["Article"] = "記事";
$Definition["Authenticate"] = "認証する";
$Definition["Back"] = "戻る";
$Definition["Cancel"] = "キャンセル";
$Definition["Categories"] = "カテゴリ";
$Definition["Client ID is required."] = "クライアントIDが必要です。";
$Definition["Client Secret is required."] = "クライアントシークレットが必要です。";
$Definition["Configure"] = "設定";
$Definition["Cursor pagination uses a url to point to the next page of results. Offset pagination uses a page number and item count to fetch the next page."] = "カーソルページネーションは、結果の次のページを指すURLを使用します。オフセットページネーションは、次のページを取得するためにページ番号と項目数を使用します。";
$Definition["Discussions"] = "ディスカッション";
$Definition["Federated Search allows you to include external content within community search results such as knowledge base articles, courses from a learning management system, blog articles and more, to centralize content search within community. <0>Learn more</0>."] = "横断検索により、コミュニティの検索結果にナレッジベース記事、学習管理システム（LMS）のコース、ブログ記事等の外部コンテンツを含め、コミュニティ内にコンテンツ検索を集約できます。<0>詳細はこちら</0>。";
$Definition["Good job! Here is a preview of some of your external articles, listed on your community's Search Results page."] = "よくできました！こちらはコミュニティの検索結果ページにリストアップされる外部記事の一部のプレビューです。";
$Definition["Great!"] = "素晴らしい！";
$Definition["Groups"] = "グループ";
$Definition["Help Menu"] = "ヘルプメニュー";
$Definition["Here is what a single result provided by the API looks like:"] = "APIが提示する単一の結果はこのような見た目になります。";
$Definition["Idea"] = "アイデア";
$Definition["Ideas"] = "アイデア";
$Definition["Integrates Salesforce's knowledge base articles into the Vanilla community search, consolidating self-service support resources within the community platform."] = "セールスフォースのナレッジベースコミュニティをVanillaコミュニティ検索に統合し、コミュニティプラットフォーム内のセルフサービスのサポート資料を統一します。";
$Definition["Knowledge Bases"] = "知識ベース";
$Definition["Label is required."] = "ラベルが必要です。";
$Definition["Loading"] = "ロード中";
$Definition["Maximum length is 100 characters."] = "最大100文字です。";
$Definition["Maximum length is 500 characters."] = "最大500文字です。";
$Definition["Maximum number of posts to be included in the email digest."] = "電子メールダイジェストに含めることができる投稿の最大数。";
$Definition["Messages"] = "メッセージ";
$Definition["Modify <0/> search connector"] = "<0/>検索コネクタを設定";
$Definition["My Account"] = "マイアカウント";
$Definition["Next"] = "次へ進む";
$Definition["No results found."] = "結果が見つかりませんでした。";
$Definition["Notifications"] = "通知";
$Definition["Number of posts from groups"] = "グループからの投稿数";
$Definition["Our Search Connectors will allow you to easily configure the connection between Vanilla and external platforms. Can't find what you're looking for? Let us know which search connectors you need by posting and Idea in our <0>customer community</0>."] = "検索コネクタにより、Vanillaと外部プラットフォーム間の接続を簡単に設定できます。探しているものが見つかりませんか？必要な検索コネクタについては、<0>カスタマーコミュニティ</0>にアイデアを投稿してお知らせください。";
$Definition["Please enter some basic information about your custom search connector."] = "カスタム検索コネクタについて、なんらかの基本情報を入力してください。";
$Definition["Poll"] = "投票";
$Definition["Polls"] = "Polls";
...
$Definition["Response Body"] = "レスポンスボディ";
$Definition["Response Headers"] = "レスポンスヘッダー";
$Definition["Salesforce Article Search"] = "セールスフォース記事検索";
$Definition["Save"] = "保存";
$Definition["Search Connectors"] = "検索コネクタ";
$Definition["Site domain is required."] = "サイトドメインが必要です。";
$Definition["Some parameters required to search may be unique to your API. Please configure your search connector with these parameters so that the connector can correctly format search queries for your community."] = "検索に必要なパラメーターは、お使いのAPIに固有のものである可能性があります。コネクタがコミュニティの検索クエリを正しくフォーマットできるよう、これらのパラメーターを使って検索コネクタを設定してください。";
$Definition["Surfaces Zendesk Help Center knowledge base articles in Vanilla community search to centralize self-service help within community."] = "Zendeskヘルプセンターのナレッジベース記事をVanillaコミュニティの検索結果に表示し、セルフサービスヘルプを一元化します。";
$Definition["Tag"] = "タグ";
$Definition["Test Custom API"] = "カスタムAPIのテスト";
$Definition["Test your custom API"] = "あなたのカスタムAPIのテスト";
$Definition["Test your pagination configuration"] = "ページネーション設定のテスト";
$Definition["The roles that are allowed to access this connector."] = "このコネクタへのアクセスを許可されているロールです。";
$Definition["This search connector has an invalid configuration."] = "この検索コネクタの設定は無効です。";
$Definition["Tip: These required parameters can usually be found in the documentation for your API"] = "ヒント：これらの必要なパラメーターは、通常API用のドキュメントに記載されています";
$Definition["To finish configuring the Search Connector, tell us where to find the following values within the result object."] = "検索コネクタの設定を終了するには、結果オブジェクト内の以下の値の場所をお知らせください。";
$Definition["Visit Site"] = "サイトへ移動";
$Definition["What kind of pagination does your API use?"] = "お使いのAPIはどんな種類のページネーションを使用しますか？";
$Definition["When you're ready, use these buttons to check that your pagination configuration functions as expected"] = "準備ができたらこれらのボタンを使用し、ページネーション設定が予期通りに機能しているかを確認してください";
$Definition["When you're ready, use this button to test the API and view its results."] = "準備ができたら、このボタンを使ってAPIをテストし、結果を閲覧してください。";
$Definition["Where is the list of results located in this response?"] = "このレスポンスの結果リストはどこにありますか？";
$Definition["You must configure this search connector to enable it."] = "この検索コネクタを有効化するには設定する必要があります。";
$Definition["You must select at least one role."] = "少なくとも1つの役割を選択する必要があります。";
$Definition["Zendesk Guide"] = "Zendeskガイド";
