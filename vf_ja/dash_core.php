...
$Definition['Sources that are selected here will be available to AI Suggested Answers. Add additional sources through Federated Search. <0/>'] = 'ここで選択されたソースは、AI提案された回答で利用できるようになります。横串検索を通じてさらなるソースを追加します。<0/>';
