...
$Definition['Allow links to be transformed'] = 'リンクをディスカッションおよびコメント内の埋め込み表現に変換できるようにします。例えば、YouTubeリンクは埋め込み動画に変換されます。';
...
$Definition['Which reactions you use really depends on your community.'] = 'どのリアクションを実際に使用するかはあなたのコミュニティ次第ですが、いくつかの点に留意することをお勧めします。';
