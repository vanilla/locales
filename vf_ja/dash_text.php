...
$Definition['RichEditor.QuoteEnable.Notes'] = '次のオプションを使用して、リッチエディターの引用符を有効にします。これは、デフォルトのフォーマッタが「リッチ」の場合にのみ適用されます。';
...
$Definition['This setting loads the page before executing Javascript.'] = 'この設定は、JavaScriptを実行する前にページをロードします。これにより、SEOを改善できます。<br><strong>**警告：この機能を有効にすると、サイトでJavaScriptエラーが発生する可能性があります。**</strong>';
