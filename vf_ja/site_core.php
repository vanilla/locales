...
$Definition["To access the paragraph format menu, press control, shift, and P. To access the text format menu, press control, shift, and I. Use the arrow keys to navigate in each menu."] = "段落書式メニューにアクセスするにはCtrl + Shift + P キーを押し、テキスト書式メニューにアクセスするには、Ctrl + Shift + I キーを押してください。各メニュー内を移動するには、矢印キーを使用してください。";
