...
$Definition['Are you sure you want to leave this conversation?'] = '本当にこの会話を残したいのですか？';
...
$Definition['HeadlineFormat.Registration'] = '{ActivityUserID,You}が参加しました。';
...
$Definition['Post Discussion'] = 'ポストディスカッション';
...
$Definition['Rank'] = 'ランク';
$Definition['Ranks.ActivityFormat'] = '{ActivityUserID,user} {ActivityUserID,plural,was,were}は{Data.Name,plaintext}に昇進しました。';
...
$Definition['You\'ve asked questions that have now been answered'] = '<a href="{/discussions/mine?qna=Answered,url}">あなた様のご質問に対する回答が今ありました。</a>この回答を認証されるか、拒否されるか、確認して下さい。';
