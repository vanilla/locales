...
$Definition['Allow links to be transformed'] = 'Permita que los enlaces se transformen en representaciones incrustadas en discusiones y comentarios. Por ejemplo, un enlace de YouTube se transformará en un video incrustado.';
$Definition['Allow users with the %s permission to change their own avatars from their profile pages in Vanilla.'] = 'Permita que los usuarios con el permiso %s cambien sus propios avatares desde sus páginas de perfil en Vanilla.';
...
$Definition['If enabled, the full content of posts will be sent in email notifications to users.'] = 'Si está habilitado, el contenido completo de las publicaciones se enviará por correo electrónico a los usuarios.';
...
$Definition['RichEditor.QuoteEnable.Notes'] = 'Use la siguiente opción para habilitar comillas para el Editor enriquecido. Esto solo se aplicará si el formateador predeterminado es "Rich".';
...
$Definition['ShareImageDescription'] = 'Cuando alguien comparte un enlace desde su sitio, intentamos tomar una imagen de la página. Si no hay una imagen en la página, usaremos esta imagen en su lugar. La imagen debe ser de al menos 50 × 50, pero recomendamos 200 × 200.';
...
$Definition['Tagging allows users to add a tag to discussions they start in order to make them more discoverable. '] = 'El etiquetado permite a los usuarios agregar una etiqueta a las discusiones que inician para que sean más reconocibles.';
...
$Definition['They work just like regular themes. Once one has been added to the themes folder, you can enable it here.'] = 'Funcionan como los temas habituales. Una vez que haya agregado uno a la carpeta de temas, puede habilitarlo aquí.';
...
$Definition['This role is personal info. Only users with permission to view personal info will see it.'] = 'Este rol es información personal. Solo los usuarios con permiso para ver información personal la verán.';
$Definition['This setting loads the page before executing Javascript.'] = 'Esta configuración carga la página antes de ejecutar Javascript, lo que puede mejorar su SEO. <br> <strong>** Advertencia: habilitar esta función puede causar errores de Javascript en su sitio. **</strong>';
...
$Definition['TouchIconDescription'] = 'El icono táctil aparece cuando marca un sitio web en la pantalla de inicio de un dispositivo Apple. Estos son generalmente 152 píxeles. Apple agrega esquinas redondeadas y efectos de iluminación automáticamente.';
...
$Definition['Which reactions you use really depends on your community.'] = 'Las reacciones que use realmente dependen de su comunidad, pero le recomendamos tener en cuenta algunos puntos.';
