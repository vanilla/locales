...
$Definition['Recommend special ranks for admins and mods.'] = 'Es una buena idea tener rangos especiales para moderadores y administradores para que su comunidad pueda ver fácilmente quién está a cargo.';
$Definition['Recommend starting with five ranks.'] = 'No quieres tener demasiados rangos. Recomendamos comenzar con cinco. Puede agregar más si su comunidad es realmente grande.';
...
$Definition['This page lists the endpoints of your API.'] = 'Esta página enumera los puntos finales de su API. Haga clic en los puntos finales para obtener más información. Puede realizar llamadas en vivo a la API desde esta página o externamente utilizando un token de acceso.';
$Definition['This role is personal info. Only users with permission to view personal info will see it.'] = 'Este rol es información personal. Solamente los usuarios con permiso para ver la información personal la verán.';
$Definition['This setting loads the page before executing Javascript.'] = 'Este ajuste carga la página antes de ejecutar el Javascript que puede mejorar tu SEO. <br><strong>**Advertencia: Habilitar esta función puede causar errores de Javascript en tu sitio.**</strong>';
