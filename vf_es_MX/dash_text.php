...
$Definition['If enabled, the full content of posts will be sent in email notifications to users.'] =
    'Si está habilitado, el contenido completo de las publicaciones se enviará por correo electrónico a los usuarios.';
...
$Definition['RichEditor.QuoteEnable.Notes'] =
    'Use la siguiente opción para habilitar comillas para el Editor enriquecido. Esto solo se aplicará si el formateador predeterminado es "Rich".';
...
$Definition['ShareImageDescription'] =
    'Cuando alguien comparte un enlace desde su sitio, intentamos tomar una imagen de la página. Si no hay una imagen en la página, usaremos esta imagen en su lugar. La imagen debe ser de al menos 50 × 50, pero recomendamos 200 × 200.';
...
$Definition['This role is personal info. Only users with permission to view personal info will see it.'] =
    'Este rol es información personal. Solo los usuarios con permiso para ver información personal la verán.';
$Definition['This setting loads the page before executing Javascript.'] =
    'Esta configuración carga la página antes de ejecutar Javascript, lo que puede mejorar su SEO. <br> <strong>** Advertencia: habilitar esta función puede causar errores de Javascript en su sitio. **</strong>';
...
$Definition["This theme cannot be deleted because it is the currently applied theme."] = "Este tema no se puede eliminar porque es el tema aplicado actualmente.";
