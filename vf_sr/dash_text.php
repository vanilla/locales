...
$Definition['Start the first discussion.'] = 'Нека се лоптица котрља у вашој заједници тако <a href="{/post/discussion,url}">што ћете</a> одмах <a href="{/post/discussion,url}">започети прву расправу</a> .';
