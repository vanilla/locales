...
$Definition['If enabled, the full content of posts will be sent in email notifications to users.'] = 'Ако је омогућено, целокупни садржај постова бит ће послан корисницима у е-порукама.';
...
$Definition['This setting loads the page before executing Javascript.'] = 'Ово подешавање учитава страницу пре извршења Јавасцрипта који може побољшати ваш СЕО. <br> <strong>** Упозорење: Омогућавање ове функције може проузроковати погрешке ЈаваСцрипта на вашој веб локацији **.</strong>';
