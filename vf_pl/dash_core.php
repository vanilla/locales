...
$Definition['Number of days before a follow up email is automatically sent.'] = 'Liczba dni do automatycznego wysłania wiadomości e-mail uzupełniającej.';
...
$Definition['The default banner image across the site. This can be overriden on a per category basis.'] = 'Domyślny obraz banera w całej witrynie. Może być zastępowany w ramach każdej kategorii.';
