...
$Definition['You can specify a whitelist of trusted domains. (CSP)'] = 'Możesz określić białą listę zaufanych domen (np. twojadomena.com), z których można bezpiecznie ładować JavaScript.';
