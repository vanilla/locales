...
$Definition['A role with default type "unconfirmed" is required to use email confirmation.'] = 'Do potwierdzenia adresu e-mail wymagana jest rola z domyślnym typem "niepotwierdzony".';
