...
$Definition['<strong>Heads Up!</strong> Deleting a role can result in users not having access to the application.'] = '<strong>Heads-up!</strong> Usunięcie roli może spowodować, że użytkownicy nie będą mieli dostępu do aplikacji.';
$Definition['<strong>Heads Up!</strong> Moving discussions into a replacement category can result in discussions vanishing (or appearing) if the replacement category has different permissions than the category being deleted.'] = '<strong>Heads-up!</strong> Przeniesienie dyskusji do kategorii zamiennej może spowodować zniknięcie (lub pojawienie się) dyskusji, jeśli kategoria zastępcza ma inne uprawnienia niż kategoria usuwana.';

$Definition['About.DisableStatistics'] = 'Jeśli musisz wyłączyć raportowanie danych z jakiegoś powodu biznesowego, możesz to zrobić, dodając następujący wiersz do pliku konfiguracyjnego instalacji: <code>$Configuration[\'Garden\'][\'Analytics\'][\'Enabled\'] = FALSE;</code>';
...
$Definition['Access your community forum by clicking the "Visit Site" link.'] = 'Wejdź na forum społeczności, klikając link "Odwiedź witrynę" u góry tej strony lub <a href={/,url}> klikając tutaj </a>. Forum społeczności jest tym, co zobaczą wszyscy Twoi użytkownicy &, odwiedzając <a href="{/,url,domain}"> {/, url, domain} </a>.';
...
$Definition['Choose a theme for this subcommunity. <0>Read more</0>'] = 'Wybierz motyw dla tej społeczności. <0> Czytaj więcej </0>';
...
$Definition['Everyone who signs up gets a profile page.'] = 'Każdy, kto zarejestruje się w Twojej społeczności, uzyskuje publiczną stronę profilu, na której może przesłać swoje zdjęcie, zarządzać ustawieniami profilu i śledzić fajne rzeczy w społeczności. Powinieneś <a href="{/profile,url}"> dostosować swój profil teraz </a>.';
...
$Definition['Prevent spam on your forum by limiting the number of discussions &amp; comments that users can post within a given period of time.'] = 'Zapobieganie spamowi na forum przez ograniczenie liczby dyskusji i komentarzy, które użytkownicy mogą wysłać w danym okresie czasu.';
...
$Definition['Requires “Flag” reaction permission.'] = 'Wymaga pozwolenia na reakcję „Oznacz”.';
$Definition['Requires “Negative” reaction permission.'] = 'Wymaga pozwolenia na „negatywną” reakcję.';
$Definition['Requires “Positive” reaction permission.'] = 'Wymaga pozwolenia na „pozytywną” reakcję.';
...
$Definition['RichEditor.QuoteEnable.Notes'] = 'Użyj poniższej opcji, aby włączyć cytaty w edytorze Rich. Będzie to miało zastosowanie tylko wtedy, gdy domyślnym formatowaniem jest „Rich”.';
...
$Definition['Security.Hsts.HTTPSWarning'] = 'Ostrzeżenie: Tę funkcję należy włączyć wyłącznie, jeśli jest się pewnym, że wszystkie subdomeny zostały skonfigurowane dla HTTPS, z ważnymi certyfikatami.';
$Definition['Security.Hsts.IncludeSubDomains'] = 'Jeśli ta zasada jest włączona, ma również zastosowanie do wszystkich Twoich subdomen.';
$Definition['Security.Hsts.MaxAgeRecommendation'] = 'Polecamy zacząć od maksymalnego wieku 1 tygodnia, a następnie zwiększenie go do 1 miesiąca, a potem 1 roku, po zorientowaniu się, czy strona działa zgodnie z oczekiwaniami.';
$Definition['Security.Hsts.SubmitWarning'] = 'Ostrzeżenie: Wspaniale jest wspierać wstępne wczytywanie HSTS jako najlepszą praktykę. Aby upewnić się, że wstępne wczytanie Twojej strony powiodło się (to znaczy, otrzymać pełną ochronę zamierzonej konfiguracji), trzeba jednak przesłać ją do hstspreload.org.';
$Definition['Select the default type for this role, if any.'] = 'Wybierz domyślny typ tej roli, jeśli istnieje.';
$Definition['ShareImageDescription'] = 'Gdy ktoś udostępnia link z Twojej witryny, próbujemy pobrać obraz ze strony. Jeśli na stronie nie ma obrazu, użyjemy go zamiast tego. Obraz powinien mieć co najmniej 50 × 50, ale zalecamy 200 × 200.';
...
$Definition['Some older themes don\'t support full editing capability.'] = 'Niektóre starsze motywy nie obsługują pełnej możliwości edycji. Aby zobaczyć, co obsługuje motyw, możesz najechać kursorem na jego nazwę, aby zobaczyć, gdzie wprowadzone zostaną zmiany.';
...
$Definition['Tagging allows users to add a tag to discussions they start in order to make them more discoverable. '] = 'Tagowanie pozwala użytkownikom dodawać znacznik do rozpoczętych dyskusji, aby uczynić je bardziej wykrywalnymi.';
...
$Definition['The <0/> lab needs to be configured to match your custom theme.'] = 'NB Laboratorium <0/> musi być skonfigurowane tak, aby pasowało do Twojego motywu niestandardowego. Można to zrobić za pomocą naszego nowego edytora motywów. <1>Dowiedz się więcej.</1>';
...
$Definition['Theme preview is limited to displaying the theme\'s template and css.'] = 'Podgląd motywu jest ograniczony do wyświetlania szablonu motywu i css.';
...
$Definition['This page lists the endpoints of your API.'] = 'Ta strona zawiera listę punktów końcowych interfejsu API. Kliknij punkty końcowe, aby uzyskać więcej informacji. Możesz wykonywać połączenia na żywo do interfejsu API z tej strony lub zewnętrznie za pomocą tokena dostępu.';
$Definition['This role is personal info. Only users with permission to view personal info will see it.'] = 'Ta rola to dane osobowe. Tylko użytkownicy posiadający uprawnienia do przeglądania danych osobowych będą je widzieć.';
$Definition['This setting loads the page before executing Javascript.'] = 'To ustawienie ładuje stronę przed uruchomieniem Javascript, co może poprawić SEO. <br> <strong>** Ostrzeżenie: włączenie tej funkcji może powodować błędy JavaScript w Twojej witrynie. **</strong>';
$Definition['This theme cannot be deleted because it is the currently applied theme.'] = 'Nie można usunąć tego motywu, ponieważ jest to obecnie stosowany motyw.';
...
$Definition['TouchIconDescription'] = 'Ikona dotykowa pojawia się po dodaniu do zakładek strony internetowej na ekranie głównym urządzenia Apple. Zazwyczaj są to 152 piksele. Apple automatycznie dodaje zaokrąglone rogi i efekt świetlny.';
...
$Definition['Usercards'] = 'Karty użytkownika';
$Definition['Usercards allow you to get a quick in-line snapshot of a user\'s information.'] = 'Karty użytkownika umożliwiają szybkie uzyskanie wbudowanej migawki informacji o użytkowniku. Podczas przeglądania postów i tabel wyników kliknij nazwę użytkownika, aby zobaczyć kartę z podstawowymi informacjami o profilu użytkownika bez konieczności opuszczania strony. Włącz tę funkcję, aby dodać karty użytkownika do niestandardowego motywu.';
...
$Definition['Vanilla\'s new search service is finally here.'] = 'Nowa usługa wyszukiwania Vanilla jest już dostępna. Włącz nasz nowy interfejs użytkownika strony wyszukiwania, aby uzyskać dostęp do najnowszych funkcji wyszukiwania, takich jak wyszukiwanie członków, sortowanie wyszukiwania i wyróżnianie terminów.';
...
$Definition['Warning: Loading tables can be slow.'] = '<b>Ostrzeżenie</b> : konfiguracja serwera nie obsługuje szybkiego ładowania danych. Jeśli importujesz bardzo duży plik (np. Ponad 200 000 komentarzy), możesz rozważyć zmianę konfiguracji. Kliknij <a href="http://vanillaforums.com/porter">tutaj,</a> aby uzyskać więcej informacji.';
...
$Definition['Welcome to Vanilla\'s theming UI.'] = 'Witamy w tematycznym interfejsie użytkownika Vanilla. Ta strona zawiera listę wszystkich dostępnych motywów i umożliwia ich kopiowanie lub edytowanie.';
...
$Definition['Which reactions you use really depends on your community.'] = 'To, których reakcji użyjesz, zależy od twojej społeczności, ale zalecamy pamiętać o kilku kwestiach.';
