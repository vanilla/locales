...
$Definition['RichEditor.QuoteEnable.Notes'] =
    'Użyj poniższej opcji, aby włączyć cytaty w edytorze Rich. Będzie to miało zastosowanie tylko wtedy, gdy domyślnym formatowaniem jest „Rich”.';
...
$Definition['Tagging allows users to add a tag to discussions they start in order to make them more discoverable. '] =
    'Tagowanie pozwala użytkownikom dodawać znacznik do rozpoczętych dyskusji, aby uczynić je bardziej wykrywalnymi.';
...
$Definition['This setting loads the page before executing Javascript.'] =
    'To ustawienie ładuje stronę przed uruchomieniem Javascript, co może poprawić SEO. <br> <strong>** Ostrzeżenie: włączenie tej funkcji może powodować błędy JavaScript w Twojej witrynie. **</strong>';
...
$Definition['Which reactions you use really depends on your community.'] =
    'To, których reakcji użyjesz, zależy od twojej społeczności, ale zalecamy pamiętać o kilku kwestiach.';
