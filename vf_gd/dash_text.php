...
$Definition['Recommend special ranks for admins and mods.'] =
    'Is e deagh bheachd a th ’ann rangannan sònraichte a bhith agad airson luchd-riaghlaidh agus luchd-rianachd gus am faic do choimhearsnachd gu furasta cò a tha os cionn.';
$Definition['Recommend starting with five ranks.'] =
    'Chan eil thu airson cus rangannan a bhith agad. Tha sinn a ’moladh tòiseachadh le còig. Faodaidh tu barrachd a chuir ris ma tha a ’choimhearsnachd agad gu math mòr.';
...
$Definition['This page lists the endpoints of your API.'] =
    'Tha an duilleag seo a ’liostadh puingean crìochnachaidh an API agad. Cliog air endpoints airson tuilleadh fiosrachaidh. Faodaidh tu gairmean beò a dhèanamh chun API bhon duilleag seo no taobh a-muigh a ’cleachdadh comharra ruigsinneachd.';
...
$Definition['This setting loads the page before executing Javascript.'] =
    'Bidh an suidheachadh seo a ’luchdachadh na duilleige mus cuir thu Javascript an gnìomh a dh’ fhaodadh do SEO adhartachadh. <br> <strong>** Rabhadh: Faodaidh comasachadh an fheart seo mearachdan Javascript adhbhrachadh air an làrach agad. **</strong>';
...
$Definition['TouchIconDescription'] =
    'Bidh an ìomhaigh suathaidh a ’nochdadh nuair a chuireas tu comharra-lìn air làrach-lìn air sgàilean dachaigh inneal Apple. Mar as trice is e seo 152 piogsail. Bidh Apple a ’cur oiseanan cruinn agus buaidh solais gu fèin-ghluasadach.';
...
$Definition['Warning: Loading tables can be slow.'] =
    '<b>Rabhadh</b> : Chan eil rèiteachadh an fhrithealaiche agad a ’toirt taic do luchdachadh dàta luath. Ma tha thu a ’toirt a-steach faidhle glè mhòr (ex. Còrr is 200,000 beachd) is dòcha gum bi thu airson beachdachadh air an rèiteachadh agad atharrachadh. Cliog an <a href="http://vanillaforums.com/porter">seo</a> airson tuilleadh fiosrachaidh.';
