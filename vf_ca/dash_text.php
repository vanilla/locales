...
$Definition['Recommend special ranks for admins and mods.'] =
    'És una bona idea disposar de files especials per a moderadors i administradors perquè la vostra comunitat pugui veure fàcilment qui és el responsable.';
$Definition['Recommend starting with five ranks.'] =
    'No voldreu tenir massa files. Recomanem començar per cinc. Podeu afegir-ne més si la vostra comunitat és realment nombrosa.';
...
$Definition['This setting loads the page before executing Javascript.'] =
    'Aquesta configuració carrega la pàgina abans d’executar Javascript, que pot millorar el vostre SEO. <br> <strong>** Advertència: habilitar aquesta funció pot causar errors de Javascript al vostre lloc. **</strong>';
...
$Definition['Which reactions you use really depends on your community.'] =
    'Les reaccions que feu servir depèn realment de la vostra comunitat, però us recomanem que tingueu en compte un parell de punts.';
