...
$Definition['Digest Settings'] = 'Configuració del resum';
...
$Definition['Recommended dimensions are about 400px by 300px or smaller with similar ratio.'] = 'Les dimensions recomanades són d\'uns 400 px per 300 px o més petites amb una proporció similar.';
...
$Definition['Tagging allows users to add a tag to discussions they start in order to make them more discoverable. '] =
    'L\'etiquetatge permet als usuaris afegir una etiqueta a les discussions que inicien per tal de fer-les més descobertes.';
...
$Definition['The database user you specified does not have permission to access the database. Have you created the database yet? The database reported: <code>%s</code>'] =
    'L’usuari de la base de dades que heu especificat no té permís per accedir a la base de dades. Ja heu creat la base de dades? La base de dades reportada: <code>%s</code>';
...
$Definition['TouchIconDescription'] =
    'La icona tàctil apareix en marcar un lloc web a la pantalla inicial d’un dispositiu Apple. Generalment són 152 píxels. Apple afegeix les cantonades arrodonides i l\'efecte de la llum automàticament.';
...
$Definition['Warning: Loading tables can be slow.'] =
    '<b>Avís</b> : la vostra configuració del servidor no admet la càrrega ràpida de dades. Si importeu un fitxer molt gran (ex. Més de 200.000 comentaris), potser voldreu plantejar-vos canviar la configuració. Feu clic <a href="http://vanillaforums.com/porter">aquí</a> per obtenir més informació.';
