...
$Definition['If enabled, the full content of posts will be sent in email notifications to users.'] =
    'Si està activat, el contingut complet de les publicacions s’enviarà per correu electrònic als usuaris.';
...
$Definition['ShareImageDescription'] =
    'Quan algú comparteix un enllaç des del vostre lloc, intentem agafar una imatge de la pàgina. Si no hi ha cap imatge a la pàgina, utilitzarem aquesta imatge. La imatge ha de tenir com a mínim 50 × 50, però recomanem 200 × 200.';
