...
$Definition['RichEditor.QuoteEnable.Notes'] = 'Gamitin ang sumusunod na pagpipilian upang paganahin ang mga quote para sa Rich Editor. Maglalapat lamang ito kung ang default na formatter ay "Mayaman".';
...
$Definition['This setting loads the page before executing Javascript.'] = 'Ang setting na ito ay naglo-load ng pahina bago isagawa ang Javascript na maaaring mapabuti ang iyong SEO. <br> <strong>** Babala: Paganahin ang tampok na ito ay maaaring maging sanhi ng mga error sa Javascript sa iyong site. **</strong>';
$Definition['This theme cannot be deleted because it is the currently applied theme.'] = 'Ang temang ito ay hindi matanggal dahil ito ang kasalukuyang inilapat na tema.';
