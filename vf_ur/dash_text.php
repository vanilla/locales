...
$Definition['API Overview'] = "API کا جائزہ";
...
$Definition['Digest Settings'] = 'ڈائجسٹ کی ترتیبات';
...
$Definition['Rate Limits'] = 'شرح کی حدیں';
...
$Definition['Recommended dimensions are about 400px by 300px or smaller with similar ratio.'] = 'تجویز کردہ طول و عرض تقریباً 400px x 300px یا اسی طرح کے تناسب کے ساتھ چھوٹے ہیں۔';
...
$Definition['Role Tokens'] = 'رول ٹوکنز';
...
$Definition['Tagging allows users to add a tag to discussions they start in order to make them more discoverable. '] =
    'ٹیگ کرنے سے صارفین کو ان مباحثوں میں ٹیگ شامل کرنے کی اجازت ملتی ہے تاکہ وہ انھیں مزید قابل فہم بنائیں۔';
...
$Definition['The database user you specified does not have permission to access the database. Have you created the database yet? The database reported: <code>%s</code>'] =
    'آپ کے بیان کردہ ڈیٹا بیس صارف کے پاس ڈیٹا بیس تک رسائی کی اجازت نہیں ہے۔ کیا آپ نے ابھی تک ڈیٹا بیس بنایا ہے؟ ڈیٹا بیس کی اطلاع: <code>%s</code>';
...
$Definition['This setting loads the page before executing Javascript.'] =
    'یہ ترتیب جاوا اسکرپٹ پر عمل کرنے سے پہلے پیج کو بوجھ دیتی ہے جو آپ کے SEO کو بہتر بنا سکتی ہے۔ <br> <strong>** انتباہ: اس خصوصیت کو چالو کرنے سے آپ کی ویب سائٹ پر جاوا اسکرپٹ کی غلطیاں ہوسکتی ہیں۔ **</strong>';
...
$Definition['TouchIconDescription'] =
    'ٹچ آئیکن ظاہر ہوتا ہے جب آپ ایپل ڈیوائس کے ہوم اسکرین پر کسی ویب سائٹ کو بک مارک کرتے ہیں۔ یہ عام طور پر 152 پکسلز ہیں۔ ایپل گول کونے اور روشنی کا اثر خود بخود شامل کرتا ہے۔';
...
$Definition['Warning: Loading tables can be slow.'] =
    '<b>انتباہ</b> : آپ کی سرور ترتیب میں فاسٹ ڈیٹا لوڈنگ کا تعاون نہیں ہے۔ اگر آپ بہت بڑی فائل درآمد کر رہے ہیں (جیسے 200،000 تبصرے) تو آپ اپنی تشکیل تبدیل کرنے پر غور کرنا چاہتے ہو۔ مزید معلومات کے لئے <a href="http://vanillaforums.com/porter">یہاں</a> کلک کریں۔';
...
$Definition['When enabled, you can <0>manage products</0>, and group subcommunities by those products.'] = 'فعال ہونے پر، آپ <0>پروڈکٹس کا نظم کر سکتے ہیں۔</0> ، اور ان پروڈکٹس کے ذریعہ ذیلی کمیونٹیز کو گروپ کریں۔';
...
$Definition["The site description usually appears in search engines. You should try having a description that is 100-150 characters long."] = "سائٹ کی تفصیل عام طور پر سرچ انجنوں میں ظاہر ہوتی ہے۔ آپ کو 100-150 حروف کی تفصیل رکھنے کی کوشش کرنی چاہیے۔";
$Definition["This title appears on your site's banner and in your browser's title bar. If a logo is uploaded, it will replace this title on user-facing forum pages. Also, keep in mind some themes may hide this title."] = "یہ عنوان آپ کی سائٹ کے بینر اور آپ کے براؤزر کے ٹائٹل بار میں ظاہر ہوتا ہے۔ اگر لوگو اپ لوڈ کیا جاتا ہے، تو یہ اس عنوان کو صارف کے سامنے والے فورم کے صفحات پر بدل دے گا۔ اس کے علاوہ، ذہن میں رکھیں کہ کچھ موضوعات اس عنوان کو چھپا سکتے ہیں۔";
$Definition["Your organization name is used for SEO microdata and JSON+LD"] = "آپ کی تنظیم کا نام SEO مائیکرو ڈیٹا اور JSON+LD کے لیے استعمال کیا جاتا ہے۔";
$Definition["This logo appears at the top of your site. Themes made with the theme editor and some custom themes don't use this setting."] = "یہ لوگو آپ کی سائٹ کے اوپری حصے میں ظاہر ہوتا ہے۔ تھیم ایڈیٹر کے ساتھ بنائی گئی تھیمز اور کچھ حسب ضرورت تھیمز اس ترتیب کو استعمال نہیں کرتے ہیں۔";
...
$Definition["Your site's favicon appears in your browser's title bar. It will be scaled down appropriately."] = "آپ کی سائٹ کا فیویکن آپ کے براؤزر کے ٹائٹل بار میں ظاہر ہوتا ہے۔ اسے مناسب طریقے سے چھوڑا جائے گا۔";
...
$Definition["Usercards allow you to get a quick in-line snapshot of a user's information."] = "یوزر کارڈز آپ کو صارف کی معلومات کا فوری ان لائن سنیپ شاٹ حاصل کرنے کی اجازت دیتے ہیں۔ پوسٹس اور لیڈر بورڈز دیکھتے وقت، صفحہ سے دور جانے کے بغیر صارف کی بنیادی پروفائل کی معلومات کی نمائش کرنے والا کارڈ دیکھنے کے لیے صارف نام پر کلک کریں۔ اپنے حسب ضرورت تھیم میں یوزر کارڈز شامل کرنے کے لیے اس خصوصیت کو فعال کریں۔";
$Definition['New Search Page'] = 'نیا سرچ پیج۔';
$Definition["Vanilla's new search service is finally here."] = "وینیلا کی نئی سرچ سروس آخر کار یہاں ہے۔ ہمارے نئے سرچ پیج UI کو فعال کریں تاکہ تلاش کی تازہ ترین خصوصیات تک رسائی حاصل کی جا سکے جیسے ممبر تلاش، تلاش کی چھانٹی اور اصطلاح کو نمایاں کرنا۔";
...
$Definition["Recent Post List Page"] = "حالیہ پوسٹ کی فہرست کا صفحہ";
$Definition["Custom"] = "حسب ضرورت";
$Definition["Category List Page"] = "زمرہ کی فہرست کا صفحہ";
$Definition["Home Page Type"] = "ہوم پیج کی قسم";
$Definition["Choose a page to serve as the subcommunity homepage."] = "ذیلی کمیونٹی ہوم پیج کے طور پر کام کرنے کے لیے ایک صفحہ منتخب کریں۔";
$Definition["Selected Home Page Type is a custom layout. You can manage the layout for this subcommunity in <0/>."] = "منتخب ہوم پیج کی قسم ایک حسب ضرورت ترتیب ہے۔ آپ <0/> میں اس ذیلی کمیونٹی کے لے آؤٹ کا نظم کر سکتے ہیں۔";
$Definition["Default Subcommunity"] = "ڈیفالٹ ذیلی کمیونٹی";
$Definition["Make this the default subcommunity. Visitors will be directed here first when they access the community."] = "اسے ڈیفالٹ ذیلی کمیونٹی بنائیں۔ جب زائرین کمیونٹی تک رسائی حاصل کریں گے تو انہیں سب سے پہلے یہاں ہدایت کی جائے گی۔";
$Definition["Post number must be between 3–20."] = "پوسٹ نمبر 3-20 کے درمیان ہونا چاہیے۔";
$Definition["Pages"] = "صفحات";
$Definition["Widget Builder"] = "ویجیٹ بلڈر";
$Definition["Custom Pages"] = "حسب ضرورت صفحات";
$Definition["Site Home Pages"] = "سائٹ ہوم پیجز";
$Definition["Subcommunity Home Pages"] = "ذیلی کمیونٹی ہوم پیجز";
$Definition["Choose a theme for this subcommunity.  <0>Read more</0>"] = "اس ذیلی کمیونٹی کے لیے ایک تھیم منتخب کریں۔ <0>مزید پڑھیں</0>";
$Definition["Vanilla Messages"] = "ونیلا پیغامات";
$Definition["From <0/>"] = "<0/> سے";
$Definition["Manage Products"] = "مصنوعات کا نظم کریں۔";
$Definition["Pages"] = "صفحات";
$Definition["Widget Builder"] = "ویجیٹ بلڈر";
$Definition["Custom Pages"] = "حسب ضرورت صفحات";
$Definition["Site Home Pages"] = "سائٹ ہوم پیجز";
$Definition["Subcommunity Home Pages"] = "ذیلی کمیونٹی ہوم پیجز";
$Definition["Choose a theme for this subcommunity.  <0>Read more</0>"] = "اس ذیلی کمیونٹی کے لیے ایک تھیم منتخب کریں۔ <0>مزید پڑھیں</0>";
$Definition["Search subcommunities."] = "ذیلی کمیونٹیز تلاش کریں۔";
$Definition["The view you were looking for could not be found."] = "آپ جس منظر کی تلاش کر رہے تھے وہ نہیں مل سکا۔";
$Definition["View Not Found"] = "دیکھیں نہیں ملا";
$Definition["site"] = "سائٹ";
$Definition["Selected Home Page Type is a legacy layout."] = "منتخب ہوم پیج کی قسم میراثی ترتیب ہے۔";
$Definition["The default home page type can be changed in <0/>."] = "پہلے سے طے شدہ ہوم پیج کی قسم کو <0/> میں تبدیل کیا جا سکتا ہے۔";

// Sentiment

$Definition["Keyword Settings"] = "مطلوبہ الفاظ کی ترتیبات";
$Definition["Extremely Negative to Negative"] = "انتہائی منفی سے منفی";
$Definition["Negative to Balanced"] = "متوازن سے منفی";
$Definition["Balanced to Positive"] = "مثبت سے متوازن";
$Definition["Positive to Highly Positive"] = "مثبت سے انتہائی مثبت";
$Definition["Sentiment Keywords"] = "جذبات کے مطلوبہ الفاظ";
$Definition["Sentiment Settings"] = "جذبات کی ترتیبات";
$Definition["Add Keyword"] = "مطلوبہ الفاظ شامل کریں۔";
$Definition["Keyword Limit Reached"] = "مطلوبہ الفاظ کی حد تک پہنچ گئی۔";
$Definition["You can only track up to 100 keywords. Untrack some to add new keywords."] = "آپ صرف 100 مطلوبہ الفاظ تک کا پتہ لگا سکتے ہیں۔ نئے مطلوبہ الفاظ شامل کرنے کے لیے کچھ کو ہٹا دیں۔";
$Definition["Calibrate Sentiment Levels"] = "جذبات کی سطحوں کو کیلیبریٹ کریں۔";
$Definition["Sentiment Level Distribution Adjustment"] = "جذباتی سطح کی تقسیم کی ایڈجسٹمنٹ";
$Definition["The 4 sliders represent the points between each sentiment level. Drag the sliders to calibrate the overall sentiment level distribution to your community's content."] = "4 سلائیڈرز ہر جذباتی سطح کے درمیان پوائنٹس کی نمائندگی کرتے ہیں۔ اپنی کمیونٹی کے مواد میں مجموعی جذباتی سطح کی تقسیم کو کیلیبریٹ کرنے کے لیے سلائیڈرز کو گھسیٹیں۔";
$Definition["Calibrated Sentiment Distribution Preview"] = "کیلیبریٹڈ جذبات کی تقسیم کا پیش نظارہ";
$Definition["(Read Only)"] = "(صرف پڑھنے کے لیے)";
$Definition["This graph visualizes how the content in your community would be distributed based on your calibration adjustment."] = "یہ گراف اس بات کا تصور کرتا ہے کہ آپ کی کمیونٹی میں آپ کے کیلیبریشن ایڈجسٹمنٹ کی بنیاد پر مواد کیسے تقسیم کیا جائے گا۔";
$Definition["all time sentiment"] = "ہر وقت جذبات";
$Definition["keyword"] = "کلیدی لفظ";
$Definition["number of uses"] = "استعمال کی تعداد";
$Definition["last use"] = "آخری استعمال";
$Definition["tracking"] = "ٹریکنگ";
$Definition["Sentiment"] = "جذبہ";
$Definition["Tracked Status"] = "ٹریک شدہ اسٹیٹس";
$Definition["Tracked Only"] = "صرف ٹریک کیا گیا۔";
$Definition["Untracked Only"] = "صرف غیر ٹریک شدہ";
$Definition["Strongly Negative"] = "سخت منفی";
$Definition["Negative"] = "منفی";
$Definition["Positive"] = "مثبت";
$Definition["Highly Positive"] = "انتہائی مثبت";
$Definition["Clear all filters"] = "تمام فلٹرز صاف کریں۔";
$Definition["Keyword is required."] = "مطلوبہ الفاظ کی ضرورت ہے۔";
$Definition["Maximum length is 100 characters."] = "زیادہ سے زیادہ لمبائی 100 حروف ہے۔";
$Definition["Keyword"] = "کلیدی لفظ";
$Definition["Add a new tracked keyword"] = "ایک نیا ٹریک کردہ کلیدی لفظ شامل کریں۔";
$Definition["New keywords will be tracked in analytics. You can choose to turn off tracking after creating this keyword."] = "نئے مطلوبہ الفاظ کو تجزیات میں ٹریک کیا جائے گا۔ آپ یہ مطلوبہ لفظ بنانے کے بعد ٹریکنگ کو بند کرنے کا انتخاب کر سکتے ہیں۔";
$Definition["Extremely Negative"] = "انتہائی منفی";
$Definition["Extremely Positive"] = "انتہائی مثبت";
$Definition["Filter by:"] = "فلٹر بذریعہ:";
