...
$Definition['You can specify a whitelist of trusted domains.'] = 'Můžete definovat seznam prověřených důvěryhodných domén (např. yourdomain.com), u nichž je přesměrování a vnoření bezpečné.';
$Definition['You can specify a whitelist of trusted domains. (CSP)'] = 'Můžete určit whitelist důvěryhodných domén (např. Yourdomain.com), ze kterých je bezpečné načítat javascript.';
