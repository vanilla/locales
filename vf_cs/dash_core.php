...
$Definition['%1$s version %2$s is available.'] =
    '%1$s verse %2$s je k dispozici.';
$Definition["%s is not a valid email address"] =
    "%s není platná e-mailová adresa";
...
$Definition["%s user(s) will be affected by this action."] =
    "Tato akce se týká %s uživatelů.";

$Definition["<0/> will suggest answers on Q&A posts"] =
    "<0/> bude navrhovat odpovědi u příspěvků s otázkami a odpověďmi";
$Definition["<0 /> will not suggest answers on Q&A posts"] =
    "<0 /> nebude navrhovat odpovědi na příspěvky s otázkami a odpověďmi";
...
$Definition["1 in 5 is recommended for most communities."] =
    "1 z 5 se doporučuje pro většinu komunit.";
$Definition["1 in 20 is recommended for most communities."] =
    "Pro většinu komunit se doporučuje 1 z 20.";
...
$Definition["[%s] Confirm Your Email Address"] =
    "[%s] Potvrď svoji e-mailovou adresu";
...
] = 'Dosáhli jste maximálního počtu pokusů o přihlášení. Počkejte prosím %s a zkuste to znovu.';
...
$Definition["A unique label name that cannot be changed once saved."] =
    "Jedinečný název štítku, který nelze po uložení změnit.";
...
$Definition['"Accept Answer" if a suggestion answers your question.'] =
    '„Přijmout odpověď“, pokud na vaši otázku odpovídá návrh.';
...
$Definition["Accepted answer pageview ratio representing a deflected case"] =
    "Přijatý poměr zobrazení stránky s odpovědí představující odchýlený případ";
...
$Definition["Add a new Pocket to your site."] =
    "Přidat novou Kapsu na vaši stránku.";
$Definition[
    ...
    "Přidejte odkaz Zoom nebo ID schůzky pro připojení této události k Zoomu a aktivujte tlačítka registrace a připojení jedním kliknutím. Upozorňujeme, že pokud vaše událost vyžaduje registraci, nemůžete po vytvoření události aktualizovat ID schůzky ani odkaz.";
...
$Definition[
    ...
    "Přidejte svou vlastní doménu(y) Kaltura a přeměňte odkazy na vložená videa v diskuzích, komentářích nebo článcích.";
$Definition[
    "Add your custom Kaltura domain(s) to transform links into embedded videos in posts, comments or articles."
] =
    "Přidejte svou vlastní doménu(y) Kaltura a přeměňte odkazy na vložená videa v příspěvcích, komentářích nebo článcích.";
...
$Definition[
    ...
    "AI Suggested Answers poskytuje navrhované odpovědi na základě příspěvků komunity a propojených znalostních bází. Tuto funkci můžete kdykoli zapnout nebo vypnout v předvolbách svého profilu.";
$Definition[
    "Alert users if they click a link in a post that will lead them away from the forum. "
] =
    "Upozornit uživatele, pokud kliknou na odkaz v příspěvku, který je odvede z fóra pryč";
...
$Definition["Allow this connection to issue API access tokens."] =
    "Povolit tomuto připojení vydávat přístupové tokeny pro API.";
$Definition["Allow Third-Party Script Execution"] =
    "Povolit spouštění skriptů třetích stran";
$Definition["Allow users to change their own avatars"] =
    "Povolit uživatelům, aby si měnili své avatary";
$Definition["Allow users to dismiss this message"] =
    "Povolit uživatelům, aby tuto zprávu zavřeli.";
...
$Definition["An enabled message will be visible on the site."] =
    "Aktivovaná zpráva bude viditelná na stránce.";
$Definition["An answer in this the community thread was marked as accepted"] =
    "Odpověď v tomto vláknu komunity byla označena jako přijatá";
$Definition["An error occurred updating your privacy setting"] =
    "Při aktualizaci vašeho nastavení ochrany osobních údajů došlo k chybě";
$Definition["Anonymize Analytics Data by Default"] =
    "Ve výchozím nastavení anonymizovat data Analytics";
$Definition["Answers is not available if you have not accepted cookies."] =
    "Odpovědi nejsou k dispozici, pokud jste nepřijali soubory cookie.";
$Definition["API"] = "API";
...
$Definition[
    ...
    "Opravdu chcete vypnout všechny odpovědi navržené umělou inteligencí? Tuto akci můžete kdykoli vrátit zpět v nastavení svého profilu.";
...
] = "Je vyžadován alespoň jeden viditelný sloupec. Zobrazit nebo přidat viditelný sloupec.";
$Definition["A url-friendly version of the category name for better SEO."] =
    "Hezčí URL pro lepší SEO.";
...
$Definition[
    ...
    "Před aktivací této funkce si prosím uvědomte následující možné důsledky:";
...
$Definition["Bookmark a discussion using its star icon."] =
    "Uložte si diskusi pomocí ikony hvězdičky.";
...
$Definition["Categories to Exclude from AI Answers"] =
    "Kategorie k vyloučení z odpovědí AI";
$Definition["Categories are used to organize discussions."] =
    "Kategorie jsou určeny k pomoci ostatním uživatelům organizovat jejich diskuze, aby byly smysluplné pro vaši komunitu.";
$Definition["Categories are used to organize posts."] =
    "Kategorie se používají k tomu, aby pomohli vašim uživatelům uspořádat jejich příspěvky způsobem, který je smysluplný pro vaši komunitu.";
$Definition["Categories allow you to organize your posts."] =
    "Kategorie vám umožňují organizovat vaše příspěvky.";
...
$Definition["Choose how many records to display."] =
    "Vyberte, kolik záznamů chcete zobrazit.";
$Definition["Choose when to load records from."] =
    "Zvolte, od kdy chcete nahrávat záznamy.";
...
$Definition["Configuration settings for password fields in Vanilla"] =
    "Nastavení konfigurace pro pole hesla ve Vanille";
$Definition["Configure custom Kaltura domains"] =
    "Konfigurace vlastních domén Kaltura";
...
$Definition[
    ...
    "Chcete-li povolit konfiguraci webu pro otázky a odpovědi, kontaktujte tým společnosti Vanilla. Poté povolte doplněk Q&A v sekci Addons na řídicím panelu.";
$Definition[
    ...
    "Chcete-li povolit konfiguraci webu pro otázky a odpovědi, kontaktujte tým společnosti Vanilla. Poté povolte doplněk Q&A v sekci <0/> na řídicím panelu.";
...
$Definition[
    ...
    "Mohlo by dojít k ohrožení zabezpečení, jako je Cross-Site Scripting (XSS), pokud dojde ke kompromitaci počátečních skriptů.";
...
$Definition["Display content from followed categories"] =
    "Zobrazte obsah ze sledovaných kategorií";
...
$Definition[
    ...
    "Nápadně zobrazuje obrázek banneru z brandingové stránky v celém motivu.";
$Definition["Display a searchbox on top of the banner image."] =
    "Zobrazit vyhledávací pole v horní části obrázku banneru.";
$Definition["Display records from this category."] =
    "Zobrazit záznamy z této kategorie.";
$Definition["Display records from this subcommunity."] =
    "Zobrazit záznamy z této dílčí komunity.";
...
$Definition[
    ...
    "Widget Výzva k přehledu e-mailů bude k dispozici, když bude povolen přehled e-mailů.";
...
$Definition[
    ...
    "E-mailové přehledy budou zasílány ve vybraný den každý týden. Změny nastaveného dne se projeví v následujícím týdnu.";
...
$Definition["Enable checkboxes on discussions and comments"] =
    "Zapnout zaškrtávací okénka v diskuzích a komentářích";
...
$Definition["Enable link embeds in discussions and comments"] =
    "Povolit vkládání odkazů v diskuzích a komentářích";
$Definition["Enable link embeds in posts and comments"] =
    "Povolit vkládání odkazů do příspěvků a komentářů";
...
$Definition["Enable sending notification emails"] =
    "Povolit odesílání e-mailů s upozorněním";
...
$Definition["Enable to only show posts from categories a user follows."] =
    "Aktivujte, aby se zobrazovaly pouze příspěvky z kategorií, které uživatel sleduje.";
$Definition[
    "Enable to get a preview of our new user management dashboard with improved search and new configuration options."
] =
    "Povolením získáte náhled našeho nového panelu správy uživatelů s vylepšeným vyhledáváním a novými možnostmi konfigurace.";
...
$Definition[
    ...
    "Povolení této funkce změní vaše zásady zabezpečení obsahu tak, aby důvěřovaly dalším skriptům vloženým jako závislosti vašimi vlastními skripty.";
$Definition[
...
$Definition["Error sending email. Please review the addresses and try again."] =
    "Chyba odeslání emailu. Ověřte prosím adresu a opakujte.";
...
$Definition[
    ...
    "Externí vyhledávání nahradí Vanilla's out of the box search poskytovatelem vyhledávání třetí strany dle vašeho výběru.";
...
$Definition["FaviconDescription"] =
    "Favikona vašich stránek se zobrazuje na hlavní liště prohlížeče. Odpovídajícím způsobem se zmenší.";
...
$Definition[
    ...
    "Chcete-li například povolit yourdomain.com, www.yourdomain.com a help.yourdomain.com, přidejte *.yourdomain.com";
...
$Definition["Full post in email notifications"] =
    "Celý příspěvek v e-mailových upozorněních";

$Definition["Garden"] = "Garden";
$Definition["Garden.api.ssoIDPermission.description"] =
    "Role s tímto oprávněním budou moci rozbalovat SSO ID ve voláních API v2.";
...
$Definition[
    ...
    "Generování návrhů. Až budou připraveny ke kontrole, budete informováni.";
...
$Definition[
    ...
    "Zdravím vás. Jsem váš asistent pro návrhy umělé inteligence, který vám pomůže najít relevantní články a příspěvky k zodpovězení vašich dotazů. Neváhejte se zeptat na jakékoli dotazy.";
...
$Definition["Hide discussions from Recent Discussions and Widgets."] =
    "Skrýt diskuse z Nedávných diskuzí a widgetů.";
$Definition["Hide posts from Recent Posts Page and Widgets."] =
    "Skrýt příspěvky ze stránky Poslední příspěvky a widgetů.";
...
$Definition["Hide signatures on embedded comments"] =
    "Skrýt podpisy ve vložených komentářích";
...
$Definition[
    ...
    "To však přináší zvýšenou odpovědnost za zajištění bezpečnosti vašeho webu.";
...
$Definition["If left empty, Email Logo is used."] =
    "Pokud ponecháte prázdné, použije se logo e-mailu.";
$Definition[
    ...
    "Pokud máte v sekci „Odkaz na podmínky použití“ výše odkaz na interní dokument, bude text „Text podmínek použití“ ignorován. Pokud chcete tento text použít, odkaz odstraňte.";
...
$Definition["Include full post in email notifications"] =
    "Zahrnout do e-mailových upozornění celý příspěvek";
...
$Definition["Include featured images with posts in email digest"] =
    "Zahrnout doporučené obrázky s příspěvky do e-mailového přehledu";
$Definition["Include internal profile fields"] =
    "Zahrnout vnitřní pole profilu";
$Definition["Include private profile fields"] =
    "Zahrnout pole soukromého profilu";
...
$Definition["It looks like you edited your post. <0/> or <1/>."] =
    "Zdá se, že jste svůj příspěvek upravili. <0/> nebo <1/>.";
...
$Definition["Large images will be scaled down."] =
    "Velké obrázky budou zmenšeny na maximální šířku podle %spx a maximální výšku podle %spx.";
...
$Definition["Limits: 60 characters, no breaks."] =
    "Omezení: 60 znaků, bez přestávek.";
...
$Definition["Add your site to trusted domains."] =
    "Když je povoleno vkládání, zajistěte, aby byl váš web přidán do umístění %s.";
...
$Definition["Manage Suggested Answer Sources"] =
    "Správa navrhovaných zdrojů odpovědí";
...
$Definition["Mark All Suggested Answers as Accepted"] =
    "Označte všechny navrhované odpovědi jako přijaté";
...
$Definition[
    ...
    "Složitější jazyk a může zavádět některé termíny specifické pro dané odvětví, ale stále je pro většinu lidí srozumitelný.";
...
$Definition[
    ...
    "Technickější jazyk a termíny specifické pro dané odvětví – předpokládá vyšší úroveň ofTech porozumění / obeznámenosti s předmětem.";
...
$Definition["No item options are available for Link display type."] =
    "Pro typ zobrazení Odkaz nejsou k dispozici žádné možnosti položek.";
...
$Definition["Notify me when my questions have AI Suggested Answers"] =
    "Upozorněte mě, když moje otázky obsahují odpovědi navržené umělou inteligencí";
...
$Definition[
    ...
    'K dispozici jsou pouze pole s jedním zaškrtávacím políčkem, rozevíracím seznamem s jedním výběrem, rozevíracím seznamem s více výběry nebo číselným rozevíracím seznamem. Jakmile jsou pole vybrána, zobrazí se níže, takže si můžete vybrat konkrétní odpovědi pro každé pole profilu.';
...
$Definition["Only visible to users with roles with permission."] =
    "Viditelné jen pro uživatele s oprávněnými rolemi.";
$Definition[
    "Open cases will only display if the user has a valid Salesforce connection."
] =
    "Otevřené případy se zobrazí pouze v případě, že má uživatel platné připojení ke službě Salesforce.";
...
$Definition["Or select an image on your computer (2mb max)"] =
    "Nebo vyberte obrázek na vašem počítači (maximálně 2 MB)";
...
$Definition["Pageview ratio representing a deflected case"] =
    "Poměr zobrazení stránky představující odchýlenou velikost písmen";
...
$Definition["Please enter a unique API Label, this one has been used before"] =
    "Zadejte prosím jedinečný štítek API, tento byl již dříve použit.";
...
$Definition[
    ...
    "Možné problémy s kompatibilitou se staršími prohlížeči, které ovlivňují uživatelský dojem.";
...
$Definition[
    ...
    "Protokoly (např. https://) a cesty (např. vasedomena.com/nejaka/cesta) by měly být vynechány.";
...
$Definition["Read more in the documentation"] =
    "Přečtěte si více v dokumentaci";
...
$Definition[
    ...
    "Doporučené rozměry jsou 400 x 300 pixelů nebo menší s podobným poměrem.";
...
$Definition["Reload the page to see recent updates."] =
    "Chcete-li zobrazit nejnovější aktualizace, znovu načtěte stránku.";
$Definition["Reload the page to access recent updates."] =
    "Chcete-li získat přístup k nejnovějším aktualizacím, znovu načtěte stránku.";
...
$Definition["Reset password and send email notification to user"] =
    "Resetovat heslo a zaslat uživateli upozornění na email";
...
$Definition["RolePersonalInfo"] =
    "Tato role je osobním údajem. Pouze uživatelé s povolením k prohlížení osobních údajů ji mohou vidět.";
...
$Definition["Search by user or role."] =
    "Hledejte uživatele podle jména nebo e-mailu, volitelně pomocí % jako zástupného znaku. Můžete také hledat podle ID uživatele, názvu role nebo “zakázané uživatele”.";
...
] = "Vyberte, které sloupce se zobrazí v seznamu stránek pro správu uživatelů.";
$Definition["Selection will affect the item options available."] =
    "Výběr ovlivní dostupné možnosti položky.";
...
$Definition['Separate each word with a semi-colon ";"'] =
    'Oddělte každé slovo středníkem „;“';
$Definition[
    "Set this interest as default to suggest following its mapped categories and tags to all users."
] =
    "Nastavte tento zájem jako výchozí, abyste všem uživatelům navrhovali sledování jeho namapovaných kategorií a značek.";
...
] = "Ukažte každému uživateli přizpůsobený seznam nápadů, které vytvořil nebo pro které hlasoval.";
...
] = "Zde vybrané zdroje budou k dispozici pro AI Suggested Answers.";
$Definition["Specify one domain per line. Use * for wildcard matches."] =
    "Uvádějte vždy jednu doménu na řádek. Volitelnou část řetězce označte hvězdičkou *.";
$Definition["Spoof"] = "Spoof";
$Definition["SSO Role"] = "Role SSO";
$Definition["SSO roles are always passed through SSO."] =
    "Role SSO jsou vždy předávány SSO.";
...
$Definition[
    ...
    "Předmět shrnutí začněte nastavením [Název banneru] v části Vzhled > Branding a SEO";
...
$Definition[
    ...
    "Styly a obecný vizuální vzhled všech e-mailů, včetně přehledu e-mailů, se nastavují na celém webu na stránce Nastavení e-mailu.";
...
$Definition["Suggestions are only visible to you until you accept the answer"] =
    "Návrhy jsou viditelné pouze pro vás, dokud nepřijmete odpověď";
$Definition["Suggestions may only be generated on questions"] =
    "Návrhy lze generovat pouze na otázky";
...
$Definition["Thanks for sticking with us for a full year."] =
    "Děkujeme, že jste se s námi byli po celý rok.";
$Definition["Thanks for sticking with us for %s years."] =
    "Děkujeme, že jste s námi %s let.";
...
$Definition["The content you were looking for has been deleted."] =
    "Obsah, který jsi hledal byl vymazán.";
$Definition[
    "The default banner image across the site. This can be overridden on a per category basis."
] =
    "Výchozí obrázek banneru na celém webu. To lze přepsat na základě kategorie.";
...
$Definition["The email address this test will be sent to."] =
    "E-mailová adresa, na kterou bude tento test odeslán.";
...
$Definition["The first line of content in the email digest after the title."] =
    "První řádek obsahu v e-mailovém výtahu za názvem.";
$Definition["The homepage title is displayed on your home page."] =
    "Nadpis domácí stránky je zobrazen na domácí stránce fóra. Vyberte takový nadpis, který byste chtěli, aby byl zobrazen ve vyhledávačích.";
...
$Definition["The Key in the XML payload to designate %s."] =
    "Klíč v užitečném obsahu XML k označení %s.";
$Definition[
    "The test digest will generate content as if it were this user receiving the digest."
] =
    "Testovací výtah vygeneruje obsah, jako by to byl tento uživatel.";
...
$Definition[
    ...
    'Vyskytla se chyba nahrávání obrázku. Povolené formáty vašeho obrázku jsou: gif, jpg, png';
...
$Definition["There are currently no requests."] =
    "V tuto chvíli nejsou žádné žádosti.";
...
$Definition["The next three email digest delivery dates"] =
    "Další tři data doručení e-mailového přehledu";
...
$Definition[
    ...
    "Na většině webů to není nutné, kromě těch, které využívají funkce jako AdSense a Správce značek Google.";
$Definition[
    ...
    "Toto je souhrn vytvořený AI z odkazovaného diskusního příspěvku, který by mohl odpovědět na otázku. Souhrn je vytvořen tak, aby mohl být použit jako přijatá odpověď.";
...
$Definition["This controls how the responses are phrased and spelled."] =
    "To řídí, jak jsou odpovědi formulovány a hláskovány.";
$Definition["This Database"] = "This Database";
$Definition["QnAFollowup.Feature.Enabled"] =
    "Tato funkce odesílá e-maily autorům zodpovězených otázek, které nemají akceptovanou odpověď.";
...
$Definition[
    ...
    'Tento obrázek bude použit v seznamech kategorií a widgetech při použití možnosti stylu „Ikona“.';
$Definition[
    ...
    'Tento obrázek se zobrazí v banneru této kategorie a ve widgetech kategorií při použití možností stylu „Obrázek“ a/nebo „Pozadí“. Doporučené rozměry jsou přibližně 1000 x 400 pixelů nebo podobný poměr.';
...
$Definition[
    ...
    "To lze použít k zahrnutí obsahu, jako je název organizace a adresa, do e-mailového výtahu.";
$Definition["This name will be shown in the community."] =
    "Toto jméno se zobrazí v komunitě.";
...
] = "Toto téma nelze odstranit, protože je aktuálně používané.";
...
$Definition[
    ...
    "To navede ostatní uživatele s podobnými otázkami ke správným odpovědím rychleji a zobrazí odpověď navrženou umělou inteligencí a propojí odkazovaný materiál pro ostatní uživatele. Návrhy jsou viditelné pouze pro vás, dokud nepřijmete odpověď.";
...
$Definition["Truncate the initial discussion text to this many words."] =
    "Zkraťte počáteční text diskuze na tento počet slov.";
...
$Definition["Up to a maximum of 100 items may be displayed."] =
    "Lze zobrazit maximálně 100 položek.";
...
$Definition["Use asterisks for wildcards"] =
    'Používejte hvězdičky pro zástupné znaky, například  "*@gmail.com"';
...
$Definition[
    ...
    "Používá vysoce odborný jazyk a oborově specifické výrazy určené pro ty, kteří mají hluboké porozumění předmětu.";
$Definition[
    "Uses industry-specific terms where necessary, but also provides explanations of definitions to ensure clarity."
] =
    "V případě potřeby používá výrazy specifické pro dané odvětví, ale také poskytuje vysvětlení definic, aby byla zajištěna srozumitelnost.";
$Definition[
...
$Definition[
    ...
    "Uživatelé mohou sledovat kategorie a přihlásit se k odběru upozornění na nové příspěvky. Vyberte, které kategorie by měli noví uživatelé ve výchozím nastavení sledovat.";
...
$Definition[
    ...
    "Uživatelé nebudou upozorněni, pokud postupují podle těchto odkazů na důvěryhodné domény.";
$Definition[
    "Users will be redirected to this URL after accepting an invitation."
] =
    "Po přijetí pozvání budou uživatelé přesměrováni na tuto URL adresu. Může to být úplná adresa URL nebo cesta k přesměrování v rámci webu.";
...
$Definition["Users with the no ads permission will not see this pocket."] =
    "Uživatelé s vypnutými reklamami neuvidí tuto záložku.";
...
$Definition["Use weekly community email digest"] =
    "Použijte týdenní přehled e-mailů komunity";
...
$Definition["View browser compatibility chart"] =
    "Zobrazit tabulku kompatibility prohlížeče";
...
] = "Upozornit uživatele, pokud je odkaz v příspěvku odvede z fóra pryč";
$Definition[
...
$Definition[
    ...
    "Vítejte. Jsem váš AI Suggestion Assistant, nástroj založený na strojovém učení určený k vyhledání a navrhování relevantních článků a příspěvků v reakci na vaše dotazy. Zadejte prosím své dotazy a já vám poskytnu nejvhodnější informace.";
$Definition['What\'s the Buzz?'] = 'What\'s the Buzz?';
$Definition["When enabled, search result will open in a new browser tab."] =
    "Pokud je tato možnost povolena, otevře se výsledek vyhledávání na nové kartě prohlížeče.";
$Definition[
    "When enabled, your community will have AI Suggestions shown in Q&A. <0/>"
] = "Když je tato možnost povolena, vaše komunita bude mít návrhy AI zobrazené v otázkách a odpovědích. <0/>";
$Definition[
    ...
    "Když je toto nastavení povoleno, údaje o uživateli v datech Analytics budou ve výchozím nastavení anonymizovány, dokud uživatel nevyjádří souhlas se soubory cookie Analytics. <0>Další informace</0>";
...
$Definition["Why am I seeing AI Suggested Answers?"] =
    "Proč se mi zobrazují odpovědi navržené umělou inteligencí?";
...
$Definition["You are not allowed to use suggestions"] =
    "Nemáte povoleno používat návrhy";
...
$Definition[
    ...
    "Pomocí tohoto nástroje můžete blokovat IP adresy, e-mailové domény a slova v uživatelských jménech.";
$Definition[
...
] = "Můžete vyhledávat uživatele podle uživatelského jména nebo e-mailu, zástupné znaky jsou implicitní.";
$Definition["You can specify an allow list of trusted domains."] =
    "Můžete zadat seznam důvěryhodných domén, které jsou bezpečné pro přesměrování a vkládání.";
$Definition["You can specify an allow list of trusted domains. (CSP)"] =
    "Můžete zadat seznam povolených důvěryhodných domén (např. vasedomena.com), ze kterých je bezpečné načíst javascript.";
$Definition[
...
$Definition[
    ...
    "Během vývoje můžete svou stránku chránit HTTP uživatelským jménem/heslem.";
$Definition[
    "You can send emails in plain text by disabling the toggle below."
] = "Můžete odesílat emaily ve formátu prostého textu vypnutím přepínače níže. ";
...
$Definition[
    ...
    "Editor témat opouštíte bez uložení změn. Před odchodem se ujistěte, že jsou vaše aktualizace uloženy.";
$Definition[
    "You are leaving the Email Settings page without saving your changes. Make sure your updates are saved before exiting."
] =
    "Opouštíte stránku Nastavení e-mailu bez uložení změn. Před ukončením se ujistěte, že jsou vaše aktualizace uloženy.";
...
$Definition['You can also include placeholders in your email content—these will be automatically replaced with relevant user or post information when the email is sent. For example, Hello {user.name}! or Check out {discussion.name}.'] = 'Do obsahu e-mailu můžete také zahrnout zástupné symboly – ty budou při odeslání e-mailu automaticky nahrazeny relevantními informacemi o uživateli nebo příspěvku. Například Dobrý den, {uživatel.jméno}! nebo Podívejte se na {diskuse.jméno}.';
