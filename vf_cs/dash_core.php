...
$Definition['ForceWysiwyg.Notes1'] = 'Zaškrtnutím níže uvedené volby editoru sdělíte, aby reinterpretoval všechny staré příspěvky jako Wysiwyg. ';
$Definition['ForceWysiwyg.Notes2'] = 'Toto nastavení se projeví pouze v případě, že byl jako formát příspěvku výše vybrán Wysiwyg. Účelem této možnosti je normalizovat formát editoru. Pokud jsou načteny starší příspěvky editované jiným formátem, jako například markdown nebo BBCode, tato volba vynutí použití formátu Wysiwyg.';
...
$Definition['Reinterpret All Posts As Wysiwyg'] = 'Reinterpretovat všechny příspěvky jako Wysiwyg';
