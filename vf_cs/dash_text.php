...
$Definition['If enabled, the full content of posts will be sent in email notifications to users.'] =
    'Pokud je tato možnost povolena, bude veškerý obsah příspěvků odeslán uživatelům prostřednictvím e-mailových oznámení.';
...
$Definition['RichEditor.QuoteEnable.Notes'] =
    'Pomocí následující možnosti povolte nabídky pro Rich Editor. To bude platit, pouze pokud je výchozí formátovací formát „Rich“.';
...
$Definition['ShareImageDescription'] =
    'Když někdo sdílí odkaz z vašeho webu, pokusíme se obrázek ze stránky chytit. Pokud na stránce není obrázek, použijeme tento obrázek. Obrázek by měl být alespoň 50 × 50, ale doporučujeme 200 × 200.';
...
$Definition['This role is personal info. Only users with permission to view personal info will see it.'] =
    'Tato role je osobní informace. Zobrazí se pouze uživatelům s povolením k prohlížení osobních údajů.';
$Definition['This setting loads the page before executing Javascript.'] =
    'Toto nastavení načte stránku před spuštěním Javascriptu, což může vylepšit vaše SEO. <br> <strong>** Varování: Povolení této funkce může způsobit chyby Javascriptu na vašem webu. **</strong>';
