...
$Definition['Allow links to be transformed'] =
    'Umožňují transformaci odkazů na vložené reprezentace v diskusích a komentářích. Například odkaz na YouTube se změní na vložené video.';
...
$Definition['This role is personal info. Only users with permission to view personal info will see it.'] = 'Tato role je osobním údajem. Pouze uživatelé s povolením k prohlížení osobních údajů ji mohou vidět.';
$Definition['This setting loads the page before executing Javascript.'] = 'Tímto nastavením se stránka načte před spuštěním Javascriptu, což může zlepšit vaše SEO.<br><strong>**Varování: Povolením této funkce může dojít k chybám Javascriptu na vašich stránkách.**</strong>';
